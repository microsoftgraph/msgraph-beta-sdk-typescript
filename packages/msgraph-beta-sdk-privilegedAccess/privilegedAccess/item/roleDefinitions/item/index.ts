 ...
 */
export const GovernanceRoleDefinitionItemRequestBuilderUriTemplate = "{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleDefinitions/{governanceRoleDefinition%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
