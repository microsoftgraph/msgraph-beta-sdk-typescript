 ...
 */
export const MailboxSettingsRequestBuilderUriTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/owners/{user%2Did}/mailboxSettings{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
