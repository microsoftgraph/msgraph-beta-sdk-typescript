 ...
 */
export const UserItemRequestBuilderUriTemplate = "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/owners/{user%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
