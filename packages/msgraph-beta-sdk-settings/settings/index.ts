...
// @ts-ignore
import { createDirectorySettingCollectionResponseFromDiscriminatorValue, createDirectorySettingFromDiscriminatorValue, serializeDirectorySetting, type DirectorySetting, type DirectorySettingCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { DirectorySettingItemRequestBuilderRequestsMetadata, type DirectorySettingItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface SettingsRequestBuilder extends BaseRequestBuilder<SettingsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/group-list-settings?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/group-post-settings?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const SettingsRequestBuilderUriTemplate = "{+baseurl}/settings{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
