...
import { PrivilegedRolesRequestBuilderNavigationMetadata, PrivilegedRolesRequestBuilderRequestsMetadata, PrivilegedRolesRequestBuilderUriTemplate, type PrivilegedRolesRequestBuilder } from './privilegedRoles/';
...
export function createPrivilegedRolesServiceClient(requestAdapter: RequestAdapter, backingStore?: BackingStoreFactory | undefined) {
    ...
    return apiClientProxifier<PrivilegedRolesServiceClient>(requestAdapter, pathParameters, PrivilegedRolesServiceClientUriTemplate, PrivilegedRolesServiceClientNavigationMetadata, undefined);
}
/**
