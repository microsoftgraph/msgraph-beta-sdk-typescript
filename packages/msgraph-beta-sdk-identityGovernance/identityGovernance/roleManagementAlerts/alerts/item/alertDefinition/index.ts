 ...
 */
export const AlertDefinitionRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/roleManagementAlerts/alerts/{unifiedRoleManagementAlert%2Did}/alertDefinition{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
