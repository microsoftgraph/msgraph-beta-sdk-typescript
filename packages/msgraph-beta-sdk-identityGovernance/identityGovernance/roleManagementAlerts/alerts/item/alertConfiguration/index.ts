 ...
 */
export const AlertConfigurationRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/roleManagementAlerts/alerts/{unifiedRoleManagementAlert%2Did}/alertConfiguration{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
