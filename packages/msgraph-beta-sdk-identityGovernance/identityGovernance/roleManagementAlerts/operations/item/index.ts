 ...
 */
export const LongRunningOperationItemRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/roleManagementAlerts/operations/{longRunningOperation%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
