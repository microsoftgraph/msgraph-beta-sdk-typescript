...
// @ts-ignore
import { createAccessReviewHistoryInstanceCollectionResponseFromDiscriminatorValue, createAccessReviewHistoryInstanceFromDiscriminatorValue, serializeAccessReviewHistoryInstance, type AccessReviewHistoryInstance, type AccessReviewHistoryInstanceCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface InstancesRequestBuilder extends BaseRequestBuilder<InstancesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/accessreviewhistorydefinition-list-instances?view=graph-rest-beta|Find more info here}
     */
