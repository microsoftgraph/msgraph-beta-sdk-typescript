...
export interface AccessReviewScheduleDefinitionItemRequestBuilder extends BaseRequestBuilder<AccessReviewScheduleDefinitionItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/accessreviewscheduledefinition-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/accessreviewscheduledefinition-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<AccessReviewScheduleDefinition>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/accessreviewscheduledefinition-update?view=graph-rest-beta|Find more info here}
     */
