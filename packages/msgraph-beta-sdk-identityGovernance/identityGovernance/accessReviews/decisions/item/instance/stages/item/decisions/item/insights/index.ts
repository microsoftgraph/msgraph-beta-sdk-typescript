...
import { createGovernanceInsightCollectionResponseFromDiscriminatorValue, createGovernanceInsightFromDiscriminatorValue, serializeGovernanceInsight, type GovernanceInsight, type GovernanceInsightCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
 ...
 */
export const InsightsRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/stages/{accessReviewStage%2Did}/decisions/{accessReviewInstanceDecisionItem%2Did1}/insights{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
