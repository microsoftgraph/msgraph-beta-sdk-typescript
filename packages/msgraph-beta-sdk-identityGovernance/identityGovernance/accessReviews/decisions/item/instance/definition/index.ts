 ...
 */
export const DefinitionRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem%2Did}/instance/definition{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
