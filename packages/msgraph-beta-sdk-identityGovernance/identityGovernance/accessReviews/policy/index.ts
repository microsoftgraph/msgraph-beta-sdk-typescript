...
// @ts-ignore
import { createAccessReviewPolicyFromDiscriminatorValue, serializeAccessReviewPolicy, type AccessReviewPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PolicyRequestBuilder extends BaseRequestBuilder<PolicyRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/accessreviewpolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<AccessReviewPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/accessreviewpolicy-update?view=graph-rest-beta|Find more info here}
     */
