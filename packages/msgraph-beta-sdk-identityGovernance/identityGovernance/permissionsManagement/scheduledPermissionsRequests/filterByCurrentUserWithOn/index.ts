...
import { createScheduledPermissionsRequestFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeScheduledPermissionsRequest, type BaseCollectionPaginationCountResponse, type ScheduledPermissionsRequest } from '@microsoft/msgraph-beta-sdk/models/';
...
export function deserializeIntoFilterByCurrentUserWithOnGetResponse(filterByCurrentUserWithOnGetResponse: Partial<FilterByCurrentUserWithOnGetResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "value": n => { filterByCurrentUserWithOnGetResponse.value = n.getCollectionOfObjectValues<ScheduledPermissionsRequest>(createScheduledPermissionsRequestFromDiscriminatorValue); },
    }
}
export interface FilterByCurrentUserWithOnGetResponse extends BaseCollectionPaginationCountResponse, Parsable {
     ...
     * The value property
     */
    value?: ScheduledPermissionsRequest[];
}
/**
...
export function serializeFilterByCurrentUserWithOnGetResponse(writer: SerializationWriter, filterByCurrentUserWithOnGetResponse: Partial<FilterByCurrentUserWithOnGetResponse> | undefined = {}) : void {
    ...
    writer.writeCollectionOfObjectValues<ScheduledPermissionsRequest>("value", filterByCurrentUserWithOnGetResponse.value, serializeScheduledPermissionsRequest);
}
/**
 * Uri template for the request builder.
 */
export const FilterByCurrentUserWithOnRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/permissionsManagement/scheduledPermissionsRequests/filterByCurrentUser(on='{on}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
