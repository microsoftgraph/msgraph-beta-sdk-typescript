...
import { createScheduledPermissionsRequestCollectionResponseFromDiscriminatorValue, createScheduledPermissionsRequestFromDiscriminatorValue, serializeScheduledPermissionsRequest, type ScheduledPermissionsRequest, type ScheduledPermissionsRequestCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
 ...
 * Represents a permissions request that Permissions Management uses to manage permissions for an identity on resources in the authorization system. This request can be granted, rejected or canceled by identities in Permissions Management.
 */
export interface ScheduledPermissionsRequestsRequestBuilderGetQueryParameters {
    /**
 ...
 */
export const ScheduledPermissionsRequestsRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/permissionsManagement/scheduledPermissionsRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
 * Provides operations to manage the scheduledPermissionsRequests property of the microsoft.graph.permissionsManagement entity.
 */
...
export const GetOrderbyQueryParameterTypeObject = {
    ...
    RequestedPermissionsDesc: "requestedPermissions desc",
 ...
 */
const ScheduledPermissionsRequestsRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "count": "%24count",
    "expand": "%24expand",
    "filter": "%24filter",
    "orderby": "%24orderby",
