...
// @ts-ignore
import { createAgreementAcceptanceCollectionResponseFromDiscriminatorValue, createAgreementAcceptanceFromDiscriminatorValue, serializeAgreementAcceptance, type AgreementAcceptance, type AgreementAcceptanceCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AcceptancesRequestBuilder extends BaseRequestBuilder<AcceptancesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/agreement-list-acceptances?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const AcceptancesRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/acceptances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
