 ...
 */
export const GroupRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/privilegedAccess/group/eligibilitySchedules/{privilegedAccessGroupEligibilitySchedule%2Did}/group{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
