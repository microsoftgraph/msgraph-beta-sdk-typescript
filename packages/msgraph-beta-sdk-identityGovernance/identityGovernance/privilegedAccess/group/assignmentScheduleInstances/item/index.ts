...
// @ts-ignore
import { createPrivilegedAccessGroupAssignmentScheduleInstanceFromDiscriminatorValue, serializePrivilegedAccessGroupAssignmentScheduleInstance, type PrivilegedAccessGroupAssignmentScheduleInstance } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PrivilegedAccessGroupAssignmentScheduleInstanceItemRequestBuilder extends BaseRequestBuilder<PrivilegedAccessGroupAssignmentScheduleInstanceItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/privilegedaccessgroupassignmentscheduleinstance-get?view=graph-rest-beta|Find more info here}
     */
