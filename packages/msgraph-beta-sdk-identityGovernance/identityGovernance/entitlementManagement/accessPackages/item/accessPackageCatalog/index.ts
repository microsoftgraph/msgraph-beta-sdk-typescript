 ...
 */
export const AccessPackageCatalogRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage%2Did}/accessPackageCatalog{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
