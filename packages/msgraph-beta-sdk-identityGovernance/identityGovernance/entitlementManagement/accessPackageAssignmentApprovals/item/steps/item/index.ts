...
// @ts-ignore
import { createApprovalStepFromDiscriminatorValue, serializeApprovalStep, type ApprovalStep } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ApprovalStepItemRequestBuilder extends BaseRequestBuilder<ApprovalStepItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/approvalstep-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ApprovalStep>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/approvalstep-update?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const ApprovalStepItemRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentApprovals/{approval%2Did}/steps/{approvalStep%2Did}{?%24expand,%24select}";
/**
