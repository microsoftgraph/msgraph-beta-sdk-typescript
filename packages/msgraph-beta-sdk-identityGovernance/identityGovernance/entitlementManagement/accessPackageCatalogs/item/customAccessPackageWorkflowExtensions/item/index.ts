...
// @ts-ignore
import { createCustomAccessPackageWorkflowExtensionFromDiscriminatorValue, serializeCustomAccessPackageWorkflowExtension, type CustomAccessPackageWorkflowExtension } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface CustomAccessPackageWorkflowExtensionItemRequestBuilder extends BaseRequestBuilder<CustomAccessPackageWorkflowExtensionItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/customaccesspackageworkflowextension-delete?view=graph-rest-1.0|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @deprecated  as of 2022-10/PrivatePreview:MicrosofEntitlementManagementCustomextensions
     * @see {@link https://learn.microsoft.com/graph/api/customaccesspackageworkflowextension-get?view=graph-rest-1.0|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @deprecated  as of 2022-10/PrivatePreview:MicrosofEntitlementManagementCustomextensions
     * @see {@link https://learn.microsoft.com/graph/api/customaccesspackageworkflowextension-update?view=graph-rest-1.0|Find more info here}
     */
