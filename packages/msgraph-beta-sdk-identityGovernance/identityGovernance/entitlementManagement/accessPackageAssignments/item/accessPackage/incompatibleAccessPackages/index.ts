...
// @ts-ignore
import { createAccessPackageCollectionResponseFromDiscriminatorValue, type AccessPackageCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface IncompatibleAccessPackagesRequestBuilder extends BaseRequestBuilder<IncompatibleAccessPackagesRequestBuilder> {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.identityGovernance.entitlementManagement.accessPackageAssignments.item.accessPackage.incompatibleAccessPackages.item collection
 ...
 */
export const IncompatibleAccessPackagesRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackage/incompatibleAccessPackages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
