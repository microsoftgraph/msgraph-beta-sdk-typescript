...
// @ts-ignore
import { createAccessPackageAssignmentCollectionResponseFromDiscriminatorValue, createAccessPackageAssignmentFromDiscriminatorValue, serializeAccessPackageAssignment, type AccessPackageAssignment, type AccessPackageAssignmentCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface AccessPackageAssignmentsRequestBuilder extends BaseRequestBuilder<AccessPackageAssignmentsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/entitlementmanagement-list-accesspackageassignments?view=graph-rest-1.0|Find more info here}
     */
 ...
 */
export const AccessPackageAssignmentsRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
