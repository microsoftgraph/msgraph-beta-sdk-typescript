...
// @ts-ignore
import { createAccessPackageSuggestionFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeAccessPackageSuggestion, serializeBaseCollectionPaginationCountResponse, type AccessPackageSuggestion, type BaseCollectionPaginationCountResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export function deserializeIntoFilterByCurrentUserWithOnGetResponse(filterByCurrentUserWithOnGetResponse: Partial<FilterByCurrentUserWithOnGetResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "value": n => { filterByCurrentUserWithOnGetResponse.value = n.getCollectionOfObjectValues<AccessPackageSuggestion>(createAccessPackageSuggestionFromDiscriminatorValue); },
    }
}
...
export interface FilterByCurrentUserWithOnRequestBuilder extends BaseRequestBuilder<FilterByCurrentUserWithOnRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/accesspackagesuggestions-filterbycurrentuser?view=graph-rest-beta|Find more info here}
     */
...
export function serializeFilterByCurrentUserWithOnGetResponse(writer: SerializationWriter, filterByCurrentUserWithOnGetResponse: Partial<FilterByCurrentUserWithOnGetResponse> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeCollectionOfObjectValues<AccessPackageSuggestion>("value", filterByCurrentUserWithOnGetResponse.value, serializeAccessPackageSuggestion);
}
/**
 * Uri template for the request builder.
 */
export const FilterByCurrentUserWithOnRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageSuggestions/filterByCurrentUser(on='{on}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
