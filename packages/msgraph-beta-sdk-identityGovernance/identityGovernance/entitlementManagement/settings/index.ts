...
// @ts-ignore
import { createEntitlementManagementSettingsFromDiscriminatorValue, serializeEntitlementManagementSettings, type EntitlementManagementSettings } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SettingsRequestBuilder extends BaseRequestBuilder<SettingsRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/entitlementmanagementsettings-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<EntitlementManagementSettings>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/entitlementmanagementsettings-update?view=graph-rest-beta|Find more info here}
     */
