...
// @ts-ignore
import { createAccessPackageResourceRequestCollectionResponseFromDiscriminatorValue, createAccessPackageResourceRequestFromDiscriminatorValue, serializeAccessPackageResourceRequest, type AccessPackageResourceRequest, type AccessPackageResourceRequestCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AccessPackageResourceRequestsRequestBuilder extends BaseRequestBuilder<AccessPackageResourceRequestsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/entitlementmanagement-list-accesspackageresourcerequests?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/entitlementmanagement-post-accesspackageresourcerequests?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const AccessPackageResourceRequestsRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResourceRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
