...
// @ts-ignore
import { createTaskCollectionResponseFromDiscriminatorValue, createTaskFromDiscriminatorValue, serializeTask, type Task, type TaskCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/identityGovernance/index.js';
// @ts-ignore
...
export interface TasksRequestBuilder extends BaseRequestBuilder<TasksRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identitygovernance-workflow-list-task?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const TasksRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
