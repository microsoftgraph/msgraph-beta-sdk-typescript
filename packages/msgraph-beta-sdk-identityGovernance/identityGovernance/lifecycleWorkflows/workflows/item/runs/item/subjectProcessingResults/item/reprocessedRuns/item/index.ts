...
// @ts-ignore
import { createRunFromDiscriminatorValue, type Run } from '@microsoft/msgraph-beta-sdk/models/identityGovernance/index.js';
// @ts-ignore
 ...
 */
export const RunItemRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/runs/{run%2Did}/subjectProcessingResults/{subjectProcessingResult%2Did}/reprocessedRuns/{run%2Did1}{?%24expand,%24select}";
/**
