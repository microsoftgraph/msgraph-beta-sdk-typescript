...
// @ts-ignore
import { createUserProcessingResultCollectionResponseFromDiscriminatorValue, type UserProcessingResultCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/identityGovernance/';
// @ts-ignore
...
export interface UserProcessingResultsRequestBuilder extends BaseRequestBuilder<UserProcessingResultsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identitygovernance-run-list-userprocessingresults?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const UserProcessingResultsRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/runs/{run%2Did}/userProcessingResults{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
