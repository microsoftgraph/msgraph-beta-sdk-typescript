...
// @ts-ignore
import { createSubjectProcessingResultFromDiscriminatorValue, type SubjectProcessingResult } from '@microsoft/msgraph-beta-sdk/models/identityGovernance/index.js';
// @ts-ignore
...
export interface SubjectProcessingResultItemRequestBuilder extends BaseRequestBuilder<SubjectProcessingResultItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identitygovernance-subjectprocessingresult-get?view=graph-rest-beta|Find more info here}
     */
 ...
 * Read the properties and relationships of a subjectProcessingResult object for a workflow run.
 */
export interface SubjectProcessingResultItemRequestBuilderGetQueryParameters {
    /**
 ...
 */
export const SubjectProcessingResultItemRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/runs/{run%2Did}/subjectProcessingResults/{subjectProcessingResult%2Did}{?%24expand,%24select}";
/**
 * Mapper for query parameters from symbol name to serialization name represented as a constant.
 */
const SubjectProcessingResultItemRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "expand": "%24expand",
    "select": "%24select",
};
/**
 ...
 */
export const SubjectProcessingResultItemRequestBuilderNavigationMetadata: Record<Exclude<keyof SubjectProcessingResultItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    reprocessedRuns: {
 ...
 */
export const SubjectProcessingResultItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: SubjectProcessingResultItemRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
        adapterMethodName: "send",
        responseBodyFactory:  createSubjectProcessingResultFromDiscriminatorValue,
        queryParametersMapper: SubjectProcessingResultItemRequestBuilderGetQueryParametersMapper,
    },
};
/* tslint:enable */
/* eslint-enable */
