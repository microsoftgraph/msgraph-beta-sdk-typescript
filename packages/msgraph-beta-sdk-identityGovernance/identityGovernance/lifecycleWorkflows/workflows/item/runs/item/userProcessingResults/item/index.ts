...
// @ts-ignore
import { createUserProcessingResultFromDiscriminatorValue, type UserProcessingResult } from '@microsoft/msgraph-beta-sdk/models/identityGovernance/index.js';
// @ts-ignore
...
export interface UserProcessingResultItemRequestBuilder extends BaseRequestBuilder<UserProcessingResultItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identitygovernance-userprocessingresult-get?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const UserProcessingResultItemRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/runs/{run%2Did}/userProcessingResults/{userProcessingResult%2Did}{?%24expand,%24select}";
/**
