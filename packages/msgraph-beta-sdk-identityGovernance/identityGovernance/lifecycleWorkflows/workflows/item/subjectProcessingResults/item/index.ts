 ...
 */
export const SubjectProcessingResultItemRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/subjectProcessingResults/{subjectProcessingResult%2Did}{?%24expand,%24select}";
/**
