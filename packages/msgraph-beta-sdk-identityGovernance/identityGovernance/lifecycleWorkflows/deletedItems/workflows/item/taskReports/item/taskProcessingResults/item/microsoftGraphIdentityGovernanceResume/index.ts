...
// @ts-ignore
import { createCustomTaskExtensionCallbackDataFromDiscriminatorValue, serializeCustomTaskExtensionCallbackData, type CustomTaskExtensionCallbackData } from '@microsoft/msgraph-beta-sdk/models/identityGovernance/index.js';
// @ts-ignore
...
export interface MicrosoftGraphIdentityGovernanceResumeRequestBuilder extends BaseRequestBuilder<MicrosoftGraphIdentityGovernanceResumeRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identitygovernance-taskprocessingresult-resume?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const MicrosoftGraphIdentityGovernanceResumeRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/taskReports/{taskReport%2Did}/taskProcessingResults/{taskProcessingResult%2Did}/microsoft.graph.identityGovernance.resume";
/**
