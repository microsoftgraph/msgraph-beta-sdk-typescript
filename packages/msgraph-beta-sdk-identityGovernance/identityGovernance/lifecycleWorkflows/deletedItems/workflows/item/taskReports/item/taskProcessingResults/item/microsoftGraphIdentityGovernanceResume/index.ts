...
// @ts-ignore
import { createCustomTaskExtensionCallbackDataFromDiscriminatorValue, serializeCustomTaskExtensionCallbackData, type CustomTaskExtensionCallbackData } from '@microsoft/msgraph-beta-sdk/models/identityGovernance/';
// @ts-ignore
