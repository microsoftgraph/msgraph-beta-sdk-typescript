...
export interface CreatedByRequestBuilder extends BaseRequestBuilder<CreatedByRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<CreatedByRequestBuilderGetQueryParameters> | undefined) : Promise<DirectoryObject | undefined>;
    /**
     * Get createdBy from identityGovernance
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const CreatedByRequestBuilderUriTemplate = "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/lifecyclePolicies/{lifecyclePolicy%2Did}/versions/{lifecyclePolicy%2Did1}/createdBy{?%24expand,%24select}";
/**
