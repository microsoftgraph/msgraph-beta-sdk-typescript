...
// @ts-ignore
import { createCustomTaskExtensionCollectionResponseFromDiscriminatorValue, createCustomTaskExtensionFromDiscriminatorValue, serializeCustomTaskExtension, type CustomTaskExtension, type CustomTaskExtensionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/identityGovernance/index.js';
// @ts-ignore
