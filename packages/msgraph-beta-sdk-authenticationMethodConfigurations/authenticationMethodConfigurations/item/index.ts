 ...
 */
export const AuthenticationMethodConfigurationItemRequestBuilderUriTemplate = "{+baseurl}/authenticationMethodConfigurations/{authenticationMethodConfiguration%2Did}{?%24expand,%24select}";
/**
