...
// @ts-ignore
import { createManagedEBookCategoryCollectionResponseFromDiscriminatorValue, type ManagedEBookCategoryCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CategoriesRequestBuilder extends BaseRequestBuilder<CategoriesRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<CategoriesRequestBuilderGetQueryParameters> | undefined) : Promise<ManagedEBookCategoryCollectionResponse | undefined>;
    /**
     * The list of categories for this eBook.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const CategoriesRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/categories{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
