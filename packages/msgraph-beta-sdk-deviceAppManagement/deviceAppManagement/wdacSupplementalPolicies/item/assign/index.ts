...
export interface AssignPostRequestBody extends AdditionalDataHolder, BackedModel, Parsable {
     ...
     */
    wdacPolicyAssignments?: WindowsDefenderApplicationControlSupplementalPolicyAssignment[] | null;
}
/**
...
export function deserializeIntoAssignPostRequestBody(assignPostRequestBody: Partial<AssignPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "wdacPolicyAssignments": n => { assignPostRequestBody.wdacPolicyAssignments = n.getCollectionOfObjectValues<WindowsDefenderApplicationControlSupplementalPolicyAssignment>(createWindowsDefenderApplicationControlSupplementalPolicyAssignmentFromDiscriminatorValue); },
    }
}
/**
...
export function serializeAssignPostRequestBody(writer: SerializationWriter, assignPostRequestBody: Partial<AssignPostRequestBody> | undefined | null = {}) : void {
    if (assignPostRequestBody) {
        writer.writeCollectionOfObjectValues<WindowsDefenderApplicationControlSupplementalPolicyAssignment>("wdacPolicyAssignments", assignPostRequestBody.wdacPolicyAssignments, serializeWindowsDefenderApplicationControlSupplementalPolicyAssignment);
 ...
 */
export const AssignRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/wdacSupplementalPolicies/{windowsDefenderApplicationControlSupplementalPolicy%2Did}/assign";
/**
