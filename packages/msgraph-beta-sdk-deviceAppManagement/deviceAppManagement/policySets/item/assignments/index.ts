...
// @ts-ignore
import { createPolicySetAssignmentCollectionResponseFromDiscriminatorValue, createPolicySetAssignmentFromDiscriminatorValue, serializePolicySetAssignment, type PolicySetAssignment, type PolicySetAssignmentCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { PolicySetAssignmentItemRequestBuilderRequestsMetadata, type PolicySetAssignmentItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface AssignmentsRequestBuilder extends BaseRequestBuilder<AssignmentsRequestBuilder> {
     ...
     * @returns {Promise<PolicySetAssignmentCollectionResponse>}
 ...
 */
export const AssignmentsRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/policySets/{policySet%2Did}/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
