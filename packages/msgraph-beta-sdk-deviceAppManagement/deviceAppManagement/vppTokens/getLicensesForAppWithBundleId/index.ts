 ...
 */
export const GetLicensesForAppWithBundleIdRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/vppTokens/getLicensesForApp(bundleId='{bundleId}'){?%24top,%24skip,%24search,%24filter,%24count}";
/* tslint:enable */
/* eslint-enable */
