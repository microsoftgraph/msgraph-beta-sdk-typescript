...
// @ts-ignore
import { createMobileContainedAppCollectionResponseFromDiscriminatorValue, createMobileContainedAppFromDiscriminatorValue, serializeMobileContainedApp, type MobileContainedApp, type MobileContainedAppCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ContainedAppsRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedAndroidLobApp/contentVersions/{mobileAppContent%2Did}/containedApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
