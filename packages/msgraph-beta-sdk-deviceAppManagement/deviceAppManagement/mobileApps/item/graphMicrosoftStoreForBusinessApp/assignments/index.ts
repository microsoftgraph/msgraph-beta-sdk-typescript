...
// @ts-ignore
import { createMobileAppAssignmentCollectionResponseFromDiscriminatorValue, createMobileAppAssignmentFromDiscriminatorValue, serializeMobileAppAssignment, type MobileAppAssignment, type MobileAppAssignmentCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const AssignmentsRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.microsoftStoreForBusinessApp/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
