...
import { createMobileAppCategoryCollectionResponseFromDiscriminatorValue, type MobileAppCategoryCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
 ...
 */
export const CategoriesRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.microsoftStoreForBusinessApp/categories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
