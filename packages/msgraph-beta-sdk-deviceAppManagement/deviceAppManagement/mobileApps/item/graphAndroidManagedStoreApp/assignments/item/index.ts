...
// @ts-ignore
import { createMobileAppAssignmentFromDiscriminatorValue, serializeMobileAppAssignment, type MobileAppAssignment } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const MobileAppAssignmentItemRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidManagedStoreApp/assignments/{mobileAppAssignment%2Did}{?%24expand,%24select}";
/**
