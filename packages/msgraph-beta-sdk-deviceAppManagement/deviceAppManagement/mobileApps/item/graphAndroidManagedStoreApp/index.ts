...
// @ts-ignore
import { createAndroidManagedStoreAppFromDiscriminatorValue, type AndroidManagedStoreApp } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GraphAndroidManagedStoreAppRequestBuilder extends BaseRequestBuilder<GraphAndroidManagedStoreAppRequestBuilder> {
     ...
     * @returns {Promise<AndroidManagedStoreApp>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     */
     get(requestConfiguration?: RequestConfiguration<GraphAndroidManagedStoreAppRequestBuilderGetQueryParameters> | undefined) : Promise<AndroidManagedStoreApp | undefined>;
    /**
     * Get the item of type microsoft.graph.mobileApp as microsoft.graph.androidManagedStoreApp
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const GraphAndroidManagedStoreAppRequestBuilderUriTemplate = "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidManagedStoreApp{?%24expand,%24select}";
/**
