...
// @ts-ignore
import { createManagedIOSLobAppFromDiscriminatorValue, type ManagedIOSLobApp } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GraphManagedIOSLobAppRequestBuilder extends BaseRequestBuilder<GraphManagedIOSLobAppRequestBuilder> {
     ...
     * @returns {Promise<ManagedIOSLobApp>}
