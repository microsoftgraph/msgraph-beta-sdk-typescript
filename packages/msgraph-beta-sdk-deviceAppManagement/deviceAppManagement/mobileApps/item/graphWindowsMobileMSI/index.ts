...
// @ts-ignore
import { createWindowsMobileMSIFromDiscriminatorValue, type WindowsMobileMSI } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GraphWindowsMobileMSIRequestBuilder extends BaseRequestBuilder<GraphWindowsMobileMSIRequestBuilder> {
     ...
     * @returns {Promise<WindowsMobileMSI>}
