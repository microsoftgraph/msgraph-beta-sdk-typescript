...
// @ts-ignore
import { createDomainCollectionResponseFromDiscriminatorValue, createDomainFromDiscriminatorValue, serializeDomain, type Domain, type DomainCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { DomainItemRequestBuilderNavigationMetadata, DomainItemRequestBuilderRequestsMetadata, type DomainItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface DomainsRequestBuilder extends BaseRequestBuilder<DomainsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/domain-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/domain-post-domains?view=graph-rest-beta|Find more info here}
     */
