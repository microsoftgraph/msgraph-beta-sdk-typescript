...
// @ts-ignore
import { createInternalDomainFederationFromDiscriminatorValue, serializeInternalDomainFederation, type InternalDomainFederation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface InternalDomainFederationItemRequestBuilder extends BaseRequestBuilder<InternalDomainFederationItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/internaldomainfederation-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/internaldomainfederation-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<InternalDomainFederation>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/internaldomainfederation-update?view=graph-rest-beta|Find more info here}
     */
