...
// @ts-ignore
import { createInternalDomainFederationCollectionResponseFromDiscriminatorValue, createInternalDomainFederationFromDiscriminatorValue, serializeInternalDomainFederation, type InternalDomainFederation, type InternalDomainFederationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface FederationConfigurationRequestBuilder extends BaseRequestBuilder<FederationConfigurationRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/domain-list-federationconfiguration?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/domain-post-federationconfiguration?view=graph-rest-beta|Find more info here}
     */
