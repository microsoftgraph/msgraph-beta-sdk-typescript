...
// @ts-ignore
import { createDomainFromDiscriminatorValue, type Domain } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RootDomainRequestBuilder extends BaseRequestBuilder<RootDomainRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/domain-list-rootdomain?view=graph-rest-beta|Find more info here}
     */
