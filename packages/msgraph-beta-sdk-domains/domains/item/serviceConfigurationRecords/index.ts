...
// @ts-ignore
import { createDomainDnsRecordCollectionResponseFromDiscriminatorValue, createDomainDnsRecordFromDiscriminatorValue, serializeDomainDnsRecord, type DomainDnsRecord, type DomainDnsRecordCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ServiceConfigurationRecordsRequestBuilder extends BaseRequestBuilder<ServiceConfigurationRecordsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/domain-list-serviceconfigurationrecords?view=graph-rest-beta|Find more info here}
     */
