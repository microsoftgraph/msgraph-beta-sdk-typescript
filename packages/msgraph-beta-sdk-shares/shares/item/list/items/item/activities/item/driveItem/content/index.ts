 ...
 */
export const ContentRequestBuilderUriTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem/content{?%24format*}";
/* tslint:enable */
/* eslint-enable */
