 ...
 */
export const ContentRequestBuilderUriTemplate = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem/content";
/* tslint:enable */
/* eslint-enable */
