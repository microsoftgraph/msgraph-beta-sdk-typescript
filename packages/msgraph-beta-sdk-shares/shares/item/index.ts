...
// @ts-ignore
import { createSharedDriveItemFromDiscriminatorValue, serializeSharedDriveItem, type SharedDriveItem } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SharedDriveItemItemRequestBuilder extends BaseRequestBuilder<SharedDriveItemItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/shares-get?view=graph-rest-beta|Find more info here}
     */
