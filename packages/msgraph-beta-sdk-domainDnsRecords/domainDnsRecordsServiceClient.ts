...
export function createDomainDnsRecordsServiceClient(requestAdapter: RequestAdapter, backingStore?: BackingStoreFactory | undefined) {
    ...
    return apiClientProxifier<DomainDnsRecordsServiceClient>(requestAdapter, pathParameters, DomainDnsRecordsServiceClientUriTemplate, DomainDnsRecordsServiceClientNavigationMetadata, undefined);
}
/**
