...
// @ts-ignore
import { createAdministrativeUnitCollectionResponseFromDiscriminatorValue, createAdministrativeUnitFromDiscriminatorValue, serializeAdministrativeUnit, type AdministrativeUnit, type AdministrativeUnitCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AdministrativeUnitsRequestBuilder extends BaseRequestBuilder<AdministrativeUnitsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/directory-list-administrativeunits?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/directory-post-administrativeunits?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const AdministrativeUnitsRequestBuilderUriTemplate = "{+baseurl}/administrativeUnits{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
