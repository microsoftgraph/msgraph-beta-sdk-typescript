...
import { createOrgContactFromDiscriminatorValue, type OrgContact } from '@microsoft/msgraph-beta-sdk/models/';
 ...
 */
export const GraphOrgContactRequestBuilderUriTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/graph.orgContact{?%24expand,%24select}";
/**
 * Casts the previous resource to orgContact.
 */
