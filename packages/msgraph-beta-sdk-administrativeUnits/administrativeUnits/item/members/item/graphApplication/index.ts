 ...
 */
export const GraphApplicationRequestBuilderUriTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/graph.application{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
