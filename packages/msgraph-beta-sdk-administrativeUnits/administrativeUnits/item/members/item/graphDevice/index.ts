 ...
 */
export const GraphDeviceRequestBuilderUriTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/graph.device{?%24expand,%24select}";
/* tslint:enable */
/* eslint-enable */
