 ...
 */
export const GraphUserRequestBuilderUriTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/graph.user{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
