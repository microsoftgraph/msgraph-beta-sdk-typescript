...
export interface MembersRequestBuilder extends BaseRequestBuilder<MembersRequestBuilder> {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.administrativeUnits.item.members.item collection
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/administrativeunit-post-members?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const MembersRequestBuilderUriTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
