 ...
 */
export const ScopedRoleMembershipItemRequestBuilderUriTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/scopedRoleMembers/{scopedRoleMembership%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
