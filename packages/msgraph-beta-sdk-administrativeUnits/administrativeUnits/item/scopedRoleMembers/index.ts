...
// @ts-ignore
import { createScopedRoleMembershipCollectionResponseFromDiscriminatorValue, createScopedRoleMembershipFromDiscriminatorValue, serializeScopedRoleMembership, type ScopedRoleMembership, type ScopedRoleMembershipCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ScopedRoleMembersRequestBuilder extends BaseRequestBuilder<ScopedRoleMembersRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/administrativeunit-list-scopedrolemembers?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/administrativeunit-post-scopedrolemembers?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const ScopedRoleMembersRequestBuilderUriTemplate = "{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/scopedRoleMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
