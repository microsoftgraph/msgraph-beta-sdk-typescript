...
// @ts-ignore
import { createChatFromDiscriminatorValue, serializeChat, type Chat } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
// @ts-ignore
import { RemoveAllAccessForUserRequestBuilderRequestsMetadata, type RemoveAllAccessForUserRequestBuilder } from './removeAllAccessForUser/';
// @ts-ignore
...
export interface ChatItemRequestBuilder extends BaseRequestBuilder<ChatItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/chat-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Chat>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/chat-patch?view=graph-rest-beta|Find more info here}
     */
