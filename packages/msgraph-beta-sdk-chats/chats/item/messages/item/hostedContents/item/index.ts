...
export interface ChatMessageHostedContentItemRequestBuilder extends BaseRequestBuilder<ChatMessageHostedContentItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/chatmessagehostedcontent-get?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const ChatMessageHostedContentItemRequestBuilderUriTemplate = "{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}/hostedContents/{chatMessageHostedContent%2Did}{?%24expand,%24select}";
/**
