...
export interface MembersRequestBuilder extends BaseRequestBuilder<MembersRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/chat-post-members?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const MembersRequestBuilderUriTemplate = "{+baseurl}/chats/{chat%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
