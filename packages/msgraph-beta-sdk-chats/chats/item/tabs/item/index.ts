...
// @ts-ignore
import { createTeamsTabFromDiscriminatorValue, serializeTeamsTab, type TeamsTab } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TeamsTabItemRequestBuilder extends BaseRequestBuilder<TeamsTabItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/chat-delete-tabs?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/chat-get-tabs?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<TeamsTab>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/chat-patch-tabs?view=graph-rest-beta|Find more info here}
     */
