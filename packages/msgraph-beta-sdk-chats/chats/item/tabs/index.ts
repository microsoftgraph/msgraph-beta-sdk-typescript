...
export interface TabsRequestBuilder extends BaseRequestBuilder<TabsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/chat-list-tabs?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/chat-post-tabs?view=graph-rest-beta|Find more info here}
     */
