...
export interface InstalledAppsRequestBuilder extends BaseRequestBuilder<InstalledAppsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/chat-list-installedapps?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/chat-post-installedapps?view=graph-rest-beta|Find more info here}
     */
