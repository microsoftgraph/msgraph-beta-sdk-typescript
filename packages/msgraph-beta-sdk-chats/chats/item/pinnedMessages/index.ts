...
// @ts-ignore
import { createPinnedChatMessageInfoCollectionResponseFromDiscriminatorValue, createPinnedChatMessageInfoFromDiscriminatorValue, serializePinnedChatMessageInfo, type PinnedChatMessageInfo, type PinnedChatMessageInfoCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PinnedMessagesRequestBuilder extends BaseRequestBuilder<PinnedMessagesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/chat-list-pinnedmessages?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/chat-post-pinnedmessages?view=graph-rest-beta|Find more info here}
     */
