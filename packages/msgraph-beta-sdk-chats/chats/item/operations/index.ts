...
// @ts-ignore
import { createTeamsAsyncOperationCollectionResponseFromDiscriminatorValue, createTeamsAsyncOperationFromDiscriminatorValue, serializeTeamsAsyncOperation, type TeamsAsyncOperation, type TeamsAsyncOperationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface OperationsRequestBuilder extends BaseRequestBuilder<OperationsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/chat-list-operations?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const OperationsRequestBuilderUriTemplate = "{+baseurl}/chats/{chat%2Did}/operations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
