...
// @ts-ignore
import { createChatCollectionResponseFromDiscriminatorValue, createChatFromDiscriminatorValue, serializeChat, type Chat, type ChatCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
// @ts-ignore
import { GetAllRetainedMessagesRequestBuilderRequestsMetadata, type GetAllRetainedMessagesRequestBuilder } from './getAllRetainedMessages/';
// @ts-ignore
...
export interface ChatsRequestBuilder extends BaseRequestBuilder<ChatsRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/chat-post?view=graph-rest-beta|Find more info here}
     */
