...
// @ts-ignore
import { createKeyCredentialFromDiscriminatorValue, createPasswordCredentialFromDiscriminatorValue, serializeKeyCredential, serializePasswordCredential, type KeyCredential, type PasswordCredential } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AddKeyRequestBuilder extends BaseRequestBuilder<AddKeyRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/application-addkey?view=graph-rest-beta|Find more info here}
     */
