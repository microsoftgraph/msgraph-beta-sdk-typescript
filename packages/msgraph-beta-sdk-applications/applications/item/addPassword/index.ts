...
// @ts-ignore
import { createPasswordCredentialFromDiscriminatorValue, serializePasswordCredential, type PasswordCredential } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AddPasswordRequestBuilder extends BaseRequestBuilder<AddPasswordRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/application-addpassword?view=graph-rest-beta|Find more info here}
     */
