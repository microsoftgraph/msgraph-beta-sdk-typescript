...
// @ts-ignore
import { createExtensionPropertyCollectionResponseFromDiscriminatorValue, createExtensionPropertyFromDiscriminatorValue, serializeExtensionProperty, type ExtensionProperty, type ExtensionPropertyCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ExtensionPropertiesRequestBuilder extends BaseRequestBuilder<ExtensionPropertiesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/application-list-extensionproperty?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/application-post-extensionproperty?view=graph-rest-beta|Find more info here}
     */
