...
// @ts-ignore
import { createExtensionPropertyFromDiscriminatorValue, serializeExtensionProperty, type ExtensionProperty } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ExtensionPropertyItemRequestBuilder extends BaseRequestBuilder<ExtensionPropertyItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/extensionproperty-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/extensionproperty-get?view=graph-rest-beta|Find more info here}
     */
