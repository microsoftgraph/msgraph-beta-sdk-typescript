...
// @ts-ignore
import { createSynchronizationTemplateFromDiscriminatorValue, serializeSynchronizationTemplate, type SynchronizationTemplate } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SynchronizationTemplateItemRequestBuilder extends BaseRequestBuilder<SynchronizationTemplateItemRequestBuilder> {
     ...
     * @returns {Promise<SynchronizationTemplate>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/synchronization-synchronizationtemplate-update?view=graph-rest-beta|Find more info here}
     */
