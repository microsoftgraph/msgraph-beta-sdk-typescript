...
// @ts-ignore
import { createSynchronizationSecretKeyStringValuePairFromDiscriminatorValue, serializeSynchronizationSecretKeyStringValuePair, type SynchronizationSecretKeyStringValuePair } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ValidateCredentialsRequestBuilder extends BaseRequestBuilder<ValidateCredentialsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/synchronization-synchronizationjob-validatecredentials?view=graph-rest-beta|Find more info here}
     */
