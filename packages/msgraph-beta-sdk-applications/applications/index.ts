...
// @ts-ignore
import { createApplicationCollectionResponseFromDiscriminatorValue, createApplicationFromDiscriminatorValue, serializeApplication, type Application, type ApplicationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ApplicationsRequestBuilder extends BaseRequestBuilder<ApplicationsRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/application-post-applications?view=graph-rest-beta|Find more info here}
     */
