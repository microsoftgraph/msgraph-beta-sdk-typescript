 ...
 */
export const AlertRequestBuilderUriTemplate = "{+baseurl}/tenantRelationships/managedTenants/managedTenantApiNotifications/{managedTenantApiNotification%2Did}/alert{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
