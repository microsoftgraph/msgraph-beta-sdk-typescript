...
// @ts-ignore
import { createTenantGroupFromDiscriminatorValue, serializeTenantGroup, type TenantGroup } from '@microsoft/msgraph-beta-sdk/models/managedTenants/index.js';
// @ts-ignore
...
export interface TenantGroupItemRequestBuilder extends BaseRequestBuilder<TenantGroupItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/managedtenants-tenantgroup-get?view=graph-rest-beta|Find more info here}
     */
