 ...
 */
export const AlertRequestBuilderUriTemplate = "{+baseurl}/tenantRelationships/managedTenants/managedTenantEmailNotifications/{managedTenantEmailNotification%2Did}/alert{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
