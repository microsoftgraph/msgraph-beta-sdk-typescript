...
// @ts-ignore
import { createDeviceCompliancePolicySettingStateSummaryFromDiscriminatorValue, serializeDeviceCompliancePolicySettingStateSummary, type DeviceCompliancePolicySettingStateSummary } from '@microsoft/msgraph-beta-sdk/models/managedTenants/index.js';
// @ts-ignore
...
export interface DeviceCompliancePolicySettingStateSummaryItemRequestBuilder extends BaseRequestBuilder<DeviceCompliancePolicySettingStateSummaryItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/managedtenants-devicecompliancepolicysettingstatesummary-get?view=graph-rest-beta|Find more info here}
     */
