...
// @ts-ignore
import { createDeviceCompliancePolicySettingStateSummaryCollectionResponseFromDiscriminatorValue, createDeviceCompliancePolicySettingStateSummaryFromDiscriminatorValue, serializeDeviceCompliancePolicySettingStateSummary, type DeviceCompliancePolicySettingStateSummary, type DeviceCompliancePolicySettingStateSummaryCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/managedTenants/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { DeviceCompliancePolicySettingStateSummaryItemRequestBuilderRequestsMetadata, type DeviceCompliancePolicySettingStateSummaryItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface DeviceCompliancePolicySettingStateSummariesRequestBuilder extends BaseRequestBuilder<DeviceCompliancePolicySettingStateSummariesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/managedtenants-managedtenant-list-devicecompliancepolicysettingstatesummary?view=graph-rest-beta|Find more info here}
     */
