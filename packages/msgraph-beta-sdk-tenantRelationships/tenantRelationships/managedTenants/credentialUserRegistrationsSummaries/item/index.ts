...
// @ts-ignore
import { createCredentialUserRegistrationsSummaryFromDiscriminatorValue, serializeCredentialUserRegistrationsSummary, type CredentialUserRegistrationsSummary } from '@microsoft/msgraph-beta-sdk/models/managedTenants/index.js';
// @ts-ignore
...
export interface CredentialUserRegistrationsSummaryItemRequestBuilder extends BaseRequestBuilder<CredentialUserRegistrationsSummaryItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/managedtenants-credentialuserregistrationssummary-get?view=graph-rest-beta|Find more info here}
     */
