...
// @ts-ignore
import { createWindowsProtectionStateCollectionResponseFromDiscriminatorValue, createWindowsProtectionStateFromDiscriminatorValue, serializeWindowsProtectionState, type WindowsProtectionState, type WindowsProtectionStateCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/managedTenants/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { type WindowsProtectionStateItemRequestBuilder, WindowsProtectionStateItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
...
export interface WindowsProtectionStatesRequestBuilder extends BaseRequestBuilder<WindowsProtectionStatesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/managedtenants-managedtenant-list-windowsprotectionstates?view=graph-rest-beta|Find more info here}
     */
