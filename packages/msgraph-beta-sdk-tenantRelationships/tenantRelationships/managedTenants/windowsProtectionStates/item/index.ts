...
// @ts-ignore
import { createWindowsProtectionStateFromDiscriminatorValue, serializeWindowsProtectionState, type WindowsProtectionState } from '@microsoft/msgraph-beta-sdk/models/managedTenants/index.js';
// @ts-ignore
...
export interface WindowsProtectionStateItemRequestBuilder extends BaseRequestBuilder<WindowsProtectionStateItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/managedtenants-windowsprotectionstate-get?view=graph-rest-beta|Find more info here}
     */
