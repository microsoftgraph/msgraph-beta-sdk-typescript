...
// @ts-ignore
import { createManagedDeviceComplianceCollectionResponseFromDiscriminatorValue, createManagedDeviceComplianceFromDiscriminatorValue, serializeManagedDeviceCompliance, type ManagedDeviceCompliance, type ManagedDeviceComplianceCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/managedTenants/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { ManagedDeviceComplianceItemRequestBuilderRequestsMetadata, type ManagedDeviceComplianceItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface ManagedDeviceCompliancesRequestBuilder extends BaseRequestBuilder<ManagedDeviceCompliancesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/managedtenants-managedtenant-list-manageddevicecompliances?view=graph-rest-beta|Find more info here}
     */
