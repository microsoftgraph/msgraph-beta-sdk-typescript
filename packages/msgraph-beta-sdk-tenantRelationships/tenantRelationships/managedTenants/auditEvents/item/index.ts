...
// @ts-ignore
import { createAuditEventFromDiscriminatorValue, serializeAuditEvent, type AuditEvent } from '@microsoft/msgraph-beta-sdk/models/managedTenants/index.js';
// @ts-ignore
...
export interface AuditEventItemRequestBuilder extends BaseRequestBuilder<AuditEventItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/managedtenants-auditevent-get?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const AuditEventItemRequestBuilderUriTemplate = "{+baseurl}/tenantRelationships/managedTenants/auditEvents/{auditEvent%2Did}{?%24expand,%24select}";
/**
