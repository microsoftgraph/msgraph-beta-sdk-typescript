 ...
 * @param AddUserInputLogPostRequestBody The instance to deserialize into.
 ...
 * @param AddUserInputLogPostRequestBody The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeAddUserInputLogPostRequestBody(writer: SerializationWriter, addUserInputLogPostRequestBody: Partial<AddUserInputLogPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!addUserInputLogPostRequestBody || isSerializingDerivedType) { return; }
