...
import { MicrosoftGraphManagedTenantsOffboardTenantRequestBuilderRequestsMetadata, MicrosoftGraphManagedTenantsOffboardTenantRequestBuilderUriTemplate, type MicrosoftGraphManagedTenantsOffboardTenantRequestBuilder } from './microsoftGraphManagedTenantsOffboardTenant/';
import { MicrosoftGraphManagedTenantsResetTenantOnboardingStatusRequestBuilderRequestsMetadata, MicrosoftGraphManagedTenantsResetTenantOnboardingStatusRequestBuilderUriTemplate, type MicrosoftGraphManagedTenantsResetTenantOnboardingStatusRequestBuilder } from './microsoftGraphManagedTenantsResetTenantOnboardingStatus/';
...
export interface TenantItemRequestBuilder extends BaseRequestBuilder<TenantItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/managedtenants-tenant-get?view=graph-rest-1.0|Find more info here}
     */
 ...
 */
export const TenantItemRequestBuilderUriTemplate = "{+baseurl}/tenantRelationships/managedTenants/tenants/{tenant%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
