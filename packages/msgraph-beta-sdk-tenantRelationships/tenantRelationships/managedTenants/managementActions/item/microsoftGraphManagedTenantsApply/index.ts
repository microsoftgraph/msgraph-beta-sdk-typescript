...
import { createManagementActionDeploymentStatusFromDiscriminatorValue, serializeManagementActionDeploymentStatus, type ManagementActionDeploymentStatus } from '@microsoft/msgraph-beta-sdk/models/managedTenants/';
...
export interface MicrosoftGraphManagedTenantsApplyRequestBuilder extends BaseRequestBuilder<MicrosoftGraphManagedTenantsApplyRequestBuilder> {
     ...
     * @returns a Promise of ManagementActionDeploymentStatus
     * @see {@link https://learn.microsoft.com/graph/api/managedtenants-managementaction-apply?view=graph-rest-1.0|Find more info here}
     */
