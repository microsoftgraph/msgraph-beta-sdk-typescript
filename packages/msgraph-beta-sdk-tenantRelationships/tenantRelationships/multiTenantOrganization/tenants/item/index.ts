 ...
 */
export const MultiTenantOrganizationMemberItemRequestBuilderUriTemplate = "{+baseurl}/tenantRelationships/multiTenantOrganization/tenants/{multiTenantOrganizationMember%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
