...
// @ts-ignore
import { createMultiTenantOrganizationMemberFromDiscriminatorValue, serializeMultiTenantOrganizationMember, type MultiTenantOrganizationMember } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface MultiTenantOrganizationMemberItemRequestBuilder extends BaseRequestBuilder<MultiTenantOrganizationMemberItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/multitenantorganization-delete-tenants?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/multitenantorganizationmember-get?view=graph-rest-beta|Find more info here}
     */
