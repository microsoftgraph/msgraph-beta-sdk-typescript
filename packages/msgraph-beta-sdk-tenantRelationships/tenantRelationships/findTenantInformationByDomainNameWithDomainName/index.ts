...
// @ts-ignore
import { createTenantInformationFromDiscriminatorValue, type TenantInformation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface FindTenantInformationByDomainNameWithDomainNameRequestBuilder extends BaseRequestBuilder<FindTenantInformationByDomainNameWithDomainNameRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/tenantrelationship-findtenantinformationbydomainname?view=graph-rest-beta|Find more info here}
     */
