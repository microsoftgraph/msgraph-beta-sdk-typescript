...
// @ts-ignore
import { createDelegatedAdminCustomerCollectionResponseFromDiscriminatorValue, createDelegatedAdminCustomerFromDiscriminatorValue, serializeDelegatedAdminCustomer, type DelegatedAdminCustomer, type DelegatedAdminCustomerCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DelegatedAdminCustomersRequestBuilder extends BaseRequestBuilder<DelegatedAdminCustomersRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/tenantrelationship-list-delegatedadmincustomers?view=graph-rest-beta|Find more info here}
     */
