...
export interface AccessAssignmentsRequestBuilder extends BaseRequestBuilder<AccessAssignmentsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/delegatedadminrelationship-list-accessassignments?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/delegatedadminrelationship-post-accessassignments?view=graph-rest-beta|Find more info here}
     */
