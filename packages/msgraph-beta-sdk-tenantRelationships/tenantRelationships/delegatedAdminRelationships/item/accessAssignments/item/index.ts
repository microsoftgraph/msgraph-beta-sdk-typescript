...
// @ts-ignore
import { createDelegatedAdminAccessAssignmentFromDiscriminatorValue, serializeDelegatedAdminAccessAssignment, type DelegatedAdminAccessAssignment } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DelegatedAdminAccessAssignmentItemRequestBuilder extends BaseRequestBuilder<DelegatedAdminAccessAssignmentItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/delegatedadminaccessassignment-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/delegatedadminaccessassignment-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<DelegatedAdminAccessAssignment>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/delegatedadminaccessassignment-update?view=graph-rest-beta|Find more info here}
     */
