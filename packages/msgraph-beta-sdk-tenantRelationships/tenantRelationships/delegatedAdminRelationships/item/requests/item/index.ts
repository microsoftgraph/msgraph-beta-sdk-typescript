...
// @ts-ignore
import { createDelegatedAdminRelationshipRequestFromDiscriminatorValue, serializeDelegatedAdminRelationshipRequest, type DelegatedAdminRelationshipRequest } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DelegatedAdminRelationshipRequestItemRequestBuilder extends BaseRequestBuilder<DelegatedAdminRelationshipRequestItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/delegatedadminrelationshiprequest-get?view=graph-rest-beta|Find more info here}
     */
