...
// @ts-ignore
import { createDelegatedAdminRelationshipFromDiscriminatorValue, serializeDelegatedAdminRelationship, type DelegatedAdminRelationship } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface DelegatedAdminRelationshipItemRequestBuilder extends BaseRequestBuilder<DelegatedAdminRelationshipItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/delegatedadminrelationship-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/delegatedadminrelationship-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<DelegatedAdminRelationship>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/delegatedadminrelationship-update?view=graph-rest-beta|Find more info here}
     */
