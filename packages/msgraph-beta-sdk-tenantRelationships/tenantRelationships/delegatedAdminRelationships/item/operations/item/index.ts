...
// @ts-ignore
import { createDelegatedAdminRelationshipOperationFromDiscriminatorValue, serializeDelegatedAdminRelationshipOperation, type DelegatedAdminRelationshipOperation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DelegatedAdminRelationshipOperationItemRequestBuilder extends BaseRequestBuilder<DelegatedAdminRelationshipOperationItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/delegatedadminrelationshipoperation-get?view=graph-rest-beta|Find more info here}
     */
