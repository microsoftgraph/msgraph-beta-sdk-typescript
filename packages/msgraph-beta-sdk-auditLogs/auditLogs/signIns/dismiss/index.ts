...
export interface DismissRequestBuilder extends BaseRequestBuilder<DismissRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/signin-dismiss?view=graph-rest-beta|Find more info here}
     */
...
export function serializeDismissPostRequestBody(writer: SerializationWriter, dismissPostRequestBody: Partial<DismissPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeCollectionOfPrimitiveValues<string>("requestIds", dismissPostRequestBody.requestIds);
    writer.writeAdditionalData(dismissPostRequestBody.additionalData);
}
/**
 * Uri template for the request builder.
 */
export const DismissRequestBuilderUriTemplate = "{+baseurl}/auditLogs/signIns/dismiss";
/**
