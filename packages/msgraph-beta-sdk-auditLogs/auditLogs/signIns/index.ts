...
// @ts-ignore
import { createSignInCollectionResponseFromDiscriminatorValue, createSignInFromDiscriminatorValue, serializeSignIn, type SignIn, type SignInCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SignInsRequestBuilder extends BaseRequestBuilder<SignInsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/signin-list?view=graph-rest-beta|Find more info here}
     */
