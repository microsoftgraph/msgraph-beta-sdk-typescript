...
// @ts-ignore
import { createSignInFromDiscriminatorValue, serializeSignIn, type SignIn } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SignInItemRequestBuilder extends BaseRequestBuilder<SignInItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/signin-get?view=graph-rest-beta|Find more info here}
     */
