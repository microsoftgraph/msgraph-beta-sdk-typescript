...
// @ts-ignore
import { createDirectoryAuditFromDiscriminatorValue, serializeDirectoryAudit, type DirectoryAudit } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DirectoryAuditItemRequestBuilder extends BaseRequestBuilder<DirectoryAuditItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/directoryaudit-get?view=graph-rest-beta|Find more info here}
     */
