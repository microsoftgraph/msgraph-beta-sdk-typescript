...
// @ts-ignore
import { createDirectoryAuditCollectionResponseFromDiscriminatorValue, createDirectoryAuditFromDiscriminatorValue, serializeDirectoryAudit, type DirectoryAudit, type DirectoryAuditCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DirectoryAuditsRequestBuilder extends BaseRequestBuilder<DirectoryAuditsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/directoryaudit-list?view=graph-rest-beta|Find more info here}
     */
