...
// @ts-ignore
import { createSnapshotCollectionResponseFromDiscriminatorValue, createSnapshotFromDiscriminatorValue, serializeSnapshot, type Snapshot, type SnapshotCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/entraRecoveryServices/index.js';
// @ts-ignore
...
export interface SnapshotsRequestBuilder extends BaseRequestBuilder<SnapshotsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/entrarecoveryservices-recovery-list-snapshots?view=graph-rest-beta|Find more info here}
     */
