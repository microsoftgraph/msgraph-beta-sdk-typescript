...
// @ts-ignore
import { createRecoveryJobFromDiscriminatorValue, type RecoveryJob } from '@microsoft/msgraph-beta-sdk/models/entraRecoveryServices/index.js';
// @ts-ignore
 ...
 */
export const RecoveryJobItemRequestBuilderUriTemplate = "{+baseurl}/directory/recovery/snapshots/{snapshot%2Did}/recoveryJobs/{recoveryJob%2Did}{?%24expand,%24select}";
/**
 * Mapper for query parameters from symbol name to serialization name represented as a constant.
 */
const RecoveryJobItemRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "expand": "%24expand",
    "select": "%24select",
};
/**
 ...
 */
export const RecoveryJobItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: RecoveryJobItemRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
        adapterMethodName: "send",
        responseBodyFactory:  createRecoveryJobFromDiscriminatorValue,
        queryParametersMapper: RecoveryJobItemRequestBuilderGetQueryParametersMapper,
    },
};
/* tslint:enable */
/* eslint-enable */
