...
// @ts-ignore
import { createRecoveryJobBaseCollectionResponseFromDiscriminatorValue, createRecoveryJobBaseFromDiscriminatorValue, serializeRecoveryJobBase, type RecoveryJobBase, type RecoveryJobBaseCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/entraRecoveryServices/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { RecoveryJobBaseItemRequestBuilderNavigationMetadata, RecoveryJobBaseItemRequestBuilderRequestsMetadata, type RecoveryJobBaseItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface JobsRequestBuilder extends BaseRequestBuilder<JobsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/entrarecoveryservices-recovery-list-jobs?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const JobsRequestBuilderUriTemplate = "{+baseurl}/directory/recovery/jobs{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
...
export const JobsRequestBuilderNavigationMetadata: Record<Exclude<keyof JobsRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byRecoveryJobBaseId: {
        requestsMetadata: RecoveryJobBaseItemRequestBuilderRequestsMetadata,
        navigationMetadata: RecoveryJobBaseItemRequestBuilderNavigationMetadata,
        pathParametersMappings: ["recoveryJobBase%2Did"],
    },
    count: {
...
export const JobsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createRecoveryJobBaseCollectionResponseFromDiscriminatorValue,
