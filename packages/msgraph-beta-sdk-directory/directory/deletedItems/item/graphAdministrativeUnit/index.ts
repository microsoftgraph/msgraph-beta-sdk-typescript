 ...
 */
export const GraphAdministrativeUnitRequestBuilderUriTemplate = "{+baseurl}/directory/deletedItems/{directoryObject%2Did}/graph.administrativeUnit{?%24expand,%24select}";
/**
