 ...
 */
export const GraphAdministrativeUnitRequestBuilderUriTemplate = "{+baseurl}/directory/deletedItems/{directoryObject%2Did}/graph.administrativeUnit{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
