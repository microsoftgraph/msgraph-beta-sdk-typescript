...
// @ts-ignore
import { createPendingExternalUserProfileCollectionResponseFromDiscriminatorValue, createPendingExternalUserProfileFromDiscriminatorValue, serializePendingExternalUserProfile, type PendingExternalUserProfile, type PendingExternalUserProfileCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { PendingExternalUserProfileItemRequestBuilderRequestsMetadata, type PendingExternalUserProfileItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface PendingExternalUserProfilesRequestBuilder extends BaseRequestBuilder<PendingExternalUserProfilesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/directory-list-pendingexternaluserprofile?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/directory-post-pendingexternaluserprofile?view=graph-rest-beta|Find more info here}
     */
