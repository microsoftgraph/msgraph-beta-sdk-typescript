...
// @ts-ignore
import { createPendingExternalUserProfileFromDiscriminatorValue, serializePendingExternalUserProfile, type PendingExternalUserProfile } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PendingExternalUserProfileItemRequestBuilder extends BaseRequestBuilder<PendingExternalUserProfileItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/directory-delete-pendingexternaluserprofiles?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/pendingexternaluserprofile-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<PendingExternalUserProfile>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/pendingexternaluserprofile-update?view=graph-rest-beta|Find more info here}
     */
