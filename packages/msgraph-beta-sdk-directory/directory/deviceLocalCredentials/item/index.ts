...
// @ts-ignore
import { createDeviceLocalCredentialInfoFromDiscriminatorValue, serializeDeviceLocalCredentialInfo, type DeviceLocalCredentialInfo } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DeviceLocalCredentialInfoItemRequestBuilder extends BaseRequestBuilder<DeviceLocalCredentialInfoItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/devicelocalcredentialinfo-get?view=graph-rest-beta|Find more info here}
     */
