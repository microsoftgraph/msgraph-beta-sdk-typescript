...
export interface CustomSecurityAttributeDefinitionsRequestBuilder extends BaseRequestBuilder<CustomSecurityAttributeDefinitionsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/directory-list-customsecurityattributedefinitions?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/directory-post-customsecurityattributedefinitions?view=graph-rest-beta|Find more info here}
     */
