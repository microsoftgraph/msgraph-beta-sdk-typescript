...
// @ts-ignore
import { createCustomSecurityAttributeDefinitionFromDiscriminatorValue, serializeCustomSecurityAttributeDefinition, type CustomSecurityAttributeDefinition } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { AllowedValuesRequestBuilderNavigationMetadata, AllowedValuesRequestBuilderRequestsMetadata, type AllowedValuesRequestBuilder } from './allowedValues/index.js';
// @ts-ignore
...
export interface CustomSecurityAttributeDefinitionItemRequestBuilder extends BaseRequestBuilder<CustomSecurityAttributeDefinitionItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/customsecurityattributedefinition-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<CustomSecurityAttributeDefinition>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/customsecurityattributedefinition-update?view=graph-rest-beta|Find more info here}
     */
