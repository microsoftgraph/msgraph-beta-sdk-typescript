...
// @ts-ignore
import { createAllowedValueFromDiscriminatorValue, serializeAllowedValue, type AllowedValue } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AllowedValueItemRequestBuilder extends BaseRequestBuilder<AllowedValueItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/allowedvalue-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<AllowedValue>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/allowedvalue-update?view=graph-rest-beta|Find more info here}
     */
