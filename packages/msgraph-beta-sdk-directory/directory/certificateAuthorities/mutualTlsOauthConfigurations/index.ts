...
// @ts-ignore
import { createMutualTlsOauthConfigurationCollectionResponseFromDiscriminatorValue, createMutualTlsOauthConfigurationFromDiscriminatorValue, serializeMutualTlsOauthConfiguration, type MutualTlsOauthConfiguration, type MutualTlsOauthConfigurationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { MutualTlsOauthConfigurationItemRequestBuilderRequestsMetadata, type MutualTlsOauthConfigurationItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export interface MutualTlsOauthConfigurationsRequestBuilder extends BaseRequestBuilder<MutualTlsOauthConfigurationsRequestBuilder> {
    /**
 ...
 */
export const MutualTlsOauthConfigurationsRequestBuilderUriTemplate = "{+baseurl}/directory/certificateAuthorities/mutualTlsOauthConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
 * Mapper for query parameters from symbol name to serialization name represented as a constant.
 */
const MutualTlsOauthConfigurationsRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "count": "%24count",
    "expand": "%24expand",
    "filter": "%24filter",
    "orderby": "%24orderby",
 ...
 */
export const MutualTlsOauthConfigurationsRequestBuilderNavigationMetadata: Record<Exclude<keyof MutualTlsOauthConfigurationsRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byMutualTlsOauthConfigurationId: {
        requestsMetadata: MutualTlsOauthConfigurationItemRequestBuilderRequestsMetadata,
        pathParametersMappings: ["mutualTlsOauthConfiguration%2Did"],
    },
    count: {
 ...
 */
export const MutualTlsOauthConfigurationsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: MutualTlsOauthConfigurationsRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
        errorMappings: {
            XXX: createODataErrorFromDiscriminatorValue as ParsableFactory<Parsable>,
        },
        adapterMethodName: "send",
        responseBodyFactory:  createMutualTlsOauthConfigurationCollectionResponseFromDiscriminatorValue,
        queryParametersMapper: MutualTlsOauthConfigurationsRequestBuilderGetQueryParametersMapper,
    },
    post: {
        uriTemplate: MutualTlsOauthConfigurationsRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
