...
// @ts-ignore
import { createDeviceTemplateCollectionResponseFromDiscriminatorValue, createDeviceTemplateFromDiscriminatorValue, serializeDeviceTemplate, type DeviceTemplate, type DeviceTemplateCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { DeviceTemplateItemRequestBuilderNavigationMetadata, DeviceTemplateItemRequestBuilderRequestsMetadata, type DeviceTemplateItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const DeviceTemplatesRequestBuilderUriTemplate = "{+baseurl}/directory/templates/deviceTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
 * Mapper for query parameters from symbol name to serialization name represented as a constant.
 */
const DeviceTemplatesRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "count": "%24count",
    "expand": "%24expand",
    "filter": "%24filter",
    "orderby": "%24orderby",
 ...
 */
export const DeviceTemplatesRequestBuilderNavigationMetadata: Record<Exclude<keyof DeviceTemplatesRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byDeviceTemplateId: {
        requestsMetadata: DeviceTemplateItemRequestBuilderRequestsMetadata,
        navigationMetadata: DeviceTemplateItemRequestBuilderNavigationMetadata,
 ...
 */
export const DeviceTemplatesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: DeviceTemplatesRequestBuilderUriTemplate,
        ...
        queryParametersMapper: DeviceTemplatesRequestBuilderGetQueryParametersMapper,
    },
    post: {
        uriTemplate: DeviceTemplatesRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
