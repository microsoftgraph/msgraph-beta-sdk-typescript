...
// @ts-ignore
import { createAdministrativeUnitFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeAdministrativeUnit, serializeBaseDeltaFunctionResponse, type AdministrativeUnit, type BaseDeltaFunctionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/directory/administrativeUnits/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
