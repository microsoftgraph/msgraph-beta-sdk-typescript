...
// @ts-ignore
import { createRemoteTenantGroupFromDiscriminatorValue, serializeRemoteTenantGroup, type RemoteTenantGroup } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RemoteTenantGroupItemRequestBuilder extends BaseRequestBuilder<RemoteTenantGroupItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @deprecated  as of 2025-03/PrivatePreview:remoteTenantGroupsAPI on 2025-12-02 and will be removed 2028-12-07
     * @see {@link https://learn.microsoft.com/graph/api/remotetenantgroup-get?view=graph-rest-beta|Find more info here}
     */
