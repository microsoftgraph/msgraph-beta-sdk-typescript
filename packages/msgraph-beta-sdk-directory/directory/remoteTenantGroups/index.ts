...
// @ts-ignore
import { createRemoteTenantGroupCollectionResponseFromDiscriminatorValue, createRemoteTenantGroupFromDiscriminatorValue, serializeRemoteTenantGroup, type RemoteTenantGroup, type RemoteTenantGroupCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RemoteTenantGroupsRequestBuilder extends BaseRequestBuilder<RemoteTenantGroupsRequestBuilder> {
     ...
     * @deprecated  as of 2025-03/PrivatePreview:remoteTenantGroupsAPI on 2025-12-02 and will be removed 2028-12-07
     * @see {@link https://learn.microsoft.com/graph/api/directory-list-remotetenantgroups?view=graph-rest-beta|Find more info here}
     */
