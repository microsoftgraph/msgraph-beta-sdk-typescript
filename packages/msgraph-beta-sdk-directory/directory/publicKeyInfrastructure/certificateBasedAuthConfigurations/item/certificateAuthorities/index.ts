...
// @ts-ignore
import { createCertificateAuthorityDetailCollectionResponseFromDiscriminatorValue, createCertificateAuthorityDetailFromDiscriminatorValue, serializeCertificateAuthorityDetail, type CertificateAuthorityDetail, type CertificateAuthorityDetailCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CertificateAuthoritiesRequestBuilder extends BaseRequestBuilder<CertificateAuthoritiesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/certificatebasedauthpki-list-certificateauthorities?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/certificatebasedauthpki-post-certificateauthorities?view=graph-rest-beta|Find more info here}
     */
