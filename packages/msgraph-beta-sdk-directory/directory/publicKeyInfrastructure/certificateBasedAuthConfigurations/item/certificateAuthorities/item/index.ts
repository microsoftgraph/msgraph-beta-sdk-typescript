...
// @ts-ignore
import { createCertificateAuthorityDetailFromDiscriminatorValue, serializeCertificateAuthorityDetail, type CertificateAuthorityDetail } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CertificateAuthorityDetailItemRequestBuilder extends BaseRequestBuilder<CertificateAuthorityDetailItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/certificatebasedauthpki-delete-certificateauthorities?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/certificateauthoritydetail-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<CertificateAuthorityDetail>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/certificateauthoritydetail-update?view=graph-rest-beta|Find more info here}
     */
