...
// @ts-ignore
import { createCertificateBasedAuthPkiCollectionResponseFromDiscriminatorValue, createCertificateBasedAuthPkiFromDiscriminatorValue, serializeCertificateBasedAuthPki, type CertificateBasedAuthPki, type CertificateBasedAuthPkiCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CertificateBasedAuthConfigurationsRequestBuilder extends BaseRequestBuilder<CertificateBasedAuthConfigurationsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/publickeyinfrastructureroot-list-certificatebasedauthconfigurations?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/publickeyinfrastructureroot-post-certificatebasedauthconfigurations?view=graph-rest-beta|Find more info here}
     */
