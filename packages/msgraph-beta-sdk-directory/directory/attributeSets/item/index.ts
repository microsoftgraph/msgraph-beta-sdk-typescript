...
// @ts-ignore
import { createAttributeSetFromDiscriminatorValue, serializeAttributeSet, type AttributeSet } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AttributeSetItemRequestBuilder extends BaseRequestBuilder<AttributeSetItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/attributeset-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<AttributeSet>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/attributeset-update?view=graph-rest-beta|Find more info here}
     */
