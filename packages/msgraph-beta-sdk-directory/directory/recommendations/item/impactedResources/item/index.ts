 ...
 */
export const ImpactedResourceItemRequestBuilderUriTemplate = "{+baseurl}/directory/recommendations/{recommendation%2Did}/impactedResources/{impactedResource%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
