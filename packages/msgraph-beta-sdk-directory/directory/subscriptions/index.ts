...
// @ts-ignore
import { createCompanySubscriptionCollectionResponseFromDiscriminatorValue, createCompanySubscriptionFromDiscriminatorValue, serializeCompanySubscription, type CompanySubscription, type CompanySubscriptionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SubscriptionsRequestBuilder extends BaseRequestBuilder<SubscriptionsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/directory-list-subscriptions?view=graph-rest-beta|Find more info here}
     */
