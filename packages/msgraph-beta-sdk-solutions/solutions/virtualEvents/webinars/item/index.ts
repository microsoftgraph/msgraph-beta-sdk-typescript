...
// @ts-ignore
import { RegistrationsWithEmailRequestBuilderNavigationMetadata, RegistrationsWithEmailRequestBuilderRequestsMetadata, type RegistrationsWithEmailRequestBuilder } from './registrationsWithEmail/';
// @ts-ignore
import { RegistrationsWithUserIdRequestBuilderNavigationMetadata, RegistrationsWithUserIdRequestBuilderRequestsMetadata, type RegistrationsWithUserIdRequestBuilder } from './registrationsWithUserId/';
// @ts-ignore
...
export interface VirtualEventWebinarItemRequestBuilder extends BaseRequestBuilder<VirtualEventWebinarItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/virtualeventwebinar-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<VirtualEventWebinar>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/virtualeventwebinar-update?view=graph-rest-beta|Find more info here}
     */
