...
// @ts-ignore
import { createVirtualEventWebinarFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeVirtualEventWebinar, type BaseCollectionPaginationCountResponse, type VirtualEventWebinar } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GetByUserIdAndRoleWithUserIdWithRoleRequestBuilder extends BaseRequestBuilder<GetByUserIdAndRoleWithUserIdWithRoleRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/virtualeventwebinar-getbyuseridandrole?view=graph-rest-beta|Find more info here}
     */
