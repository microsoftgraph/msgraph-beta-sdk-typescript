...
// @ts-ignore
import { createVirtualEventTownhallFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeVirtualEventTownhall, type BaseCollectionPaginationCountResponse, type VirtualEventTownhall } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GetByUserRoleWithRoleRequestBuilder extends BaseRequestBuilder<GetByUserRoleWithRoleRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/virtualeventtownhall-getbyuserrole?view=graph-rest-beta|Find more info here}
     */
