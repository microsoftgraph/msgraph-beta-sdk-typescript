...
import { createVirtualEventTownhallFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeVirtualEventTownhall, type BaseCollectionPaginationCountResponse, type VirtualEventTownhall } from '@microsoft/msgraph-beta-sdk/models/';
 ...
 */
export const GetByUserIdAndRoleWithUserIdWithRoleRequestBuilderUriTemplate = "{+baseurl}/solutions/virtualEvents/townhalls/getByUserIdAndRole(userId='{userId}',role='{role}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
