...
// @ts-ignore
import { createVirtualEventPresenterCollectionResponseFromDiscriminatorValue, createVirtualEventPresenterFromDiscriminatorValue, serializeVirtualEventPresenter, type VirtualEventPresenter, type VirtualEventPresenterCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { type VirtualEventPresenterItemRequestBuilder, VirtualEventPresenterItemRequestBuilderNavigationMetadata, VirtualEventPresenterItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
...
export interface PresentersRequestBuilder extends BaseRequestBuilder<PresentersRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/virtualevent-list-presenters?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/virtualevent-post-presenters?view=graph-rest-beta|Find more info here}
     */
