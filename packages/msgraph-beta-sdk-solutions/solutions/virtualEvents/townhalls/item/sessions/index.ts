...
// @ts-ignore
import { createVirtualEventSessionCollectionResponseFromDiscriminatorValue, createVirtualEventSessionFromDiscriminatorValue, serializeVirtualEventSession, type VirtualEventSession, type VirtualEventSessionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const SessionsRequestBuilderUriTemplate = "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
