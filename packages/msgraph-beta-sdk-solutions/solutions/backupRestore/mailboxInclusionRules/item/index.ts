...
// @ts-ignore
import { createMailboxProtectionRuleFromDiscriminatorValue, serializeMailboxProtectionRule, type MailboxProtectionRule } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface MailboxProtectionRuleItemRequestBuilder extends BaseRequestBuilder<MailboxProtectionRuleItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     */
     patch(body: MailboxProtectionRule, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<MailboxProtectionRule | undefined>;
    /**
     * Delete navigation property mailboxInclusionRules for solutions
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     * @returns {RequestInformation}
     */
     toPatchRequestInformation(body: MailboxProtectionRule, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * The list of mailbox inclusion rules applied to the tenant.
 */
 ...
 */
export const MailboxProtectionRuleItemRequestBuilderUriTemplate = "{+baseurl}/solutions/backupRestore/mailboxInclusionRules/{mailboxProtectionRule%2Did}{?%24expand,%24select}";
/**
