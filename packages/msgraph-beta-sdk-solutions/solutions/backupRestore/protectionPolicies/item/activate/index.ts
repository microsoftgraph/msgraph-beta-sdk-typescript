...
// @ts-ignore
import { createProtectionPolicyBaseFromDiscriminatorValue, type ProtectionPolicyBase } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ActivateRequestBuilder extends BaseRequestBuilder<ActivateRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/protectionpolicybase-activate?view=graph-rest-beta|Find more info here}
     */
