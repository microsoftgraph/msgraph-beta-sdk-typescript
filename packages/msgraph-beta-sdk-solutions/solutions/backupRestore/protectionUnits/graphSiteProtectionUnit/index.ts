...
// @ts-ignore
import { createSiteProtectionUnitCollectionResponseFromDiscriminatorValue, type SiteProtectionUnitCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const GraphSiteProtectionUnitRequestBuilderNavigationMetadata: Record<Exclude<keyof GraphSiteProtectionUnitRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    count: {
