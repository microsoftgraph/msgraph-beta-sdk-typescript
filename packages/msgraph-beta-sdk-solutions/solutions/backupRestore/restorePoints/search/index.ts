...
// @ts-ignore
import { createRestorePointSearchResponseFromDiscriminatorValue, createTimePeriodFromDiscriminatorValue, RestorePointPreference, RestorePointPreferenceObject, RestorePointTags, RestorePointTagsObject, serializeRestorePointSearchResponse, serializeTimePeriod, type RestorePointSearchResponse, type TimePeriod } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
// @ts-ignore
export function serializeSearchPostRequestBody(writer: SerializationWriter, searchPostRequestBody: Partial<SearchPostRequestBody> | undefined = {}) : void {
