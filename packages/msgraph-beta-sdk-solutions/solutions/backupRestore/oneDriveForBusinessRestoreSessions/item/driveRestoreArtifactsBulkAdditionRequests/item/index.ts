...
// @ts-ignore
import { createDriveRestoreArtifactsBulkAdditionRequestFromDiscriminatorValue, serializeDriveRestoreArtifactsBulkAdditionRequest, type DriveRestoreArtifactsBulkAdditionRequest } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DriveRestoreArtifactsBulkAdditionRequestItemRequestBuilder extends BaseRequestBuilder<DriveRestoreArtifactsBulkAdditionRequestItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/driverestoreartifactsbulkadditionrequest-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/driverestoreartifactsbulkadditionrequest-get?view=graph-rest-beta|Find more info here}
     */
