...
// @ts-ignore
import { createMailboxRestoreArtifactsBulkAdditionRequestFromDiscriminatorValue, serializeMailboxRestoreArtifactsBulkAdditionRequest, type MailboxRestoreArtifactsBulkAdditionRequest } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface MailboxRestoreArtifactsBulkAdditionRequestItemRequestBuilder extends BaseRequestBuilder<MailboxRestoreArtifactsBulkAdditionRequestItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/mailboxrestoreartifactsbulkadditionrequest-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/mailboxrestoreartifactsbulkadditionrequest-get?view=graph-rest-beta|Find more info here}
     */
