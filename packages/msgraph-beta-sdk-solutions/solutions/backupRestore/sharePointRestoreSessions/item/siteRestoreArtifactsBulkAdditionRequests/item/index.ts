...
// @ts-ignore
import { createSiteRestoreArtifactsBulkAdditionRequestFromDiscriminatorValue, serializeSiteRestoreArtifactsBulkAdditionRequest, type SiteRestoreArtifactsBulkAdditionRequest } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SiteRestoreArtifactsBulkAdditionRequestItemRequestBuilder extends BaseRequestBuilder<SiteRestoreArtifactsBulkAdditionRequestItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/siterestoreartifactsbulkadditionrequest-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/siterestoreartifactsbulkadditionrequest-get?view=graph-rest-beta|Find more info here}
     */
