...
// @ts-ignore
import { createDriveProtectionUnitCollectionResponseFromDiscriminatorValue, createDriveProtectionUnitFromDiscriminatorValue, serializeDriveProtectionUnit, type DriveProtectionUnit, type DriveProtectionUnitCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/';
// @ts-ignore
import { DriveProtectionUnitItemRequestBuilderRequestsMetadata, type DriveProtectionUnitItemRequestBuilder } from './item/';
// @ts-ignore
...
export interface DriveProtectionUnitsRequestBuilder extends BaseRequestBuilder<DriveProtectionUnitsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/backuprestoreroot-list-driveprotectionunits?view=graph-rest-beta|Find more info here}
     */
