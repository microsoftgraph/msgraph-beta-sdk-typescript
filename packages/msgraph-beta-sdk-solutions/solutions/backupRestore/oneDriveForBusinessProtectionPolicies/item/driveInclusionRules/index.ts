...
// @ts-ignore
import { createDriveProtectionRuleCollectionResponseFromDiscriminatorValue, type DriveProtectionRuleCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/';
// @ts-ignore
import { DriveProtectionRuleItemRequestBuilderRequestsMetadata, type DriveProtectionRuleItemRequestBuilder } from './item/';
// @ts-ignore
...
export interface DriveInclusionRulesRequestBuilder extends BaseRequestBuilder<DriveInclusionRulesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/onedriveforbusinessprotectionpolicy-list-driveinclusionrules?view=graph-rest-beta|Find more info here}
     */
