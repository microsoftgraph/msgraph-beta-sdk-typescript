...
// @ts-ignore
import { createDriveProtectionUnitsBulkAdditionJobFromDiscriminatorValue, type DriveProtectionUnitsBulkAdditionJob } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DriveProtectionUnitsBulkAdditionJobItemRequestBuilder extends BaseRequestBuilder<DriveProtectionUnitsBulkAdditionJobItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/driveprotectionunitsbulkadditionjobs-get?view=graph-rest-beta|Find more info here}
     */
