...
// @ts-ignore
import { createMailboxProtectionUnitsBulkAdditionJobFromDiscriminatorValue, type MailboxProtectionUnitsBulkAdditionJob } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface MailboxProtectionUnitsBulkAdditionJobItemRequestBuilder extends BaseRequestBuilder<MailboxProtectionUnitsBulkAdditionJobItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/mailboxprotectionunitsbulkadditionjobs-get?view=graph-rest-beta|Find more info here}
     */
