...
// @ts-ignore
import { createBookingCurrencyFromDiscriminatorValue, serializeBookingCurrency, type BookingCurrency } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface BookingCurrencyItemRequestBuilder extends BaseRequestBuilder<BookingCurrencyItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/bookingcurrency-get?view=graph-rest-beta|Find more info here}
     */
