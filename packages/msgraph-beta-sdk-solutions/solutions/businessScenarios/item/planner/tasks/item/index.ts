 ...
 */
export const BusinessScenarioTaskItemRequestBuilderUriTemplate = "{+baseurl}/solutions/businessScenarios/{businessScenario%2Did}/planner/tasks/{businessScenarioTask%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
