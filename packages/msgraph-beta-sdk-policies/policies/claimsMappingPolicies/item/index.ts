...
// @ts-ignore
import { createClaimsMappingPolicyFromDiscriminatorValue, serializeClaimsMappingPolicy, type ClaimsMappingPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ClaimsMappingPolicyItemRequestBuilder extends BaseRequestBuilder<ClaimsMappingPolicyItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/claimsmappingpolicy-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/claimsmappingpolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ClaimsMappingPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/claimsmappingpolicy-update?view=graph-rest-beta|Find more info here}
     */
