...
// @ts-ignore
import { createFederatedTokenValidationPolicyFromDiscriminatorValue, serializeFederatedTokenValidationPolicy, type FederatedTokenValidationPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface FederatedTokenValidationPolicyRequestBuilder extends BaseRequestBuilder<FederatedTokenValidationPolicyRequestBuilder> {
     ...
     * @returns {Promise<FederatedTokenValidationPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/federatedtokenvalidationpolicy-update?view=graph-rest-beta|Find more info here}
     */
