...
// @ts-ignore
import { createActivityBasedTimeoutPolicyFromDiscriminatorValue, serializeActivityBasedTimeoutPolicy, type ActivityBasedTimeoutPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ActivityBasedTimeoutPolicyItemRequestBuilder extends BaseRequestBuilder<ActivityBasedTimeoutPolicyItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/activitybasedtimeoutpolicy-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/activitybasedtimeoutpolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ActivityBasedTimeoutPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/activitybasedtimeoutpolicy-update?view=graph-rest-beta|Find more info here}
     */
