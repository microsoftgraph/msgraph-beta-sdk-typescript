...
// @ts-ignore
import { createActivityBasedTimeoutPolicyCollectionResponseFromDiscriminatorValue, createActivityBasedTimeoutPolicyFromDiscriminatorValue, serializeActivityBasedTimeoutPolicy, type ActivityBasedTimeoutPolicy, type ActivityBasedTimeoutPolicyCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { ActivityBasedTimeoutPolicyItemRequestBuilderNavigationMetadata, ActivityBasedTimeoutPolicyItemRequestBuilderRequestsMetadata, type ActivityBasedTimeoutPolicyItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface ActivityBasedTimeoutPoliciesRequestBuilder extends BaseRequestBuilder<ActivityBasedTimeoutPoliciesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/activitybasedtimeoutpolicy-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/activitybasedtimeoutpolicy-post-activitybasedtimeoutpolicies?view=graph-rest-beta|Find more info here}
     */
