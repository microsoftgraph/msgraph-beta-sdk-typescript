...
// @ts-ignore
import { createCrossTenantAccessPolicyFromDiscriminatorValue, serializeCrossTenantAccessPolicy, type CrossTenantAccessPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CrossTenantAccessPolicyRequestBuilder extends BaseRequestBuilder<CrossTenantAccessPolicyRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/crosstenantaccesspolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<CrossTenantAccessPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/crosstenantaccesspolicy-update?view=graph-rest-beta|Find more info here}
     */
