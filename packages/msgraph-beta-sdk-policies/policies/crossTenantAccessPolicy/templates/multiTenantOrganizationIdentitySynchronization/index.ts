...
// @ts-ignore
import { createMultiTenantOrganizationIdentitySyncPolicyTemplateFromDiscriminatorValue, serializeMultiTenantOrganizationIdentitySyncPolicyTemplate, type MultiTenantOrganizationIdentitySyncPolicyTemplate } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface MultiTenantOrganizationIdentitySynchronizationRequestBuilder extends BaseRequestBuilder<MultiTenantOrganizationIdentitySynchronizationRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/multitenantorganizationidentitysyncpolicytemplate-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<MultiTenantOrganizationIdentitySyncPolicyTemplate>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/multitenantorganizationidentitysyncpolicytemplate-update?view=graph-rest-beta|Find more info here}
     */
