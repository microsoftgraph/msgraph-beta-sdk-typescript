...
// @ts-ignore
import { createMultiTenantOrganizationPartnerConfigurationTemplateFromDiscriminatorValue, serializeMultiTenantOrganizationPartnerConfigurationTemplate, type MultiTenantOrganizationPartnerConfigurationTemplate } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface MultiTenantOrganizationPartnerConfigurationRequestBuilder extends BaseRequestBuilder<MultiTenantOrganizationPartnerConfigurationRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/multitenantorganizationpartnerconfigurationtemplate-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<MultiTenantOrganizationPartnerConfigurationTemplate>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/multitenantorganizationpartnerconfigurationtemplate-update?view=graph-rest-beta|Find more info here}
     */
