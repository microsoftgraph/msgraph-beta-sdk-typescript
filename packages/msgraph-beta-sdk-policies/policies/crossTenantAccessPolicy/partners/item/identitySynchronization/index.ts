...
// @ts-ignore
import { createCrossTenantIdentitySyncPolicyPartnerFromDiscriminatorValue, serializeCrossTenantIdentitySyncPolicyPartner, type CrossTenantIdentitySyncPolicyPartner } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface IdentitySynchronizationRequestBuilder extends BaseRequestBuilder<IdentitySynchronizationRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/crosstenantidentitysyncpolicypartner-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<CrossTenantIdentitySyncPolicyPartner>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/crosstenantaccesspolicyconfigurationpartner-put-identitysynchronization?view=graph-rest-beta|Find more info here}
     */
