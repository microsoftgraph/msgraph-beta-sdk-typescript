...
// @ts-ignore
import { createCrossTenantAccessPolicyConfigurationDefaultFromDiscriminatorValue, serializeCrossTenantAccessPolicyConfigurationDefault, type CrossTenantAccessPolicyConfigurationDefault } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DefaultRequestBuilder extends BaseRequestBuilder<DefaultRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/crosstenantaccesspolicyconfigurationdefault-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<CrossTenantAccessPolicyConfigurationDefault>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/crosstenantaccesspolicyconfigurationdefault-update?view=graph-rest-beta|Find more info here}
     */
