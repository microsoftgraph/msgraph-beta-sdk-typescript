...
// @ts-ignore
import { createAdminConsentRequestPolicyFromDiscriminatorValue, serializeAdminConsentRequestPolicy, type AdminConsentRequestPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AdminConsentRequestPolicyRequestBuilder extends BaseRequestBuilder<AdminConsentRequestPolicyRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/adminconsentrequestpolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<AdminConsentRequestPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/adminconsentrequestpolicy-update?view=graph-rest-beta|Find more info here}
     */
