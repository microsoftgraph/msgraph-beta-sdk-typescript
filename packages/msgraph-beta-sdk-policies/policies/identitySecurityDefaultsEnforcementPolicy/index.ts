...
// @ts-ignore
import { createIdentitySecurityDefaultsEnforcementPolicyFromDiscriminatorValue, serializeIdentitySecurityDefaultsEnforcementPolicy, type IdentitySecurityDefaultsEnforcementPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface IdentitySecurityDefaultsEnforcementPolicyRequestBuilder extends BaseRequestBuilder<IdentitySecurityDefaultsEnforcementPolicyRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/identitysecuritydefaultsenforcementpolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<IdentitySecurityDefaultsEnforcementPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/identitysecuritydefaultsenforcementpolicy-update?view=graph-rest-beta|Find more info here}
     */
