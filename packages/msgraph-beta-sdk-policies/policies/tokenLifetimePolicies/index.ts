...
// @ts-ignore
import { createTokenLifetimePolicyCollectionResponseFromDiscriminatorValue, createTokenLifetimePolicyFromDiscriminatorValue, serializeTokenLifetimePolicy, type TokenLifetimePolicy, type TokenLifetimePolicyCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TokenLifetimePoliciesRequestBuilder extends BaseRequestBuilder<TokenLifetimePoliciesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/tokenlifetimepolicy-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/tokenlifetimepolicy-post-tokenlifetimepolicies?view=graph-rest-beta|Find more info here}
     */
