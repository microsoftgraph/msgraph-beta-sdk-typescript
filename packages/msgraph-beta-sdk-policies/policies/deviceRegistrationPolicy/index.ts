...
// @ts-ignore
import { createDeviceRegistrationPolicyFromDiscriminatorValue, type DeviceRegistrationPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DeviceRegistrationPolicyRequestBuilder extends BaseRequestBuilder<DeviceRegistrationPolicyRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/deviceregistrationpolicy-get?view=graph-rest-beta|Find more info here}
     */
