 ...
 */
export const RefRequestBuilderUriTemplate = "{+baseurl}/policies/mobileDeviceManagementPolicies/{mobilityManagementPolicy%2Did}/includedGroups/{group%2Did}/$ref{?%40id*}";
/* tslint:enable */
/* eslint-enable */
