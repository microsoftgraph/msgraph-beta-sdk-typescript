...
export interface FeatureRolloutPoliciesRequestBuilder extends BaseRequestBuilder<FeatureRolloutPoliciesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/list-featurerolloutpolicies?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/post-featurerolloutpolicies?view=graph-rest-beta|Find more info here}
     */
