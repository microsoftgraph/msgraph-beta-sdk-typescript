...
export interface FeatureRolloutPolicyItemRequestBuilder extends BaseRequestBuilder<FeatureRolloutPolicyItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/featurerolloutpolicy-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/featurerolloutpolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<FeatureRolloutPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/featurerolloutpolicy-update?view=graph-rest-beta|Find more info here}
     */
