...
// @ts-ignore
import { createPermissionGrantConditionSetFromDiscriminatorValue, serializePermissionGrantConditionSet, type PermissionGrantConditionSet } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PermissionGrantConditionSetItemRequestBuilder extends BaseRequestBuilder<PermissionGrantConditionSetItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/permissiongrantpolicy-delete-includes?view=graph-rest-beta|Find more info here}
     */
