...
// @ts-ignore
import { createPermissionGrantPolicyCollectionResponseFromDiscriminatorValue, createPermissionGrantPolicyFromDiscriminatorValue, serializePermissionGrantPolicy, type PermissionGrantPolicy, type PermissionGrantPolicyCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { PermissionGrantPolicyItemRequestBuilderNavigationMetadata, PermissionGrantPolicyItemRequestBuilderRequestsMetadata, type PermissionGrantPolicyItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface PermissionGrantPoliciesRequestBuilder extends BaseRequestBuilder<PermissionGrantPoliciesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/permissiongrantpolicy-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/permissiongrantpolicy-post-permissiongrantpolicies?view=graph-rest-beta|Find more info here}
     */
