...
// @ts-ignore
import { createOwnerlessGroupPolicyFromDiscriminatorValue, serializeOwnerlessGroupPolicy, type OwnerlessGroupPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface OwnerlessGroupPolicyRequestBuilder extends BaseRequestBuilder<OwnerlessGroupPolicyRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/ownerlessgrouppolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<OwnerlessGroupPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/ownerlessgrouppolicy-upsert?view=graph-rest-beta|Find more info here}
     */
