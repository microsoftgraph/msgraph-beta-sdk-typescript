...
// @ts-ignore
import { createTenantAppManagementPolicyFromDiscriminatorValue, serializeTenantAppManagementPolicy, type TenantAppManagementPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DefaultAppManagementPolicyRequestBuilder extends BaseRequestBuilder<DefaultAppManagementPolicyRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/tenantappmanagementpolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<TenantAppManagementPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/tenantappmanagementpolicy-update?view=graph-rest-beta|Find more info here}
     */
