...
// @ts-ignore
import { createHomeRealmDiscoveryPolicyFromDiscriminatorValue, serializeHomeRealmDiscoveryPolicy, type HomeRealmDiscoveryPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface HomeRealmDiscoveryPolicyItemRequestBuilder extends BaseRequestBuilder<HomeRealmDiscoveryPolicyItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/homerealmdiscoverypolicy-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/homerealmdiscoverypolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<HomeRealmDiscoveryPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/homerealmdiscoverypolicy-update?view=graph-rest-beta|Find more info here}
     */
