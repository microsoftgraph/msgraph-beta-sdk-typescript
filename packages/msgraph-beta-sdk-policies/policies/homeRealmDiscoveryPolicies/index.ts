...
// @ts-ignore
import { createHomeRealmDiscoveryPolicyCollectionResponseFromDiscriminatorValue, createHomeRealmDiscoveryPolicyFromDiscriminatorValue, serializeHomeRealmDiscoveryPolicy, type HomeRealmDiscoveryPolicy, type HomeRealmDiscoveryPolicyCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { HomeRealmDiscoveryPolicyItemRequestBuilderNavigationMetadata, HomeRealmDiscoveryPolicyItemRequestBuilderRequestsMetadata, type HomeRealmDiscoveryPolicyItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface HomeRealmDiscoveryPoliciesRequestBuilder extends BaseRequestBuilder<HomeRealmDiscoveryPoliciesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/homerealmdiscoverypolicy-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/homerealmdiscoverypolicy-post-homerealmdiscoverypolicies?view=graph-rest-beta|Find more info here}
     */
