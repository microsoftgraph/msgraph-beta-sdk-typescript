...
// @ts-ignore
import { createAuthenticationFlowsPolicyFromDiscriminatorValue, serializeAuthenticationFlowsPolicy, type AuthenticationFlowsPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AuthenticationFlowsPolicyRequestBuilder extends BaseRequestBuilder<AuthenticationFlowsPolicyRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/authenticationflowspolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<AuthenticationFlowsPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/authenticationflowspolicy-update?view=graph-rest-beta|Find more info here}
     */
