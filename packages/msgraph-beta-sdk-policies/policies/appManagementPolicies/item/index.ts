...
// @ts-ignore
import { createAppManagementPolicyFromDiscriminatorValue, serializeAppManagementPolicy, type AppManagementPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AppManagementPolicyItemRequestBuilder extends BaseRequestBuilder<AppManagementPolicyItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/appmanagementpolicy-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/appmanagementpolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<AppManagementPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/appmanagementpolicy-update?view=graph-rest-beta|Find more info here}
     */
