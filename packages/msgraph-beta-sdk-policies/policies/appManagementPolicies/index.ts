...
// @ts-ignore
import { createAppManagementPolicyCollectionResponseFromDiscriminatorValue, createAppManagementPolicyFromDiscriminatorValue, serializeAppManagementPolicy, type AppManagementPolicy, type AppManagementPolicyCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AppManagementPoliciesRequestBuilder extends BaseRequestBuilder<AppManagementPoliciesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/appmanagementpolicy-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/appmanagementpolicy-post?view=graph-rest-beta|Find more info here}
     */
