...
export interface MobilityManagementPolicyItemRequestBuilder extends BaseRequestBuilder<MobilityManagementPolicyItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/mobileappmanagementpolicies-delete?view=graph-rest-1.0|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/mobileappmanagementpolicies-get?view=graph-rest-1.0|Find more info here}
     */
     ...
     * @returns {Promise<MobilityManagementPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/mobileappmanagementpolicies-update?view=graph-rest-1.0|Find more info here}
     */
