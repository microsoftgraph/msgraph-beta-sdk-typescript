 ...
 */
export const MobilityManagementPolicyItemRequestBuilderUriTemplate = "{+baseurl}/policies/mobileAppManagementPolicies/{mobilityManagementPolicy%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
