 ...
 */
export const RefRequestBuilderUriTemplate = "{+baseurl}/policies/mobileAppManagementPolicies/{mobilityManagementPolicy%2Did}/includedGroups/{group%2Did}/$ref{?%40id*}";
/* tslint:enable */
/* eslint-enable */
