...
// @ts-ignore
import { createServicePrincipalCreationPolicyFromDiscriminatorValue, serializeServicePrincipalCreationPolicy, type ServicePrincipalCreationPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
