...
// @ts-ignore
import { createTokenIssuancePolicyFromDiscriminatorValue, serializeTokenIssuancePolicy, type TokenIssuancePolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TokenIssuancePolicyItemRequestBuilder extends BaseRequestBuilder<TokenIssuancePolicyItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/tokenissuancepolicy-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/tokenissuancepolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<TokenIssuancePolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/tokenissuancepolicy-update?view=graph-rest-beta|Find more info here}
     */
