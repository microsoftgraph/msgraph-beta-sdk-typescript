...
// @ts-ignore
import { createTokenIssuancePolicyCollectionResponseFromDiscriminatorValue, createTokenIssuancePolicyFromDiscriminatorValue, serializeTokenIssuancePolicy, type TokenIssuancePolicy, type TokenIssuancePolicyCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TokenIssuancePoliciesRequestBuilder extends BaseRequestBuilder<TokenIssuancePoliciesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/tokenissuancepolicy-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/tokenissuancepolicy-post-tokenissuancepolicy?view=graph-rest-beta|Find more info here}
     */
