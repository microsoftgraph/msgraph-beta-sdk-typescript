...
// @ts-ignore
import { createUnifiedRoleManagementPolicyRuleFromDiscriminatorValue, serializeUnifiedRoleManagementPolicyRule, type UnifiedRoleManagementPolicyRule } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface UnifiedRoleManagementPolicyRuleItemRequestBuilder extends BaseRequestBuilder<UnifiedRoleManagementPolicyRuleItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/unifiedrolemanagementpolicyrule-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<UnifiedRoleManagementPolicyRule>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/unifiedrolemanagementpolicyrule-update?view=graph-rest-beta|Find more info here}
     */
