...
// @ts-ignore
import { createUnifiedRoleManagementPolicyCollectionResponseFromDiscriminatorValue, createUnifiedRoleManagementPolicyFromDiscriminatorValue, serializeUnifiedRoleManagementPolicy, type UnifiedRoleManagementPolicy, type UnifiedRoleManagementPolicyCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface RoleManagementPoliciesRequestBuilder extends BaseRequestBuilder<RoleManagementPoliciesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/policyroot-list-rolemanagementpolicies?view=graph-rest-beta|Find more info here}
     */
