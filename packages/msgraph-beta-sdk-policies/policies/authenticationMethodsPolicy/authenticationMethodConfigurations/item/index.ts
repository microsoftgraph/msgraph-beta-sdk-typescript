...
// @ts-ignore
import { createAuthenticationMethodConfigurationFromDiscriminatorValue, serializeAuthenticationMethodConfiguration, type AuthenticationMethodConfiguration } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AuthenticationMethodConfigurationItemRequestBuilder extends BaseRequestBuilder<AuthenticationMethodConfigurationItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/externalauthenticationmethodconfiguration-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/externalauthenticationmethodconfiguration-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<AuthenticationMethodConfiguration>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/externalauthenticationmethodconfiguration-update?view=graph-rest-beta|Find more info here}
     */
