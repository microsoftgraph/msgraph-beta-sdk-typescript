...
// @ts-ignore
import { createAuthenticationMethodsPolicyFromDiscriminatorValue, serializeAuthenticationMethodsPolicy, type AuthenticationMethodsPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AuthenticationMethodsPolicyRequestBuilder extends BaseRequestBuilder<AuthenticationMethodsPolicyRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/authenticationmethodspolicy-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<AuthenticationMethodsPolicy>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/authenticationmethodspolicy-update?view=graph-rest-beta|Find more info here}
     */
