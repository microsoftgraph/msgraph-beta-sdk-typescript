...
// @ts-ignore
import { createApplicationServicePrincipalFromDiscriminatorValue, serializeApplicationServicePrincipal, type ApplicationServicePrincipal } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface InstantiateRequestBuilder extends BaseRequestBuilder<InstantiateRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/applicationtemplate-instantiate?view=graph-rest-beta|Find more info here}
     */
