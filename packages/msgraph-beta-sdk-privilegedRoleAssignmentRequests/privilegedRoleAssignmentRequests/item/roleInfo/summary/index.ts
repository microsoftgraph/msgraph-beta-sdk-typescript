 ...
 */
export const SummaryRequestBuilderUriTemplate = "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo/summary{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
