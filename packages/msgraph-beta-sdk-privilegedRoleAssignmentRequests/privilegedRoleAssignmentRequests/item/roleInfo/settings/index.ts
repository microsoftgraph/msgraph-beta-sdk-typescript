...
// @ts-ignore
import { createPrivilegedRoleSettingsFromDiscriminatorValue, serializePrivilegedRoleSettings, type PrivilegedRoleSettings } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const SettingsRequestBuilderUriTemplate = "{+baseurl}/privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest%2Did}/roleInfo/settings{?%24expand,%24select}";
/**
