 ...
 */
export const IndustryDataRunActivityItemRequestBuilderUriTemplate = "{+baseurl}/external/industryData/runs/{industryDataRun%2Did}/activities/{industryDataRunActivity%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
