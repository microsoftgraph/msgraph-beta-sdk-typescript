...
// @ts-ignore
import { createIndustryDataConnectorCollectionResponseFromDiscriminatorValue, createIndustryDataConnectorFromDiscriminatorValue, serializeIndustryDataConnector, type IndustryDataConnector, type IndustryDataConnectorCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/industryData/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { IndustryDataConnectorItemRequestBuilderNavigationMetadata, IndustryDataConnectorItemRequestBuilderRequestsMetadata, type IndustryDataConnectorItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface DataConnectorsRequestBuilder extends BaseRequestBuilder<DataConnectorsRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/industrydata-onerosterapidataconnector-post?view=graph-rest-beta|Find more info here}
     */
