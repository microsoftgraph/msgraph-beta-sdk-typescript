...
// @ts-ignore
import { createIndustryDataRootFromDiscriminatorValue, type IndustryDataRoot } from '@microsoft/msgraph-beta-sdk/models/industryData/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { DataConnectorsRequestBuilderNavigationMetadata, DataConnectorsRequestBuilderRequestsMetadata, type DataConnectorsRequestBuilder } from './dataConnectors/index.js';
// @ts-ignore
import { InboundFlowsRequestBuilderNavigationMetadata, InboundFlowsRequestBuilderRequestsMetadata, type InboundFlowsRequestBuilder } from './inboundFlows/index.js';
// @ts-ignore
...
// @ts-ignore
import { OutboundProvisioningFlowSetsRequestBuilderNavigationMetadata, OutboundProvisioningFlowSetsRequestBuilderRequestsMetadata, type OutboundProvisioningFlowSetsRequestBuilder } from './outboundProvisioningFlowSets/index.js';
// @ts-ignore
import { ReferenceDefinitionsRequestBuilderNavigationMetadata, ReferenceDefinitionsRequestBuilderRequestsMetadata, type ReferenceDefinitionsRequestBuilder } from './referenceDefinitions/index.js';
// @ts-ignore
import { RoleGroupsRequestBuilderNavigationMetadata, RoleGroupsRequestBuilderRequestsMetadata, type RoleGroupsRequestBuilder } from './roleGroups/index.js';
// @ts-ignore
...
// @ts-ignore
import { SourceSystemsRequestBuilderNavigationMetadata, SourceSystemsRequestBuilderRequestsMetadata, type SourceSystemsRequestBuilder } from './sourceSystems/index.js';
// @ts-ignore
import { type YearsRequestBuilder, YearsRequestBuilderNavigationMetadata, YearsRequestBuilderRequestsMetadata } from './years/index.js';
// @ts-ignore
...
export const IndustryDataRequestBuilderNavigationMetadata: Record<Exclude<keyof IndustryDataRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ...
    outboundProvisioningFlowSets: {
        requestsMetadata: OutboundProvisioningFlowSetsRequestBuilderRequestsMetadata,
        navigationMetadata: OutboundProvisioningFlowSetsRequestBuilderNavigationMetadata,
    },
