...
import { DataConnectorRequestBuilderRequestsMetadata, type DataConnectorRequestBuilder } from './dataConnector/';
...
export interface InboundFlowItemRequestBuilder extends BaseRequestBuilder<InboundFlowItemRequestBuilder> {
     ...
     * @returns {Promise<InboundFlow>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/industrydata-inboundfileflow-update?view=graph-rest-1.0|Find more info here}
     */
