...
// @ts-ignore
import { createIdentityFromDiscriminatorValue, serializeIdentity, type Identity } from '@microsoft/msgraph-beta-sdk/models/externalConnectors/index.js';
// @ts-ignore
...
export interface IdentityItemRequestBuilder extends BaseRequestBuilder<IdentityItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/externalconnectors-externalgroupmember-delete?view=graph-rest-beta|Find more info here}
     */
