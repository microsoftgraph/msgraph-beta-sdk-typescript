...
// @ts-ignore
import { createIdentityCollectionResponseFromDiscriminatorValue, createIdentityFromDiscriminatorValue, serializeIdentity, type Identity, type IdentityCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/externalConnectors/index.js';
// @ts-ignore
...
export interface MembersRequestBuilder extends BaseRequestBuilder<MembersRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/externalconnectors-externalgroup-post-members?view=graph-rest-beta|Find more info here}
     */
