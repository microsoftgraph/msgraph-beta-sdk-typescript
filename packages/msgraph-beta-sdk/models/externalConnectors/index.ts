...
// @ts-ignore
import { BinaryOperator, BinaryOperatorObject, createAuthorizationSystemFromDiscriminatorValue, createPublicErrorFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, deserializeIntoEntity, serializeAuthorizationSystem, serializeBaseCollectionPaginationCountResponse, serializeEntity, serializePublicError, type AuthorizationSystem, type BaseCollectionPaginationCountResponse, type Entity, type PublicError } from '../index.js';
// @ts-ignore
...
export interface ComplianceSettings extends AdditionalDataHolder, BackedModel, Parsable {
     ...
     */
    eDiscoveryResultTemplates?: DisplayTemplate[] | null;
    /**
     * The OdataType property
     */
    odataType?: string | null;
...
export interface External extends AdditionalDataHolder, BackedModel, Parsable {
     ...
     */
    industryData?: IndustryDataRoot | null;
    /**
     * The OdataType property
     */
    odataType?: string | null;
...
export interface ExternalConnection extends Entity, Parsable {
     ...
     */
    enabledContentExperiences?: ContentExperienceType[] | null;
    /**
     * The groups property
     */
     ...
     */
    ingestedItemsCount?: number | null;
    /**
     * The items property
     */
 ...
 */
// @ts-ignore
export function serializeComplianceSettings(writer: SerializationWriter, complianceSettings: Partial<ComplianceSettings> | undefined | null = {}) : void {
 ...
 */
// @ts-ignore
export function serializeConnectionQuota(writer: SerializationWriter, connectionQuota: Partial<ConnectionQuota> | undefined | null = {}) : void {
    if (connectionQuota) {
 ...
 */
// @ts-ignore
export function serializeRankingHint(writer: SerializationWriter, rankingHint: Partial<RankingHint> | undefined | null = {}) : void {
    if (rankingHint) {
