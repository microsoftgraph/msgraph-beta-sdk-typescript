...
// @ts-ignore
import { deserializeIntoBaseCollectionPaginationCountResponse, deserializeIntoEntity, DevicePlatformTypeObject, serializeBaseCollectionPaginationCountResponse, serializeEntity, type BaseCollectionPaginationCountResponse, type DevicePlatformType, type Entity } from '../index.js';
// @ts-ignore
...
export function deserializeIntoAnswerKeyword(answerKeyword: Partial<AnswerKeyword> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "keywords": n => { answerKeyword.keywords = n.getCollectionOfPrimitiveValues<string>("string"); },
        ...
        "reservedKeywords": n => { answerKeyword.reservedKeywords = n.getCollectionOfPrimitiveValues<string>("string"); },
    }
}
/**
 * The deserialization information for the current model
...
export function deserializeIntoBookmark(bookmark: Partial<Bookmark> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "categories": n => { bookmark.categories = n.getCollectionOfPrimitiveValues<string>("string"); },
        "groupIds": n => { bookmark.groupIds = n.getCollectionOfPrimitiveValues<string>("string"); },
        ...
        "languageTags": n => { bookmark.languageTags = n.getCollectionOfPrimitiveValues<string>("string"); },
        "platforms": n => { bookmark.platforms = n.getCollectionOfEnumValues<DevicePlatformType>(DevicePlatformTypeObject); },
        "powerAppIds": n => { bookmark.powerAppIds = n.getCollectionOfPrimitiveValues<string>("string"); },
...
export function deserializeIntoQna(qna: Partial<Qna> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "groupIds": n => { qna.groupIds = n.getCollectionOfPrimitiveValues<string>("string"); },
        ...
        "languageTags": n => { qna.languageTags = n.getCollectionOfPrimitiveValues<string>("string"); },
