...
// @ts-ignore
import { createIdentityFromDiscriminatorValue, createIdentitySetFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, deserializeIntoEntity, deserializeIntoIdentity, serializeBaseCollectionPaginationCountResponse, serializeEntity, serializeIdentity, serializeIdentitySet, type BaseCollectionPaginationCountResponse, type Entity, type Identity, type IdentitySet } from '../index.js';
// @ts-ignore
...
export interface CallLogRow extends AdditionalDataHolder, BackedModel, Parsable {
     ...
     */
    otherPartyCountryCode?: string | null;
    /**
 ...
 */
// @ts-ignore
export function createPstnBlockedUsersLogRowFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
 ...
 */
// @ts-ignore
export function createPstnOnlineMeetingDialoutReportFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
 ...
 */
// @ts-ignore
export function createSmsLogRowFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoSmsLogRow;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
...
export function deserializeIntoPstnBlockedUsersLogRow(pstnBlockedUsersLogRow: Partial<PstnBlockedUsersLogRow> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "userBlockMode": n => { pstnBlockedUsersLogRow.userBlockMode = n.getEnumValue<PstnUserBlockMode>(PstnUserBlockModeObject); },
...
export function deserializeIntoPstnCallLogRow(pstnCallLogRow: Partial<PstnCallLogRow> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "clientLocalIpV4Address": n => { pstnCallLogRow.clientLocalIpV4Address = n.getStringValue(); },
        "clientLocalIpV6Address": n => { pstnCallLogRow.clientLocalIpV6Address = n.getStringValue(); },
        "clientPublicIpV4Address": n => { pstnCallLogRow.clientPublicIpV4Address = n.getStringValue(); },
        "clientPublicIpV6Address": n => { pstnCallLogRow.clientPublicIpV6Address = n.getStringValue(); },
...
export function deserializeIntoSmsLogRow(smsLogRow: Partial<SmsLogRow> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "smsUnits": n => { smsLogRow.smsUnits = n.getNumberValue(); },
...
export interface DirectRoutingLogRow extends CallLogRow, Parsable {
     ...
     */
    transferorCorrelationId?: string | null;
    /**
...
export interface PstnBlockedUsersLogRow extends AdditionalDataHolder, BackedModel, Parsable {
    /**
     * Stores model information.
     */
    backingStoreEnabled?: boolean | null;
     ...
     */
    userBlockMode?: PstnUserBlockMode | null;
    /**
...
export type PstnUserBlockMode = (typeof PstnUserBlockModeObject)[keyof typeof PstnUserBlockModeObject];
 ...
 */
// @ts-ignore
export function serializeCallLogRow(writer: SerializationWriter, callLogRow: Partial<CallLogRow> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!callLogRow || isSerializingDerivedType) { return; }
 ...
 */
// @ts-ignore
export function serializePstnBlockedUsersLogRow(writer: SerializationWriter, pstnBlockedUsersLogRow: Partial<PstnBlockedUsersLogRow> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!pstnBlockedUsersLogRow || isSerializingDerivedType) { return; }
    ...
    writer.writeEnumValue<PstnUserBlockMode>("userBlockMode", pstnBlockedUsersLogRow.userBlockMode);
 ...
 */
// @ts-ignore
export function serializePstnOnlineMeetingDialoutReport(writer: SerializationWriter, pstnOnlineMeetingDialoutReport: Partial<PstnOnlineMeetingDialoutReport> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!pstnOnlineMeetingDialoutReport || isSerializingDerivedType) { return; }
 ...
 */
// @ts-ignore
export function serializeSmsLogRow(writer: SerializationWriter, smsLogRow: Partial<SmsLogRow> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!smsLogRow || isSerializingDerivedType) { return; }
