 ...
 */
// @ts-ignore
export function createApprovalRuleFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
 ...
 */
// @ts-ignore
export function createAssignedGroupFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
 ...
 */
// @ts-ignore
export function createExcludedGroupAssignmentFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
 ...
 */
// @ts-ignore
export function createGroupAssignmentFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    if(!parseNode) throw new Error("parseNode cannot be undefined");
    const mappingValueNode = parseNode?.getChildNode("@odata.type");
    if (mappingValueNode) {
        const mappingValue = mappingValueNode.getStringValue();
 ...
 */
// @ts-ignore
export function createIncludedGroupAssignmentFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoIncludedGroupAssignment;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 ...
 */
// @ts-ignore
export function createPolicyApprovalCollectionResponseFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
 ...
 */
// @ts-ignore
export function createPolicyApprovalFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
 ...
 */
// @ts-ignore
export function createPolicyCollectionResponseFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
 ...
 */
// @ts-ignore
export function createQualityUpdateApprovalRuleFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoQualityUpdateApprovalRule;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 ...
 */
// @ts-ignore
export function createQualityUpdatePolicyFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoQualityUpdatePolicy;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 ...
 */
// @ts-ignore
export function createQualityUpdateRingFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
 ...
 */
// @ts-ignore
export function createRecoveryApprovalRuleFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoRecoveryApprovalRule;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 ...
 */
// @ts-ignore
export function createRecoveryUpdateCatalogEntryFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoRecoveryUpdateCatalogEntry;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 ...
 */
// @ts-ignore
export function createRingCollectionResponseFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
 ...
 */
// @ts-ignore
export function createRingFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    if(!parseNode) throw new Error("parseNode cannot be undefined");
    const mappingValueNode = parseNode?.getChildNode("@odata.type");
    if (mappingValueNode) {
        const mappingValue = mappingValueNode.getStringValue();
 ...
 */
// @ts-ignore
export function deserializeIntoApprovalRule(approvalRule: Partial<ApprovalRule> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
 ...
 */
// @ts-ignore
export function deserializeIntoAssignedGroup(assignedGroup: Partial<AssignedGroup> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "backingStoreEnabled": n => { assignedGroup.backingStoreEnabled = true; },
        "group": n => { assignedGroup.group = n.getObjectValue<Group>(createGroupFromDiscriminatorValue); },
 ...
 */
// @ts-ignore
export function deserializeIntoExcludedGroupAssignment(excludedGroupAssignment: Partial<ExcludedGroupAssignment> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...deserializeIntoGroupAssignment(excludedGroupAssignment),
        "assignments": n => { excludedGroupAssignment.assignments = n.getCollectionOfObjectValues<AssignedGroup>(createAssignedGroupFromDiscriminatorValue); },
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function deserializeIntoGroupAssignment(groupAssignment: Partial<GroupAssignment> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
 ...
 */
// @ts-ignore
export function deserializeIntoIncludedGroupAssignment(includedGroupAssignment: Partial<IncludedGroupAssignment> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...deserializeIntoGroupAssignment(includedGroupAssignment),
        "assignments": n => { includedGroupAssignment.assignments = n.getCollectionOfObjectValues<AssignedGroup>(createAssignedGroupFromDiscriminatorValue); },
    }
}
/**
 * The deserialization information for the current model
...
export function deserializeIntoPolicy(policy: Partial<Policy> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "applicableContent": n => { policy.applicableContent = n.getCollectionOfObjectValues<ApplicableContent>(createApplicableContentFromDiscriminatorValue); },
        "approvalRules": n => { policy.approvalRules = n.getCollectionOfObjectValues<ApprovalRule>(createApprovalRuleFromDiscriminatorValue); },
        "approvals": n => { policy.approvals = n.getCollectionOfObjectValues<PolicyApproval>(createPolicyApprovalFromDiscriminatorValue); },
        "createdDateTime": n => { policy.createdDateTime = n.getDateValue(); },
        "description": n => { policy.description = n.getStringValue(); },
        "displayName": n => { policy.displayName = n.getStringValue(); },
        "lastModifiedDateTime": n => { policy.lastModifiedDateTime = n.getDateValue(); },
        "rings": n => { policy.rings = n.getCollectionOfObjectValues<Ring>(createRingFromDiscriminatorValue); },
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function deserializeIntoPolicyApproval(policyApproval: Partial<PolicyApproval> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...deserializeIntoEntity(policyApproval),
        "catalogEntry": n => { policyApproval.catalogEntry = n.getObjectValue<CatalogEntry>(createCatalogEntryFromDiscriminatorValue); },
        "catalogEntryId": n => { policyApproval.catalogEntryId = n.getStringValue(); },
        "createdDateTime": n => { policyApproval.createdDateTime = n.getDateValue(); },
        "lastModifiedDateTime": n => { policyApproval.lastModifiedDateTime = n.getDateValue(); },
        "status": n => { policyApproval.status = n.getEnumValue<ApprovalStatus>(ApprovalStatusObject); },
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function deserializeIntoPolicyApprovalCollectionResponse(policyApprovalCollectionResponse: Partial<PolicyApprovalCollectionResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...deserializeIntoBaseCollectionPaginationCountResponse(policyApprovalCollectionResponse),
        "value": n => { policyApprovalCollectionResponse.value = n.getCollectionOfObjectValues<PolicyApproval>(createPolicyApprovalFromDiscriminatorValue); },
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function deserializeIntoPolicyCollectionResponse(policyCollectionResponse: Partial<PolicyCollectionResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...deserializeIntoBaseCollectionPaginationCountResponse(policyCollectionResponse),
        "value": n => { policyCollectionResponse.value = n.getCollectionOfObjectValues<Policy>(createPolicyFromDiscriminatorValue); },
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function deserializeIntoQualityUpdateApprovalRule(qualityUpdateApprovalRule: Partial<QualityUpdateApprovalRule> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...deserializeIntoApprovalRule(qualityUpdateApprovalRule),
        "cadence": n => { qualityUpdateApprovalRule.cadence = n.getEnumValue<QualityUpdateCadence>(QualityUpdateCadenceObject); },
        "classification": n => { qualityUpdateApprovalRule.classification = n.getEnumValue<QualityUpdateClassification>(QualityUpdateClassificationObject); },
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function deserializeIntoQualityUpdatePolicy(qualityUpdatePolicy: Partial<QualityUpdatePolicy> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...deserializeIntoPolicy(qualityUpdatePolicy),
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function deserializeIntoQualityUpdateRing(qualityUpdateRing: Partial<QualityUpdateRing> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...deserializeIntoRing(qualityUpdateRing),
        "isHotpatchEnabled": n => { qualityUpdateRing.isHotpatchEnabled = n.getBooleanValue(); },
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function deserializeIntoRecoveryApprovalRule(recoveryApprovalRule: Partial<RecoveryApprovalRule> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...deserializeIntoApprovalRule(recoveryApprovalRule),
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function deserializeIntoRecoveryUpdateCatalogEntry(recoveryUpdateCatalogEntry: Partial<RecoveryUpdateCatalogEntry> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...deserializeIntoSoftwareUpdateCatalogEntry(recoveryUpdateCatalogEntry),
        "catalogName": n => { recoveryUpdateCatalogEntry.catalogName = n.getStringValue(); },
        "productRevisions": n => { recoveryUpdateCatalogEntry.productRevisions = n.getCollectionOfObjectValues<ProductRevision>(createProductRevisionFromDiscriminatorValue); },
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function deserializeIntoRing(ring: Partial<Ring> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...deserializeIntoEntity(ring),
        "createdDateTime": n => { ring.createdDateTime = n.getDateValue(); },
        "deferralInDays": n => { ring.deferralInDays = n.getNumberValue(); },
        "description": n => { ring.description = n.getStringValue(); },
        "displayName": n => { ring.displayName = n.getStringValue(); },
        "excludedGroupAssignment": n => { ring.excludedGroupAssignment = n.getObjectValue<ExcludedGroupAssignment>(createExcludedGroupAssignmentFromDiscriminatorValue); },
        "includedGroupAssignment": n => { ring.includedGroupAssignment = n.getObjectValue<IncludedGroupAssignment>(createIncludedGroupAssignmentFromDiscriminatorValue); },
        "isPaused": n => { ring.isPaused = n.getBooleanValue(); },
        "lastModifiedDateTime": n => { ring.lastModifiedDateTime = n.getDateValue(); },
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function deserializeIntoRingCollectionResponse(ringCollectionResponse: Partial<RingCollectionResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...deserializeIntoBaseCollectionPaginationCountResponse(ringCollectionResponse),
        "value": n => { ringCollectionResponse.value = n.getCollectionOfObjectValues<Ring>(createRingFromDiscriminatorValue); },
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function serializeApprovalRule(writer: SerializationWriter, approvalRule: Partial<ApprovalRule> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!approvalRule || isSerializingDerivedType) { return; }
 ...
 */
// @ts-ignore
export function serializeAssignedGroup(writer: SerializationWriter, assignedGroup: Partial<AssignedGroup> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!assignedGroup || isSerializingDerivedType) { return; }
    writer.writeObjectValue<Group>("group", assignedGroup.group, serializeGroup);
 ...
 */
// @ts-ignore
export function serializeExcludedGroupAssignment(writer: SerializationWriter, excludedGroupAssignment: Partial<ExcludedGroupAssignment> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!excludedGroupAssignment || isSerializingDerivedType) { return; }
    serializeGroupAssignment(writer, excludedGroupAssignment, isSerializingDerivedType)
    writer.writeCollectionOfObjectValues<AssignedGroup>("assignments", excludedGroupAssignment.assignments, serializeAssignedGroup);
}
/**
 * Serializes information the current object
 ...
 */
// @ts-ignore
export function serializeGroupAssignment(writer: SerializationWriter, groupAssignment: Partial<GroupAssignment> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!groupAssignment || isSerializingDerivedType) { return; }
 ...
 */
// @ts-ignore
export function serializeIncludedGroupAssignment(writer: SerializationWriter, includedGroupAssignment: Partial<IncludedGroupAssignment> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!includedGroupAssignment || isSerializingDerivedType) { return; }
    serializeGroupAssignment(writer, includedGroupAssignment, isSerializingDerivedType)
    writer.writeCollectionOfObjectValues<AssignedGroup>("assignments", includedGroupAssignment.assignments, serializeAssignedGroup);
}
/**
 * Serializes information the current object
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
...
export function serializePolicy(writer: SerializationWriter, policy: Partial<Policy> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeCollectionOfObjectValues<ApplicableContent>("applicableContent", policy.applicableContent, serializeApplicableContent);
    writer.writeCollectionOfObjectValues<ApprovalRule>("approvalRules", policy.approvalRules, serializeApprovalRule);
    writer.writeCollectionOfObjectValues<PolicyApproval>("approvals", policy.approvals, serializePolicyApproval);
    ...
    writer.writeCollectionOfObjectValues<Ring>("rings", policy.rings, serializeRing);
 ...
 */
// @ts-ignore
export function serializePolicyApproval(writer: SerializationWriter, policyApproval: Partial<PolicyApproval> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!policyApproval || isSerializingDerivedType) { return; }
    serializeEntity(writer, policyApproval, isSerializingDerivedType)
    writer.writeObjectValue<CatalogEntry>("catalogEntry", policyApproval.catalogEntry, serializeCatalogEntry);
    ...
    writer.writeEnumValue<ApprovalStatus>("status", policyApproval.status);
}
/**
 * Serializes information the current object
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 ...
 */
// @ts-ignore
export function serializePolicyApprovalCollectionResponse(writer: SerializationWriter, policyApprovalCollectionResponse: Partial<PolicyApprovalCollectionResponse> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!policyApprovalCollectionResponse || isSerializingDerivedType) { return; }
    serializeBaseCollectionPaginationCountResponse(writer, policyApprovalCollectionResponse, isSerializingDerivedType)
    writer.writeCollectionOfObjectValues<PolicyApproval>("value", policyApprovalCollectionResponse.value, serializePolicyApproval);
}
/**
 * Serializes information the current object
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 ...
 */
// @ts-ignore
export function serializePolicyCollectionResponse(writer: SerializationWriter, policyCollectionResponse: Partial<PolicyCollectionResponse> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!policyCollectionResponse || isSerializingDerivedType) { return; }
    serializeBaseCollectionPaginationCountResponse(writer, policyCollectionResponse, isSerializingDerivedType)
    writer.writeCollectionOfObjectValues<Policy>("value", policyCollectionResponse.value, serializePolicy);
}
/**
 * Serializes information the current object
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 ...
 */
// @ts-ignore
export function serializeQualityUpdateApprovalRule(writer: SerializationWriter, qualityUpdateApprovalRule: Partial<QualityUpdateApprovalRule> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!qualityUpdateApprovalRule || isSerializingDerivedType) { return; }
    serializeApprovalRule(writer, qualityUpdateApprovalRule, isSerializingDerivedType)
    writer.writeEnumValue<QualityUpdateCadence>("cadence", qualityUpdateApprovalRule.cadence);
    writer.writeEnumValue<QualityUpdateClassification>("classification", qualityUpdateApprovalRule.classification);
}
/**
 * Serializes information the current object
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 ...
 */
// @ts-ignore
export function serializeQualityUpdatePolicy(writer: SerializationWriter, qualityUpdatePolicy: Partial<QualityUpdatePolicy> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!qualityUpdatePolicy || isSerializingDerivedType) { return; }
 ...
 */
// @ts-ignore
export function serializeQualityUpdateRing(writer: SerializationWriter, qualityUpdateRing: Partial<QualityUpdateRing> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!qualityUpdateRing || isSerializingDerivedType) { return; }
 ...
 */
// @ts-ignore
export function serializeRecoveryApprovalRule(writer: SerializationWriter, recoveryApprovalRule: Partial<RecoveryApprovalRule> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!recoveryApprovalRule || isSerializingDerivedType) { return; }
 ...
 */
// @ts-ignore
export function serializeRecoveryUpdateCatalogEntry(writer: SerializationWriter, recoveryUpdateCatalogEntry: Partial<RecoveryUpdateCatalogEntry> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!recoveryUpdateCatalogEntry || isSerializingDerivedType) { return; }
    ...
    writer.writeCollectionOfObjectValues<ProductRevision>("productRevisions", recoveryUpdateCatalogEntry.productRevisions, serializeProductRevision);
}
/**
 * Serializes information the current object
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 ...
 */
// @ts-ignore
export function serializeRing(writer: SerializationWriter, ring: Partial<Ring> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!ring || isSerializingDerivedType) { return; }
    ...
    writer.writeObjectValue<ExcludedGroupAssignment>("excludedGroupAssignment", ring.excludedGroupAssignment, serializeExcludedGroupAssignment);
    writer.writeObjectValue<IncludedGroupAssignment>("includedGroupAssignment", ring.includedGroupAssignment, serializeIncludedGroupAssignment);
 ...
 */
// @ts-ignore
export function serializeRingCollectionResponse(writer: SerializationWriter, ringCollectionResponse: Partial<RingCollectionResponse> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!ringCollectionResponse || isSerializingDerivedType) { return; }
    serializeBaseCollectionPaginationCountResponse(writer, ringCollectionResponse, isSerializingDerivedType)
    writer.writeCollectionOfObjectValues<Ring>("value", ringCollectionResponse.value, serializeRing);
}
/**
 * Serializes information the current object
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
