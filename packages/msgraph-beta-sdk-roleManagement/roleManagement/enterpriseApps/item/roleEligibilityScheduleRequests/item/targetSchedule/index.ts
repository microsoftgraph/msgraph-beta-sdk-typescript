...
// @ts-ignore
import { createUnifiedRoleEligibilityScheduleFromDiscriminatorValue, type UnifiedRoleEligibilitySchedule } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const TargetScheduleRequestBuilderUriTemplate = "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/targetSchedule{?%24expand,%24select}";
/**
