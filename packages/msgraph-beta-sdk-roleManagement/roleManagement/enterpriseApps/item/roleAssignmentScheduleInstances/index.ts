...
// @ts-ignore
import { createUnifiedRoleAssignmentScheduleInstanceCollectionResponseFromDiscriminatorValue, createUnifiedRoleAssignmentScheduleInstanceFromDiscriminatorValue, serializeUnifiedRoleAssignmentScheduleInstance, type UnifiedRoleAssignmentScheduleInstance, type UnifiedRoleAssignmentScheduleInstanceCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const RoleAssignmentScheduleInstancesRequestBuilderUriTemplate = "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentScheduleInstances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
