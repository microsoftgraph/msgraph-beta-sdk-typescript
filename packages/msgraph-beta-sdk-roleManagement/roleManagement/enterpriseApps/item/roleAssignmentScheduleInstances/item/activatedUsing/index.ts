...
// @ts-ignore
import { createUnifiedRoleEligibilityScheduleInstanceFromDiscriminatorValue, type UnifiedRoleEligibilityScheduleInstance } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ActivatedUsingRequestBuilderUriTemplate = "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstance%2Did}/activatedUsing{?%24expand,%24select}";
/**
