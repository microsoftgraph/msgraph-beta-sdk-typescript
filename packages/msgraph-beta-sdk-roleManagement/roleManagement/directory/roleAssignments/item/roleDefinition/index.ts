 ...
 */
export const RoleDefinitionRequestBuilderUriTemplate = "{+baseurl}/roleManagement/directory/roleAssignments/{unifiedRoleAssignment%2Did}/roleDefinition{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
