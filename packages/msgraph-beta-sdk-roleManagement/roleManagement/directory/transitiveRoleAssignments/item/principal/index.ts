 ...
 */
export const PrincipalRequestBuilderUriTemplate = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/principal{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
