 ...
 */
export const UnifiedRoleAssignmentItemRequestBuilderUriTemplate = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
