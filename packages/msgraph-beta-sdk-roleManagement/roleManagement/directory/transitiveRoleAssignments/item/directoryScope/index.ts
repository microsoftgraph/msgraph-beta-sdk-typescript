 ...
 */
export const DirectoryScopeRequestBuilderUriTemplate = "{+baseurl}/roleManagement/directory/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/directoryScope{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
