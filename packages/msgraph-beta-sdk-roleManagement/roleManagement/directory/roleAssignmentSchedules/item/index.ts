 ...
 */
export const UnifiedRoleAssignmentScheduleItemRequestBuilderUriTemplate = "{+baseurl}/roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
