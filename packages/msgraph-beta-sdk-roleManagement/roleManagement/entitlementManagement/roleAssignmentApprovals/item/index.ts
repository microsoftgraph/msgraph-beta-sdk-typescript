 ...
 */
export const ApprovalItemRequestBuilderUriTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentApprovals/{approval%2Did}{?%24expand,%24select}";
/* tslint:enable */
/* eslint-enable */
