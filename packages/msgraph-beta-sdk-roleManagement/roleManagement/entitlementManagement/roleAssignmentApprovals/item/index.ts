 ...
 */
export const ApprovalItemRequestBuilderUriTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentApprovals/{approval%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
