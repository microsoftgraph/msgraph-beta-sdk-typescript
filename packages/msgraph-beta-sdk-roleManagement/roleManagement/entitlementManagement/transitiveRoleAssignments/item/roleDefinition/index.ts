 ...
 */
export const RoleDefinitionRequestBuilderUriTemplate = "{+baseurl}/roleManagement/entitlementManagement/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/roleDefinition{?%24expand,%24select}";
/* tslint:enable */
/* eslint-enable */
