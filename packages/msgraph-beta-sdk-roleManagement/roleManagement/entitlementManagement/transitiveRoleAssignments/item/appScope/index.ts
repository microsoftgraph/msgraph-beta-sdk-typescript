 ...
 */
export const AppScopeRequestBuilderUriTemplate = "{+baseurl}/roleManagement/entitlementManagement/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/appScope{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
