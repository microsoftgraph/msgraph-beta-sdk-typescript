...
// @ts-ignore
import { createUnifiedRbacApplicationMultipleFromDiscriminatorValue, serializeUnifiedRbacApplicationMultiple, type UnifiedRbacApplicationMultiple } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export const DefenderRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    get: {
        ...
        responseBodyFactory:  createUnifiedRbacApplicationMultipleFromDiscriminatorValue,
    ...
    patch: {
        ...
        requestBodySerializer: serializeUnifiedRbacApplicationMultiple,
