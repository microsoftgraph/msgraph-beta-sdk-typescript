 ...
 */
export const UnifiedRoleDefinitionItemRequestBuilderUriTemplate = "{+baseurl}/roleManagement/cloudPC/roleDefinitions/{unifiedRoleDefinition%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
