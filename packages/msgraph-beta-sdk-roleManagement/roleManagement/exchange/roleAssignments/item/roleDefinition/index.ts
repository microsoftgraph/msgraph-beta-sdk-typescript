 ...
 */
export const RoleDefinitionRequestBuilderUriTemplate = "{+baseurl}/roleManagement/exchange/roleAssignments/{unifiedRoleAssignment%2Did}/roleDefinition{?%24expand,%24select}";
/* tslint:enable */
/* eslint-enable */
