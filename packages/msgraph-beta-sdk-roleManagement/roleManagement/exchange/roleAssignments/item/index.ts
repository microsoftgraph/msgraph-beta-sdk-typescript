 ...
 */
export const UnifiedRoleAssignmentItemRequestBuilderUriTemplate = "{+baseurl}/roleManagement/exchange/roleAssignments/{unifiedRoleAssignment%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
