...
export interface UnifiedRoleAssignmentItemRequestBuilder extends BaseRequestBuilder<UnifiedRoleAssignmentItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/unifiedroleassignment-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/unifiedroleassignment-get?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const UnifiedRoleAssignmentItemRequestBuilderUriTemplate = "{+baseurl}/roleManagement/exchange/roleAssignments/{unifiedRoleAssignment%2Did}{?%24expand,%24select}";
/**
