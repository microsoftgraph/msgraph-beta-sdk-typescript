 ...
 */
export const PrincipalRequestBuilderUriTemplate = "{+baseurl}/roleManagement/exchange/roleAssignments/{unifiedRoleAssignment%2Did}/principal{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
