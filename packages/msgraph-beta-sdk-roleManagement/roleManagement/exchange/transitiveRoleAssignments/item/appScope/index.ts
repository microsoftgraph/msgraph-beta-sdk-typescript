 ...
 */
export const AppScopeRequestBuilderUriTemplate = "{+baseurl}/roleManagement/exchange/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/appScope{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
