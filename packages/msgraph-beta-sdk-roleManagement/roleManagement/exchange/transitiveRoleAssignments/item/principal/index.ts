 ...
 */
export const PrincipalRequestBuilderUriTemplate = "{+baseurl}/roleManagement/exchange/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/principal{?%24expand,%24select}";
/**
 * Provides operations to manage the principal property of the microsoft.graph.unifiedRoleAssignment entity.
 */
