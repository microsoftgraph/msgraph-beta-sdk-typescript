 ...
 */
export const RoleDefinitionRequestBuilderUriTemplate = "{+baseurl}/roleManagement/deviceManagement/roleAssignments/{unifiedRoleAssignmentMultiple%2Did}/roleDefinition{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
