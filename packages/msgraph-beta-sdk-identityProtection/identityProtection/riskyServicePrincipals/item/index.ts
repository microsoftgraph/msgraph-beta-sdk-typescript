...
// @ts-ignore
import { createRiskyServicePrincipalFromDiscriminatorValue, serializeRiskyServicePrincipal, type RiskyServicePrincipal } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RiskyServicePrincipalItemRequestBuilder extends BaseRequestBuilder<RiskyServicePrincipalItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/riskyserviceprincipal-get?view=graph-rest-beta|Find more info here}
     */
