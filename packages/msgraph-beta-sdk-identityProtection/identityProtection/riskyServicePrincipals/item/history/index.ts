...
// @ts-ignore
import { createRiskyServicePrincipalHistoryItemCollectionResponseFromDiscriminatorValue, createRiskyServicePrincipalHistoryItemFromDiscriminatorValue, serializeRiskyServicePrincipalHistoryItem, type RiskyServicePrincipalHistoryItem, type RiskyServicePrincipalHistoryItemCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { RiskyServicePrincipalHistoryItemItemRequestBuilderRequestsMetadata, type RiskyServicePrincipalHistoryItemItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface HistoryRequestBuilder extends BaseRequestBuilder<HistoryRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/riskyserviceprincipal-list-history?view=graph-rest-beta|Find more info here}
     */
