...
// @ts-ignore
import { createRiskyServicePrincipalCollectionResponseFromDiscriminatorValue, createRiskyServicePrincipalFromDiscriminatorValue, serializeRiskyServicePrincipal, type RiskyServicePrincipal, type RiskyServicePrincipalCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RiskyServicePrincipalsRequestBuilder extends BaseRequestBuilder<RiskyServicePrincipalsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identityprotectionroot-list-riskyserviceprincipals?view=graph-rest-beta|Find more info here}
     */
