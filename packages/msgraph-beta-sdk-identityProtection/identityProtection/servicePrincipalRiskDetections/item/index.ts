...
// @ts-ignore
import { createServicePrincipalRiskDetectionFromDiscriminatorValue, serializeServicePrincipalRiskDetection, type ServicePrincipalRiskDetection } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ServicePrincipalRiskDetectionItemRequestBuilder extends BaseRequestBuilder<ServicePrincipalRiskDetectionItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/serviceprincipalriskdetection-get?view=graph-rest-beta|Find more info here}
     */
