...
// @ts-ignore
import { createContractFromDiscriminatorValue, serializeContract, type Contract } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ContractItemRequestBuilder extends BaseRequestBuilder<ContractItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/contract-get?view=graph-rest-beta|Find more info here}
     */
