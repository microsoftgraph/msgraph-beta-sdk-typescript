...
import { createDataSourceCollectionResponseFromDiscriminatorValue, type DataSourceCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/ediscovery/';
 ...
 */
export const CustodianSourcesRequestBuilderUriTemplate = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}/custodianSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
