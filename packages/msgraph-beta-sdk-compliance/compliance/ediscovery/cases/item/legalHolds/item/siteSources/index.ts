...
// @ts-ignore
import { createSiteSourceCollectionResponseFromDiscriminatorValue, createSiteSourceFromDiscriminatorValue, serializeSiteSource, type SiteSource, type SiteSourceCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/ediscovery/index.js';
// @ts-ignore
...
export interface SiteSourcesRequestBuilder extends BaseRequestBuilder<SiteSourcesRequestBuilder> {
     ...
     * @deprecated The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace
     * @see {@link https://learn.microsoft.com/graph/api/ediscovery-legalhold-list-sitesources?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @deprecated The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace
     * @see {@link https://learn.microsoft.com/graph/api/ediscovery-legalhold-post-sitesources?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const SiteSourcesRequestBuilderUriTemplate = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}/siteSources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
