...
// @ts-ignore
import { createUnifiedGroupSourceCollectionResponseFromDiscriminatorValue, createUnifiedGroupSourceFromDiscriminatorValue, serializeUnifiedGroupSource, type UnifiedGroupSource, type UnifiedGroupSourceCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/ediscovery/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { type UnifiedGroupSourceItemRequestBuilder, UnifiedGroupSourceItemRequestBuilderNavigationMetadata, UnifiedGroupSourceItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
...
export interface UnifiedGroupSourcesRequestBuilder extends BaseRequestBuilder<UnifiedGroupSourcesRequestBuilder> {
     ...
     * @deprecated The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace on 2022-12-05 and will be removed 2023-02-01
     * @see {@link https://learn.microsoft.com/graph/api/ediscovery-custodian-list-unifiedgroupsources?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @deprecated The ediscovery Apis are deprecated under /compliance and will stop returning data from February 01, 2023. Please use the new ediscovery Apis under /security. as of 2022-12/ediscoveryNamespace on 2022-12-05 and will be removed 2023-02-01
     * @see {@link https://learn.microsoft.com/graph/api/ediscovery-custodian-post-unifiedgroupsources?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const UnifiedGroupSourcesRequestBuilderUriTemplate = "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians/{custodian%2Did}/unifiedGroupSources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
