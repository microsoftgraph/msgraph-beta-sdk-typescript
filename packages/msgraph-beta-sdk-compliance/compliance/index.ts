...
import { createComplianceFromDiscriminatorValue, serializeCompliance, type Compliance } from '@microsoft/msgraph-beta-sdk/models/';
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/';
import { EdiscoveryRequestBuilderNavigationMetadata, EdiscoveryRequestBuilderRequestsMetadata, EdiscoveryRequestBuilderUriTemplate, type EdiscoveryRequestBuilder } from './ediscovery/';
...
export interface ComplianceRequestBuilder extends BaseRequestBuilder<ComplianceRequestBuilder> {
     ...
     */
    get ediscovery(): EdiscoveryRequestBuilder;
    /**
     * Get compliance
 ...
 */
export const ComplianceRequestBuilderNavigationMetadata: Record<Exclude<keyof ComplianceRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ediscovery: {
        uriTemplate: EdiscoveryRequestBuilderUriTemplate,
        requestsMetadata: EdiscoveryRequestBuilderRequestsMetadata,
        navigationMetadata: EdiscoveryRequestBuilderNavigationMetadata,
    },
};
/**
