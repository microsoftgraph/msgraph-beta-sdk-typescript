...
export function createAuthenticationMethodsPolicyServiceClient(requestAdapter: RequestAdapter, backingStore?: BackingStoreFactory | undefined) {
    ...
    return apiClientProxifier<AuthenticationMethodsPolicyServiceClient>(requestAdapter, pathParameters, AuthenticationMethodsPolicyServiceClientUriTemplate, AuthenticationMethodsPolicyServiceClientNavigationMetadata, undefined);
}
/**
