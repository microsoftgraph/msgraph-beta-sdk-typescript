...
export interface ConversationMemberItemRequestBuilder extends BaseRequestBuilder<ConversationMemberItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/team-delete-members?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/team-get-members?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ConversationMember>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/team-update-members?view=graph-rest-beta|Find more info here}
     */
