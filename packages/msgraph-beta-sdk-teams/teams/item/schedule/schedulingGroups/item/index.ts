...
// @ts-ignore
import { createSchedulingGroupFromDiscriminatorValue, serializeSchedulingGroup, type SchedulingGroup } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SchedulingGroupItemRequestBuilder extends BaseRequestBuilder<SchedulingGroupItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/schedulinggroup-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/schedulinggroup-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<SchedulingGroup>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/schedulinggroup-put?view=graph-rest-beta|Find more info here}
     */
