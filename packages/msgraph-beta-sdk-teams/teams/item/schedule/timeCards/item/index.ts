...
export interface TimeCardItemRequestBuilder extends BaseRequestBuilder<TimeCardItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/timecard-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/timecard-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<TimeCard>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/timecard-replace?view=graph-rest-beta|Find more info here}
     */
