...
export interface TimeCardsRequestBuilder extends BaseRequestBuilder<TimeCardsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/timecard-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/timecard-post?view=graph-rest-beta|Find more info here}
     */
