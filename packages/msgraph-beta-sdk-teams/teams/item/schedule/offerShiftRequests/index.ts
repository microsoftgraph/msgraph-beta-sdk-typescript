...
export interface OfferShiftRequestsRequestBuilder extends BaseRequestBuilder<OfferShiftRequestsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/offershiftrequest-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/offershiftrequest-post?view=graph-rest-beta|Find more info here}
     */
