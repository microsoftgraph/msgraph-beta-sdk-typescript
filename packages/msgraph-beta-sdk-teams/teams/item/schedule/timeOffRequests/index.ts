...
// @ts-ignore
import { createTimeOffRequestCollectionResponseFromDiscriminatorValue, createTimeOffRequestFromDiscriminatorValue, serializeTimeOffRequest, type TimeOffRequest, type TimeOffRequestCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TimeOffRequestsRequestBuilder extends BaseRequestBuilder<TimeOffRequestsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/timeoffrequest-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/timeoffrequest-post?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const TimeOffRequestsRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/schedule/timeOffRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
