...
export interface TimeOffRequestItemRequestBuilder extends BaseRequestBuilder<TimeOffRequestItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/timeoffrequest-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/timeoffrequest-get?view=graph-rest-beta|Find more info here}
     */
