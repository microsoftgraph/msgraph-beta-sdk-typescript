...
// @ts-ignore
import { createShiftFromDiscriminatorValue, serializeShift, type Shift } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ShiftItemRequestBuilder extends BaseRequestBuilder<ShiftItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/shift-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/shift-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Shift>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/shift-put?view=graph-rest-beta|Find more info here}
     */
