...
// @ts-ignore
import { createShiftCollectionResponseFromDiscriminatorValue, createShiftFromDiscriminatorValue, serializeShift, type Shift, type ShiftCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface ShiftsRequestBuilder extends BaseRequestBuilder<ShiftsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/schedule-list-shifts?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/schedule-post-shifts?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const ShiftsRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/schedule/shifts{?%24count,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
