...
// @ts-ignore
import { createTimeOffReasonCollectionResponseFromDiscriminatorValue, createTimeOffReasonFromDiscriminatorValue, serializeTimeOffReason, type TimeOffReason, type TimeOffReasonCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface TimeOffReasonsRequestBuilder extends BaseRequestBuilder<TimeOffReasonsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/schedule-list-timeoffreasons?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/schedule-post-timeoffreasons?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const TimeOffReasonsRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/schedule/timeOffReasons{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
