...
// @ts-ignore
import { createTimeOffReasonFromDiscriminatorValue, serializeTimeOffReason, type TimeOffReason } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TimeOffReasonItemRequestBuilder extends BaseRequestBuilder<TimeOffReasonItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/timeoffreason-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/timeoffreason-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<TimeOffReason>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/timeoffreason-put?view=graph-rest-beta|Find more info here}
     */
