...
// @ts-ignore
import { createTimeOffFromDiscriminatorValue, serializeTimeOff, type TimeOff } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TimeOffItemRequestBuilder extends BaseRequestBuilder<TimeOffItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/timeoff-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/timeoff-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<TimeOff>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/timeoff-put?view=graph-rest-beta|Find more info here}
     */
