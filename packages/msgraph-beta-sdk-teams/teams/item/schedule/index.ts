...
export interface ScheduleRequestBuilder extends BaseRequestBuilder<ScheduleRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/schedule-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Schedule>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/team-put-schedule?view=graph-rest-beta|Find more info here}
     */
