...
// @ts-ignore
import { createOpenShiftFromDiscriminatorValue, serializeOpenShift, type OpenShift } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface OpenShiftItemRequestBuilder extends BaseRequestBuilder<OpenShiftItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/openshift-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/openshift-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<OpenShift>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/openshift-update?view=graph-rest-beta|Find more info here}
     */
