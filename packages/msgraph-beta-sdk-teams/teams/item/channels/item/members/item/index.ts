...
export interface ConversationMemberItemRequestBuilder extends BaseRequestBuilder<ConversationMemberItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/channel-delete-members?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/channel-get-members?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ConversationMember>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/conversationmember-update?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const ConversationMemberItemRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/members/{conversationMember%2Did}{?%24expand,%24select}";
/**
