...
// @ts-ignore
import { createPlannerPlanCollectionResponseFromDiscriminatorValue, createPlannerPlanFromDiscriminatorValue, serializePlannerPlan, type PlannerPlan, type PlannerPlanCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PlansRequestBuilder extends BaseRequestBuilder<PlansRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/teamschannelplanner-list-plans?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const PlansRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/planner/plans{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
