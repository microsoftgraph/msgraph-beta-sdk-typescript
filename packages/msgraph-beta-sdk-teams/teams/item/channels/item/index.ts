...
// @ts-ignore
import { createChannelFromDiscriminatorValue, serializeChannel, type Channel } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ChannelItemRequestBuilder extends BaseRequestBuilder<ChannelItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/channel-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/channel-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Channel>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/channel-patch?view=graph-rest-beta|Find more info here}
     */
