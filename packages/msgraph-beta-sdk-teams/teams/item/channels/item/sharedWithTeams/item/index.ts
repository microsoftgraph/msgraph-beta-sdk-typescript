...
export interface SharedWithChannelTeamInfoItemRequestBuilder extends BaseRequestBuilder<SharedWithChannelTeamInfoItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/sharedwithchannelteaminfo-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/sharedwithchannelteaminfo-get?view=graph-rest-beta|Find more info here}
     */
