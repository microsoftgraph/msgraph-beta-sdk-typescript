...
export interface ChatMessageItemRequestBuilder extends BaseRequestBuilder<ChatMessageItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/chatmessage-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ChatMessage>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/chatmessage-update?view=graph-rest-beta|Find more info here}
     */
