...
// @ts-ignore
import { createChatMessageHostedContentCollectionResponseFromDiscriminatorValue, createChatMessageHostedContentFromDiscriminatorValue, serializeChatMessageHostedContent, type ChatMessageHostedContent, type ChatMessageHostedContentCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface HostedContentsRequestBuilder extends BaseRequestBuilder<HostedContentsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/chatmessage-list-hostedcontents?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const HostedContentsRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/hostedContents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
