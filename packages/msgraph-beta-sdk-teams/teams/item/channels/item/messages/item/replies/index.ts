...
// @ts-ignore
import { createChatMessageCollectionResponseFromDiscriminatorValue, createChatMessageFromDiscriminatorValue, serializeChatMessage, type ChatMessage, type ChatMessageCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RepliesRequestBuilder extends BaseRequestBuilder<RepliesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/chatmessage-list-replies?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/chatmessage-post-replies?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const RepliesRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
