...
export interface ChannelsRequestBuilder extends BaseRequestBuilder<ChannelsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/channel-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/channel-post?view=graph-rest-beta|Find more info here}
     */
