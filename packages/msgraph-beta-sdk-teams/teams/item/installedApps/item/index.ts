...
export interface TeamsAppInstallationItemRequestBuilder extends BaseRequestBuilder<TeamsAppInstallationItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/team-delete-installedapps?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/team-get-installedapps?view=graph-rest-beta|Find more info here}
     */
