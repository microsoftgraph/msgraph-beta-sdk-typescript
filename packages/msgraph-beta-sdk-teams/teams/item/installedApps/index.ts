...
// @ts-ignore
import { createTeamsAppInstallationCollectionResponseFromDiscriminatorValue, createTeamsAppInstallationFromDiscriminatorValue, serializeTeamsAppInstallation, type TeamsAppInstallation, type TeamsAppInstallationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface InstalledAppsRequestBuilder extends BaseRequestBuilder<InstalledAppsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/team-list-installedapps?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/team-post-installedapps?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const InstalledAppsRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/installedApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
