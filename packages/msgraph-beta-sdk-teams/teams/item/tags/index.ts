...
// @ts-ignore
import { createTeamworkTagCollectionResponseFromDiscriminatorValue, createTeamworkTagFromDiscriminatorValue, serializeTeamworkTag, type TeamworkTag, type TeamworkTagCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TagsRequestBuilder extends BaseRequestBuilder<TagsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/teamworktag-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/teamworktag-post?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const TagsRequestBuilderUriTemplate = "{+baseurl}/teams/{team%2Did}/tags{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
