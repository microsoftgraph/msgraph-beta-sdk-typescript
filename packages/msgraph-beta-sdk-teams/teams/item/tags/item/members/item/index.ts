...
export interface TeamworkTagMemberItemRequestBuilder extends BaseRequestBuilder<TeamworkTagMemberItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/teamworktagmember-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/teamworktagmember-get?view=graph-rest-beta|Find more info here}
     */
