...
// @ts-ignore
import { createTeamworkTagFromDiscriminatorValue, serializeTeamworkTag, type TeamworkTag } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TeamworkTagItemRequestBuilder extends BaseRequestBuilder<TeamworkTagItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/teamworktag-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/teamworktag-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<TeamworkTag>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/teamworktag-update?view=graph-rest-beta|Find more info here}
     */
