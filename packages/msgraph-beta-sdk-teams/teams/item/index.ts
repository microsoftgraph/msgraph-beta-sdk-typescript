...
export interface TeamItemRequestBuilder extends BaseRequestBuilder<TeamItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/team-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Team>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/team-update?view=graph-rest-beta|Find more info here}
     */
