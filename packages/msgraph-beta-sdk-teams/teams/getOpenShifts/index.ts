...
// @ts-ignore
import { createOpenShiftFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeOpenShift, type BaseCollectionPaginationCountResponse, type OpenShift } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export interface GetOpenShiftsRequestBuilder extends BaseRequestBuilder<GetOpenShiftsRequestBuilder> {
    /**
     ...
     * @see {@link https://learn.microsoft.com/graph/api/team-getopenshifts?view=graph-rest-beta|Find more info here}
     */
 ...
 * Get all openShift objects across all teams a user is a direct member of.
 */
export interface GetOpenShiftsRequestBuilderGetQueryParameters {
    /**
