...
// @ts-ignore
import { createCompanyFromDiscriminatorValue, type Company } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { AgedAccountsPayableRequestBuilderNavigationMetadata, AgedAccountsPayableRequestBuilderRequestsMetadata, type AgedAccountsPayableRequestBuilder } from './agedAccountsPayable/index.js';
// @ts-ignore
import { AgedAccountsReceivableRequestBuilderNavigationMetadata, AgedAccountsReceivableRequestBuilderRequestsMetadata, type AgedAccountsReceivableRequestBuilder } from './agedAccountsReceivable/index.js';
// @ts-ignore
import { CompanyInformationRequestBuilderNavigationMetadata, CompanyInformationRequestBuilderRequestsMetadata, type CompanyInformationRequestBuilder } from './companyInformation/index.js';
// @ts-ignore
import { CountriesRegionsRequestBuilderNavigationMetadata, CountriesRegionsRequestBuilderRequestsMetadata, type CountriesRegionsRequestBuilder } from './countriesRegions/index.js';
// @ts-ignore
...
// @ts-ignore
import { CustomerPaymentJournalsRequestBuilderNavigationMetadata, CustomerPaymentJournalsRequestBuilderRequestsMetadata, type CustomerPaymentJournalsRequestBuilder } from './customerPaymentJournals/index.js';
// @ts-ignore
import { CustomerPaymentsRequestBuilderNavigationMetadata, CustomerPaymentsRequestBuilderRequestsMetadata, type CustomerPaymentsRequestBuilder } from './customerPayments/index.js';
// @ts-ignore
...
// @ts-ignore
import { DimensionsRequestBuilderNavigationMetadata, DimensionsRequestBuilderRequestsMetadata, type DimensionsRequestBuilder } from './dimensions/index.js';
// @ts-ignore
import { DimensionValuesRequestBuilderNavigationMetadata, DimensionValuesRequestBuilderRequestsMetadata, type DimensionValuesRequestBuilder } from './dimensionValues/index.js';
// @ts-ignore
import { EmployeesRequestBuilderNavigationMetadata, EmployeesRequestBuilderRequestsMetadata, type EmployeesRequestBuilder } from './employees/index.js';
// @ts-ignore
import { GeneralLedgerEntriesRequestBuilderNavigationMetadata, GeneralLedgerEntriesRequestBuilderRequestsMetadata, type GeneralLedgerEntriesRequestBuilder } from './generalLedgerEntries/index.js';
// @ts-ignore
import { ItemCategoriesRequestBuilderNavigationMetadata, ItemCategoriesRequestBuilderRequestsMetadata, type ItemCategoriesRequestBuilder } from './itemCategories/index.js';
// @ts-ignore
...
// @ts-ignore
import { JournalLinesRequestBuilderNavigationMetadata, JournalLinesRequestBuilderRequestsMetadata, type JournalLinesRequestBuilder } from './journalLines/index.js';
// @ts-ignore
import { JournalsRequestBuilderNavigationMetadata, JournalsRequestBuilderRequestsMetadata, type JournalsRequestBuilder } from './journals/index.js';
// @ts-ignore
...
// @ts-ignore
import { PaymentTermsRequestBuilderNavigationMetadata, PaymentTermsRequestBuilderRequestsMetadata, type PaymentTermsRequestBuilder } from './paymentTerms/index.js';
// @ts-ignore
...
// @ts-ignore
import { PurchaseInvoiceLinesRequestBuilderNavigationMetadata, PurchaseInvoiceLinesRequestBuilderRequestsMetadata, type PurchaseInvoiceLinesRequestBuilder } from './purchaseInvoiceLines/index.js';
// @ts-ignore
import { PurchaseInvoicesRequestBuilderNavigationMetadata, PurchaseInvoicesRequestBuilderRequestsMetadata, type PurchaseInvoicesRequestBuilder } from './purchaseInvoices/index.js';
// @ts-ignore
import { SalesCreditMemoLinesRequestBuilderNavigationMetadata, SalesCreditMemoLinesRequestBuilderRequestsMetadata, type SalesCreditMemoLinesRequestBuilder } from './salesCreditMemoLines/index.js';
// @ts-ignore
import { SalesCreditMemosRequestBuilderNavigationMetadata, SalesCreditMemosRequestBuilderRequestsMetadata, type SalesCreditMemosRequestBuilder } from './salesCreditMemos/index.js';
// @ts-ignore
import { SalesInvoiceLinesRequestBuilderNavigationMetadata, SalesInvoiceLinesRequestBuilderRequestsMetadata, type SalesInvoiceLinesRequestBuilder } from './salesInvoiceLines/index.js';
// @ts-ignore
import { SalesInvoicesRequestBuilderNavigationMetadata, SalesInvoicesRequestBuilderRequestsMetadata, type SalesInvoicesRequestBuilder } from './salesInvoices/index.js';
// @ts-ignore
import { SalesOrderLinesRequestBuilderNavigationMetadata, SalesOrderLinesRequestBuilderRequestsMetadata, type SalesOrderLinesRequestBuilder } from './salesOrderLines/index.js';
// @ts-ignore
import { SalesOrdersRequestBuilderNavigationMetadata, SalesOrdersRequestBuilderRequestsMetadata, type SalesOrdersRequestBuilder } from './salesOrders/index.js';
// @ts-ignore
import { SalesQuoteLinesRequestBuilderNavigationMetadata, SalesQuoteLinesRequestBuilderRequestsMetadata, type SalesQuoteLinesRequestBuilder } from './salesQuoteLines/index.js';
// @ts-ignore
import { SalesQuotesRequestBuilderNavigationMetadata, SalesQuotesRequestBuilderRequestsMetadata, type SalesQuotesRequestBuilder } from './salesQuotes/index.js';
// @ts-ignore
import { ShipmentMethodsRequestBuilderNavigationMetadata, ShipmentMethodsRequestBuilderRequestsMetadata, type ShipmentMethodsRequestBuilder } from './shipmentMethods/index.js';
// @ts-ignore
import { TaxAreasRequestBuilderNavigationMetadata, TaxAreasRequestBuilderRequestsMetadata, type TaxAreasRequestBuilder } from './taxAreas/index.js';
// @ts-ignore
import { TaxGroupsRequestBuilderNavigationMetadata, TaxGroupsRequestBuilderRequestsMetadata, type TaxGroupsRequestBuilder } from './taxGroups/index.js';
// @ts-ignore
import { type UnitsOfMeasureRequestBuilder, UnitsOfMeasureRequestBuilderNavigationMetadata, UnitsOfMeasureRequestBuilderRequestsMetadata } from './unitsOfMeasure/index.js';
// @ts-ignore
import { type VendorsRequestBuilder, VendorsRequestBuilderNavigationMetadata, VendorsRequestBuilderRequestsMetadata } from './vendors/index.js';
// @ts-ignore
