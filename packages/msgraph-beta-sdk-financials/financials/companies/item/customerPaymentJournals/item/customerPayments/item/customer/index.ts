...
// @ts-ignore
import { createCustomerFromDiscriminatorValue, serializeCustomer, type Customer } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const CustomerRequestBuilderUriTemplate = "{+baseurl}/financials/companies/{company%2Did}/customerPaymentJournals/{customerPaymentJournal%2Did}/customerPayments/{customerPayment%2Did}/customer{?%24expand,%24select}";
/**
