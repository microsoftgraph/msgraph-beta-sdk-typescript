 ...
 */
export const PrivilegedRoleAssignmentItemRequestBuilderUriTemplate = "{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo/assignments/{privilegedRoleAssignment%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
