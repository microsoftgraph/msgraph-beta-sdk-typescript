...
import { PrivilegedApprovalRequestBuilderNavigationMetadata, PrivilegedApprovalRequestBuilderRequestsMetadata, PrivilegedApprovalRequestBuilderUriTemplate, type PrivilegedApprovalRequestBuilder } from './privilegedApproval/';
...
export function createPrivilegedApprovalServiceClient(requestAdapter: RequestAdapter, backingStore?: BackingStoreFactory | undefined) {
    ...
    return apiClientProxifier<PrivilegedApprovalServiceClient>(requestAdapter, pathParameters, PrivilegedApprovalServiceClientUriTemplate, PrivilegedApprovalServiceClientNavigationMetadata, undefined);
}
/**
