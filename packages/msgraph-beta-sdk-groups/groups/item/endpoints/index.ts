...
import { createEndpointCollectionResponseFromDiscriminatorValue, createEndpointFromDiscriminatorValue, serializeEndpoint, type Endpoint, type EndpointCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
...
export interface EndpointsRequestBuilder extends BaseRequestBuilder<EndpointsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/group-list-endpoints?view=graph-rest-1.0|Find more info here}
     */
 ...
 */
export const EndpointsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/endpoints{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/* tslint:enable */
/* eslint-enable */
