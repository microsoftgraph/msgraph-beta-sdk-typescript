...
// @ts-ignore
import { createConversationThreadFromDiscriminatorValue, serializeConversationThread, type ConversationThread } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ConversationThreadItemRequestBuilder extends BaseRequestBuilder<ConversationThreadItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/conversationthread-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/conversationthread-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ConversationThread>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/group-update-thread?view=graph-rest-beta|Find more info here}
     */
