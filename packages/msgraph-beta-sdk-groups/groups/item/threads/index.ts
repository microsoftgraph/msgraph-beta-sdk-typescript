...
export interface ThreadsRequestBuilder extends BaseRequestBuilder<ThreadsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/group-list-threads?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/group-post-threads?view=graph-rest-beta|Find more info here}
     */
