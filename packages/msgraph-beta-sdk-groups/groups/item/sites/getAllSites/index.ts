...
// @ts-ignore
import { createSiteFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeSite, type BaseCollectionPaginationCountResponse, type Site } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GetAllSitesRequestBuilder extends BaseRequestBuilder<GetAllSitesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/site-getallsites?view=graph-rest-beta|Find more info here}
     */
