 ...
 */
export const MailboxSettingsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage/createdByUser/mailboxSettings{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
