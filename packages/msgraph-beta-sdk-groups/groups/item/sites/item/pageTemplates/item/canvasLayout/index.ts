...
// @ts-ignore
import { createCanvasLayoutFromDiscriminatorValue, serializeCanvasLayout, type CanvasLayout } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const CanvasLayoutRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/pageTemplates/{pageTemplate%2Did}/canvasLayout{?%24expand,%24select}";
/**
