...
// @ts-ignore
import { createTermFromDiscriminatorValue, type Term } from '@microsoft/msgraph-beta-sdk/models/termStore/index.js';
// @ts-ignore
 ...
 */
export const ToTermRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}/toTerm{?%24expand,%24select}";
/**
