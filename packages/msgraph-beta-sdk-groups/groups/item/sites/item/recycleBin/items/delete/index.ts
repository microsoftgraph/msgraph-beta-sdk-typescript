...
export function serializeDeletePostRequestBody(writer: SerializationWriter, deletePostRequestBody: Partial<DeletePostRequestBody> | undefined | null = {}) : void {
    if (deletePostRequestBody) {
        writer.writeCollectionOfPrimitiveValues<string>("ids", deletePostRequestBody.ids);
 ...
 */
export const DeleteRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/recycleBin/items/delete";
/**
