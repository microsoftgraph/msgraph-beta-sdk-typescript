...
// @ts-ignore
import { createListItemVersionCollectionResponseFromDiscriminatorValue, createListItemVersionFromDiscriminatorValue, serializeListItemVersion, type ListItemVersion, type ListItemVersionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const VersionsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/versions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
