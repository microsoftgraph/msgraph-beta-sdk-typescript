...
// @ts-ignore
import { createThreatAssessmentResultCollectionResponseFromDiscriminatorValue, createThreatAssessmentResultFromDiscriminatorValue, serializeThreatAssessmentResult, type ThreatAssessmentResult, type ThreatAssessmentResultCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ResultsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}/results{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
