...
// @ts-ignore
import { createDlpEvaluatePoliciesJobResponseFromDiscriminatorValue, createDlpEvaluationInputFromDiscriminatorValue, createDlpNotificationFromDiscriminatorValue, createTextClassificationRequestFromDiscriminatorValue, serializeDlpEvaluatePoliciesJobResponse, serializeDlpEvaluationInput, serializeDlpNotification, serializeTextClassificationRequest, type DlpEvaluatePoliciesJobResponse, type DlpEvaluationInput, type DlpNotification, type TextClassificationRequest } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export function deserializeIntoEvaluatePostRequestBody(evaluatePostRequestBody: Partial<EvaluatePostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "classifyText": n => { evaluatePostRequestBody.classifyText = n.getObjectValue<TextClassificationRequest>(createTextClassificationRequestFromDiscriminatorValue); },
...
export interface EvaluatePostRequestBody extends AdditionalDataHolder, BackedModel, Parsable {
     ...
     */
    classifyText?: TextClassificationRequest | null;
    /**
     * The evaluationInput property
     */
    evaluationInput?: DlpEvaluationInput | null;
    /**
     * The notificationInfo property
     */
    notificationInfo?: DlpNotification | null;
    /**
     * The target property
     */
    target?: string | null;
...
export function serializeEvaluatePostRequestBody(writer: SerializationWriter, evaluatePostRequestBody: Partial<EvaluatePostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeObjectValue<TextClassificationRequest>("classifyText", evaluatePostRequestBody.classifyText, serializeTextClassificationRequest);
 ...
 */
export const EvaluateRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/dataLossPreventionPolicies/evaluate";
/**
