...
// @ts-ignore
import { createUsageRightsIncludedFromDiscriminatorValue, type UsageRightsIncluded } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const RightsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/{sensitivityLabel%2Did1}/rights{?%24expand,%24select}";
/**
