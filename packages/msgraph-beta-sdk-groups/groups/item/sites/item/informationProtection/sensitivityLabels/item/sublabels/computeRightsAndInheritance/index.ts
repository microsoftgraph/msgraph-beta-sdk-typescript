...
// @ts-ignore
import { createComputeRightsAndInheritanceResultFromDiscriminatorValue, createProtectedContentFromDiscriminatorValue, serializeComputeRightsAndInheritanceResult, serializeProtectedContent, type ComputeRightsAndInheritanceResult, type ProtectedContent } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ComputeRightsAndInheritanceRequestBuilder extends BaseRequestBuilder<ComputeRightsAndInheritanceRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/sensitivitylabel-computerightsandinheritance?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const ComputeRightsAndInheritanceRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/computeRightsAndInheritance";
/**
