 ...
 */
export const InformationProtectionRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/informationProtection{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
