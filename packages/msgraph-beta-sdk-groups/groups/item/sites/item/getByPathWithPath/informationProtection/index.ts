 ...
 */
export const InformationProtectionRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/informationProtection{?%24expand,%24select}";
/**
