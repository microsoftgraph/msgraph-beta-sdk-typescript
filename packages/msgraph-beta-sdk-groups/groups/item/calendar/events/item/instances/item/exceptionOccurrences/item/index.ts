 ...
 */
export const EventItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
