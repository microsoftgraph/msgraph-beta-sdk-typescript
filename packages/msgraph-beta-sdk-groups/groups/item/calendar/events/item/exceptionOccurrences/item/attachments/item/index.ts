 ...
 */
export const AttachmentItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/attachments/{attachment%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
