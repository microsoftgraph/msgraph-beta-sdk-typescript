 ...
 */
export const CreateUploadSessionRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/attachments/createUploadSession";
/**
