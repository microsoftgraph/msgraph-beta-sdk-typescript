...
// @ts-ignore
import { createCalendarPermissionCollectionResponseFromDiscriminatorValue, createCalendarPermissionFromDiscriminatorValue, serializeCalendarPermission, type CalendarPermission, type CalendarPermissionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const CalendarPermissionsRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/calendar/calendarPermissions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
