...
// @ts-ignore
import { createAssignedLicenseFromDiscriminatorValue, createGroupFromDiscriminatorValue, serializeAssignedLicense, serializeGroup, type AssignedLicense, type Group } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AssignLicenseRequestBuilder extends BaseRequestBuilder<AssignLicenseRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/group-assignlicense?view=graph-rest-beta|Find more info here}
     */
