 ...
 */
export const GraphOrgContactRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/{directoryObject%2Did}/graph.orgContact{?%24expand,%24select}";
/**
 * Casts the previous resource to orgContact.
 */
