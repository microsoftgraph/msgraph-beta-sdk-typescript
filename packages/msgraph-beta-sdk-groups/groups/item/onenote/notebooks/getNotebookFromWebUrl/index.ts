...
// @ts-ignore
import { createCopyNotebookModelFromDiscriminatorValue, serializeCopyNotebookModel, type CopyNotebookModel } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GetNotebookFromWebUrlRequestBuilder extends BaseRequestBuilder<GetNotebookFromWebUrlRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/notebook-getnotebookfromweburl?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const GetNotebookFromWebUrlRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/onenote/notebooks/getNotebookFromWebUrl";
/**
