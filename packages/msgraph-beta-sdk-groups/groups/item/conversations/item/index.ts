...
// @ts-ignore
import { createConversationFromDiscriminatorValue, type Conversation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ConversationItemRequestBuilder extends BaseRequestBuilder<ConversationItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/group-get-conversation?view=graph-rest-beta|Find more info here}
     */
