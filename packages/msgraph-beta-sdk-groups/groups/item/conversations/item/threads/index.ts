...
// @ts-ignore
import { createConversationThreadCollectionResponseFromDiscriminatorValue, createConversationThreadFromDiscriminatorValue, serializeConversationThread, type ConversationThread, type ConversationThreadCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ThreadsRequestBuilder extends BaseRequestBuilder<ThreadsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/conversation-list-threads?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/conversation-post-threads?view=graph-rest-beta|Find more info here}
     */
