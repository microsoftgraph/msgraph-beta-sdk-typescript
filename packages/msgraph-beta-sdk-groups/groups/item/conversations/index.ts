...
// @ts-ignore
import { createConversationCollectionResponseFromDiscriminatorValue, createConversationFromDiscriminatorValue, serializeConversation, type Conversation, type ConversationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ConversationsRequestBuilder extends BaseRequestBuilder<ConversationsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/group-list-conversations?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/group-post-conversations?view=graph-rest-beta|Find more info here}
     */
