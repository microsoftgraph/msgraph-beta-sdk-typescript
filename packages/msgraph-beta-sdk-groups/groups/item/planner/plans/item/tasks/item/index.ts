 ...
 */
export const PlannerTaskItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}{?%24expand,%24select}";
/* tslint:enable */
/* eslint-enable */
