 ...
 */
export const PlannerTaskItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
