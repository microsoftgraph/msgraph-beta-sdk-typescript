...
// @ts-ignore
import { createGroupFromDiscriminatorValue, serializeGroup, type Group } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GroupItemRequestBuilder extends BaseRequestBuilder<GroupItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/group-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/group-get?view=graph-rest-beta|Find more info here}
     */
