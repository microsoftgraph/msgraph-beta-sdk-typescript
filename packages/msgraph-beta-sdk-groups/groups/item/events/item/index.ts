...
// @ts-ignore
import { createEventFromDiscriminatorValue, serializeEvent, type Event } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
// @ts-ignore
import { ExceptionOccurrencesRequestBuilderNavigationMetadata, ExceptionOccurrencesRequestBuilderRequestsMetadata, type ExceptionOccurrencesRequestBuilder } from './exceptionOccurrences/';
// @ts-ignore
...
export interface EventItemRequestBuilder extends BaseRequestBuilder<EventItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/group-delete-event?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/group-get-event?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Event>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/group-update-event?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const EventItemRequestBuilderUriTemplate = "{+baseurl}/groups/{group%2Did}/events/{event%2Did}{?%24expand,%24select}";
/**
