...
// @ts-ignore
import { createEventCollectionResponseFromDiscriminatorValue, createEventFromDiscriminatorValue, serializeEvent, type Event, type EventCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface EventsRequestBuilder extends BaseRequestBuilder<EventsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/group-list-events?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/group-post-events?view=graph-rest-beta|Find more info here}
     */
