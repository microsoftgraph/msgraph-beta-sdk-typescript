...
// @ts-ignore
import { createGroupCollectionResponseFromDiscriminatorValue, createGroupFromDiscriminatorValue, serializeGroup, type Group, type GroupCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { EvaluateDynamicMembershipRequestBuilderRequestsMetadata, type EvaluateDynamicMembershipRequestBuilder } from './evaluateDynamicMembership/index.js';
// @ts-ignore
...
export interface GroupsRequestBuilder extends BaseRequestBuilder<GroupsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/group-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/group-post-groups?view=graph-rest-beta|Find more info here}
     */
