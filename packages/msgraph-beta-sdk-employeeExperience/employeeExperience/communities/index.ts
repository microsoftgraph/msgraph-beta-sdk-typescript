...
// @ts-ignore
import { CommunityItemRequestBuilderNavigationMetadata, CommunityItemRequestBuilderRequestsMetadata, type CommunityItemRequestBuilder } from './item/';
// @ts-ignore
...
export interface CommunitiesRequestBuilder extends BaseRequestBuilder<CommunitiesRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/employeeexperience-post-communities?view=graph-rest-beta|Find more info here}
     */
