...
// @ts-ignore
import { createCommunityFromDiscriminatorValue, serializeCommunity, type Community } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CommunityItemRequestBuilder extends BaseRequestBuilder<CommunityItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/community-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/community-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Community>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/community-update?view=graph-rest-beta|Find more info here}
     */
