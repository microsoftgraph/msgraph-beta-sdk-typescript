 ...
 */
export const MailboxSettingsRequestBuilderUriTemplate = "{+baseurl}/employeeExperience/communities/{community%2Did}/owners/{user%2Did}/mailboxSettings{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
