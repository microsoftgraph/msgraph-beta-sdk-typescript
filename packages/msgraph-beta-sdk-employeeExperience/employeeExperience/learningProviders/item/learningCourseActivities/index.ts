...
// @ts-ignore
import { createLearningCourseActivityCollectionResponseFromDiscriminatorValue, createLearningCourseActivityFromDiscriminatorValue, serializeLearningCourseActivity, type LearningCourseActivity, type LearningCourseActivityCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface LearningCourseActivitiesRequestBuilder extends BaseRequestBuilder<LearningCourseActivitiesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/learningcourseactivity-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/employeeexperienceuser-post-learningcourseactivities?view=graph-rest-beta|Find more info here}
     */
