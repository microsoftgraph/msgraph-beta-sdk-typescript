...
// @ts-ignore
import { createLearningCourseActivityFromDiscriminatorValue, serializeLearningCourseActivity, type LearningCourseActivity } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface LearningCourseActivitiesWithExternalcourseActivityIdRequestBuilder extends BaseRequestBuilder<LearningCourseActivitiesWithExternalcourseActivityIdRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/learningcourseactivity-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<LearningCourseActivity>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/learningcourseactivity-update?view=graph-rest-beta|Find more info here}
     */
