...
// @ts-ignore
import { createLearningProviderFromDiscriminatorValue, serializeLearningProvider, type LearningProvider } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface LearningProviderItemRequestBuilder extends BaseRequestBuilder<LearningProviderItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/employeeexperience-delete-learningproviders?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/learningprovider-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<LearningProvider>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/learningprovider-update?view=graph-rest-beta|Find more info here}
     */
