...
// @ts-ignore
import { createLearningContentCollectionResponseFromDiscriminatorValue, createLearningContentFromDiscriminatorValue, serializeLearningContent, type LearningContent, type LearningContentCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface LearningContentsRequestBuilder extends BaseRequestBuilder<LearningContentsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/learningprovider-list-learningcontents?view=graph-rest-beta|Find more info here}
     */
