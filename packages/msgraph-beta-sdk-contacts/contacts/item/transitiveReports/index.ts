 ...
 */
export interface TransitiveReportsRequestBuilder extends BaseRequestBuilder<TransitiveReportsRequestBuilder> {
    /**
     ...
     * @see {@link https://learn.microsoft.com/graph/api/orgcontact-get-transitivereports?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const TransitiveReportsRequestBuilderUriTemplate = "{+baseurl}/contacts/{orgContact%2Did}/transitiveReports{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
 * Mapper for query parameters from symbol name to serialization name represented as a constant.
 */
const TransitiveReportsRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "count": "%24count",
    "expand": "%24expand",
    "filter": "%24filter",
    "orderby": "%24orderby",
 ...
 */
export const TransitiveReportsRequestBuilderNavigationMetadata: Record<Exclude<keyof TransitiveReportsRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byDirectoryObjectId: {
 ...
 */
export const TransitiveReportsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        queryParametersMapper: TransitiveReportsRequestBuilderGetQueryParametersMapper,
    },
};
/* tslint:enable */
/* eslint-enable */
