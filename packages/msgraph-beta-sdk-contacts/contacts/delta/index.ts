...
import { createOrgContactFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeOrgContact, type BaseDeltaFunctionResponse, type OrgContact } from '@microsoft/msgraph-beta-sdk/models/';
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/contacts/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
