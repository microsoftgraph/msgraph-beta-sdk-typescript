...
// @ts-ignore
import { createOrgContactFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeOrgContact, type BaseDeltaFunctionResponse, type OrgContact } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/orgcontact-delta?view=graph-rest-beta|Find more info here}
     */
