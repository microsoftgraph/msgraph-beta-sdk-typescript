...
// @ts-ignore
import { createOrgContactCollectionResponseFromDiscriminatorValue, createOrgContactFromDiscriminatorValue, serializeOrgContact, type OrgContact, type OrgContactCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ContactsRequestBuilder extends BaseRequestBuilder<ContactsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/orgcontact-list?view=graph-rest-beta|Find more info here}
     */
