...
// @ts-ignore
import { createCalendarCollectionResponseFromDiscriminatorValue, createCalendarFromDiscriminatorValue, serializeCalendar, type Calendar, type CalendarCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
