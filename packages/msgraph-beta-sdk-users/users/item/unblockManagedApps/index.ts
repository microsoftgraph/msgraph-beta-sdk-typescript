 ...
 */
export interface UnblockManagedAppsRequestBuilder extends BaseRequestBuilder<UnblockManagedAppsRequestBuilder> {
    /**
 ...
 */
export const UnblockManagedAppsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/unblockManagedApps";
/**
