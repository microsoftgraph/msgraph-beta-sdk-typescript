...
import { ItemPatentItemRequestBuilderRequestsMetadata, ItemPatentItemRequestBuilderUriTemplate, type ItemPatentItemRequestBuilder } from './item/';
...
export interface PatentsRequestBuilder extends BaseRequestBuilder<PatentsRequestBuilder> {
     ...
     * @returns a ItemPatentItemRequestBuilder
     */
     ...
     * @returns a Promise of ItemPatentCollectionResponse
 ...
 */
export const PatentsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/profile/patents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
