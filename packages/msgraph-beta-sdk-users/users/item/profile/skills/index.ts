...
import { SkillProficiencyItemRequestBuilderRequestsMetadata, SkillProficiencyItemRequestBuilderUriTemplate, type SkillProficiencyItemRequestBuilder } from './item/';
...
export interface SkillsRequestBuilder extends BaseRequestBuilder<SkillsRequestBuilder> {
     ...
     * @returns a SkillProficiencyItemRequestBuilder
     */
     ...
     * @returns a Promise of SkillProficiencyCollectionResponse
 ...
 */
export const SkillsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/profile/skills{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
