...
import { type UserAccountInformationItemRequestBuilder, UserAccountInformationItemRequestBuilderRequestsMetadata, UserAccountInformationItemRequestBuilderUriTemplate } from './item/';
...
export interface AccountRequestBuilder extends BaseRequestBuilder<AccountRequestBuilder> {
     ...
     * @returns a UserAccountInformationItemRequestBuilder
     */
     ...
     * @returns a Promise of UserAccountInformationCollectionResponse
 ...
 */
export const AccountRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/profile/account{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
