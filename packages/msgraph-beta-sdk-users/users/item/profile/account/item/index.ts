 ...
 */
export const UserAccountInformationItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/profile/account/{userAccountInformation%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
