 ...
 */
export const EducationalActivityItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/profile/educationalActivities/{educationalActivity%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
