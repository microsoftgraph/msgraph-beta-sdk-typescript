...
import { PersonAnnotationItemRequestBuilderRequestsMetadata, PersonAnnotationItemRequestBuilderUriTemplate, type PersonAnnotationItemRequestBuilder } from './item/';
...
export interface NotesRequestBuilder extends BaseRequestBuilder<NotesRequestBuilder> {
     ...
     * @returns a PersonAnnotationItemRequestBuilder
     */
     ...
     * @returns a Promise of PersonAnnotationCollectionResponse
     ...
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns a Promise of PersonAnnotation
 ...
 */
export const NotesRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/profile/notes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
