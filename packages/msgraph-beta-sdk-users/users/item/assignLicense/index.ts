...
// @ts-ignore
import { createAssignedLicenseFromDiscriminatorValue, createUserFromDiscriminatorValue, serializeAssignedLicense, serializeUser, type AssignedLicense, type User } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
