 ...
 */
export const CreateDeviceLogCollectionRequestRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/createDeviceLogCollectionRequest";
/* tslint:enable */
/* eslint-enable */
