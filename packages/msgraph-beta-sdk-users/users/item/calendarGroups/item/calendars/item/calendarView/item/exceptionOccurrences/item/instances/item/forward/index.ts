...
// @ts-ignore
import { createRecipientFromDiscriminatorValue, serializeRecipient, type Recipient } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ForwardRequestBuilder extends BaseRequestBuilder<ForwardRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/event-forward?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const ForwardRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/forward";
/**
