...
// @ts-ignore
import { createTimeSlotFromDiscriminatorValue, serializeTimeSlot, type TimeSlot } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DeclineRequestBuilder extends BaseRequestBuilder<DeclineRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/event-decline?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const DeclineRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/decline";
/**
