...
// @ts-ignore
import { createDateTimeTimeZoneFromDiscriminatorValue, serializeDateTimeTimeZone, type DateTimeTimeZone } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SnoozeReminderRequestBuilder extends BaseRequestBuilder<SnoozeReminderRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/event-snoozereminder?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const SnoozeReminderRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/snoozeReminder";
/**
