 ...
 * @param EvaluateDynamicMembershipPostRequestBody The instance to deserialize into.
 ...
 * @param EvaluateDynamicMembershipPostRequestBody The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeEvaluateDynamicMembershipPostRequestBody(writer: SerializationWriter, evaluateDynamicMembershipPostRequestBody: Partial<EvaluateDynamicMembershipPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!evaluateDynamicMembershipPostRequestBody || isSerializingDerivedType) { return; }
 ...
 */
export const EvaluateDynamicMembershipRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/joinedGroups/evaluateDynamicMembership";
/**
