...
// @ts-ignore
import { createLongRunningOperationFromDiscriminatorValue, serializeLongRunningOperation, type LongRunningOperation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface LongRunningOperationItemRequestBuilder extends BaseRequestBuilder<LongRunningOperationItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/authenticationoperation-get?view=graph-rest-beta|Find more info here}
     */
