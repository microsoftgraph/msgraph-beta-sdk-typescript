...
// @ts-ignore
import { createEmailAuthenticationMethodFromDiscriminatorValue, serializeEmailAuthenticationMethod, type EmailAuthenticationMethod } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface EmailAuthenticationMethodItemRequestBuilder extends BaseRequestBuilder<EmailAuthenticationMethodItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/emailauthenticationmethod-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<EmailAuthenticationMethod>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/emailauthenticationmethod-update?view=graph-rest-beta|Find more info here}
     */
