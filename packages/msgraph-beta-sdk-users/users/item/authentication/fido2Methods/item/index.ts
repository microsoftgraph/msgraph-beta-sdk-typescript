...
// @ts-ignore
import { createFido2AuthenticationMethodFromDiscriminatorValue, type Fido2AuthenticationMethod } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface Fido2AuthenticationMethodItemRequestBuilder extends BaseRequestBuilder<Fido2AuthenticationMethodItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/fido2authenticationmethod-delete?view=graph-rest-beta|Find more info here}
     */
