...
// @ts-ignore
import { createSoftwareOathAuthenticationMethodFromDiscriminatorValue, type SoftwareOathAuthenticationMethod } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SoftwareOathAuthenticationMethodItemRequestBuilder extends BaseRequestBuilder<SoftwareOathAuthenticationMethodItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/softwareoathauthenticationmethod-delete?view=graph-rest-beta|Find more info here}
     */
