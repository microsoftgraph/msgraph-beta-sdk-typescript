 ...
 */
export interface AssignToRequestBuilder extends BaseRequestBuilder<AssignToRequestBuilder> {
    /**
 ...
 */
export const AssignToRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/authentication/hardwareOathMethods/{hardwareOathAuthenticationMethod%2Did}/device/hardwareOathDevices/{hardwareOathTokenAuthenticationMethodDevice%2Did}/assignTo{?%24expand,%24select}";
/**
 * Mapper for query parameters from symbol name to serialization name represented as a constant.
 */
const AssignToRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "expand": "%24expand",
    "select": "%24select",
};
/**
 ...
 */
export const AssignToRequestBuilderNavigationMetadata: Record<Exclude<keyof AssignToRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    mailboxSettings: {
 ...
 */
export const AssignToRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: AssignToRequestBuilderUriTemplate,
        ...
        queryParametersMapper: AssignToRequestBuilderGetQueryParametersMapper,
    },
};
/* tslint:enable */
/* eslint-enable */
