...
export function deserializeIntoActivatePostRequestBody(activatePostRequestBody: Partial<ActivatePostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "displayName": n => { activatePostRequestBody.displayName = n.getStringValue(); },
        "verificationCode": n => { activatePostRequestBody.verificationCode = n.getStringValue(); },
    }
}
/**
 ...
 */
export const ActivateRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/authentication/hardwareOathMethods/{hardwareOathAuthenticationMethod%2Did}/activate";
/**
