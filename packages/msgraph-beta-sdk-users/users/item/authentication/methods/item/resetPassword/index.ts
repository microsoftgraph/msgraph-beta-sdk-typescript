...
// @ts-ignore
import { createPasswordResetResponseFromDiscriminatorValue, serializePasswordResetResponse, type PasswordResetResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ResetPasswordRequestBuilder extends BaseRequestBuilder<ResetPasswordRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/authenticationmethod-resetpassword?view=graph-rest-beta|Find more info here}
     */
