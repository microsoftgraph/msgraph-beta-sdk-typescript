...
// @ts-ignore
import { createUserConsentRequestCollectionResponseFromDiscriminatorValue, createUserConsentRequestFromDiscriminatorValue, serializeUserConsentRequest, type UserConsentRequest, type UserConsentRequestCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { type UserConsentRequestItemRequestBuilder, UserConsentRequestItemRequestBuilderNavigationMetadata, UserConsentRequestItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
 ...
 */
export const UserConsentRequestsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/appConsentRequestsForApproval/{appConsentRequest%2Did}/userConsentRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
