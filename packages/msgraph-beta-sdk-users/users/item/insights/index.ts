...
import { createItemInsightsFromDiscriminatorValue, serializeItemInsights, type ItemInsights } from '@microsoft/msgraph-beta-sdk/models/';
...
export interface InsightsRequestBuilder extends BaseRequestBuilder<InsightsRequestBuilder> {
     ...
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns a Promise of ItemInsights
     */
