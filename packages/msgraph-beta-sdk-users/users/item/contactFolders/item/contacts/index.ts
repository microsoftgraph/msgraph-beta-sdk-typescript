...
// @ts-ignore
import { createContactCollectionResponseFromDiscriminatorValue, createContactFromDiscriminatorValue, serializeContact, type Contact, type ContactCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { ContactItemRequestBuilderNavigationMetadata, ContactItemRequestBuilderRequestsMetadata, type ContactItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const ContactsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/contacts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
