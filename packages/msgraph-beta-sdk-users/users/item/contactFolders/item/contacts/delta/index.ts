...
// @ts-ignore
import { createContactFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeContact, type BaseDeltaFunctionResponse, type Contact } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
