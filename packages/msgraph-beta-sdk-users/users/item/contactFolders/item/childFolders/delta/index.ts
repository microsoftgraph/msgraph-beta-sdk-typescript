...
// @ts-ignore
import { createContactFolderFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeContactFolder, type BaseDeltaFunctionResponse, type ContactFolder } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/contactfolder-delta?view=graph-rest-beta|Find more info here}
     */
