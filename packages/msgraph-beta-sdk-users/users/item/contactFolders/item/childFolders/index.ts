...
// @ts-ignore
import { createContactFolderCollectionResponseFromDiscriminatorValue, createContactFolderFromDiscriminatorValue, serializeContactFolder, type ContactFolder, type ContactFolderCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { ContactFolderItemRequestBuilderNavigationMetadata, ContactFolderItemRequestBuilderRequestsMetadata, type ContactFolderItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const ChildFoldersRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/childFolders{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
