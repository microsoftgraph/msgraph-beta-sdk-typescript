...
// @ts-ignore
import { createConversionUserDetailsFromDiscriminatorValue, createPasswordProfileFromDiscriminatorValue, serializeConversionUserDetails, serializePasswordProfile, type ConversionUserDetails, type PasswordProfile } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface ConvertExternalToInternalMemberUserRequestBuilder extends BaseRequestBuilder<ConvertExternalToInternalMemberUserRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/user-convertexternaltointernalmemberuser?view=graph-rest-1.0|Find more info here}
     */
