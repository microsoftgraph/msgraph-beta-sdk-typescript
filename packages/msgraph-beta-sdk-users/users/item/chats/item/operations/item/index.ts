 ...
 */
export const TeamsAsyncOperationItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/operations/{teamsAsyncOperation%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
