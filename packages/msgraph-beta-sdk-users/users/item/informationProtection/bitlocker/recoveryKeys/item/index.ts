 ...
 */
export const BitlockerRecoveryKeyItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/informationProtection/bitlocker/recoveryKeys/{bitlockerRecoveryKey%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
