 ...
 */
export const InformationProtectionLabelItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/informationProtection/policy/labels/{informationProtectionLabel%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
