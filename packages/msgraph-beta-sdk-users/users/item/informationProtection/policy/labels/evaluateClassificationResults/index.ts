 ...
 */
export const EvaluateClassificationResultsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/informationProtection/policy/labels/evaluateClassificationResults";
/**
