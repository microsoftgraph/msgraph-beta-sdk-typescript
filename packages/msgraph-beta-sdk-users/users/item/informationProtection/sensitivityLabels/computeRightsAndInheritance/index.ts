 ...
 */
export const ComputeRightsAndInheritanceRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/informationProtection/sensitivityLabels/computeRightsAndInheritance";
/**
