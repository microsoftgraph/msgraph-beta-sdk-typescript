...
// @ts-ignore
import { createChatFromDiscriminatorValue, type Chat } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ChatRequestBuilder extends BaseRequestBuilder<ChatRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/userscopeteamsappinstallation-get-chat?view=graph-rest-beta|Find more info here}
     */
