...
// @ts-ignore
import { createUserScopeTeamsAppInstallationCollectionResponseFromDiscriminatorValue, createUserScopeTeamsAppInstallationFromDiscriminatorValue, serializeUserScopeTeamsAppInstallation, type UserScopeTeamsAppInstallation, type UserScopeTeamsAppInstallationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { type UserScopeTeamsAppInstallationItemRequestBuilder, UserScopeTeamsAppInstallationItemRequestBuilderNavigationMetadata, UserScopeTeamsAppInstallationItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
...
export interface InstalledAppsRequestBuilder extends BaseRequestBuilder<InstalledAppsRequestBuilder> {
     ...
     * @deprecated  as of 2024-07/PrivatePreview:copilotExportAPI
     * @see {@link https://learn.microsoft.com/graph/api/userteamwork-list-installedapps?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @deprecated  as of 2024-07/PrivatePreview:copilotExportAPI
     * @see {@link https://learn.microsoft.com/graph/api/userteamwork-post-installedapps?view=graph-rest-beta|Find more info here}
     */
