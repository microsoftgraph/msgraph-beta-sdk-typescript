...
import { OutlookTaskFolderItemRequestBuilderNavigationMetadata, OutlookTaskFolderItemRequestBuilderRequestsMetadata, OutlookTaskFolderItemRequestBuilderUriTemplate, type OutlookTaskFolderItemRequestBuilder } from './item/';
...
export interface TaskFoldersRequestBuilder extends BaseRequestBuilder<TaskFoldersRequestBuilder> {
     ...
     * @deprecated The Outlook tasks API is deprecated and will stop returning data on February 20, 2023. Please use the new To Do API. For more details, please visit https://developer.microsoft.com/en-us/office/blogs/announcing-the-general-availability-of-microsoft-to-do-apis-on-graph/ as of 2020-08/Outlook_Tasks
     * @see {@link https://learn.microsoft.com/graph/api/outlooktaskgroup-list-taskfolders?view=graph-rest-1.0|Find more info here}
     */
     ...
     * @deprecated The Outlook tasks API is deprecated and will stop returning data on February 20, 2023. Please use the new To Do API. For more details, please visit https://developer.microsoft.com/en-us/office/blogs/announcing-the-general-availability-of-microsoft-to-do-apis-on-graph/ as of 2020-08/Outlook_Tasks
     * @see {@link https://learn.microsoft.com/graph/api/outlooktaskgroup-post-taskfolders?view=graph-rest-1.0|Find more info here}
     */
 ...
 */
export const TaskFoldersRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
/* tslint:enable */
/* eslint-enable */
