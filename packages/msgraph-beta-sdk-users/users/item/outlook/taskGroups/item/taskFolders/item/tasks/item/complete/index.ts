...
// @ts-ignore
import { createOutlookTaskFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeOutlookTask, type BaseCollectionPaginationCountResponse, type OutlookTask } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
 ...
 */
export const CompleteRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/outlook/taskGroups/{outlookTaskGroup%2Did}/taskFolders/{outlookTaskFolder%2Did}/tasks/{outlookTask%2Did}/complete";
/**
