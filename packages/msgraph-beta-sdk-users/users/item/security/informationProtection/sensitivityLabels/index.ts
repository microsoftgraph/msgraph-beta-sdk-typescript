...
// @ts-ignore
import { createSensitivityLabelCollectionResponseFromDiscriminatorValue, createSensitivityLabelFromDiscriminatorValue, serializeSensitivityLabel, type SensitivityLabel, type SensitivityLabelCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
// @ts-ignore
import { MicrosoftGraphSecurityEvaluateApplicationRequestBuilderRequestsMetadata, type MicrosoftGraphSecurityEvaluateApplicationRequestBuilder } from './microsoftGraphSecurityEvaluateApplication/index.js';
// @ts-ignore
import { MicrosoftGraphSecurityEvaluateClassificationResultsRequestBuilderRequestsMetadata, type MicrosoftGraphSecurityEvaluateClassificationResultsRequestBuilder } from './microsoftGraphSecurityEvaluateClassificationResults/index.js';
// @ts-ignore
import { MicrosoftGraphSecurityEvaluateRemovalRequestBuilderRequestsMetadata, type MicrosoftGraphSecurityEvaluateRemovalRequestBuilder } from './microsoftGraphSecurityEvaluateRemoval/index.js';
// @ts-ignore
import { MicrosoftGraphSecurityExtractContentLabelRequestBuilderRequestsMetadata, type MicrosoftGraphSecurityExtractContentLabelRequestBuilder } from './microsoftGraphSecurityExtractContentLabel/index.js';
// @ts-ignore
