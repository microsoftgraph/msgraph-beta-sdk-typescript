...
import { createClassificationResultFromDiscriminatorValue, createContentInfoFromDiscriminatorValue, createInformationProtectionActionFromDiscriminatorValue, serializeClassificationResult, serializeContentInfo, serializeInformationProtectionAction, type ClassificationResult, type ContentInfo, type InformationProtectionAction } from '@microsoft/msgraph-beta-sdk/models/security/';
 ...
 */
export const MicrosoftGraphSecurityEvaluateClassificationResultsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels/microsoft.graph.security.evaluateClassificationResults";
/**
