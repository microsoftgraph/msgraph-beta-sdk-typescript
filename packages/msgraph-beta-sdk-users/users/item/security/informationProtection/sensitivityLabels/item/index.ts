 ...
 */
export const SensitivityLabelItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
