 ...
 */
export const ParentRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/security/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/parent{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
