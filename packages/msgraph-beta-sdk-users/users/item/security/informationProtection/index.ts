...
import { LabelPolicySettingsRequestBuilderRequestsMetadata, type LabelPolicySettingsRequestBuilder } from './labelPolicySettings/';
 ...
 */
export const InformationProtectionRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/security/informationProtection{?%24expand,%24select}";
/**
 * Provides operations to manage the informationProtection property of the microsoft.graph.security.security entity.
 */
export const GetExpandQueryParameterTypeObject = {
    Asterisk: "*",
    LabelPolicySettings: "labelPolicySettings",
