...
export interface RefRequestBuilder extends BaseRequestBuilder<RefRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/agentuser-delete-sponsors?view=graph-rest-beta|Find more info here}
     */
     ...
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/agentuser-post-sponsors?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const RefRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/sponsors/$ref{?%24count,%24filter,%24orderby,%24search,%24skip,%24top}";
/**
...
export const RefRequestBuilderRequestsMetadata: RequestsMetadata = {
    delete: {
        uriTemplate: "{+baseurl}/users/{user%2Did}/sponsors/$ref?@id={%40id}",
