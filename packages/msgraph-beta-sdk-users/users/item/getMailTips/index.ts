...
// @ts-ignore
import { createMailTipsFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, MailTipsTypeObject, serializeBaseCollectionPaginationCountResponse, serializeMailTips, type BaseCollectionPaginationCountResponse, type MailTips, type MailTipsType } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GetMailTipsRequestBuilder extends BaseRequestBuilder<GetMailTipsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/user-getmailtips?view=graph-rest-beta|Find more info here}
     */
