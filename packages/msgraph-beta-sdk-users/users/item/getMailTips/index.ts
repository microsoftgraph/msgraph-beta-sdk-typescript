...
// @ts-ignore
import { createMailTipsFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, MailTipsType, MailTipsTypeObject, serializeBaseCollectionPaginationCountResponse, serializeMailTips, type BaseCollectionPaginationCountResponse, type MailTips } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
