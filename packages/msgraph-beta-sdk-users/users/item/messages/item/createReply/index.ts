...
export interface CreateReplyRequestBuilder extends BaseRequestBuilder<CreateReplyRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/message-createreply?view=graph-rest-beta|Find more info here}
     */
 ...
 */
// @ts-ignore
export function serializeCreateReplyPostRequestBody(writer: SerializationWriter, createReplyPostRequestBody: Partial<CreateReplyPostRequestBody> | undefined | null = {}) : void {
    if (createReplyPostRequestBody) {
 ...
 */
export const CreateReplyRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/messages/{message%2Did}/createReply";
/**
