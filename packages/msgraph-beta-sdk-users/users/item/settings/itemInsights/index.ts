...
// @ts-ignore
import { createUserInsightsSettingsFromDiscriminatorValue, serializeUserInsightsSettings, type UserInsightsSettings } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ItemInsightsRequestBuilder extends BaseRequestBuilder<ItemInsightsRequestBuilder> {
     ...
     * @returns {Promise<UserInsightsSettings>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/userinsightssettings-update?view=graph-rest-beta|Find more info here}
     */
