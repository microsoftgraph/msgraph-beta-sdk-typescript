...
// @ts-ignore
import { createShiftPreferencesFromDiscriminatorValue, serializeShiftPreferences, type ShiftPreferences } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ShiftPreferencesRequestBuilder extends BaseRequestBuilder<ShiftPreferencesRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/shiftpreferences-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ShiftPreferences>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/shiftpreferences-put?view=graph-rest-beta|Find more info here}
     */
