...
// @ts-ignore
import { createUnifiedStorageQuotaFromDiscriminatorValue, serializeUnifiedStorageQuota, type UnifiedStorageQuota } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface QuotaRequestBuilder extends BaseRequestBuilder<QuotaRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/unifiedstoragequota-get?view=graph-rest-1.0|Find more info here}
     */
