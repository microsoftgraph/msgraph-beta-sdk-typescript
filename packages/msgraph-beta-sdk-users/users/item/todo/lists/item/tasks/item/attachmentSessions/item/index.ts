...
// @ts-ignore
import { createAttachmentSessionFromDiscriminatorValue, serializeAttachmentSession, type AttachmentSession } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
