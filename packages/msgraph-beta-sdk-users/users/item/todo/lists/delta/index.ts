...
import { createTodoTaskListFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeTodoTaskList, type BaseDeltaFunctionResponse, type TodoTaskList } from '@microsoft/msgraph-beta-sdk/models/';
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/todo/lists/delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
