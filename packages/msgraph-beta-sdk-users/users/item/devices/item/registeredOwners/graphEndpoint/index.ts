...
// @ts-ignore
import { createEndpointCollectionResponseFromDiscriminatorValue, type EndpointCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const GraphEndpointRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/graph.endpoint{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
