...
// @ts-ignore
import { createEndpointFromDiscriminatorValue, type Endpoint } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
 ...
 */
export const GraphEndpointRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/graph.endpoint{?%24expand,%24select}";
/**
