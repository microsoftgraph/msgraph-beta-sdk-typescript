...
// @ts-ignore
import { createAppRoleAssignmentFromDiscriminatorValue, type AppRoleAssignment } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const GraphAppRoleAssignmentRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/graph.appRoleAssignment{?%24expand,%24select}";
/**
