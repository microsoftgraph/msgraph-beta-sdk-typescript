 ...
 */
export const GraphUserRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/graph.user{?%24expand,%24select}";
/**
 * Casts the previous resource to user.
 */
