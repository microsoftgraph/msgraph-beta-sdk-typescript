...
export interface RegisteredOwnersRequestBuilder extends BaseRequestBuilder<RegisteredOwnersRequestBuilder> {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.users.item.devices.item.registeredOwners.item collection
 ...
 */
export const RegisteredOwnersRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/* tslint:enable */
/* eslint-enable */
