 ...
 */
export const ResponsepayloadRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/commands/{command%2Did}/responsepayload{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
