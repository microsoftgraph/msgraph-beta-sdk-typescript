...
export interface RegisteredUsersRequestBuilder extends BaseRequestBuilder<RegisteredUsersRequestBuilder> {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.users.item.devices.item.registeredUsers.item collection
 ...
 */
export const RegisteredUsersRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/* tslint:enable */
/* eslint-enable */
