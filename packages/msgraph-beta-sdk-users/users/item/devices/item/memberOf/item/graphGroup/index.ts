 ...
 */
export const GraphGroupRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf/{directoryObject%2Did}/graph.group{?%24expand,%24select}";
/**
