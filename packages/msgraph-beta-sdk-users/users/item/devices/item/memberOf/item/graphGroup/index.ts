 ...
 */
export const GraphGroupRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/memberOf/{directoryObject%2Did}/graph.group{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
