 ...
 */
export const DirectoryObjectItemRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24expand,%24select}";
/**
