...
// @ts-ignore
import { createDeviceFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeDevice, type BaseDeltaFunctionResponse, type Device } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
