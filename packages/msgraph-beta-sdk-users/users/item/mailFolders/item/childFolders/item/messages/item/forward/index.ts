...
// @ts-ignore
import { createMessageFromDiscriminatorValue, createRecipientFromDiscriminatorValue, serializeMessage, serializeRecipient, type Message, type Recipient } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
