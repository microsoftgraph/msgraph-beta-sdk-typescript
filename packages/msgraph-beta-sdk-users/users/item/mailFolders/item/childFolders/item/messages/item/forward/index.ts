...
// @ts-ignore
import { createMessageFromDiscriminatorValue, createRecipientFromDiscriminatorValue, serializeMessage, serializeRecipient, type Message, type Recipient } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ForwardRequestBuilder extends BaseRequestBuilder<ForwardRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/message-forward?view=graph-rest-beta|Find more info here}
     */
