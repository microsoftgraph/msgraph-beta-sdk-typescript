...
// @ts-ignore
import { createMailFolderFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeMailFolder, type BaseDeltaFunctionResponse, type MailFolder } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/mailfolder-delta?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/mailFolders/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
