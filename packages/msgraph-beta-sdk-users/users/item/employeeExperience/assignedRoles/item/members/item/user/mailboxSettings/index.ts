 ...
 */
export const MailboxSettingsRequestBuilderUriTemplate = "{+baseurl}/users/{user%2Did}/employeeExperience/assignedRoles/{engagementRole%2Did}/members/{engagementRoleMember%2Did}/user/mailboxSettings{?%24expand,%24select}";
/**
