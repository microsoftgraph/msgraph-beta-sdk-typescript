...
export interface AgentGroupsRequestBuilder extends BaseRequestBuilder<AgentGroupsRequestBuilder> {
    ...
    /**
     * Gets an item from the github.com/microsoftgraph/msgraph-sdk-typescript/.onPremisesPublishingProfiles.item.agentGroups.item.publishedResources.item.agentGroups.item collection
 ...
 */
export const AgentGroupsRequestBuilderUriTemplate = "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources/{publishedResource%2Did}/agentGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
