...
export interface DirectoryObjectItemRequestBuilder extends BaseRequestBuilder<DirectoryObjectItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/directoryobject-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/directoryobject-get?view=graph-rest-beta|Find more info here}
     */
