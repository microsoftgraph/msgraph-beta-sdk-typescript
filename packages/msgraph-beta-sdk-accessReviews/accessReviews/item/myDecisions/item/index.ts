 ...
 */
export const AccessReviewDecisionItemRequestBuilderUriTemplate = "{+baseurl}/accessReviews/{accessReview%2Did}/myDecisions/{accessReviewDecision%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
