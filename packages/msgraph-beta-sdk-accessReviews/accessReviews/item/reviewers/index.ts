...
export interface ReviewersRequestBuilder extends BaseRequestBuilder<ReviewersRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/accessreview-listreviewers?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/accessreview-addreviewer?view=graph-rest-beta|Find more info here}
     */
