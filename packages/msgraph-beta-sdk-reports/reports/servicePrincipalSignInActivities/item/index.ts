...
// @ts-ignore
import { createServicePrincipalSignInActivityFromDiscriminatorValue, serializeServicePrincipalSignInActivity, type ServicePrincipalSignInActivity } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ServicePrincipalSignInActivityItemRequestBuilder extends BaseRequestBuilder<ServicePrincipalSignInActivityItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/serviceprincipalsigninactivity-get?view=graph-rest-beta|Find more info here}
     */
