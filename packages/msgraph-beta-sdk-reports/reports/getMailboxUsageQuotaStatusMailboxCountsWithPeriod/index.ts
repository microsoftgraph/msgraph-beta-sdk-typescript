 ...
 */
export interface GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder> {
    /**
 ...
 */
export const GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilderUriTemplate = "{+baseurl}/reports/getMailboxUsageQuotaStatusMailboxCounts(period='{period}')";
/**
