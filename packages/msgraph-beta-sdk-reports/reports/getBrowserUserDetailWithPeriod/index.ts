 ...
 */
export interface GetBrowserUserDetailWithPeriodRequestBuilder extends BaseRequestBuilder<GetBrowserUserDetailWithPeriodRequestBuilder> {
    /**
 ...
 */
export const GetBrowserUserDetailWithPeriodRequestBuilderUriTemplate = "{+baseurl}/reports/getBrowserUserDetail(period='{period}')";
/**
