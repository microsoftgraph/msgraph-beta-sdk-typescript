...
// @ts-ignore
import { createUserRequestsMetricCollectionResponseFromDiscriminatorValue, type UserRequestsMetricCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { type UserRequestsMetricItemRequestBuilder, UserRequestsMetricItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
...
export interface RequestsRequestBuilder extends BaseRequestBuilder<RequestsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/monthlyuserinsightmetricsroot-list-requests?view=graph-rest-beta|Find more info here}
     */
