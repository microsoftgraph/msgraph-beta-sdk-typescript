 ...
 */
export const MfaCompletionMetricItemRequestBuilderUriTemplate = "{+baseurl}/reports/userInsights/monthly/mfaCompletions/{mfaCompletionMetric%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
