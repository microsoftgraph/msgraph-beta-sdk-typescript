...
// @ts-ignore
import { createAzureADAuthenticationFromDiscriminatorValue, serializeAzureADAuthentication, type AzureADAuthentication } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AzureADAuthenticationRequestBuilder extends BaseRequestBuilder<AzureADAuthenticationRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/azureadauthentication-get?view=graph-rest-beta|Find more info here}
     */
