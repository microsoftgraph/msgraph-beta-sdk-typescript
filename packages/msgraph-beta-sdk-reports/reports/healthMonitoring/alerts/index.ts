...
// @ts-ignore
import { createAlertCollectionResponseFromDiscriminatorValue, createAlertFromDiscriminatorValue, serializeAlert, type Alert, type AlertCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/healthMonitoring/index.js';
// @ts-ignore
 ...
 */
export const AlertsRequestBuilderUriTemplate = "{+baseurl}/reports/healthMonitoring/alerts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
