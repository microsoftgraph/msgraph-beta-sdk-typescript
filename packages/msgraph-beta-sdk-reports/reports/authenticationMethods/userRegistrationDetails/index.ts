...
// @ts-ignore
import { createUserRegistrationDetailsCollectionResponseFromDiscriminatorValue, createUserRegistrationDetailsFromDiscriminatorValue, serializeUserRegistrationDetails, type UserRegistrationDetails, type UserRegistrationDetailsCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { type UserRegistrationDetailsItemRequestBuilder, UserRegistrationDetailsItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
...
export interface UserRegistrationDetailsRequestBuilder extends BaseRequestBuilder<UserRegistrationDetailsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/authenticationmethodsroot-list-userregistrationdetails?view=graph-rest-beta|Find more info here}
     */
