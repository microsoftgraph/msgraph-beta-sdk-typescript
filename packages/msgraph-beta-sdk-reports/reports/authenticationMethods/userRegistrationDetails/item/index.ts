...
// @ts-ignore
import { createUserRegistrationDetailsFromDiscriminatorValue, serializeUserRegistrationDetails, type UserRegistrationDetails } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface UserRegistrationDetailsItemRequestBuilder extends BaseRequestBuilder<UserRegistrationDetailsItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/userregistrationdetails-get?view=graph-rest-beta|Find more info here}
     */
