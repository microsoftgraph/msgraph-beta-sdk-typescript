...
// @ts-ignore
import { createManifestFromDiscriminatorValue, serializeManifest, type Manifest } from '@microsoft/msgraph-beta-sdk/models/partners/billing/index.js';
// @ts-ignore
...
export interface ManifestItemRequestBuilder extends BaseRequestBuilder<ManifestItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/partners-billing-manifest-get?view=graph-rest-beta|Find more info here}
     */
