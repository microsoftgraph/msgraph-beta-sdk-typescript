...
// @ts-ignore
import { createOperationFromDiscriminatorValue, serializeOperation, type Operation } from '@microsoft/msgraph-beta-sdk/models/partners/billing/index.js';
// @ts-ignore
...
export interface OperationItemRequestBuilder extends BaseRequestBuilder<OperationItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/partners-billing-operation-get?view=graph-rest-beta|Find more info here}
     */
