...
// @ts-ignore
import { AttributeSetObject, createOperationFromDiscriminatorValue, serializeOperation, type AttributeSet, type Operation } from '@microsoft/msgraph-beta-sdk/models/partners/billing/index.js';
// @ts-ignore
...
export interface MicrosoftGraphPartnersBillingExportRequestBuilder extends BaseRequestBuilder<MicrosoftGraphPartnersBillingExportRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/partners-billing-billedreconciliation-export?view=graph-rest-beta|Find more info here}
     */
