 ...
 */
export interface GetTeamsUserActivityDistributionUserCountsWithPeriodRequestBuilder extends BaseRequestBuilder<GetTeamsUserActivityDistributionUserCountsWithPeriodRequestBuilder> {
    /**
 ...
 */
export const GetTeamsUserActivityDistributionUserCountsWithPeriodRequestBuilderUriTemplate = "{+baseurl}/reports/getTeamsUserActivityDistributionUserCounts(period='{period}')";
/**
