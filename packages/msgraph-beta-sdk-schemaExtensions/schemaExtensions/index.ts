...
// @ts-ignore
import { createSchemaExtensionCollectionResponseFromDiscriminatorValue, createSchemaExtensionFromDiscriminatorValue, serializeSchemaExtension, type SchemaExtension, type SchemaExtensionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SchemaExtensionsRequestBuilder extends BaseRequestBuilder<SchemaExtensionsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/schemaextension-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/schemaextension-post-schemaextensions?view=graph-rest-beta|Find more info here}
     */
