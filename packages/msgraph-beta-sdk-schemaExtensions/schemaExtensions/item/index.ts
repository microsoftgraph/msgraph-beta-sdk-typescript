...
// @ts-ignore
import { createSchemaExtensionFromDiscriminatorValue, serializeSchemaExtension, type SchemaExtension } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SchemaExtensionItemRequestBuilder extends BaseRequestBuilder<SchemaExtensionItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/schemaextension-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/schemaextension-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<SchemaExtension>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/schemaextension-update?view=graph-rest-beta|Find more info here}
     */
