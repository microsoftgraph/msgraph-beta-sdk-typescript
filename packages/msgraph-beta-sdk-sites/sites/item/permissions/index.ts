...
// @ts-ignore
import { createPermissionCollectionResponseFromDiscriminatorValue, createPermissionFromDiscriminatorValue, serializePermission, type Permission, type PermissionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PermissionsRequestBuilder extends BaseRequestBuilder<PermissionsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/site-list-permissions?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/site-post-permissions?view=graph-rest-beta|Find more info here}
     */
