...
// @ts-ignore
import { createPermissionFromDiscriminatorValue, serializePermission, type Permission } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { GrantRequestBuilderRequestsMetadata, type GrantRequestBuilder } from './grant/index.js';
// @ts-ignore
import { RevokeGrantsRequestBuilderRequestsMetadata, type RevokeGrantsRequestBuilder } from './revokeGrants/index.js';
// @ts-ignore
...
export interface PermissionItemRequestBuilder extends BaseRequestBuilder<PermissionItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/site-get-permission?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Permission>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/site-update-permission?view=graph-rest-beta|Find more info here}
     */
