...
// @ts-ignore
import { createContentTypeFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeContentType, type BaseCollectionPaginationCountResponse, type ContentType } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GetApplicableContentTypesForListWithListIdRequestBuilder extends BaseRequestBuilder<GetApplicableContentTypesForListWithListIdRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/site-getapplicablecontenttypesforlist?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const GetApplicableContentTypesForListWithListIdRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/getApplicableContentTypesForList(listId='{listId}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
