 ...
 */
export const ContentModelsRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/contentModels{?%24count,%24expand,%24filter,%24search,%24select,%24skip,%24top}";
/**
