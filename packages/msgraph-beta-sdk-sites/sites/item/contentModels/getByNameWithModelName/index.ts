...
export interface GetByNameWithModelNameRequestBuilder extends BaseRequestBuilder<GetByNameWithModelNameRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/contentmodel-getbyname?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const GetByNameWithModelNameRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/contentModels/getByName(modelName='{modelName}')";
/**
