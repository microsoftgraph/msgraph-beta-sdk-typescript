...
// @ts-ignore
import { createSitePageCollectionResponseFromDiscriminatorValue, type SitePageCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GraphSitePageRequestBuilder extends BaseRequestBuilder<GraphSitePageRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/sitepage-get?view=graph-rest-beta|Find more info here}
     */
