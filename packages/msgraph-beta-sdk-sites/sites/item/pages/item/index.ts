...
// @ts-ignore
import { createBaseSitePageFromDiscriminatorValue, serializeBaseSitePage, type BaseSitePage } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface BaseSitePageItemRequestBuilder extends BaseRequestBuilder<BaseSitePageItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/basesitepage-get?view=graph-rest-beta|Find more info here}
     */
