 ...
 */
export const WebPartItemRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage/canvasLayout/verticalSection/webparts/{webPart%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
