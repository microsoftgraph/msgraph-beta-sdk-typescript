 ...
 */
export const LastModifiedByUserRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage/lastModifiedByUser{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
