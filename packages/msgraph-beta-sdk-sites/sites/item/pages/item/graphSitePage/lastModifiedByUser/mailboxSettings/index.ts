 ...
 */
export const MailboxSettingsRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage/lastModifiedByUser/mailboxSettings{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
