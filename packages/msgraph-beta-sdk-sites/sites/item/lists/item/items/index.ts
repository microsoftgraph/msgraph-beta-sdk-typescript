...
// @ts-ignore
import { createListItemCollectionResponseFromDiscriminatorValue, createListItemFromDiscriminatorValue, serializeListItem, type ListItem, type ListItemCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ItemsRequestBuilder extends BaseRequestBuilder<ItemsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/listitem-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/listitem-create?view=graph-rest-beta|Find more info here}
     */
