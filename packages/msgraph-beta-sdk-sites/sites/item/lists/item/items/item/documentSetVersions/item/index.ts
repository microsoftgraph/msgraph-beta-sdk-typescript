...
// @ts-ignore
import { createDocumentSetVersionFromDiscriminatorValue, serializeDocumentSetVersion, type DocumentSetVersion } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DocumentSetVersionItemRequestBuilder extends BaseRequestBuilder<DocumentSetVersionItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/documentsetversion-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/documentsetversion-get?view=graph-rest-beta|Find more info here}
     */
