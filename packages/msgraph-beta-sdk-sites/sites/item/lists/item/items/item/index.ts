...
// @ts-ignore
import { createListItemFromDiscriminatorValue, serializeListItem, type ListItem } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ListItemItemRequestBuilder extends BaseRequestBuilder<ListItemItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/listitem-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/listitem-get?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const ListItemItemRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}{?%24expand,%24select}";
/**
