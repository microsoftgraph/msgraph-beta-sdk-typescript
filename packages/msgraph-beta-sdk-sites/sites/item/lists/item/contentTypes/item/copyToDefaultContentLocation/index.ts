...
// @ts-ignore
import { createItemReferenceFromDiscriminatorValue, serializeItemReference, type ItemReference } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CopyToDefaultContentLocationRequestBuilder extends BaseRequestBuilder<CopyToDefaultContentLocationRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/contenttype-copytodefaultcontentlocation?view=graph-rest-beta|Find more info here}
     */
