...
// @ts-ignore
import { createListCollectionResponseFromDiscriminatorValue, createListFromDiscriminatorValue, serializeList, type List, type ListCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { ListItemRequestBuilderNavigationMetadata, ListItemRequestBuilderRequestsMetadata, type ListItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface ListsRequestBuilder extends BaseRequestBuilder<ListsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/list-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/list-create?view=graph-rest-beta|Find more info here}
     */
