...
// @ts-ignore
import { createRichLongRunningOperationCollectionResponseFromDiscriminatorValue, createRichLongRunningOperationFromDiscriminatorValue, serializeRichLongRunningOperation, type RichLongRunningOperation, type RichLongRunningOperationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface OperationsRequestBuilder extends BaseRequestBuilder<OperationsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/site-list-operations?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const OperationsRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/operations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
