...
// @ts-ignore
import { createRichLongRunningOperationFromDiscriminatorValue, serializeRichLongRunningOperation, type RichLongRunningOperation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RichLongRunningOperationItemRequestBuilder extends BaseRequestBuilder<RichLongRunningOperationItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/richlongrunningoperation-get?view=graph-rest-beta|Find more info here}
     */
