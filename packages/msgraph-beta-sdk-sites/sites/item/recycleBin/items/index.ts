...
// @ts-ignore
import { createRecycleBinItemCollectionResponseFromDiscriminatorValue, createRecycleBinItemFromDiscriminatorValue, serializeRecycleBinItem, type RecycleBinItem, type RecycleBinItemCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { RecycleBinItemItemRequestBuilderNavigationMetadata, RecycleBinItemItemRequestBuilderRequestsMetadata, type RecycleBinItemItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface ItemsRequestBuilder extends BaseRequestBuilder<ItemsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/recyclebin-list-items?view=graph-rest-beta|Find more info here}
     */
