 ...
 */
export const LastModifiedByUserRequestBuilderUriTemplate = "{+baseurl}/sites/{site%2Did}/recycleBin/items/{recycleBinItem%2Did}/lastModifiedByUser{?%24expand,%24select}";
/**
 * Provides operations to manage the lastModifiedByUser property of the microsoft.graph.baseItem entity.
 */
