...
// @ts-ignore
import { createContentTypeFromDiscriminatorValue, serializeContentType, type ContentType } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ContentTypeItemRequestBuilder extends BaseRequestBuilder<ContentTypeItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/contenttype-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/contenttype-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ContentType>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/contenttype-update?view=graph-rest-beta|Find more info here}
     */
