...
// @ts-ignore
import { createColumnDefinitionFromDiscriminatorValue, serializeColumnDefinition, type ColumnDefinition } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ColumnDefinitionItemRequestBuilder extends BaseRequestBuilder<ColumnDefinitionItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/columndefinition-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/columndefinition-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ColumnDefinition>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/columndefinition-update?view=graph-rest-beta|Find more info here}
     */
