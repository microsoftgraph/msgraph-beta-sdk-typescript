...
export interface ColumnsRequestBuilder extends BaseRequestBuilder<ColumnsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/site-list-columns?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/site-post-columns?view=graph-rest-beta|Find more info here}
     */
