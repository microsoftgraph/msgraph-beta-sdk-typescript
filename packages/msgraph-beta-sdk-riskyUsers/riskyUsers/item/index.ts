...
// @ts-ignore
import { createRiskyUserFromDiscriminatorValue, serializeRiskyUser, type RiskyUser } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const RiskyUserItemRequestBuilderUriTemplate = "{+baseurl}/riskyUsers/{riskyUser%2Did}{?%24expand,%24select}";
/**
