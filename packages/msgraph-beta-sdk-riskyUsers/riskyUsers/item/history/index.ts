...
// @ts-ignore
import { createRiskyUserHistoryItemCollectionResponseFromDiscriminatorValue, createRiskyUserHistoryItemFromDiscriminatorValue, serializeRiskyUserHistoryItem, type RiskyUserHistoryItem, type RiskyUserHistoryItemCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface HistoryRequestBuilder extends BaseRequestBuilder<HistoryRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/riskyuser-list-history?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const HistoryRequestBuilderUriTemplate = "{+baseurl}/riskyUsers/{riskyUser%2Did}/history{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
