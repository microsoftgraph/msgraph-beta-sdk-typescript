...
// @ts-ignore
import { createRiskyUserHistoryItemFromDiscriminatorValue, serializeRiskyUserHistoryItem, type RiskyUserHistoryItem } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RiskyUserHistoryItemItemRequestBuilder extends BaseRequestBuilder<RiskyUserHistoryItemItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/riskyuserhistoryitem-get?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const RiskyUserHistoryItemItemRequestBuilderUriTemplate = "{+baseurl}/riskyUsers/{riskyUser%2Did}/history/{riskyUserHistoryItem%2Did}{?%24expand,%24select}";
/**
