...
// @ts-ignore
import { createPresenceFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializePresence, type BaseCollectionPaginationCountResponse, type Presence } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GetPresencesByUserIdRequestBuilder extends BaseRequestBuilder<GetPresencesByUserIdRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/cloudcommunications-getpresencesbyuserid?view=graph-rest-beta|Find more info here}
     */
