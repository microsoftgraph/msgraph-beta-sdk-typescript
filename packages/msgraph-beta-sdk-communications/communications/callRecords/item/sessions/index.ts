...
// @ts-ignore
import { createSessionCollectionResponseFromDiscriminatorValue, createSessionFromDiscriminatorValue, serializeSession, type Session, type SessionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/callRecords/index.js';
// @ts-ignore
...
export interface SessionsRequestBuilder extends BaseRequestBuilder<SessionsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/callrecords-callrecord-list-sessions?view=graph-rest-beta|Find more info here}
     */
