...
// @ts-ignore
import { createCallRecordFromDiscriminatorValue, serializeCallRecord, type CallRecord } from '@microsoft/msgraph-beta-sdk/models/callRecords/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { Organizer_v2RequestBuilderRequestsMetadata, type Organizer_v2RequestBuilder } from './organizer_v2/index.js';
// @ts-ignore
import { Participants_v2RequestBuilderNavigationMetadata, Participants_v2RequestBuilderRequestsMetadata, type Participants_v2RequestBuilder } from './participants_v2/index.js';
// @ts-ignore
...
export interface CallRecordItemRequestBuilder extends BaseRequestBuilder<CallRecordItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/callrecords-callrecord-get?view=graph-rest-beta|Find more info here}
     */
