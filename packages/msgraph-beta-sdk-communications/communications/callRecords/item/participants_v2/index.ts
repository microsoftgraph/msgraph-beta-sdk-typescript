...
// @ts-ignore
import { createParticipantCollectionResponseFromDiscriminatorValue, createParticipantFromDiscriminatorValue, serializeParticipant, type Participant, type ParticipantCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/callRecords/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { ParticipantItemRequestBuilderRequestsMetadata, type ParticipantItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface Participants_v2RequestBuilder extends BaseRequestBuilder<Participants_v2RequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/callrecords-callrecord-list-participants_v2?view=graph-rest-beta|Find more info here}
     */
