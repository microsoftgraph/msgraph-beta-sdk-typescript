...
// @ts-ignore
import { createAttendeeNotificationInfoFromDiscriminatorValue, RemindBeforeTimeInMinutesTypeObject, serializeAttendeeNotificationInfo, type AttendeeNotificationInfo, type RemindBeforeTimeInMinutesType } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SendVirtualAppointmentReminderSmsRequestBuilder extends BaseRequestBuilder<SendVirtualAppointmentReminderSmsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/virtualappointment-sendvirtualappointmentremindersms?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const SendVirtualAppointmentReminderSmsRequestBuilderUriTemplate = "{+baseurl}/communications/onlineMeetings(joinWebUrl='{joinWebUrl}')/sendVirtualAppointmentReminderSms";
/**
