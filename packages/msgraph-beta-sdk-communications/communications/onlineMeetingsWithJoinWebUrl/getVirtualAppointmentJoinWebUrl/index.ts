 ...
 */
export const GetVirtualAppointmentJoinWebUrlRequestBuilderUriTemplate = "{+baseurl}/communications/onlineMeetings(joinWebUrl='{joinWebUrl}')/getVirtualAppointmentJoinWebUrl()";
/**
