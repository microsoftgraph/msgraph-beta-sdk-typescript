...
// @ts-ignore
import { createAudioRoutingGroupFromDiscriminatorValue, serializeAudioRoutingGroup, type AudioRoutingGroup } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AudioRoutingGroupItemRequestBuilder extends BaseRequestBuilder<AudioRoutingGroupItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/audioroutinggroup-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/audioroutinggroup-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<AudioRoutingGroup>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/audioroutinggroup-update?view=graph-rest-beta|Find more info here}
     */
