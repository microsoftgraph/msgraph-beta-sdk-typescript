...
// @ts-ignore
import { createCallFromDiscriminatorValue, serializeCall, type Call } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { RecordRequestBuilderRequestsMetadata, type RecordRequestBuilder } from './record/index.js';
// @ts-ignore
...
export interface CallItemRequestBuilder extends BaseRequestBuilder<CallItemRequestBuilder> {
     ...
     */
    get record(): RecordRequestBuilder;
    /**
     ...
     * @see {@link https://learn.microsoft.com/graph/api/call-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/call-get?view=graph-rest-beta|Find more info here}
     */
...
export const CallItemRequestBuilderNavigationMetadata: Record<Exclude<keyof CallItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ...
    record: {
        requestsMetadata: RecordRequestBuilderRequestsMetadata,
    },
    recordResponse: {
