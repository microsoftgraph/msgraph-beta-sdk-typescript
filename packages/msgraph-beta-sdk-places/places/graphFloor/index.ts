...
// @ts-ignore
import { createFloorCollectionResponseFromDiscriminatorValue, type FloorCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const GraphFloorRequestBuilderUriTemplate = "{+baseurl}/places/graph.floor{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
...
export const GraphFloorRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createFloorCollectionResponseFromDiscriminatorValue,
