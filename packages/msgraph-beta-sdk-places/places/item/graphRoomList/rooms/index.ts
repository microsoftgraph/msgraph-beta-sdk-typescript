...
// @ts-ignore
import { createRoomCollectionResponseFromDiscriminatorValue, createRoomFromDiscriminatorValue, serializeRoom, type Room, type RoomCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
