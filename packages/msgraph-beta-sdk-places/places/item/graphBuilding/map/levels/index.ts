...
// @ts-ignore
import { createLevelMapCollectionResponseFromDiscriminatorValue, createLevelMapFromDiscriminatorValue, serializeLevelMap, type LevelMap, type LevelMapCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface LevelsRequestBuilder extends BaseRequestBuilder<LevelsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/buildingmap-list-levels?view=graph-rest-beta|Find more info here}
     */
