...
// @ts-ignore
import { createSectionMapCollectionResponseFromDiscriminatorValue, createSectionMapFromDiscriminatorValue, serializeSectionMap, type SectionMap, type SectionMapCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SectionsRequestBuilder extends BaseRequestBuilder<SectionsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/levelmap-list-sections?view=graph-rest-beta|Find more info here}
     */
