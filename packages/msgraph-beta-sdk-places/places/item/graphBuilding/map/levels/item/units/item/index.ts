...
// @ts-ignore
import { createUnitMapFromDiscriminatorValue, serializeUnitMap, type UnitMap } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface UnitMapItemRequestBuilder extends BaseRequestBuilder<UnitMapItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/unitmap-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<UnitMap>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/unitmap-update?view=graph-rest-beta|Find more info here}
     */
