...
// @ts-ignore
import { createFixtureMapFromDiscriminatorValue, serializeFixtureMap, type FixtureMap } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface FixtureMapItemRequestBuilder extends BaseRequestBuilder<FixtureMapItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/fixturemap-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<FixtureMap>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/fixturemap-update?view=graph-rest-beta|Find more info here}
     */
