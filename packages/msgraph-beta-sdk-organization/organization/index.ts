...
// @ts-ignore
import { createOrganizationCollectionResponseFromDiscriminatorValue, createOrganizationFromDiscriminatorValue, serializeOrganization, type Organization, type OrganizationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface OrganizationRequestBuilder extends BaseRequestBuilder<OrganizationRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/organization-list?view=graph-rest-beta|Find more info here}
     */
