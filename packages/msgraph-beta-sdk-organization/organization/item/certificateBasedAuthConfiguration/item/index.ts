...
// @ts-ignore
import { createCertificateBasedAuthConfigurationFromDiscriminatorValue, type CertificateBasedAuthConfiguration } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CertificateBasedAuthConfigurationItemRequestBuilder extends BaseRequestBuilder<CertificateBasedAuthConfigurationItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/certificatebasedauthconfiguration-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/certificatebasedauthconfiguration-get?view=graph-rest-beta|Find more info here}
     */
