...
// @ts-ignore
import { createOrganizationFromDiscriminatorValue, serializeOrganization, type Organization } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { PartnerInformationRequestBuilderRequestsMetadata, type PartnerInformationRequestBuilder } from './partnerInformation/index.js';
// @ts-ignore
...
export interface OrganizationItemRequestBuilder extends BaseRequestBuilder<OrganizationItemRequestBuilder> {
     ...
     */
    get partnerInformation(): PartnerInformationRequestBuilder;
    /**
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/organization-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Organization>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/organization-update?view=graph-rest-beta|Find more info here}
     */
...
export const OrganizationItemRequestBuilderNavigationMetadata: Record<Exclude<keyof OrganizationItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ...
    partnerInformation: {
        requestsMetadata: PartnerInformationRequestBuilderRequestsMetadata,
    },
    restore: {
