...
// @ts-ignore
import { createOrganizationalBrandingFromDiscriminatorValue, serializeOrganizationalBranding, type OrganizationalBranding } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface BrandingRequestBuilder extends BaseRequestBuilder<BrandingRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/organizationalbranding-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/organizationalbranding-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<OrganizationalBranding>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/organizationalbranding-update?view=graph-rest-beta|Find more info here}
     */
