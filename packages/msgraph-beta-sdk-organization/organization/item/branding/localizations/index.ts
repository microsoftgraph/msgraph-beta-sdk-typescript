...
// @ts-ignore
import { OrganizationalBrandingLocalizationItemRequestBuilderNavigationMetadata, OrganizationalBrandingLocalizationItemRequestBuilderRequestsMetadata, type OrganizationalBrandingLocalizationItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface LocalizationsRequestBuilder extends BaseRequestBuilder<LocalizationsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/organizationalbranding-list-localizations?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/organizationalbranding-post-localizations?view=graph-rest-beta|Find more info here}
     */
