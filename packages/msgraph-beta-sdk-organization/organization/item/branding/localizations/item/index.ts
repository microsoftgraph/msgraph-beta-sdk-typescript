...
// @ts-ignore
import { createOrganizationalBrandingLocalizationFromDiscriminatorValue, serializeOrganizationalBrandingLocalization, type OrganizationalBrandingLocalization } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface OrganizationalBrandingLocalizationItemRequestBuilder extends BaseRequestBuilder<OrganizationalBrandingLocalizationItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/organizationalbrandinglocalization-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/organizationalbrandinglocalization-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<OrganizationalBrandingLocalization>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/organizationalbrandinglocalization-update?view=graph-rest-beta|Find more info here}
     */
