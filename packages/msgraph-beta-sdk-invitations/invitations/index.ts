...
// @ts-ignore
import { createInvitationCollectionResponseFromDiscriminatorValue, createInvitationFromDiscriminatorValue, serializeInvitation, type Invitation, type InvitationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface InvitationsRequestBuilder extends BaseRequestBuilder<InvitationsRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/invitation-post?view=graph-rest-beta|Find more info here}
     */
