 ...
 */
export const DirectoryObjectItemRequestBuilderUriTemplate = "{+baseurl}/invitations/{invitation%2Did}/invitedUserSponsors/{directoryObject%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
