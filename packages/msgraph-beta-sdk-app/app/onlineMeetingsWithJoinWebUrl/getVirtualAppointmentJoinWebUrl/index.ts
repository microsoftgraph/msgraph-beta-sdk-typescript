 ...
 */
export const GetVirtualAppointmentJoinWebUrlRequestBuilderUriTemplate = "{+baseurl}/app/onlineMeetings(joinWebUrl='{joinWebUrl}')/getVirtualAppointmentJoinWebUrl()";
/* tslint:enable */
/* eslint-enable */
