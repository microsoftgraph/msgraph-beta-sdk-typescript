 ...
 */
export const SendVirtualAppointmentReminderSmsRequestBuilderUriTemplate = "{+baseurl}/app/onlineMeetings(joinWebUrl='{joinWebUrl}')/sendVirtualAppointmentReminderSms";
/**
