...
// @ts-ignore
import { createTeleconferenceDeviceQualityFromDiscriminatorValue, serializeTeleconferenceDeviceQuality, type TeleconferenceDeviceQuality } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface LogTeleconferenceDeviceQualityRequestBuilder extends BaseRequestBuilder<LogTeleconferenceDeviceQualityRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/call-logteleconferencedevicequality?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const LogTeleconferenceDeviceQualityRequestBuilderUriTemplate = "{+baseurl}/app/calls/logTeleconferenceDeviceQuality";
/**
