...
// @ts-ignore
import { createCommsOperationFromDiscriminatorValue, serializeCommsOperation, type CommsOperation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const CommsOperationItemRequestBuilderUriTemplate = "{+baseurl}/app/calls/{call%2Did}/operations/{commsOperation%2Did}{?%24expand,%24select}";
/**
