...
// @ts-ignore
import { createCommsOperationCollectionResponseFromDiscriminatorValue, createCommsOperationFromDiscriminatorValue, serializeCommsOperation, type CommsOperation, type CommsOperationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const OperationsRequestBuilderUriTemplate = "{+baseurl}/app/calls/{call%2Did}/operations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
