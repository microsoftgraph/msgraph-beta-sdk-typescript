...
// @ts-ignore
import { createInvitationParticipantInfoFromDiscriminatorValue, createParticipantInfoFromDiscriminatorValue, serializeInvitationParticipantInfo, serializeParticipantInfo, type InvitationParticipantInfo, type ParticipantInfo } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TransferRequestBuilder extends BaseRequestBuilder<TransferRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/call-transfer?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const TransferRequestBuilderUriTemplate = "{+baseurl}/app/calls/{call%2Did}/transfer";
/**
