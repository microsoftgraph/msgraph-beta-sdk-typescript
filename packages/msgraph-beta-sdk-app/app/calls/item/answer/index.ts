...
// @ts-ignore
import { createIncomingCallOptionsFromDiscriminatorValue, createMediaConfigFromDiscriminatorValue, ModalityObject, serializeIncomingCallOptions, serializeMediaConfig, type IncomingCallOptions, type MediaConfig, type Modality } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const AnswerRequestBuilderUriTemplate = "{+baseurl}/app/calls/{call%2Did}/answer";
/**
