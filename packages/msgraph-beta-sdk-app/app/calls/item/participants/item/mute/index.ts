...
// @ts-ignore
import { createMuteParticipantOperationFromDiscriminatorValue, serializeMuteParticipantOperation, type MuteParticipantOperation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface MuteRequestBuilder extends BaseRequestBuilder<MuteRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/participant-mute?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const MuteRequestBuilderUriTemplate = "{+baseurl}/app/calls/{call%2Did}/participants/{participant%2Did}/mute";
/**
