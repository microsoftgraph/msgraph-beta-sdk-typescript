...
// @ts-ignore
import { createParticipantFromDiscriminatorValue, serializeParticipant, type Participant } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ParticipantItemRequestBuilderUriTemplate = "{+baseurl}/app/calls/{call%2Did}/participants/{participant%2Did}{?%24expand,%24select}";
/**
