...
// @ts-ignore
import { RejectReasonObject, type RejectReason } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RejectRequestBuilder extends BaseRequestBuilder<RejectRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/call-reject?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const RejectRequestBuilderUriTemplate = "{+baseurl}/app/calls/{call%2Did}/reject";
/**
