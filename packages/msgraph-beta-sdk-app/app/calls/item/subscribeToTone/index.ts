...
// @ts-ignore
import { createSubscribeToToneOperationFromDiscriminatorValue, serializeSubscribeToToneOperation, type SubscribeToToneOperation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
// @ts-ignore
export function serializeSubscribeToTonePostRequestBody(writer: SerializationWriter, subscribeToTonePostRequestBody: Partial<SubscribeToTonePostRequestBody> | undefined | null = {}) : void {
    if (subscribeToTonePostRequestBody) {
...
export interface SubscribeToToneRequestBuilder extends BaseRequestBuilder<SubscribeToToneRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/call-subscribetotone?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const SubscribeToToneRequestBuilderUriTemplate = "{+baseurl}/app/calls/{call%2Did}/subscribeToTone";
/**
