...
// @ts-ignore
import { createContentSharingSessionFromDiscriminatorValue, serializeContentSharingSession, type ContentSharingSession } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ContentSharingSessionItemRequestBuilderUriTemplate = "{+baseurl}/app/calls/{call%2Did}/contentSharingSessions/{contentSharingSession%2Did}{?%24expand,%24select}";
/**
