...
import { createContentSharingSessionCollectionResponseFromDiscriminatorValue, createContentSharingSessionFromDiscriminatorValue, serializeContentSharingSession, type ContentSharingSession, type ContentSharingSessionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
 ...
 */
export const ContentSharingSessionsRequestBuilderUriTemplate = "{+baseurl}/app/calls/{call%2Did}/contentSharingSessions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
