...
// @ts-ignore
import { createContentSharingSessionCollectionResponseFromDiscriminatorValue, createContentSharingSessionFromDiscriminatorValue, serializeContentSharingSession, type ContentSharingSession, type ContentSharingSessionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ContentSharingSessionsRequestBuilderUriTemplate = "{+baseurl}/app/calls/{call%2Did}/contentSharingSessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
