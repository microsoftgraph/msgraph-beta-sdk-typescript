...
// @ts-ignore
import { createUnmuteParticipantOperationFromDiscriminatorValue, serializeUnmuteParticipantOperation, type UnmuteParticipantOperation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
// @ts-ignore
export function serializeUnmutePostRequestBody(writer: SerializationWriter, unmutePostRequestBody: Partial<UnmutePostRequestBody> | undefined | null = {}) : void {
    if (unmutePostRequestBody) {
...
export interface UnmuteRequestBuilder extends BaseRequestBuilder<UnmuteRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/call-unmute?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const UnmuteRequestBuilderUriTemplate = "{+baseurl}/app/calls/{call%2Did}/unmute";
/**
