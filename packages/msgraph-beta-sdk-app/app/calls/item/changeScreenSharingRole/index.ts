...
// @ts-ignore
import { ScreenSharingRoleObject, type ScreenSharingRole } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ChangeScreenSharingRoleRequestBuilder extends BaseRequestBuilder<ChangeScreenSharingRoleRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/call-changescreensharingrole?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const ChangeScreenSharingRoleRequestBuilderUriTemplate = "{+baseurl}/app/calls/{call%2Did}/changeScreenSharingRole";
/**
