...
// @ts-ignore
import { createChatInfoFromDiscriminatorValue, createMeetingParticipantsFromDiscriminatorValue, createOnlineMeetingFromDiscriminatorValue, serializeChatInfo, serializeMeetingParticipants, serializeOnlineMeeting, type ChatInfo, type MeetingParticipants, type OnlineMeeting } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface CreateOrGetRequestBuilder extends BaseRequestBuilder<CreateOrGetRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/onlinemeeting-createorget?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const CreateOrGetRequestBuilderUriTemplate = "{+baseurl}/app/onlineMeetings/createOrGet";
/**
