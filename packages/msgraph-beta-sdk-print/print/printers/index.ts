...
// @ts-ignore
import { createPrinterCollectionResponseFromDiscriminatorValue, createPrinterFromDiscriminatorValue, serializePrinter, type Printer, type PrinterCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { PrinterItemRequestBuilderNavigationMetadata, PrinterItemRequestBuilderRequestsMetadata, type PrinterItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface PrintersRequestBuilder extends BaseRequestBuilder<PrintersRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/print-list-printers?view=graph-rest-beta|Find more info here}
     */
