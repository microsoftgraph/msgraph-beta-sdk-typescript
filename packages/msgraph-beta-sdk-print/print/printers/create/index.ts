...
// @ts-ignore
import { createPrintCertificateSigningRequestFromDiscriminatorValue, serializePrintCertificateSigningRequest, type PrintCertificateSigningRequest } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
