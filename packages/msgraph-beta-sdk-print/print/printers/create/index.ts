...
// @ts-ignore
import { createPrintCertificateSigningRequestFromDiscriminatorValue, serializePrintCertificateSigningRequest, type PrintCertificateSigningRequest } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CreateRequestBuilder extends BaseRequestBuilder<CreateRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/printer-create?view=graph-rest-beta|Find more info here}
     */
