...
// @ts-ignore
import { createPrinterFromDiscriminatorValue, serializePrinter, type Printer } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { GetCapabilitiesRequestBuilderRequestsMetadata, type GetCapabilitiesRequestBuilder } from './getCapabilities/index.js';
// @ts-ignore
...
// @ts-ignore
import { ResetDefaultsRequestBuilderRequestsMetadata, type ResetDefaultsRequestBuilder } from './resetDefaults/index.js';
// @ts-ignore
...
export interface PrinterItemRequestBuilder extends BaseRequestBuilder<PrinterItemRequestBuilder> {
     ...
     */
    get getCapabilities(): GetCapabilitiesRequestBuilder;
    /**
     ...
     */
    get resetDefaults(): ResetDefaultsRequestBuilder;
    /**
     ...
     * @see {@link https://learn.microsoft.com/graph/api/printer-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printer-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Printer>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printer-update?view=graph-rest-beta|Find more info here}
     */
...
export const PrinterItemRequestBuilderNavigationMetadata: Record<Exclude<keyof PrinterItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ...
    getCapabilities: {
        requestsMetadata: GetCapabilitiesRequestBuilderRequestsMetadata,
    },
    jobs: {
    ...
    resetDefaults: {
        requestsMetadata: ResetDefaultsRequestBuilderRequestsMetadata,
    },
