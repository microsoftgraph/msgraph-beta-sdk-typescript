...
// @ts-ignore
import { createPrintTaskTriggerFromDiscriminatorValue, serializePrintTaskTrigger, type PrintTaskTrigger } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface PrintTaskTriggerItemRequestBuilder extends BaseRequestBuilder<PrintTaskTriggerItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/printer-delete-tasktrigger?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printtasktrigger-get?view=graph-rest-beta|Find more info here}
     */
