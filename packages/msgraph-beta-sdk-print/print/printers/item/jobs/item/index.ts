...
// @ts-ignore
import { createPrintJobFromDiscriminatorValue, serializePrintJob, type PrintJob } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { CancelPrintJobRequestBuilderRequestsMetadata, type CancelPrintJobRequestBuilder } from './cancelPrintJob/index.js';
// @ts-ignore
...
// @ts-ignore
import { StartPrintJobRequestBuilderRequestsMetadata, type StartPrintJobRequestBuilder } from './startPrintJob/index.js';
// @ts-ignore
...
export interface PrintJobItemRequestBuilder extends BaseRequestBuilder<PrintJobItemRequestBuilder> {
     ...
     */
    get cancelPrintJob(): CancelPrintJobRequestBuilder;
    /**
     ...
     */
    get startPrintJob(): StartPrintJobRequestBuilder;
    /**
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printjob-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<PrintJob>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printjob-update?view=graph-rest-beta|Find more info here}
     */
...
export const PrintJobItemRequestBuilderNavigationMetadata: Record<Exclude<keyof PrintJobItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ...
    cancelPrintJob: {
        requestsMetadata: CancelPrintJobRequestBuilderRequestsMetadata,
    },
    documents: {
    ...
    startPrintJob: {
        requestsMetadata: StartPrintJobRequestBuilderRequestsMetadata,
    },
    tasks: {
