...
// @ts-ignore
import { createPrintDocumentCollectionResponseFromDiscriminatorValue, createPrintDocumentFromDiscriminatorValue, serializePrintDocument, type PrintDocument, type PrintDocumentCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DocumentsRequestBuilder extends BaseRequestBuilder<DocumentsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/printdocument-get-file?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const DocumentsRequestBuilderUriTemplate = "{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/documents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
