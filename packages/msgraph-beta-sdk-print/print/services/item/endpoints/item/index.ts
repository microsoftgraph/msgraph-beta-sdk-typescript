...
// @ts-ignore
import { createPrintServiceEndpointFromDiscriminatorValue, serializePrintServiceEndpoint, type PrintServiceEndpoint } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PrintServiceEndpointItemRequestBuilder extends BaseRequestBuilder<PrintServiceEndpointItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printserviceendpoint-get?view=graph-rest-beta|Find more info here}
     */
