...
// @ts-ignore
import { createPrintJobConfigurationFromDiscriminatorValue, createPrintJobFromDiscriminatorValue, serializePrintJob, serializePrintJobConfiguration, type PrintJob, type PrintJobConfiguration } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RedirectRequestBuilder extends BaseRequestBuilder<RedirectRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/printjob-redirect?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const RedirectRequestBuilderUriTemplate = "{+baseurl}/print/printerShares/{printerShare%2Did}/jobs/{printJob%2Did}/redirect";
/**
