...
// @ts-ignore
import { createPrintDocumentUploadPropertiesFromDiscriminatorValue, createUploadSessionFromDiscriminatorValue, serializePrintDocumentUploadProperties, serializeUploadSession, type PrintDocumentUploadProperties, type UploadSession } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CreateUploadSessionRequestBuilder extends BaseRequestBuilder<CreateUploadSessionRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/printdocument-createuploadsession?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const CreateUploadSessionRequestBuilderUriTemplate = "{+baseurl}/print/printerShares/{printerShare%2Did}/jobs/{printJob%2Did}/documents/{printDocument%2Did}/createUploadSession";
/**
