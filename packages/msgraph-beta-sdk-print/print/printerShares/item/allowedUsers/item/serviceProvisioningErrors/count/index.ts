 ...
 */
export const CountRequestBuilderUriTemplate = "{+baseurl}/print/printerShares/{printerShare%2Did}/allowedUsers/{user%2Did}/serviceProvisioningErrors/$count{?%24search,%24filter}";
/* tslint:enable */
/* eslint-enable */
