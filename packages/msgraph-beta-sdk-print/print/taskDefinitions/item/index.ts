...
// @ts-ignore
import { createPrintTaskDefinitionFromDiscriminatorValue, serializePrintTaskDefinition, type PrintTaskDefinition } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PrintTaskDefinitionItemRequestBuilder extends BaseRequestBuilder<PrintTaskDefinitionItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/print-delete-taskdefinition?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printtaskdefinition-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<PrintTaskDefinition>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/print-update-taskdefinition?view=graph-rest-beta|Find more info here}
     */
