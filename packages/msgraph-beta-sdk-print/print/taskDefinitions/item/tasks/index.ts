...
// @ts-ignore
import { createPrintTaskCollectionResponseFromDiscriminatorValue, createPrintTaskFromDiscriminatorValue, serializePrintTask, type PrintTask, type PrintTaskCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TasksRequestBuilder extends BaseRequestBuilder<TasksRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/printtaskdefinition-list-tasks?view=graph-rest-beta|Find more info here}
     */
