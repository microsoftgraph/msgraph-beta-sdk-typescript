...
export interface PrintTaskItemRequestBuilder extends BaseRequestBuilder<PrintTaskItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printtask-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<PrintTask>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printtaskdefinition-update-task?view=graph-rest-beta|Find more info here}
     */
