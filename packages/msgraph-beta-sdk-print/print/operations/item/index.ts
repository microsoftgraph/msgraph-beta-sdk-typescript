...
// @ts-ignore
import { createPrintOperationFromDiscriminatorValue, serializePrintOperation, type PrintOperation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PrintOperationItemRequestBuilder extends BaseRequestBuilder<PrintOperationItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printoperation-get?view=graph-rest-beta|Find more info here}
     */
