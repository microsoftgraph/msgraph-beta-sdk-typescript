...
export interface SharesRequestBuilder extends BaseRequestBuilder<SharesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/print-list-shares?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/print-post-shares?view=graph-rest-beta|Find more info here}
     */
