...
// @ts-ignore
import { createPrintJobCollectionResponseFromDiscriminatorValue, createPrintJobFromDiscriminatorValue, serializePrintJob, type PrintJob, type PrintJobCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface JobsRequestBuilder extends BaseRequestBuilder<JobsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/printershare-list-jobs?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printershare-post-jobs?view=graph-rest-beta|Find more info here}
     */
