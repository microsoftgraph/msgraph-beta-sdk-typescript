...
// @ts-ignore
import { createPrintConnectorCollectionResponseFromDiscriminatorValue, createPrintConnectorFromDiscriminatorValue, serializePrintConnector, type PrintConnector, type PrintConnectorCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ConnectorsRequestBuilder extends BaseRequestBuilder<ConnectorsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/print-list-connectors?view=graph-rest-beta|Find more info here}
     */
