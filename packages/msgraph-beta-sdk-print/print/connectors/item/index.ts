...
// @ts-ignore
import { createPrintConnectorFromDiscriminatorValue, serializePrintConnector, type PrintConnector } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PrintConnectorItemRequestBuilder extends BaseRequestBuilder<PrintConnectorItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/printconnector-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printconnector-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<PrintConnector>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/printconnector-update?view=graph-rest-beta|Find more info here}
     */
