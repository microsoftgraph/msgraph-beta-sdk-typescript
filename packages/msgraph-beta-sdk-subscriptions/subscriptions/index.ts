...
// @ts-ignore
import { createSubscriptionCollectionResponseFromDiscriminatorValue, createSubscriptionFromDiscriminatorValue, serializeSubscription, type Subscription, type SubscriptionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface SubscriptionsRequestBuilder extends BaseRequestBuilder<SubscriptionsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/subscription-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/subscription-post-subscriptions?view=graph-rest-beta|Find more info here}
     */
