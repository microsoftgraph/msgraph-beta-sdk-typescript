 ...
 */
export const ResourceRequestBuilderUriTemplate = "{+baseurl}/governanceRoleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}/roleDefinition/resource{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
