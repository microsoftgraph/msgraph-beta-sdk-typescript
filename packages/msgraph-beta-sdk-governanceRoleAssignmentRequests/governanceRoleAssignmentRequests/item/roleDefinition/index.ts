 ...
 */
export const RoleDefinitionRequestBuilderUriTemplate = "{+baseurl}/governanceRoleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}/roleDefinition{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
