 ...
 */
export const GovernanceRoleAssignmentRequestItemRequestBuilderUriTemplate = "{+baseurl}/governanceRoleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
