 ...
 */
export const ResourceRequestBuilderUriTemplate = "{+baseurl}/governanceRoleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}/resource{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
