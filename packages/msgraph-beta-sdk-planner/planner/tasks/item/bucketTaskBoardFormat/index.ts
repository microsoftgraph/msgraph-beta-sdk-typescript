...
export interface BucketTaskBoardFormatRequestBuilder extends BaseRequestBuilder<BucketTaskBoardFormatRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannerbuckettaskboardtaskformat-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<PlannerBucketTaskBoardTaskFormat>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannerbuckettaskboardtaskformat-update?view=graph-rest-beta|Find more info here}
     */
