...
export interface PlannerTaskItemRequestBuilder extends BaseRequestBuilder<PlannerTaskItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/plannertask-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannertask-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<PlannerTask>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannertask-update?view=graph-rest-beta|Find more info here}
     */
