...
export interface ProgressTaskBoardFormatRequestBuilder extends BaseRequestBuilder<ProgressTaskBoardFormatRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannerprogresstaskboardtaskformat-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<PlannerProgressTaskBoardTaskFormat>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannerprogresstaskboardtaskformat-update?view=graph-rest-beta|Find more info here}
     */
