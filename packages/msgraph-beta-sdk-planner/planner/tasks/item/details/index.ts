...
// @ts-ignore
import { createPlannerTaskDetailsFromDiscriminatorValue, serializePlannerTaskDetails, type PlannerTaskDetails } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DetailsRequestBuilder extends BaseRequestBuilder<DetailsRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannertaskdetails-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<PlannerTaskDetails>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannertaskdetails-update?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const DetailsRequestBuilderUriTemplate = "{+baseurl}/planner/tasks/{plannerTask%2Did}/details{?%24expand,%24select}";
/**
