...
export interface AssignedToTaskBoardFormatRequestBuilder extends BaseRequestBuilder<AssignedToTaskBoardFormatRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannerassignedtotaskboardtaskformat-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<PlannerAssignedToTaskBoardTaskFormat>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannerassignedtotaskboardtaskformat-update?view=graph-rest-beta|Find more info here}
     */
