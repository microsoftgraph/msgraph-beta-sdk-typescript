...
// @ts-ignore
import { createPlannerTaskCollectionResponseFromDiscriminatorValue, createPlannerTaskFromDiscriminatorValue, serializePlannerTask, type PlannerTask, type PlannerTaskCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TasksRequestBuilder extends BaseRequestBuilder<TasksRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/planner-list-tasks?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/planner-post-tasks?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const TasksRequestBuilderUriTemplate = "{+baseurl}/planner/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
