...
export interface BucketsRequestBuilder extends BaseRequestBuilder<BucketsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/planner-list-buckets?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/planner-post-buckets?view=graph-rest-beta|Find more info here}
     */
