...
// @ts-ignore
import { createPlannerBucketFromDiscriminatorValue, serializePlannerBucket, type PlannerBucket } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PlannerBucketItemRequestBuilder extends BaseRequestBuilder<PlannerBucketItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/plannerbucket-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannerbucket-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<PlannerBucket>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannerbucket-update?view=graph-rest-beta|Find more info here}
     */
