...
// @ts-ignore
import { createPlannerRosterFromDiscriminatorValue, serializePlannerRoster, type PlannerRoster } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PlannerRosterItemRequestBuilder extends BaseRequestBuilder<PlannerRosterItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/plannerroster-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannerroster-get?view=graph-rest-beta|Find more info here}
     */
