...
export interface PlansRequestBuilder extends BaseRequestBuilder<PlansRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/planner-list-plans?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/planner-post-plans?view=graph-rest-beta|Find more info here}
     */
