...
// @ts-ignore
import { MoveToContainerRequestBuilderRequestsMetadata, type MoveToContainerRequestBuilder } from './moveToContainer/';
// @ts-ignore
...
export interface PlannerPlanItemRequestBuilder extends BaseRequestBuilder<PlannerPlanItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/plannerplan-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannerplan-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<PlannerPlan>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/plannerplan-update?view=graph-rest-beta|Find more info here}
     */
