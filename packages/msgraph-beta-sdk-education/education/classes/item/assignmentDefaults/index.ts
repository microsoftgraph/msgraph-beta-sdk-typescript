...
// @ts-ignore
import { createEducationAssignmentDefaultsFromDiscriminatorValue, serializeEducationAssignmentDefaults, type EducationAssignmentDefaults } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AssignmentDefaultsRequestBuilder extends BaseRequestBuilder<AssignmentDefaultsRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationassignmentdefaults-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<EducationAssignmentDefaults>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationassignmentdefaults-update?view=graph-rest-beta|Find more info here}
     */
