...
export interface AssignmentSettingsRequestBuilder extends BaseRequestBuilder<AssignmentSettingsRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationassignmentsettings-get?view=graph-rest-1.0|Find more info here}
     */
...
export const GetExpandQueryParameterTypeObject = {
    Asterisk: "*",
    DefaultGradingScheme: "defaultGradingScheme",
