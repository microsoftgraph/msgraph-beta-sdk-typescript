...
// @ts-ignore
import { createEducationAssignmentSettingsFromDiscriminatorValue, serializeEducationAssignmentSettings, type EducationAssignmentSettings } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/';
// @ts-ignore
import { DefaultGradingSchemeRequestBuilderRequestsMetadata, type DefaultGradingSchemeRequestBuilder } from './defaultGradingScheme/';
// @ts-ignore
...
// @ts-ignore
import { GradingSchemesRequestBuilderNavigationMetadata, GradingSchemesRequestBuilderRequestsMetadata, type GradingSchemesRequestBuilder } from './gradingSchemes/';
// @ts-ignore
...
export interface AssignmentSettingsRequestBuilder extends BaseRequestBuilder<AssignmentSettingsRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationassignmentsettings-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<EducationAssignmentSettings>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationassignmentsettings-update?view=graph-rest-beta|Find more info here}
     */
