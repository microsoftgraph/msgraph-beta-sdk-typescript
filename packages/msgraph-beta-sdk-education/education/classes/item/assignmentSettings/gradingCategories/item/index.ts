...
// @ts-ignore
import { createEducationGradingCategoryFromDiscriminatorValue, serializeEducationGradingCategory, type EducationGradingCategory } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface EducationGradingCategoryItemRequestBuilder extends BaseRequestBuilder<EducationGradingCategoryItemRequestBuilder> {
     ...
     * @returns {Promise<EducationGradingCategory>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationgradingcategory-update?view=graph-rest-beta|Find more info here}
     */
