...
// @ts-ignore
import { createEducationCategoryFromDiscriminatorValue, serializeEducationCategory, type EducationCategory } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface EducationCategoryItemRequestBuilder extends BaseRequestBuilder<EducationCategoryItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationcategory-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationcategory-get?view=graph-rest-beta|Find more info here}
     */
