...
// @ts-ignore
import { createEducationCategoryCollectionResponseFromDiscriminatorValue, createEducationCategoryFromDiscriminatorValue, serializeEducationCategory, type EducationCategory, type EducationCategoryCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface AssignmentCategoriesRequestBuilder extends BaseRequestBuilder<AssignmentCategoriesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationclass-list-categories?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationclass-post-category?view=graph-rest-beta|Find more info here}
     */
