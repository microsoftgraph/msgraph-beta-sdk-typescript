...
// @ts-ignore
import { createEducationModuleResourceCollectionResponseFromDiscriminatorValue, createEducationModuleResourceFromDiscriminatorValue, serializeEducationModuleResource, type EducationModuleResource, type EducationModuleResourceCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ResourcesRequestBuilder extends BaseRequestBuilder<ResourcesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationmodule-list-resources?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationmodule-post-resources?view=graph-rest-beta|Find more info here}
     */
