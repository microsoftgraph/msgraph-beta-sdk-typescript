...
// @ts-ignore
import { createEducationModuleResourceFromDiscriminatorValue, serializeEducationModuleResource, type EducationModuleResource } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface EducationModuleResourceItemRequestBuilder extends BaseRequestBuilder<EducationModuleResourceItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationmoduleresource-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationmoduleresource-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<EducationModuleResource>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationmoduleresource-update?view=graph-rest-beta|Find more info here}
     */
