...
// @ts-ignore
import { createEducationModuleFromDiscriminatorValue, serializeEducationModule, type EducationModule } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface EducationModuleItemRequestBuilder extends BaseRequestBuilder<EducationModuleItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationmodule-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationmodule-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<EducationModule>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationmodule-update?view=graph-rest-beta|Find more info here}
     */
