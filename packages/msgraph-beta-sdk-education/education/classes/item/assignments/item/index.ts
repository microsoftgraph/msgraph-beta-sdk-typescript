...
// @ts-ignore
import { createEducationAssignmentFromDiscriminatorValue, serializeEducationAssignment, type EducationAssignment } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface EducationAssignmentItemRequestBuilder extends BaseRequestBuilder<EducationAssignmentItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationassignment-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationassignment-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<EducationAssignment>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationassignment-update?view=graph-rest-beta|Find more info here}
     */
