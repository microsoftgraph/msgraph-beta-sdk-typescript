...
// @ts-ignore
import { EducationAssignmentResourceItemRequestBuilderNavigationMetadata, EducationAssignmentResourceItemRequestBuilderRequestsMetadata, type EducationAssignmentResourceItemRequestBuilder } from './item/';
// @ts-ignore
...
export interface ResourcesRequestBuilder extends BaseRequestBuilder<ResourcesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationassignment-list-resources?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationassignment-post-resources?view=graph-rest-beta|Find more info here}
     */
