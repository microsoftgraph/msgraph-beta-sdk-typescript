...
// @ts-ignore
import { DependentResourcesRequestBuilderNavigationMetadata, DependentResourcesRequestBuilderRequestsMetadata, type DependentResourcesRequestBuilder } from './dependentResources/';
// @ts-ignore
...
export interface EducationAssignmentResourceItemRequestBuilder extends BaseRequestBuilder<EducationAssignmentResourceItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationassignmentresource-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationassignmentresource-get?view=graph-rest-beta|Find more info here}
     */
