...
// @ts-ignore
import { createEducationRubricFromDiscriminatorValue, serializeEducationRubric, type EducationRubric } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RubricRequestBuilder extends BaseRequestBuilder<RubricRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationassignment-delete-rubric?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationassignment-get-rubric?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<EducationRubric>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationassignment-put-rubric?view=graph-rest-beta|Find more info here}
     */
