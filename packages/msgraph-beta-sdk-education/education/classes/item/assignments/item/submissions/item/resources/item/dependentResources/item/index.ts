...
// @ts-ignore
import { createEducationSubmissionResourceFromDiscriminatorValue, serializeEducationSubmissionResource, type EducationSubmissionResource } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
