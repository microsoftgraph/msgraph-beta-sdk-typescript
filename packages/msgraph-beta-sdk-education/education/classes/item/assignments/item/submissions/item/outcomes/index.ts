...
// @ts-ignore
import { createEducationOutcomeCollectionResponseFromDiscriminatorValue, createEducationOutcomeFromDiscriminatorValue, serializeEducationOutcome, type EducationOutcome, type EducationOutcomeCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface OutcomesRequestBuilder extends BaseRequestBuilder<OutcomesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationsubmission-list-outcomes?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationfeedbackresourceoutcome-post-outcomes?view=graph-rest-beta|Find more info here}
     */
