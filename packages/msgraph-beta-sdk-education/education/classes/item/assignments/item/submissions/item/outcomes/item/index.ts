...
// @ts-ignore
import { createEducationOutcomeFromDiscriminatorValue, serializeEducationOutcome, type EducationOutcome } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface EducationOutcomeItemRequestBuilder extends BaseRequestBuilder<EducationOutcomeItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationfeedbackresourceoutcome-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<EducationOutcome>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationoutcome-update?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const EducationOutcomeItemRequestBuilderUriTemplate = "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/outcomes/{educationOutcome%2Did}{?%24expand,%24select}";
/**
