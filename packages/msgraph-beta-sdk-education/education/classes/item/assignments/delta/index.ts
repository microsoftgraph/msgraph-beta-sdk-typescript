...
// @ts-ignore
import { createEducationAssignmentFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeEducationAssignment, type BaseDeltaFunctionResponse, type EducationAssignment } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationassignment-delta?view=graph-rest-beta|Find more info here}
     */
