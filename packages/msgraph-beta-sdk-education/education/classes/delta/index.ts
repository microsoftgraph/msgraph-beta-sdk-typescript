...
// @ts-ignore
import { createEducationClassFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeEducationClass, type BaseDeltaFunctionResponse, type EducationClass } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationclass-delta?view=graph-rest-beta|Find more info here}
     */
