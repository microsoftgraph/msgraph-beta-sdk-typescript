...
// @ts-ignore
import { createEducationClassCollectionResponseFromDiscriminatorValue, createEducationClassFromDiscriminatorValue, serializeEducationClass, type EducationClass, type EducationClassCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface ClassesRequestBuilder extends BaseRequestBuilder<ClassesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationroot-list-classes?view=graph-rest-1.0|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationroot-post-classes?view=graph-rest-1.0|Find more info here}
     */
