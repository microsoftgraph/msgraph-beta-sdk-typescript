...
// @ts-ignore
import { createEducationSchoolFromDiscriminatorValue, serializeEducationSchool, type EducationSchool } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { AdministrativeUnitRequestBuilderRequestsMetadata, type AdministrativeUnitRequestBuilder } from './administrativeUnit/index.js';
// @ts-ignore
import { ClassesRequestBuilderNavigationMetadata, ClassesRequestBuilderRequestsMetadata, type ClassesRequestBuilder } from './classes/index.js';
// @ts-ignore
...
export interface EducationSchoolItemRequestBuilder extends BaseRequestBuilder<EducationSchoolItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationschool-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationschool-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<EducationSchool>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationschool-update?view=graph-rest-beta|Find more info here}
     */
