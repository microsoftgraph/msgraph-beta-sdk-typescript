...
// @ts-ignore
import { createEducationSchoolFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeEducationSchool, type BaseDeltaFunctionResponse, type EducationSchool } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationschool-delta?view=graph-rest-beta|Find more info here}
     */
