...
// @ts-ignore
import { createEducationSchoolCollectionResponseFromDiscriminatorValue, createEducationSchoolFromDiscriminatorValue, serializeEducationSchool, type EducationSchool, type EducationSchoolCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SchoolsRequestBuilder extends BaseRequestBuilder<SchoolsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationroot-list-schools?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationroot-post-schools?view=graph-rest-beta|Find more info here}
     */
