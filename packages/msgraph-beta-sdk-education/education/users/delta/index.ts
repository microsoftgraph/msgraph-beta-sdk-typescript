...
// @ts-ignore
import { createEducationUserFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeEducationUser, type BaseDeltaFunctionResponse, type EducationUser } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationuser-delta?view=graph-rest-beta|Find more info here}
     */
