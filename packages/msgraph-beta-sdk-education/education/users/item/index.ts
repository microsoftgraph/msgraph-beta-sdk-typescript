...
// @ts-ignore
import { createEducationUserFromDiscriminatorValue, serializeEducationUser, type EducationUser } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { RubricsRequestBuilderNavigationMetadata, RubricsRequestBuilderRequestsMetadata, type RubricsRequestBuilder } from './rubrics/index.js';
// @ts-ignore
...
// @ts-ignore
import { TaughtClassesRequestBuilderNavigationMetadata, TaughtClassesRequestBuilderRequestsMetadata, type TaughtClassesRequestBuilder } from './taughtClasses/index.js';
// @ts-ignore
...
export interface EducationUserItemRequestBuilder extends BaseRequestBuilder<EducationUserItemRequestBuilder> {
     ...
     * @returns {Promise<EducationUser>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/relatedcontact-update?view=graph-rest-beta|Find more info here}
     */
