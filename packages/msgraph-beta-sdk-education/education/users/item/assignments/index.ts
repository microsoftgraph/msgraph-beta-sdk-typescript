...
// @ts-ignore
import { createEducationAssignmentCollectionResponseFromDiscriminatorValue, createEducationAssignmentFromDiscriminatorValue, serializeEducationAssignment, type EducationAssignment, type EducationAssignmentCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AssignmentsRequestBuilder extends BaseRequestBuilder<AssignmentsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationuser-list-assignments?view=graph-rest-beta|Find more info here}
     */
