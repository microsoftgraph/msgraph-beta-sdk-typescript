...
// @ts-ignore
import { createEducationUserCollectionResponseFromDiscriminatorValue, createEducationUserFromDiscriminatorValue, serializeEducationUser, type EducationUser, type EducationUserCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface UsersRequestBuilder extends BaseRequestBuilder<UsersRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/educationroot-list-users?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/educationroot-post-users?view=graph-rest-beta|Find more info here}
     */
