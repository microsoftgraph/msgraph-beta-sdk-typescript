...
// @ts-ignore
import { createIdentityFromDiscriminatorValue, serializeIdentity, TeamworkInteractionTypeObject, type Identity, type TeamworkInteractionType } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
