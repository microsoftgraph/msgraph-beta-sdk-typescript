...
// @ts-ignore
import { createTeamsAppSettingsFromDiscriminatorValue, serializeTeamsAppSettings, type TeamsAppSettings } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TeamsAppSettingsRequestBuilder extends BaseRequestBuilder<TeamsAppSettingsRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/teamsappsettings-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<TeamsAppSettings>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/teamsappsettings-update?view=graph-rest-beta|Find more info here}
     */
