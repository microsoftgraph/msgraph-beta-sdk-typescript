...
// @ts-ignore
import { createDeletedTeamCollectionResponseFromDiscriminatorValue, createDeletedTeamFromDiscriminatorValue, serializeDeletedTeam, type DeletedTeam, type DeletedTeamCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { DeletedTeamItemRequestBuilderNavigationMetadata, DeletedTeamItemRequestBuilderRequestsMetadata, type DeletedTeamItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface DeletedTeamsRequestBuilder extends BaseRequestBuilder<DeletedTeamsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/teamwork-list-deletedteams?view=graph-rest-beta|Find more info here}
     */
