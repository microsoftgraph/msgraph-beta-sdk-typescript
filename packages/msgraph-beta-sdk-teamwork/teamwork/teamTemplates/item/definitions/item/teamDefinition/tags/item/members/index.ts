...
// @ts-ignore
import { createTeamworkTagMemberCollectionResponseFromDiscriminatorValue, createTeamworkTagMemberFromDiscriminatorValue, serializeTeamworkTagMember, type TeamworkTagMember, type TeamworkTagMemberCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const MembersRequestBuilderUriTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/tags/{teamworkTag%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
