...
// @ts-ignore
import { createChannelFromDiscriminatorValue, type Channel } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const ChannelItemRequestBuilderUriTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/incomingChannels/{channel%2Did}{?%24expand,%24select}";
/**
