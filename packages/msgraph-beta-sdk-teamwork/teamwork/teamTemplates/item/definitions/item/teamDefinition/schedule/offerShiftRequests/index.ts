...
// @ts-ignore
import { createOfferShiftRequestCollectionResponseFromDiscriminatorValue, createOfferShiftRequestFromDiscriminatorValue, serializeOfferShiftRequest, type OfferShiftRequest, type OfferShiftRequestCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const OfferShiftRequestsRequestBuilderUriTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/offerShiftRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
