...
// @ts-ignore
import { createSchedulingGroupCollectionResponseFromDiscriminatorValue, createSchedulingGroupFromDiscriminatorValue, serializeSchedulingGroup, type SchedulingGroup, type SchedulingGroupCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const SchedulingGroupsRequestBuilderUriTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/schedulingGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
