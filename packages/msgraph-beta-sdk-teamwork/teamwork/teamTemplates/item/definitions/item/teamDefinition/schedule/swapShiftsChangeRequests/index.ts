...
// @ts-ignore
import { createSwapShiftsChangeRequestCollectionResponseFromDiscriminatorValue, createSwapShiftsChangeRequestFromDiscriminatorValue, serializeSwapShiftsChangeRequest, type SwapShiftsChangeRequest, type SwapShiftsChangeRequestCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const SwapShiftsChangeRequestsRequestBuilderUriTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/swapShiftsChangeRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
