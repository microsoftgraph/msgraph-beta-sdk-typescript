...
// @ts-ignore
import { createOpenShiftChangeRequestCollectionResponseFromDiscriminatorValue, createOpenShiftChangeRequestFromDiscriminatorValue, serializeOpenShiftChangeRequest, type OpenShiftChangeRequest, type OpenShiftChangeRequestCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const OpenShiftChangeRequestsRequestBuilderUriTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/openShiftChangeRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
