...
// @ts-ignore
import { createPlannerPlanDetailsFromDiscriminatorValue, serializePlannerPlanDetails, type PlannerPlanDetails } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const DetailsRequestBuilderUriTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/planner/plans/{plannerPlan%2Did}/details{?%24expand,%24select}";
/**
