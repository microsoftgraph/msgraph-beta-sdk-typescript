...
// @ts-ignore
import { createTeamsAppPermissionSetFromDiscriminatorValue, serializeTeamsAppPermissionSet, type TeamsAppPermissionSet } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
