...
// @ts-ignore
import { createChatMessageHostedContentFromDiscriminatorValue, serializeChatMessageHostedContent, type ChatMessageHostedContent } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
