...
// @ts-ignore
import { createProvisionChannelEmailResultFromDiscriminatorValue, type ProvisionChannelEmailResult } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ProvisionEmailRequestBuilder extends BaseRequestBuilder<ProvisionEmailRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/channel-provisionemail?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const ProvisionEmailRequestBuilderUriTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/provisionEmail";
/**
