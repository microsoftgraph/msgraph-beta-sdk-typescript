...
// @ts-ignore
import { createTimeOffRequestFromDiscriminatorValue, serializeTimeOffRequest, type TimeOffRequest } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const TimeOffRequestItemRequestBuilderUriTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeOffRequests/{timeOffRequest%2Did}{?%24expand,%24select}";
/**
