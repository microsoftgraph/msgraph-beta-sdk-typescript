...
// @ts-ignore
import { createTeamsAppFromDiscriminatorValue, type TeamsApp } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const TeamsAppItemRequestBuilderUriTemplate = "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/enabledApps/{teamsApp%2Did}{?%24expand,%24select}";
/**
