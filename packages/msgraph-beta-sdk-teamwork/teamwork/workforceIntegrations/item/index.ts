...
// @ts-ignore
import { createWorkforceIntegrationFromDiscriminatorValue, serializeWorkforceIntegration, type WorkforceIntegration } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface WorkforceIntegrationItemRequestBuilder extends BaseRequestBuilder<WorkforceIntegrationItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/workforceintegration-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/workforceintegration-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<WorkforceIntegration>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/workforceintegration-update?view=graph-rest-beta|Find more info here}
     */
