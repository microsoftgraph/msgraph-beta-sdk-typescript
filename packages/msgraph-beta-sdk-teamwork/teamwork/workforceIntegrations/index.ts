...
// @ts-ignore
import { createWorkforceIntegrationCollectionResponseFromDiscriminatorValue, createWorkforceIntegrationFromDiscriminatorValue, serializeWorkforceIntegration, type WorkforceIntegration, type WorkforceIntegrationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { type WorkforceIntegrationItemRequestBuilder, WorkforceIntegrationItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
...
export interface WorkforceIntegrationsRequestBuilder extends BaseRequestBuilder<WorkforceIntegrationsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/workforceintegration-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/workforceintegration-post?view=graph-rest-beta|Find more info here}
     */
