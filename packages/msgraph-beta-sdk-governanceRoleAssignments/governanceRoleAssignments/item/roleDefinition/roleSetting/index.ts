 ...
 */
export const RoleSettingRequestBuilderUriTemplate = "{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}/roleDefinition/roleSetting{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
