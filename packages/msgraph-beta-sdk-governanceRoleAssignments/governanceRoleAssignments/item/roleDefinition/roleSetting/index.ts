 ...
 */
export const RoleSettingRequestBuilderUriTemplate = "{+baseurl}/governanceRoleAssignments/{governanceRoleAssignment%2Did}/roleDefinition/roleSetting{?%24expand,%24select}";
/**
 * Provides operations to manage the roleSetting property of the microsoft.graph.governanceRoleDefinition entity.
 */
