...
// @ts-ignore
import { createDirectoryRoleCollectionResponseFromDiscriminatorValue, createDirectoryRoleFromDiscriminatorValue, serializeDirectoryRole, type DirectoryRole, type DirectoryRoleCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DirectoryRolesRequestBuilder extends BaseRequestBuilder<DirectoryRolesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/directoryrole-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/directoryrole-post-directoryroles?view=graph-rest-beta|Find more info here}
     */
