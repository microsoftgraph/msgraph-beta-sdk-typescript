 ...
 */
export const GraphApplicationRequestBuilderUriTemplate = "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/{directoryObject%2Did}/graph.application{?%24expand,%24select}";
/**
 * Casts the previous resource to application.
 */
