 ...
 */
export const GraphApplicationRequestBuilderUriTemplate = "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/{directoryObject%2Did}/graph.application{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
