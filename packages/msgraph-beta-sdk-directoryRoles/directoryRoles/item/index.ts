...
// @ts-ignore
import { createDirectoryRoleFromDiscriminatorValue, serializeDirectoryRole, type DirectoryRole } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DirectoryRoleItemRequestBuilder extends BaseRequestBuilder<DirectoryRoleItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/directoryrole-get?view=graph-rest-beta|Find more info here}
     */
