...
// @ts-ignore
import { createDirectoryRoleFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeDirectoryRole, type BaseDeltaFunctionResponse, type DirectoryRole } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/directoryrole-delta?view=graph-rest-beta|Find more info here}
     */
