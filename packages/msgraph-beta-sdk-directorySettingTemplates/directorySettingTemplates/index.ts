...
// @ts-ignore
import { createDirectorySettingTemplateCollectionResponseFromDiscriminatorValue, createDirectorySettingTemplateFromDiscriminatorValue, serializeDirectorySettingTemplate, type DirectorySettingTemplate, type DirectorySettingTemplateCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { DirectorySettingTemplateItemRequestBuilderNavigationMetadata, DirectorySettingTemplateItemRequestBuilderRequestsMetadata, type DirectorySettingTemplateItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface DirectorySettingTemplatesRequestBuilder extends BaseRequestBuilder<DirectorySettingTemplatesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/directorysettingtemplate-list?view=graph-rest-beta|Find more info here}
     */
