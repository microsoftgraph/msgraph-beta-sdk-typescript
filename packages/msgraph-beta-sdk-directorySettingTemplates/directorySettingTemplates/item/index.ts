...
// @ts-ignore
import { createDirectorySettingTemplateFromDiscriminatorValue, serializeDirectorySettingTemplate, type DirectorySettingTemplate } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DirectorySettingTemplateItemRequestBuilder extends BaseRequestBuilder<DirectorySettingTemplateItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/directorysettingtemplate-get?view=graph-rest-beta|Find more info here}
     */
