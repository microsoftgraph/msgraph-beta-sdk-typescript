...
import { createDirectoryObjectFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeDirectoryObject, type BaseDeltaFunctionResponse, type DirectoryObject } from '@microsoft/msgraph-beta-sdk/models/';
 ...
 */
export const DeltaRequestBuilderUriTemplate = "{+baseurl}/directorySettingTemplates/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
