...
// @ts-ignore
import { createSubscribedSkuCollectionResponseFromDiscriminatorValue, createSubscribedSkuFromDiscriminatorValue, serializeSubscribedSku, type SubscribedSku, type SubscribedSkuCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { SubscribedSkuItemRequestBuilderRequestsMetadata, type SubscribedSkuItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface SubscribedSkusRequestBuilder extends BaseRequestBuilder<SubscribedSkusRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/subscribedsku-list?view=graph-rest-beta|Find more info here}
     */
