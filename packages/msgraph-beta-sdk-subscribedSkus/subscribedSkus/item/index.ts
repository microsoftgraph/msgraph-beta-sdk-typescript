...
// @ts-ignore
import { createSubscribedSkuFromDiscriminatorValue, serializeSubscribedSku, type SubscribedSku } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SubscribedSkuItemRequestBuilder extends BaseRequestBuilder<SubscribedSkuItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/subscribedsku-get?view=graph-rest-beta|Find more info here}
     */
