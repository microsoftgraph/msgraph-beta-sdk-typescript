...
// @ts-ignore
import { createOAuth2PermissionGrantFromDiscriminatorValue, serializeOAuth2PermissionGrant, type OAuth2PermissionGrant } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface OAuth2PermissionGrantItemRequestBuilder extends BaseRequestBuilder<OAuth2PermissionGrantItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/oauth2permissiongrant-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/oauth2permissiongrant-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<OAuth2PermissionGrant>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/oauth2permissiongrant-update?view=graph-rest-beta|Find more info here}
     */
