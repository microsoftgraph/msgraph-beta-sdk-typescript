...
// @ts-ignore
import { createOAuth2PermissionGrantCollectionResponseFromDiscriminatorValue, createOAuth2PermissionGrantFromDiscriminatorValue, serializeOAuth2PermissionGrant, type OAuth2PermissionGrant, type OAuth2PermissionGrantCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { OAuth2PermissionGrantItemRequestBuilderRequestsMetadata, type OAuth2PermissionGrantItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface Oauth2PermissionGrantsRequestBuilder extends BaseRequestBuilder<Oauth2PermissionGrantsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/oauth2permissiongrant-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/oauth2permissiongrant-post?view=graph-rest-beta|Find more info here}
     */
