...
// @ts-ignore
import { createAttachmentCollectionResponseFromDiscriminatorValue, createAttachmentFromDiscriminatorValue, serializeAttachment, type Attachment, type AttachmentCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/caseManagement/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { AttachmentItemRequestBuilderNavigationMetadata, AttachmentItemRequestBuilderRequestsMetadata, type AttachmentItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface AttachmentsRequestBuilder extends BaseRequestBuilder<AttachmentsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-casemanagement-case-list-attachments?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-casemanagement-case-post-attachments?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const AttachmentsRequestBuilderUriTemplate = "{+baseurl}/security/caseManagement/cases/{case%2Did}/attachments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
...
export const AttachmentsRequestBuilderNavigationMetadata: Record<Exclude<keyof AttachmentsRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byAttachmentId: {
        ...
        navigationMetadata: AttachmentItemRequestBuilderNavigationMetadata,
