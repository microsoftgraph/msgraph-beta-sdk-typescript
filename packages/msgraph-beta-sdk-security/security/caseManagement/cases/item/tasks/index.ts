...
// @ts-ignore
import { createTaskCollectionResponseFromDiscriminatorValue, createTaskFromDiscriminatorValue, serializeTask, type Task, type TaskCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/caseManagement/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { TaskItemRequestBuilderRequestsMetadata, type TaskItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface TasksRequestBuilder extends BaseRequestBuilder<TasksRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-casemanagement-case-list-tasks?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-casemanagement-case-post-tasks?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const TasksRequestBuilderUriTemplate = "{+baseurl}/security/caseManagement/cases/{case%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
