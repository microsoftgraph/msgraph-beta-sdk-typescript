...
// @ts-ignore
import { createCollaborationRootFromDiscriminatorValue, serializeCollaborationRoot, type CollaborationRoot } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
