...
// @ts-ignore
import { createAnalyzedEmailFromDiscriminatorValue, RemediationActionObject, RemediationSeverityObject, serializeAnalyzedEmail, type AnalyzedEmail, type RemediationAction, type RemediationSeverity } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
