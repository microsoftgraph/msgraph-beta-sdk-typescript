...
// @ts-ignore
import { createSimulationAutomationFromDiscriminatorValue, serializeSimulationAutomation, type SimulationAutomation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SimulationAutomationItemRequestBuilder extends BaseRequestBuilder<SimulationAutomationItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/simulationautomation-get?view=graph-rest-beta|Find more info here}
     */
