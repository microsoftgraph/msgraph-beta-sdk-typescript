...
// @ts-ignore
import { createSimulationCollectionResponseFromDiscriminatorValue, createSimulationFromDiscriminatorValue, serializeSimulation, type Simulation, type SimulationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { SimulationItemRequestBuilderNavigationMetadata, SimulationItemRequestBuilderRequestsMetadata, type SimulationItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface SimulationsRequestBuilder extends BaseRequestBuilder<SimulationsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/attacksimulationroot-list-simulations?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/attacksimulationroot-post-simulation?view=graph-rest-beta|Find more info here}
     */
