...
// @ts-ignore
import { createEndUserNotificationCollectionResponseFromDiscriminatorValue, createEndUserNotificationFromDiscriminatorValue, serializeEndUserNotification, type EndUserNotification, type EndUserNotificationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface EndUserNotificationsRequestBuilder extends BaseRequestBuilder<EndUserNotificationsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/attacksimulationroot-list-endusernotifications?view=graph-rest-beta|Find more info here}
     */
