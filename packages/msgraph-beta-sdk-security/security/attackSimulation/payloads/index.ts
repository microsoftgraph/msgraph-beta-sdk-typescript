...
// @ts-ignore
import { createPayloadCollectionResponseFromDiscriminatorValue, createPayloadFromDiscriminatorValue, serializePayload, type Payload, type PayloadCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PayloadsRequestBuilder extends BaseRequestBuilder<PayloadsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/attacksimulationroot-list-payloads?view=graph-rest-beta|Find more info here}
     */
