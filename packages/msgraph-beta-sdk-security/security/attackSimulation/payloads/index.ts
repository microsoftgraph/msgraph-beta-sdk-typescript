...
// @ts-ignore
import { createPayloadCollectionResponseFromDiscriminatorValue, createPayloadFromDiscriminatorValue, serializePayload, type Payload, type PayloadCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
