...
// @ts-ignore
import { createPayloadFromDiscriminatorValue, serializePayload, type Payload } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface PayloadItemRequestBuilder extends BaseRequestBuilder<PayloadItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/payload-get?view=graph-rest-beta|Find more info here}
     */
