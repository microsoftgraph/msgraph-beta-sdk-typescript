...
// @ts-ignore
import { createTrainingCollectionResponseFromDiscriminatorValue, createTrainingFromDiscriminatorValue, serializeTraining, type Training, type TrainingCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TrainingsRequestBuilder extends BaseRequestBuilder<TrainingsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/attacksimulationroot-list-trainings?view=graph-rest-beta|Find more info here}
     */
