...
// @ts-ignore
import { createAlertCommentFromDiscriminatorValue, serializeAlertComment, type AlertComment } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface CommentsRequestBuilder extends BaseRequestBuilder<CommentsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-alert-post-comments?view=graph-rest-beta|Find more info here}
     */
