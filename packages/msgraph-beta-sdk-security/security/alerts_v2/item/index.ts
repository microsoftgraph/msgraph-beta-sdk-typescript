...
// @ts-ignore
import { createAlertFromDiscriminatorValue, serializeAlert, type Alert } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface AlertItemRequestBuilder extends BaseRequestBuilder<AlertItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-alert-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Alert>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-alert-update?view=graph-rest-beta|Find more info here}
     */
