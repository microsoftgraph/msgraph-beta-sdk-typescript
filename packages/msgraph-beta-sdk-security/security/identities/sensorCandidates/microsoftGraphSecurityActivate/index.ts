...
export interface MicrosoftGraphSecurityActivateRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityActivateRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-sensorcandidate-activate?view=graph-rest-beta|Find more info here}
     */
...
export function serializeActivatePostRequestBody(writer: SerializationWriter, activatePostRequestBody: Partial<ActivatePostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeCollectionOfPrimitiveValues<string>("serverIds", activatePostRequestBody.serverIds);
