...
// @ts-ignore
import { createIdentityAccountsFromDiscriminatorValue, serializeIdentityAccounts, type IdentityAccounts } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
