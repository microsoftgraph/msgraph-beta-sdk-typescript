...
// @ts-ignore
import { createHealthIssueCollectionResponseFromDiscriminatorValue, createHealthIssueFromDiscriminatorValue, serializeHealthIssue, type HealthIssue, type HealthIssueCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface HealthIssuesRequestBuilder extends BaseRequestBuilder<HealthIssuesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-identitycontainer-list-healthissues?view=graph-rest-beta|Find more info here}
     */
