...
// @ts-ignore
import { createHealthIssueFromDiscriminatorValue, serializeHealthIssue, type HealthIssue } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface HealthIssueItemRequestBuilder extends BaseRequestBuilder<HealthIssueItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-healthissue-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<HealthIssue>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-healthissue-update?view=graph-rest-beta|Find more info here}
     */
