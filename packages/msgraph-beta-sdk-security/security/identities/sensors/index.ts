...
// @ts-ignore
import { createSensorCollectionResponseFromDiscriminatorValue, createSensorFromDiscriminatorValue, serializeSensor, type Sensor, type SensorCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
