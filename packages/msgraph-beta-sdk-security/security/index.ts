...
// @ts-ignore
import { AuditLogRequestBuilderNavigationMetadata, AuditLogRequestBuilderRequestsMetadata, type AuditLogRequestBuilder } from './auditLog/';
// @ts-ignore
import { CasesRequestBuilderNavigationMetadata, CasesRequestBuilderRequestsMetadata, type CasesRequestBuilder } from './cases/';
// @ts-ignore
import { CloudAppSecurityProfilesRequestBuilderNavigationMetadata, CloudAppSecurityProfilesRequestBuilderRequestsMetadata, type CloudAppSecurityProfilesRequestBuilder } from './cloudAppSecurityProfiles/';
// @ts-ignore
import { CollaborationRequestBuilderNavigationMetadata, CollaborationRequestBuilderRequestsMetadata, type CollaborationRequestBuilder } from './collaboration/';
// @ts-ignore
import { DomainSecurityProfilesRequestBuilderNavigationMetadata, DomainSecurityProfilesRequestBuilderRequestsMetadata, type DomainSecurityProfilesRequestBuilder } from './domainSecurityProfiles/';
// @ts-ignore
import { FileSecurityProfilesRequestBuilderNavigationMetadata, FileSecurityProfilesRequestBuilderRequestsMetadata, type FileSecurityProfilesRequestBuilder } from './fileSecurityProfiles/';
// @ts-ignore
import { HostSecurityProfilesRequestBuilderNavigationMetadata, HostSecurityProfilesRequestBuilderRequestsMetadata, type HostSecurityProfilesRequestBuilder } from './hostSecurityProfiles/';
// @ts-ignore
...
// @ts-ignore
import { IpSecurityProfilesRequestBuilderNavigationMetadata, IpSecurityProfilesRequestBuilderRequestsMetadata, type IpSecurityProfilesRequestBuilder } from './ipSecurityProfiles/';
// @ts-ignore
...
// @ts-ignore
import { PartnerRequestBuilderNavigationMetadata, PartnerRequestBuilderRequestsMetadata, type PartnerRequestBuilder } from './partner/';
// @ts-ignore
...
// @ts-ignore
import { ThreatSubmissionRequestBuilderNavigationMetadata, ThreatSubmissionRequestBuilderRequestsMetadata, type ThreatSubmissionRequestBuilder } from './threatSubmission/';
// @ts-ignore
import { TiIndicatorsRequestBuilderNavigationMetadata, TiIndicatorsRequestBuilderRequestsMetadata, type TiIndicatorsRequestBuilder } from './tiIndicators/';
// @ts-ignore
