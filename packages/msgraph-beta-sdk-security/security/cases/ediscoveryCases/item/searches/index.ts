...
// @ts-ignore
import { createEdiscoverySearchCollectionResponseFromDiscriminatorValue, createEdiscoverySearchFromDiscriminatorValue, serializeEdiscoverySearch, type EdiscoverySearch, type EdiscoverySearchCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { EdiscoverySearchItemRequestBuilderNavigationMetadata, EdiscoverySearchItemRequestBuilderRequestsMetadata, type EdiscoverySearchItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface SearchesRequestBuilder extends BaseRequestBuilder<SearchesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycase-list-searches?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycase-post-searches?view=graph-rest-beta|Find more info here}
     */
