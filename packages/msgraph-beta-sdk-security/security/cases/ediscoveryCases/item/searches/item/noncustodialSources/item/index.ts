...
// @ts-ignore
import { createEdiscoveryNoncustodialDataSourceFromDiscriminatorValue, type EdiscoveryNoncustodialDataSource } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
