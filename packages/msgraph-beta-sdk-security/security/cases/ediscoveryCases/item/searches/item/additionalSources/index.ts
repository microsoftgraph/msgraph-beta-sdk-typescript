...
// @ts-ignore
import { createDataSourceCollectionResponseFromDiscriminatorValue, createDataSourceFromDiscriminatorValue, serializeDataSource, type DataSource, type DataSourceCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface AdditionalSourcesRequestBuilder extends BaseRequestBuilder<AdditionalSourcesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverysearch-list-additionalsources?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverysearch-post-additionalsources?view=graph-rest-beta|Find more info here}
     */
