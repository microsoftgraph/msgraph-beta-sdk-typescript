...
// @ts-ignore
import { AdditionalOptionsObject, CloudAttachmentVersionObject, DocumentVersionObject, ExportCriteriaObject, ExportLocationObject, type AdditionalOptions, type CloudAttachmentVersion, type DocumentVersion, type ExportCriteria, type ExportLocation } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface MicrosoftGraphSecurityExportReportRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityExportReportRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverysearch-exportreport?view=graph-rest-beta|Find more info here}
     */
