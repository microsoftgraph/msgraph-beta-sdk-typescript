...
// @ts-ignore
import { AdditionalOptions, AdditionalOptionsObject, ExportCriteria, ExportCriteriaObject, ExportLocation, ExportLocationObject } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
