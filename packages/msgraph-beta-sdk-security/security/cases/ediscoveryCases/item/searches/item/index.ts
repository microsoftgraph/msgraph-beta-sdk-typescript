...
// @ts-ignore
import { createEdiscoverySearchFromDiscriminatorValue, serializeEdiscoverySearch, type EdiscoverySearch } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
