...
// @ts-ignore
import { createEdiscoverySearchFromDiscriminatorValue, serializeEdiscoverySearch, type EdiscoverySearch } from '@microsoft/msgraph-beta-sdk/models/security/';
// @ts-ignore
...
// @ts-ignore
import { MicrosoftGraphSecurityExportReportRequestBuilderRequestsMetadata, type MicrosoftGraphSecurityExportReportRequestBuilder } from './microsoftGraphSecurityExportReport/';
// @ts-ignore
import { MicrosoftGraphSecurityExportResultRequestBuilderRequestsMetadata, type MicrosoftGraphSecurityExportResultRequestBuilder } from './microsoftGraphSecurityExportResult/';
// @ts-ignore
...
export interface EdiscoverySearchItemRequestBuilder extends BaseRequestBuilder<EdiscoverySearchItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycase-delete-searches?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverysearch-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<EdiscoverySearch>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverysearch-update?view=graph-rest-beta|Find more info here}
     */
