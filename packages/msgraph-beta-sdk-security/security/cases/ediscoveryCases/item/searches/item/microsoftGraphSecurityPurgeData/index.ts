...
// @ts-ignore
import { PurgeAreasObject, PurgeTypeObject, type PurgeAreas, type PurgeType } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface MicrosoftGraphSecurityPurgeDataRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityPurgeDataRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverysearch-purgedata?view=graph-rest-beta|Find more info here}
     */
