...
// @ts-ignore
import { StatisticsOptions, StatisticsOptionsObject } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface MicrosoftGraphSecurityEstimateStatisticsRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityEstimateStatisticsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverysearch-estimatestatistics?view=graph-rest-beta|Find more info here}
     */
