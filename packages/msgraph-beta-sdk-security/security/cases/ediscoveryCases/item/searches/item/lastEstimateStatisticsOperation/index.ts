...
// @ts-ignore
import { createEdiscoveryEstimateOperationFromDiscriminatorValue, type EdiscoveryEstimateOperation } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface LastEstimateStatisticsOperationRequestBuilder extends BaseRequestBuilder<LastEstimateStatisticsOperationRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverysearch-list-lastestimatestatisticsoperation?view=graph-rest-beta|Find more info here}
     */
