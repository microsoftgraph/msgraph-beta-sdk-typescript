...
// @ts-ignore
import { AdditionalOptions, AdditionalOptionsObject, CloudAttachmentVersion, CloudAttachmentVersionObject, DocumentVersion, DocumentVersionObject, ExportCriteria, ExportCriteriaObject, ExportFormat, ExportFormatObject, ExportLocation, ExportLocationObject } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface MicrosoftGraphSecurityExportResultRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityExportResultRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverysearch-exportresult?view=graph-rest-beta|Find more info here}
     */
 ...
 */
// @ts-ignore
export function serializeExportResultPostRequestBody(writer: SerializationWriter, exportResultPostRequestBody: Partial<ExportResultPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!exportResultPostRequestBody || isSerializingDerivedType) { return; }
