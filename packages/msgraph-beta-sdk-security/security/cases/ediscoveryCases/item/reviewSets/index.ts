...
// @ts-ignore
import { createEdiscoveryReviewSetCollectionResponseFromDiscriminatorValue, createEdiscoveryReviewSetFromDiscriminatorValue, serializeEdiscoveryReviewSet, type EdiscoveryReviewSet, type EdiscoveryReviewSetCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface ReviewSetsRequestBuilder extends BaseRequestBuilder<ReviewSetsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycase-list-reviewsets?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycase-post-reviewsets?view=graph-rest-beta|Find more info here}
     */
