...
// @ts-ignore
import { createEdiscoveryReviewSetQueryCollectionResponseFromDiscriminatorValue, createEdiscoveryReviewSetQueryFromDiscriminatorValue, serializeEdiscoveryReviewSetQuery, type EdiscoveryReviewSetQuery, type EdiscoveryReviewSetQueryCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface QueriesRequestBuilder extends BaseRequestBuilder<QueriesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoveryreviewset-list-queries?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoveryreviewset-post-queries?view=graph-rest-beta|Find more info here}
     */
