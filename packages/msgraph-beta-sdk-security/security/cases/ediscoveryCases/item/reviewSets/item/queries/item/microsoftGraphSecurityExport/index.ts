...
// @ts-ignore
import { ExportFileStructureObject, ExportOptionsObject, type ExportFileStructure, type ExportOptions } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface MicrosoftGraphSecurityExportRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityExportRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoveryreviewsetquery-export?view=graph-rest-beta|Find more info here}
     */
