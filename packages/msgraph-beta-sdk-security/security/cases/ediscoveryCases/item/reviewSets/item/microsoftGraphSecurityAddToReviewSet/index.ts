...
// @ts-ignore
import { AdditionalDataOptionsObject, CloudAttachmentVersionObject, createEdiscoverySearchFromDiscriminatorValue, DocumentVersionObject, ItemsToIncludeObject, serializeEdiscoverySearch, type AdditionalDataOptions, type CloudAttachmentVersion, type DocumentVersion, type EdiscoverySearch, type ItemsToInclude } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface MicrosoftGraphSecurityAddToReviewSetRequestBuilder extends BaseRequestBuilder<MicrosoftGraphSecurityAddToReviewSetRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoveryreviewset-addtoreviewset?view=graph-rest-beta|Find more info here}
     */
