...
// @ts-ignore
import { createUnifiedGroupSourceFromDiscriminatorValue, serializeUnifiedGroupSource, type UnifiedGroupSource } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface UnifiedGroupSourceItemRequestBuilder extends BaseRequestBuilder<UnifiedGroupSourceItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-unifiedgroupsource-delete?view=graph-rest-beta|Find more info here}
     */
