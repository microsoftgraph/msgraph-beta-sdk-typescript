...
// @ts-ignore
import { createSiteSourceCollectionResponseFromDiscriminatorValue, createSiteSourceFromDiscriminatorValue, serializeSiteSource, type SiteSource, type SiteSourceCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface SiteSourcesRequestBuilder extends BaseRequestBuilder<SiteSourcesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycustodian-list-sitesources?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycustodian-post-sitesources?view=graph-rest-beta|Find more info here}
     */
