...
// @ts-ignore
import { createEdiscoveryIndexOperationFromDiscriminatorValue, type EdiscoveryIndexOperation } from '@microsoft/msgraph-beta-sdk/models/security/';
// @ts-ignore
...
export interface LastIndexOperationRequestBuilder extends BaseRequestBuilder<LastIndexOperationRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycustodian-list-lastindexoperation?view=graph-rest-beta|Find more info here}
     */
