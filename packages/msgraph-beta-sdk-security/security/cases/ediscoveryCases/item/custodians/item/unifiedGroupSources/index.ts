...
// @ts-ignore
import { createUnifiedGroupSourceCollectionResponseFromDiscriminatorValue, createUnifiedGroupSourceFromDiscriminatorValue, serializeUnifiedGroupSource, type UnifiedGroupSource, type UnifiedGroupSourceCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface UnifiedGroupSourcesRequestBuilder extends BaseRequestBuilder<UnifiedGroupSourcesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycustodian-list-unifiedgroupsources?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycustodian-post-unifiedgroupsources?view=graph-rest-beta|Find more info here}
     */
