...
export interface NoncustodialDataSourcesRequestBuilder extends BaseRequestBuilder<NoncustodialDataSourcesRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycase-post-noncustodialdatasources?view=graph-rest-beta|Find more info here}
     */
