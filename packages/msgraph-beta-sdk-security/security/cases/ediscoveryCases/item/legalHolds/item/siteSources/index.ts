...
import { createSiteSourceCollectionResponseFromDiscriminatorValue, createSiteSourceFromDiscriminatorValue, serializeSiteSource, type SiteSource, type SiteSourceCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/';
...
export interface SiteSourcesRequestBuilder extends BaseRequestBuilder<SiteSourcesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoveryholdpolicy-post-sitesources?view=graph-rest-1.0|Find more info here}
     */
 ...
 */
export const SiteSourcesRequestBuilderUriTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/legalHolds/{ediscoveryHoldPolicy%2Did}/siteSources{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/* tslint:enable */
/* eslint-enable */
