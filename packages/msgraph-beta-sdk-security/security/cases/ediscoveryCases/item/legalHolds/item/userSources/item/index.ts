...
// @ts-ignore
import { createUserSourceFromDiscriminatorValue, serializeUserSource, type UserSource } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface UserSourceItemRequestBuilder extends BaseRequestBuilder<UserSourceItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoveryholdpolicy-delete-usersources?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const UserSourceItemRequestBuilderUriTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/legalHolds/{ediscoveryHoldPolicy%2Did}/userSources/{userSource%2Did}{?%24expand,%24select}";
/**
