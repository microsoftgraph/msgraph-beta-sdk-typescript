...
// @ts-ignore
import { createSiteSourceFromDiscriminatorValue, serializeSiteSource, type SiteSource } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface SiteSourceItemRequestBuilder extends BaseRequestBuilder<SiteSourceItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoveryholdpolicy-delete-sitesources?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const SiteSourceItemRequestBuilderUriTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/legalHolds/{ediscoveryHoldPolicy%2Did}/siteSources/{siteSource%2Did}{?%24expand,%24select}";
/**
