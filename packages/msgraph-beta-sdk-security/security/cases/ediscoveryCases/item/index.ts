...
// @ts-ignore
import { createEdiscoveryCaseFromDiscriminatorValue, serializeEdiscoveryCase, type EdiscoveryCase } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
