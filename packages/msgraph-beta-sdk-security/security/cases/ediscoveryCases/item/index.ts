...
export interface EdiscoveryCaseItemRequestBuilder extends BaseRequestBuilder<EdiscoveryCaseItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-casesroot-delete-ediscoverycases?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycase-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<EdiscoveryCase>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycase-update?view=graph-rest-beta|Find more info here}
     */
