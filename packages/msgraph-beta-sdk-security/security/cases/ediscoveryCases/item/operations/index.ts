...
// @ts-ignore
import { createCaseOperationCollectionResponseFromDiscriminatorValue, createCaseOperationFromDiscriminatorValue, serializeCaseOperation, type CaseOperation, type CaseOperationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { CaseOperationItemRequestBuilderRequestsMetadata, type CaseOperationItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface OperationsRequestBuilder extends BaseRequestBuilder<OperationsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycase-list-operations?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const OperationsRequestBuilderUriTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/operations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
