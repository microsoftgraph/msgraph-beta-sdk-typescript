...
// @ts-ignore
import { createEdiscoveryCaseSettingsFromDiscriminatorValue, serializeEdiscoveryCaseSettings, type EdiscoveryCaseSettings } from '@microsoft/msgraph-beta-sdk/models/security/';
// @ts-ignore
