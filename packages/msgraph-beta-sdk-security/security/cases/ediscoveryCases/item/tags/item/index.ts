...
// @ts-ignore
import { createEdiscoveryReviewTagFromDiscriminatorValue, serializeEdiscoveryReviewTag, type EdiscoveryReviewTag } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface EdiscoveryReviewTagItemRequestBuilder extends BaseRequestBuilder<EdiscoveryReviewTagItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoverycase-delete-tags?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoveryreviewtag-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<EdiscoveryReviewTag>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoveryreviewtag-update?view=graph-rest-beta|Find more info here}
     */
