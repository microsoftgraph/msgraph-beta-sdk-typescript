...
// @ts-ignore
import { createEdiscoveryReviewTagCollectionResponseFromDiscriminatorValue, type EdiscoveryReviewTagCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface ChildTagsRequestBuilder extends BaseRequestBuilder<ChildTagsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-ediscoveryreviewtag-ashierarchy?view=graph-rest-beta|Find more info here}
     */
