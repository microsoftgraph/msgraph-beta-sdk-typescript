...
// @ts-ignore
import { createArticleIndicatorFromDiscriminatorValue, serializeArticleIndicator, type ArticleIndicator } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface ArticleIndicatorItemRequestBuilder extends BaseRequestBuilder<ArticleIndicatorItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-articleindicator-get?view=graph-rest-beta|Find more info here}
     */
