...
// @ts-ignore
import { createArticleIndicatorCollectionResponseFromDiscriminatorValue, type ArticleIndicatorCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface IndicatorsRequestBuilder extends BaseRequestBuilder<IndicatorsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-article-list-indicators?view=graph-rest-beta|Find more info here}
     */
