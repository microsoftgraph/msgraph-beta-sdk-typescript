...
// @ts-ignore
import { createArticleFromDiscriminatorValue, serializeArticle, type Article } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface ArticleItemRequestBuilder extends BaseRequestBuilder<ArticleItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-article-get?view=graph-rest-beta|Find more info here}
     */
