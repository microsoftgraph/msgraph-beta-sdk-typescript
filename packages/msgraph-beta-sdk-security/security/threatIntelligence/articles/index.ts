...
// @ts-ignore
import { createArticleCollectionResponseFromDiscriminatorValue, createArticleFromDiscriminatorValue, serializeArticle, type Article, type ArticleCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface ArticlesRequestBuilder extends BaseRequestBuilder<ArticlesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-threatintelligence-list-articles?view=graph-rest-beta|Find more info here}
     */
