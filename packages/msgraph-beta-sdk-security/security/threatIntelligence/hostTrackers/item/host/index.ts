...
// @ts-ignore
import { createHostFromDiscriminatorValue, type Host } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
 ...
 */
export const HostRequestBuilderUriTemplate = "{+baseurl}/security/threatIntelligence/hostTrackers/{hostTracker%2Did}/host{?%24expand,%24select}";
/**
