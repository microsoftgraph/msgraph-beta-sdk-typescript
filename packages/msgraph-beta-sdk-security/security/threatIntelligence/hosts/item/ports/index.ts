...
// @ts-ignore
import { createHostPortCollectionResponseFromDiscriminatorValue, type HostPortCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface PortsRequestBuilder extends BaseRequestBuilder<PortsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-host-list-ports?view=graph-rest-beta|Find more info here}
     */
