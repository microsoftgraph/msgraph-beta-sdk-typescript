...
// @ts-ignore
import { createHostTrackerCollectionResponseFromDiscriminatorValue, type HostTrackerCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { HostTrackerItemRequestBuilderRequestsMetadata, type HostTrackerItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface TrackersRequestBuilder extends BaseRequestBuilder<TrackersRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-host-list-trackers?view=graph-rest-beta|Find more info here}
     */
