...
// @ts-ignore
import { createHostReputationFromDiscriminatorValue, serializeHostReputation, type HostReputation } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
