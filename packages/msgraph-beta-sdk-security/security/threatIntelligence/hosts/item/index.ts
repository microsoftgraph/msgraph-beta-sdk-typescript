...
// @ts-ignore
import { createHostFromDiscriminatorValue, serializeHost, type Host } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
import { ChildHostPairsRequestBuilderNavigationMetadata, ChildHostPairsRequestBuilderRequestsMetadata, type ChildHostPairsRequestBuilder } from './childHostPairs/index.js';
// @ts-ignore
import { ComponentsRequestBuilderNavigationMetadata, ComponentsRequestBuilderRequestsMetadata, type ComponentsRequestBuilder } from './components/index.js';
// @ts-ignore
import { CookiesRequestBuilderNavigationMetadata, CookiesRequestBuilderRequestsMetadata, type CookiesRequestBuilder } from './cookies/index.js';
// @ts-ignore
...
// @ts-ignore
import { ParentHostPairsRequestBuilderNavigationMetadata, ParentHostPairsRequestBuilderRequestsMetadata, type ParentHostPairsRequestBuilder } from './parentHostPairs/index.js';
// @ts-ignore
import { PassiveDnsRequestBuilderNavigationMetadata, PassiveDnsRequestBuilderRequestsMetadata, type PassiveDnsRequestBuilder } from './passiveDns/index.js';
// @ts-ignore
import { PassiveDnsReverseRequestBuilderNavigationMetadata, PassiveDnsReverseRequestBuilderRequestsMetadata, type PassiveDnsReverseRequestBuilder } from './passiveDnsReverse/index.js';
// @ts-ignore
import { PortsRequestBuilderNavigationMetadata, PortsRequestBuilderRequestsMetadata, type PortsRequestBuilder } from './ports/index.js';
// @ts-ignore
import { ReputationRequestBuilderRequestsMetadata, type ReputationRequestBuilder } from './reputation/index.js';
// @ts-ignore
...
// @ts-ignore
import { TrackersRequestBuilderNavigationMetadata, TrackersRequestBuilderRequestsMetadata, type TrackersRequestBuilder } from './trackers/index.js';
// @ts-ignore
import { type WhoisRequestBuilder, WhoisRequestBuilderRequestsMetadata } from './whois/index.js';
// @ts-ignore
...
export interface HostItemRequestBuilder extends BaseRequestBuilder<HostItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-host-get?view=graph-rest-beta|Find more info here}
     */
