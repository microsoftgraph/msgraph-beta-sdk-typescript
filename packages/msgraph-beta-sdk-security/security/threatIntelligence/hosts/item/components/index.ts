...
// @ts-ignore
import { createHostComponentCollectionResponseFromDiscriminatorValue, type HostComponentCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/';
// @ts-ignore
