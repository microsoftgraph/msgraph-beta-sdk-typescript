...
// @ts-ignore
import { createHostComponentCollectionResponseFromDiscriminatorValue, type HostComponentCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface ComponentsRequestBuilder extends BaseRequestBuilder<ComponentsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-host-list-components?view=graph-rest-beta|Find more info here}
     */
