...
// @ts-ignore
import { createHostCookieCollectionResponseFromDiscriminatorValue, type HostCookieCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { HostCookieItemRequestBuilderRequestsMetadata, type HostCookieItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface CookiesRequestBuilder extends BaseRequestBuilder<CookiesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-host-list-cookies?view=graph-rest-beta|Find more info here}
     */
