...
// @ts-ignore
import { createVulnerabilityComponentFromDiscriminatorValue, serializeVulnerabilityComponent, type VulnerabilityComponent } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface VulnerabilityComponentItemRequestBuilder extends BaseRequestBuilder<VulnerabilityComponentItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-vulnerabilitycomponent-get?view=graph-rest-beta|Find more info here}
     */
