...
// @ts-ignore
import { createVulnerabilityFromDiscriminatorValue, serializeVulnerability, type Vulnerability } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface VulnerabilityItemRequestBuilder extends BaseRequestBuilder<VulnerabilityItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-vulnerability-get?view=graph-rest-beta|Find more info here}
     */
