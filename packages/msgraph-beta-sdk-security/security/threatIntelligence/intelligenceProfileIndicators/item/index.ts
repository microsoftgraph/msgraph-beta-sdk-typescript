...
// @ts-ignore
import { createIntelligenceProfileIndicatorFromDiscriminatorValue, serializeIntelligenceProfileIndicator, type IntelligenceProfileIndicator } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface IntelligenceProfileIndicatorItemRequestBuilder extends BaseRequestBuilder<IntelligenceProfileIndicatorItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-intelligenceprofileindicator-get?view=graph-rest-beta|Find more info here}
     */
