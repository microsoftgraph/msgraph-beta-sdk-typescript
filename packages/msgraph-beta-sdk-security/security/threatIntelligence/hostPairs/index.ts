...
// @ts-ignore
import { createHostPairCollectionResponseFromDiscriminatorValue, createHostPairFromDiscriminatorValue, serializeHostPair, type HostPair, type HostPairCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
