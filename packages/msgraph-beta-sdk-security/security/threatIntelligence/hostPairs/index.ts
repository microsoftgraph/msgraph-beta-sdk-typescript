...
import { createHostPairCollectionResponseFromDiscriminatorValue, createHostPairFromDiscriminatorValue, serializeHostPair, type HostPair, type HostPairCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/';
 ...
 */
export const HostPairsRequestBuilderUriTemplate = "{+baseurl}/security/threatIntelligence/hostPairs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
