...
// @ts-ignore
import { createHostCookieFromDiscriminatorValue, serializeHostCookie, type HostCookie } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface HostCookieItemRequestBuilder extends BaseRequestBuilder<HostCookieItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-hostcookie-get?view=graph-rest-beta|Find more info here}
     */
