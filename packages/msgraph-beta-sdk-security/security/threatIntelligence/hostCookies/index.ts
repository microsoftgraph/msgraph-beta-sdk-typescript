...
// @ts-ignore
import { createHostCookieCollectionResponseFromDiscriminatorValue, createHostCookieFromDiscriminatorValue, serializeHostCookie, type HostCookie, type HostCookieCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
