...
// @ts-ignore
import { createHostSslCertificateFromDiscriminatorValue, serializeHostSslCertificate, type HostSslCertificate } from '@microsoft/msgraph-beta-sdk/models/security/';
// @ts-ignore
