...
// @ts-ignore
import { createHostPortFromDiscriminatorValue, serializeHostPort, type HostPort } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface HostPortItemRequestBuilder extends BaseRequestBuilder<HostPortItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-hostport-get?view=graph-rest-beta|Find more info here}
     */
