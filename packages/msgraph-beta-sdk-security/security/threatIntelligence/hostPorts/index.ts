...
// @ts-ignore
import { createHostPortCollectionResponseFromDiscriminatorValue, createHostPortFromDiscriminatorValue, serializeHostPort, type HostPort, type HostPortCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
