...
// @ts-ignore
import { createSubdomainFromDiscriminatorValue, serializeSubdomain, type Subdomain } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface SubdomainItemRequestBuilder extends BaseRequestBuilder<SubdomainItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-subdomain-get?view=graph-rest-beta|Find more info here}
     */
