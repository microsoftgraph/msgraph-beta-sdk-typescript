...
// @ts-ignore
import { createHostCollectionResponseFromDiscriminatorValue, type HostCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface RelatedHostsRequestBuilder extends BaseRequestBuilder<RelatedHostsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-sslcertificate-list-relatedhosts?view=graph-rest-beta|Find more info here}
     */
