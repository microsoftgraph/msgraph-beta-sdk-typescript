...
// @ts-ignore
import { createHostComponentFromDiscriminatorValue, serializeHostComponent, type HostComponent } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface HostComponentItemRequestBuilder extends BaseRequestBuilder<HostComponentItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-hostcomponent-get?view=graph-rest-beta|Find more info here}
     */
