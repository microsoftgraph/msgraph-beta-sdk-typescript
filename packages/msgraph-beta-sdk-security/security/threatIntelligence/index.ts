...
import { createThreatIntelligenceFromDiscriminatorValue, serializeThreatIntelligence, type ThreatIntelligence } from '@microsoft/msgraph-beta-sdk/models/security/';
import { ArticleIndicatorsRequestBuilderNavigationMetadata, ArticleIndicatorsRequestBuilderRequestsMetadata, type ArticleIndicatorsRequestBuilder } from './articleIndicators/';
...
import { HostComponentsRequestBuilderNavigationMetadata, HostComponentsRequestBuilderRequestsMetadata, type HostComponentsRequestBuilder } from './hostComponents/';
import { HostCookiesRequestBuilderNavigationMetadata, HostCookiesRequestBuilderRequestsMetadata, type HostCookiesRequestBuilder } from './hostCookies/';
...
import { HostPortsRequestBuilderNavigationMetadata, HostPortsRequestBuilderRequestsMetadata, type HostPortsRequestBuilder } from './hostPorts/';
import { HostsRequestBuilderNavigationMetadata, HostsRequestBuilderRequestsMetadata, type HostsRequestBuilder } from './hosts/';
import { HostSslCertificatesRequestBuilderNavigationMetadata, HostSslCertificatesRequestBuilderRequestsMetadata, type HostSslCertificatesRequestBuilder } from './hostSslCertificates/';
import { HostTrackersRequestBuilderNavigationMetadata, HostTrackersRequestBuilderRequestsMetadata, type HostTrackersRequestBuilder } from './hostTrackers/';
import { IntelligenceProfileIndicatorsRequestBuilderNavigationMetadata, IntelligenceProfileIndicatorsRequestBuilderRequestsMetadata, type IntelligenceProfileIndicatorsRequestBuilder } from './intelligenceProfileIndicators/';
import { IntelProfilesRequestBuilderNavigationMetadata, IntelProfilesRequestBuilderRequestsMetadata, type IntelProfilesRequestBuilder } from './intelProfiles/';
import { PassiveDnsRecordsRequestBuilderNavigationMetadata, PassiveDnsRecordsRequestBuilderRequestsMetadata, type PassiveDnsRecordsRequestBuilder } from './passiveDnsRecords/';
...
import { type VulnerabilitiesRequestBuilder, VulnerabilitiesRequestBuilderNavigationMetadata, VulnerabilitiesRequestBuilderRequestsMetadata } from './vulnerabilities/';
import { type WhoisHistoryRecordsRequestBuilder, WhoisHistoryRecordsRequestBuilderNavigationMetadata, WhoisHistoryRecordsRequestBuilderRequestsMetadata } from './whoisHistoryRecords/';
