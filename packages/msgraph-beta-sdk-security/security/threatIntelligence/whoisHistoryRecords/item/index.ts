...
// @ts-ignore
import { createWhoisHistoryRecordFromDiscriminatorValue, serializeWhoisHistoryRecord, type WhoisHistoryRecord } from '@microsoft/msgraph-beta-sdk/models/security/';
// @ts-ignore
