...
// @ts-ignore
import { createWhoisRecordCollectionResponseFromDiscriminatorValue, createWhoisRecordFromDiscriminatorValue, serializeWhoisRecord, type WhoisRecord, type WhoisRecordCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface WhoisRecordsRequestBuilder extends BaseRequestBuilder<WhoisRecordsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-threatintelligence-list-whoisrecords?view=graph-rest-beta|Find more info here}
     */
