...
// @ts-ignore
import { createWhoisRecordFromDiscriminatorValue, serializeWhoisRecord, type WhoisRecord } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface WhoisRecordItemRequestBuilder extends BaseRequestBuilder<WhoisRecordItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-whoisrecord-get?view=graph-rest-beta|Find more info here}
     */
