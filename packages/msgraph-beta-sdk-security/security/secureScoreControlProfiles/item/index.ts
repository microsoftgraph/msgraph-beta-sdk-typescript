...
// @ts-ignore
import { createSecureScoreControlProfileFromDiscriminatorValue, serializeSecureScoreControlProfile, type SecureScoreControlProfile } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SecureScoreControlProfileItemRequestBuilder extends BaseRequestBuilder<SecureScoreControlProfileItemRequestBuilder> {
     ...
     * @returns {Promise<SecureScoreControlProfile>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/securescorecontrolprofiles-update?view=graph-rest-beta|Find more info here}
     */
