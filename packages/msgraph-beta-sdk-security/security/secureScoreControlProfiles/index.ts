...
// @ts-ignore
import { createSecureScoreControlProfileCollectionResponseFromDiscriminatorValue, createSecureScoreControlProfileFromDiscriminatorValue, serializeSecureScoreControlProfile, type SecureScoreControlProfile, type SecureScoreControlProfileCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SecureScoreControlProfilesRequestBuilder extends BaseRequestBuilder<SecureScoreControlProfilesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/securescorecontrolprofiles-list?view=graph-rest-beta|Find more info here}
     */
