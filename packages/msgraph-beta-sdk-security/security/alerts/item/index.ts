...
// @ts-ignore
import { createAlertFromDiscriminatorValue, serializeAlert, type Alert } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AlertItemRequestBuilder extends BaseRequestBuilder<AlertItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/alert-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @deprecated The legacy Graph Security API is deprecated and will stop returning data on January 31, 2025. Please use the new Graph Security API. as of 2024-01/Deprecation on 2024-04-10 and will be removed 2026-04-10
     * @see {@link https://learn.microsoft.com/graph/api/alert-update?view=graph-rest-beta|Find more info here}
     */
