...
// @ts-ignore
import { createAlertCollectionResponseFromDiscriminatorValue, createAlertFromDiscriminatorValue, serializeAlert, type Alert, type AlertCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { type UpdateAlertsRequestBuilder, UpdateAlertsRequestBuilderRequestsMetadata } from './updateAlerts/index.js';
// @ts-ignore
...
export interface AlertsRequestBuilder extends BaseRequestBuilder<AlertsRequestBuilder> {
     ...
     * @deprecated The legacy Graph Security API is deprecated and will stop returning data on January 31, 2025. Please use the new Graph Security API. as of 2024-01/Deprecation on 2024-04-10 and will be removed 2026-04-10
     * @see {@link https://learn.microsoft.com/graph/api/alert-list?view=graph-rest-beta|Find more info here}
     */
