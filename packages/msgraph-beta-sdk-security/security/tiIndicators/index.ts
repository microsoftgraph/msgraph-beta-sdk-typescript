...
// @ts-ignore
import { createTiIndicatorCollectionResponseFromDiscriminatorValue, createTiIndicatorFromDiscriminatorValue, serializeTiIndicator, type TiIndicator, type TiIndicatorCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { DeleteTiIndicatorsRequestBuilderRequestsMetadata, type DeleteTiIndicatorsRequestBuilder } from './deleteTiIndicators/index.js';
// @ts-ignore
import { DeleteTiIndicatorsByExternalIdRequestBuilderRequestsMetadata, type DeleteTiIndicatorsByExternalIdRequestBuilder } from './deleteTiIndicatorsByExternalId/index.js';
// @ts-ignore
import { TiIndicatorItemRequestBuilderRequestsMetadata, type TiIndicatorItemRequestBuilder } from './item/index.js';
// @ts-ignore
import { SubmitTiIndicatorsRequestBuilderRequestsMetadata, type SubmitTiIndicatorsRequestBuilder } from './submitTiIndicators/index.js';
// @ts-ignore
import { type UpdateTiIndicatorsRequestBuilder, UpdateTiIndicatorsRequestBuilderRequestsMetadata } from './updateTiIndicators/index.js';
// @ts-ignore
