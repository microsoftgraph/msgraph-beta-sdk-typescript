...
// @ts-ignore
import { createRetentionEventTypeFromDiscriminatorValue, serializeRetentionEventType, type RetentionEventType } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface RetentionEventTypeItemRequestBuilder extends BaseRequestBuilder<RetentionEventTypeItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-retentioneventtype-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-retentioneventtype-get?view=graph-rest-beta|Find more info here}
     */
