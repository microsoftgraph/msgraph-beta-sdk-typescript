...
// @ts-ignore
import { createIncidentFromDiscriminatorValue, type Incident } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
 ...
 */
export const IncidentRequestBuilderUriTemplate = "{+baseurl}/security/incidentTasks/{incidentTask%2Did}/incident{?%24expand,%24select}";
/**
 * Mapper for query parameters from symbol name to serialization name represented as a constant.
 */
const IncidentRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "expand": "%24expand",
    "select": "%24select",
};
/**
 ...
 */
export const IncidentRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: IncidentRequestBuilderUriTemplate,
        ...
        queryParametersMapper: IncidentRequestBuilderGetQueryParametersMapper,
    },
};
/* tslint:enable */
/* eslint-enable */
