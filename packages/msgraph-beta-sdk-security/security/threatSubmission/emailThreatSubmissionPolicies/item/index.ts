...
// @ts-ignore
import { createEmailThreatSubmissionPolicyFromDiscriminatorValue, serializeEmailThreatSubmissionPolicy, type EmailThreatSubmissionPolicy } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface EmailThreatSubmissionPolicyItemRequestBuilder extends BaseRequestBuilder<EmailThreatSubmissionPolicyItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-emailthreatsubmissionpolicy-get?view=graph-rest-beta|Find more info here}
     */
