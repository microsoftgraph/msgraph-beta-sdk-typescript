...
// @ts-ignore
import { createEmailThreatSubmissionPolicyCollectionResponseFromDiscriminatorValue, createEmailThreatSubmissionPolicyFromDiscriminatorValue, serializeEmailThreatSubmissionPolicy, type EmailThreatSubmissionPolicy, type EmailThreatSubmissionPolicyCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { EmailThreatSubmissionPolicyItemRequestBuilderRequestsMetadata, type EmailThreatSubmissionPolicyItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface EmailThreatSubmissionPoliciesRequestBuilder extends BaseRequestBuilder<EmailThreatSubmissionPoliciesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-emailthreatsubmissionpolicy-list?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const EmailThreatSubmissionPoliciesRequestBuilderUriTemplate = "{+baseurl}/security/threatSubmission/emailThreatSubmissionPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
