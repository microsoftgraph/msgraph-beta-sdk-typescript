...
// @ts-ignore
import { createIncidentFromDiscriminatorValue, serializeIncident, type Incident } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface IncidentItemRequestBuilder extends BaseRequestBuilder<IncidentItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-incident-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Incident>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-incident-update?view=graph-rest-beta|Find more info here}
     */
