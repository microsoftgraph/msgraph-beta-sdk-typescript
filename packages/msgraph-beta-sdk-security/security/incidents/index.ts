...
// @ts-ignore
import { createIncidentCollectionResponseFromDiscriminatorValue, createIncidentFromDiscriminatorValue, serializeIncident, type Incident, type IncidentCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface IncidentsRequestBuilder extends BaseRequestBuilder<IncidentsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-list-incidents?view=graph-rest-beta|Find more info here}
     */
