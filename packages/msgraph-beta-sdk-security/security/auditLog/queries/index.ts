...
// @ts-ignore
import { createAuditLogQueryCollectionResponseFromDiscriminatorValue, createAuditLogQueryFromDiscriminatorValue, serializeAuditLogQuery, type AuditLogQuery, type AuditLogQueryCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface QueriesRequestBuilder extends BaseRequestBuilder<QueriesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-auditcoreroot-list-auditlogqueries?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-auditcoreroot-post-auditlogqueries?view=graph-rest-beta|Find more info here}
     */
