...
// @ts-ignore
import { createWorkspaceCollectionResponseFromDiscriminatorValue, createWorkspaceFromDiscriminatorValue, serializeWorkspace, type Workspace, type WorkspaceCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/securityCopilot/index.js';
// @ts-ignore
...
export interface WorkspacesRequestBuilder extends BaseRequestBuilder<WorkspacesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/securitycopilot-list-workspaces?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const WorkspacesRequestBuilderUriTemplate = "{+baseurl}/security/securityCopilot/workspaces{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
