...
// @ts-ignore
import { createSessionFromDiscriminatorValue, serializeSession, type Session } from '@microsoft/msgraph-beta-sdk/models/security/securityCopilot/index.js';
// @ts-ignore
import { PromptsRequestBuilderNavigationMetadata, PromptsRequestBuilderRequestsMetadata, type PromptsRequestBuilder } from './prompts/index.js';
// @ts-ignore
...
export interface SessionItemRequestBuilder extends BaseRequestBuilder<SessionItemRequestBuilder> {
     ...
     */
    get prompts(): PromptsRequestBuilder;
    /**
 ...
 */
export const SessionItemRequestBuilderUriTemplate = "{+baseurl}/security/securityCopilot/workspaces/{workspace%2Did}/sessions/{session%2Did}{?%24expand,%24select}";
/**
...
export const SessionItemRequestBuilderNavigationMetadata: Record<Exclude<keyof SessionItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    prompts: {
        requestsMetadata: PromptsRequestBuilderRequestsMetadata,
        navigationMetadata: PromptsRequestBuilderNavigationMetadata,
    },
};
/**
