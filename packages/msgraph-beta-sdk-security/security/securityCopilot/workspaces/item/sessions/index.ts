...
// @ts-ignore
import { createSessionCollectionResponseFromDiscriminatorValue, createSessionFromDiscriminatorValue, serializeSession, type Session, type SessionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/securityCopilot/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { SessionItemRequestBuilderNavigationMetadata, SessionItemRequestBuilderRequestsMetadata, type SessionItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const SessionsRequestBuilderUriTemplate = "{+baseurl}/security/securityCopilot/workspaces/{workspace%2Did}/sessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
