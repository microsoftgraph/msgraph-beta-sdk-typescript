...
// @ts-ignore
import { createFilePlanDescriptorFromDiscriminatorValue, serializeFilePlanDescriptor, type FilePlanDescriptor } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
