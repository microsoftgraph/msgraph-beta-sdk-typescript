...
// @ts-ignore
import { createRetentionLabelFromDiscriminatorValue, serializeRetentionLabel, type RetentionLabel } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface RetentionLabelItemRequestBuilder extends BaseRequestBuilder<RetentionLabelItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-retentionlabel-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<RetentionLabel>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-retentionlabel-update?view=graph-rest-beta|Find more info here}
     */
