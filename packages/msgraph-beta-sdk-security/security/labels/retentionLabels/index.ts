...
// @ts-ignore
import { createRetentionLabelCollectionResponseFromDiscriminatorValue, createRetentionLabelFromDiscriminatorValue, serializeRetentionLabel, type RetentionLabel, type RetentionLabelCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface RetentionLabelsRequestBuilder extends BaseRequestBuilder<RetentionLabelsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-labelsroot-list-retentionlabel?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-labelsroot-post-retentionlabel?view=graph-rest-beta|Find more info here}
     */
