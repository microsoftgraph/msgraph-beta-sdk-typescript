...
// @ts-ignore
import { createFilePlanReferenceTemplateFromDiscriminatorValue, serializeFilePlanReferenceTemplate, type FilePlanReferenceTemplate } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface FilePlanReferenceTemplateItemRequestBuilder extends BaseRequestBuilder<FilePlanReferenceTemplateItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-fileplanreferencetemplate-get?view=graph-rest-beta|Find more info here}
     */
