...
// @ts-ignore
import { createFilePlanReferenceTemplateCollectionResponseFromDiscriminatorValue, createFilePlanReferenceTemplateFromDiscriminatorValue, serializeFilePlanReferenceTemplate, type FilePlanReferenceTemplate, type FilePlanReferenceTemplateCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface FilePlanReferencesRequestBuilder extends BaseRequestBuilder<FilePlanReferencesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-labelsroot-list-fileplanreferences?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-labelsroot-post-fileplanreferences?view=graph-rest-beta|Find more info here}
     */
