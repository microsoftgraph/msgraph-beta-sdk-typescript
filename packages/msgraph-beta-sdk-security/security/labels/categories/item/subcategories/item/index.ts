...
// @ts-ignore
import { createSubcategoryTemplateFromDiscriminatorValue, serializeSubcategoryTemplate, type SubcategoryTemplate } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface SubcategoryTemplateItemRequestBuilder extends BaseRequestBuilder<SubcategoryTemplateItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-subcategorytemplate-get?view=graph-rest-beta|Find more info here}
     */
