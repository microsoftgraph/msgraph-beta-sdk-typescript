...
// @ts-ignore
import { createCategoryTemplateCollectionResponseFromDiscriminatorValue, createCategoryTemplateFromDiscriminatorValue, serializeCategoryTemplate, type CategoryTemplate, type CategoryTemplateCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface CategoriesRequestBuilder extends BaseRequestBuilder<CategoriesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-labelsroot-list-categories?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-labelsroot-post-categories?view=graph-rest-beta|Find more info here}
     */
