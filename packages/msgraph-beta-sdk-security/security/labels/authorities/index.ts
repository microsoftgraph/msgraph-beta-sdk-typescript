...
// @ts-ignore
import { createAuthorityTemplateCollectionResponseFromDiscriminatorValue, createAuthorityTemplateFromDiscriminatorValue, serializeAuthorityTemplate, type AuthorityTemplate, type AuthorityTemplateCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface AuthoritiesRequestBuilder extends BaseRequestBuilder<AuthoritiesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-labelsroot-list-authorities?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-labelsroot-post-authorities?view=graph-rest-beta|Find more info here}
     */
