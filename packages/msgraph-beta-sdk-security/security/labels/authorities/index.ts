...
import { createAuthorityTemplateCollectionResponseFromDiscriminatorValue, createAuthorityTemplateFromDiscriminatorValue, serializeAuthorityTemplate, type AuthorityTemplate, type AuthorityTemplateCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/';
import { CountRequestBuilderRequestsMetadata, CountRequestBuilderUriTemplate, type CountRequestBuilder } from './count/';
import { AuthorityTemplateItemRequestBuilderRequestsMetadata, AuthorityTemplateItemRequestBuilderUriTemplate, type AuthorityTemplateItemRequestBuilder } from './item/';
...
export interface AuthoritiesRequestBuilder extends BaseRequestBuilder<AuthoritiesRequestBuilder> {
     ...
     * @returns a AuthorityTemplateItemRequestBuilder
     */
     ...
     * @returns a Promise of AuthorityTemplateCollectionResponse
     ...
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns a Promise of AuthorityTemplate
 ...
 */
export const AuthoritiesRequestBuilderUriTemplate = "{+baseurl}/security/labels/authorities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
