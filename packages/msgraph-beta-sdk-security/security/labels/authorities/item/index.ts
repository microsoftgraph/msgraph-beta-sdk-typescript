...
// @ts-ignore
import { createAuthorityTemplateFromDiscriminatorValue, serializeAuthorityTemplate, type AuthorityTemplate } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface AuthorityTemplateItemRequestBuilder extends BaseRequestBuilder<AuthorityTemplateItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-authoritytemplate-get?view=graph-rest-beta|Find more info here}
     */
