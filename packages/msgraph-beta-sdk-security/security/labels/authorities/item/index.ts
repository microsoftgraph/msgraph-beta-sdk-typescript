...
import { createAuthorityTemplateFromDiscriminatorValue, serializeAuthorityTemplate, type AuthorityTemplate } from '@microsoft/msgraph-beta-sdk/models/security/';
 ...
 */
export const AuthorityTemplateItemRequestBuilderUriTemplate = "{+baseurl}/security/labels/authorities/{authorityTemplate%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
