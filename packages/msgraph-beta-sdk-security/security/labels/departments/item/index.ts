...
// @ts-ignore
import { createDepartmentTemplateFromDiscriminatorValue, serializeDepartmentTemplate, type DepartmentTemplate } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface DepartmentTemplateItemRequestBuilder extends BaseRequestBuilder<DepartmentTemplateItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-departmenttemplate-get?view=graph-rest-beta|Find more info here}
     */
