...
// @ts-ignore
import { createDepartmentTemplateCollectionResponseFromDiscriminatorValue, createDepartmentTemplateFromDiscriminatorValue, serializeDepartmentTemplate, type DepartmentTemplate, type DepartmentTemplateCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface DepartmentsRequestBuilder extends BaseRequestBuilder<DepartmentsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-labelsroot-list-departments?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-labelsroot-post-departments?view=graph-rest-beta|Find more info here}
     */
