...
// @ts-ignore
import { createRetentionEventFromDiscriminatorValue, serializeRetentionEvent, type RetentionEvent } from '@microsoft/msgraph-beta-sdk/models/security/index.js';
// @ts-ignore
...
export interface RetentionEventItemRequestBuilder extends BaseRequestBuilder<RetentionEventItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/security-retentionevent-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/security-retentionevent-get?view=graph-rest-beta|Find more info here}
     */
