...
// @ts-ignore
import { createDeviceMetadataFromDiscriminatorValue, createEvaluationScopeFromDiscriminatorValue, createIntegratedApplicationMetadataFromDiscriminatorValue, createPolicyLocationFromDiscriminatorValue, createPolicyTenantScopeFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, PolicyPivotPropertyObject, serializeBaseCollectionPaginationCountResponse, serializeDeviceMetadata, serializeEvaluationScope, serializeIntegratedApplicationMetadata, serializePolicyLocation, serializePolicyTenantScope, type BaseCollectionPaginationCountResponse, type DeviceMetadata, type EvaluationScope, type IntegratedApplicationMetadata, type PolicyLocation, type PolicyPivotProperty, type PolicyTenantScope, type UserActivityTypes, UserActivityTypesObject } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export function deserializeIntoComputePostRequestBody(computePostRequestBody: Partial<ComputePostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "evaluationScope": n => { computePostRequestBody.evaluationScope = n.getObjectValue<EvaluationScope>(createEvaluationScopeFromDiscriminatorValue); },
...
export function deserializeIntoComputePostResponse(computePostResponse: Partial<ComputePostResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "value": n => { computePostResponse.value = n.getCollectionOfObjectValues<PolicyTenantScope>(createPolicyTenantScopeFromDiscriminatorValue); },
    }
}
/**
...
export function serializeComputePostRequestBody(writer: SerializationWriter, computePostRequestBody: Partial<ComputePostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeObjectValue<EvaluationScope>("evaluationScope", computePostRequestBody.evaluationScope, serializeEvaluationScope);
