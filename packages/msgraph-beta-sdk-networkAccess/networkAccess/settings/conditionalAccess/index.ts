...
// @ts-ignore
import { createConditionalAccessSettingsFromDiscriminatorValue, serializeConditionalAccessSettings, type ConditionalAccessSettings } from '@microsoft/msgraph-beta-sdk/models/networkaccess/index.js';
// @ts-ignore
...
export interface ConditionalAccessRequestBuilder extends BaseRequestBuilder<ConditionalAccessRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/networkaccess-conditionalaccesssettings-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ConditionalAccessSettings>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/networkaccess-conditionalaccesssettings-update?view=graph-rest-beta|Find more info here}
     */
