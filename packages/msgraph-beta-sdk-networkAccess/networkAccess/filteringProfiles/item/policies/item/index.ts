 ...
 */
export const PolicyLinkItemRequestBuilderUriTemplate = "{+baseurl}/networkAccess/filteringProfiles/{filteringProfile%2Did}/policies/{policyLink%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
