...
// @ts-ignore
import { createFilteringProfileFromDiscriminatorValue, serializeFilteringProfile, type FilteringProfile } from '@microsoft/msgraph-beta-sdk/models/networkaccess/index.js';
// @ts-ignore
...
export interface FilteringProfileItemRequestBuilder extends BaseRequestBuilder<FilteringProfileItemRequestBuilder> {
     ...
     * @returns {Promise<FilteringProfile>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/networkaccess-filteringprofile-update?view=graph-rest-beta|Find more info here}
     */
