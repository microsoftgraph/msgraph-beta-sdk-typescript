...
// @ts-ignore
import { createFilteringProfileCollectionResponseFromDiscriminatorValue, createFilteringProfileFromDiscriminatorValue, serializeFilteringProfile, type FilteringProfile, type FilteringProfileCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/networkaccess/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { FilteringProfileItemRequestBuilderNavigationMetadata, FilteringProfileItemRequestBuilderRequestsMetadata, type FilteringProfileItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface FilteringProfilesRequestBuilder extends BaseRequestBuilder<FilteringProfilesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/networkaccess-filteringprofile-list?view=graph-rest-beta|Find more info here}
     */
