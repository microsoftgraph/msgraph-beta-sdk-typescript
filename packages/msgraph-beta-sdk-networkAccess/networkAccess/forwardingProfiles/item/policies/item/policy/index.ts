 ...
 */
export const PolicyRequestBuilderUriTemplate = "{+baseurl}/networkAccess/forwardingProfiles/{forwardingProfile%2Did}/policies/{policyLink%2Did}/policy{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
