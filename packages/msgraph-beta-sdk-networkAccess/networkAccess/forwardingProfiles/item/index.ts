...
export interface ForwardingProfileItemRequestBuilder extends BaseRequestBuilder<ForwardingProfileItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/networkaccess-forwardingprofile-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ForwardingProfile>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/networkaccess-forwardingprofile-update?view=graph-rest-beta|Find more info here}
     */
