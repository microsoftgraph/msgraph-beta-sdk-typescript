...
// @ts-ignore
import { createNetworkAccessTrafficCollectionResponseFromDiscriminatorValue, createNetworkAccessTrafficFromDiscriminatorValue, serializeNetworkAccessTraffic, type NetworkAccessTraffic, type NetworkAccessTrafficCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/networkaccess/index.js';
// @ts-ignore
...
export interface TrafficRequestBuilder extends BaseRequestBuilder<TrafficRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/networkaccess-logs-list-traffic?view=graph-rest-beta|Find more info here}
     */
