 ...
 */
export const MailboxSettingsRequestBuilderUriTemplate = "{+baseurl}/networkAccess/logs/traffic/{networkAccessTraffic%2DtransactionId}/user/mailboxSettings{?%24expand,%24select}";
/**
