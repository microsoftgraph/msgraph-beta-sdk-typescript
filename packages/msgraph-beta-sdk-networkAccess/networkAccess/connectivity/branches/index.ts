...
// @ts-ignore
import { createBranchSiteCollectionResponseFromDiscriminatorValue, createBranchSiteFromDiscriminatorValue, serializeBranchSite, type BranchSite, type BranchSiteCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/networkaccess/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { BranchSiteItemRequestBuilderNavigationMetadata, BranchSiteItemRequestBuilderRequestsMetadata, type BranchSiteItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface BranchesRequestBuilder extends BaseRequestBuilder<BranchesRequestBuilder> {
     ...
     * @deprecated The Branches API is deprecated and will stop returning data on March 20, 2024. Please use the new Remote Network API. as of 2022-06/PrivatePreview:NetworkAccess on 2023-12-19 and will be removed 2024-03-20
     * @see {@link https://learn.microsoft.com/graph/api/networkaccess-connectivity-list-branches?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @deprecated The Branches API is deprecated and will stop returning data on March 20, 2024. Please use the new Remote Network API. as of 2022-06/PrivatePreview:NetworkAccess on 2023-12-19 and will be removed 2024-03-20
     * @see {@link https://learn.microsoft.com/graph/api/networkaccess-connectivity-post-branches?view=graph-rest-beta|Find more info here}
     */
