 ...
 */
export const CountRequestBuilderUriTemplate = "{+baseurl}/networkAccess/connectivity/branches/{branchSite%2Did}/connectivityConfiguration/links/$count{?%24search,%24filter}";
/* tslint:enable */
/* eslint-enable */
