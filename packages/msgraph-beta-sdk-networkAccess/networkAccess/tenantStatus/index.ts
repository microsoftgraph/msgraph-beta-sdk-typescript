...
// @ts-ignore
import { createTenantStatusFromDiscriminatorValue, serializeTenantStatus, type TenantStatus } from '@microsoft/msgraph-beta-sdk/models/networkaccess/index.js';
// @ts-ignore
...
export interface TenantStatusRequestBuilder extends BaseRequestBuilder<TenantStatusRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/networkaccess-tenantstatus-get?view=graph-rest-beta|Find more info here}
     */
