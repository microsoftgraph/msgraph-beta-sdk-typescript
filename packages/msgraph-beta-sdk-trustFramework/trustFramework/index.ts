...
// @ts-ignore
import { createTrustFrameworkFromDiscriminatorValue, serializeTrustFramework, type TrustFramework } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { KeySetsRequestBuilderNavigationMetadata, KeySetsRequestBuilderRequestsMetadata, type KeySetsRequestBuilder } from './keySets/index.js';
// @ts-ignore
...
export interface TrustFrameworkRequestBuilder extends BaseRequestBuilder<TrustFrameworkRequestBuilder> {
     ...
     * @returns {Promise<TrustFramework>}
