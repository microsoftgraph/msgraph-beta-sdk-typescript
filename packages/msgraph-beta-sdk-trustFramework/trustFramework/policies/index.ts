...
// @ts-ignore
import { createTrustFrameworkPolicyCollectionResponseFromDiscriminatorValue, createTrustFrameworkPolicyFromDiscriminatorValue, serializeTrustFrameworkPolicy, type TrustFrameworkPolicy, type TrustFrameworkPolicyCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { TrustFrameworkPolicyItemRequestBuilderNavigationMetadata, TrustFrameworkPolicyItemRequestBuilderRequestsMetadata, type TrustFrameworkPolicyItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface PoliciesRequestBuilder extends BaseRequestBuilder<PoliciesRequestBuilder> {
     ...
     * @returns {Promise<TrustFrameworkPolicyCollectionResponse>}
 ...
 */
export const PoliciesRequestBuilderUriTemplate = "{+baseurl}/trustFramework/policies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
