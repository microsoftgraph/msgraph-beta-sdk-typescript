...
// @ts-ignore
import { createTrustFrameworkKeyFromDiscriminatorValue, type TrustFrameworkKey } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GetActiveKeyRequestBuilder extends BaseRequestBuilder<GetActiveKeyRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/trustframeworkkeyset-getactivekey?view=graph-rest-beta|Find more info here}
     */
