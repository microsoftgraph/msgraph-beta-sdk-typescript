...
// @ts-ignore
import { createBrowserSiteListFromDiscriminatorValue, serializeBrowserSiteList, type BrowserSiteList } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface BrowserSiteListItemRequestBuilder extends BaseRequestBuilder<BrowserSiteListItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/internetexplorermode-delete-sitelists?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/browsersitelist-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<BrowserSiteList>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/browsersitelist-update?view=graph-rest-beta|Find more info here}
     */
