...
// @ts-ignore
import { createBrowserSharedCookieCollectionResponseFromDiscriminatorValue, createBrowserSharedCookieFromDiscriminatorValue, serializeBrowserSharedCookie, type BrowserSharedCookie, type BrowserSharedCookieCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SharedCookiesRequestBuilder extends BaseRequestBuilder<SharedCookiesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/browsersitelist-list-sharedcookies?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/browsersitelist-post-sharedcookies?view=graph-rest-beta|Find more info here}
     */
