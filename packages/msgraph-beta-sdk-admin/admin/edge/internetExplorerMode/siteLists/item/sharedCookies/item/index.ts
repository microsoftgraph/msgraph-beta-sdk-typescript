...
// @ts-ignore
import { createBrowserSharedCookieFromDiscriminatorValue, serializeBrowserSharedCookie, type BrowserSharedCookie } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface BrowserSharedCookieItemRequestBuilder extends BaseRequestBuilder<BrowserSharedCookieItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/browsersitelist-delete-sharedcookies?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/browsersharedcookie-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<BrowserSharedCookie>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/browsersharedcookie-update?view=graph-rest-beta|Find more info here}
     */
