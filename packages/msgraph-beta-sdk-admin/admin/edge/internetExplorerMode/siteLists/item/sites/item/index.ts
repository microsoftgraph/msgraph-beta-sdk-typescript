...
// @ts-ignore
import { createBrowserSiteFromDiscriminatorValue, serializeBrowserSite, type BrowserSite } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface BrowserSiteItemRequestBuilder extends BaseRequestBuilder<BrowserSiteItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/browsersitelist-delete-sites?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/browsersite-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<BrowserSite>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/browsersite-update?view=graph-rest-beta|Find more info here}
     */
