...
// @ts-ignore
import { createServiceUpdateMessageCollectionResponseFromDiscriminatorValue, createServiceUpdateMessageFromDiscriminatorValue, serializeServiceUpdateMessage, type ServiceUpdateMessage, type ServiceUpdateMessageCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { ServiceUpdateMessageItemRequestBuilderNavigationMetadata, ServiceUpdateMessageItemRequestBuilderRequestsMetadata, type ServiceUpdateMessageItemRequestBuilder } from './item/index.js';
// @ts-ignore
import { MarkReadRequestBuilderRequestsMetadata, type MarkReadRequestBuilder } from './markRead/index.js';
// @ts-ignore
import { MarkUnreadRequestBuilderRequestsMetadata, type MarkUnreadRequestBuilder } from './markUnread/index.js';
// @ts-ignore
import { type UnarchiveRequestBuilder, UnarchiveRequestBuilderRequestsMetadata } from './unarchive/index.js';
// @ts-ignore
import { type UnfavoriteRequestBuilder, UnfavoriteRequestBuilderRequestsMetadata } from './unfavorite/index.js';
// @ts-ignore
