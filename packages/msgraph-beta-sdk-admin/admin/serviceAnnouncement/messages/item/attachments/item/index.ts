...
// @ts-ignore
import { createServiceAnnouncementAttachmentFromDiscriminatorValue, serializeServiceAnnouncementAttachment, type ServiceAnnouncementAttachment } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ServiceAnnouncementAttachmentItemRequestBuilder extends BaseRequestBuilder<ServiceAnnouncementAttachmentItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/serviceannouncementattachment-get?view=graph-rest-beta|Find more info here}
     */
