...
// @ts-ignore
import { createServiceUpdateMessageFromDiscriminatorValue, serializeServiceUpdateMessage, type ServiceUpdateMessage } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ServiceUpdateMessageItemRequestBuilder extends BaseRequestBuilder<ServiceUpdateMessageItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/serviceupdatemessage-get?view=graph-rest-beta|Find more info here}
     */
