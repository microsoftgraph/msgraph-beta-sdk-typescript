...
// @ts-ignore
import { createServiceHealthIssueCollectionResponseFromDiscriminatorValue, createServiceHealthIssueFromDiscriminatorValue, serializeServiceHealthIssue, type ServiceHealthIssue, type ServiceHealthIssueCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface IssuesRequestBuilder extends BaseRequestBuilder<IssuesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/serviceannouncement-list-issues?view=graph-rest-beta|Find more info here}
     */
