...
// @ts-ignore
import { createServiceHealthIssueFromDiscriminatorValue, serializeServiceHealthIssue, type ServiceHealthIssue } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ServiceHealthIssueItemRequestBuilder extends BaseRequestBuilder<ServiceHealthIssueItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/servicehealthissue-get?view=graph-rest-beta|Find more info here}
     */
