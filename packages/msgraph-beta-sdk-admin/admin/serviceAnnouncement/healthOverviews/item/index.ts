...
// @ts-ignore
import { createServiceHealthFromDiscriminatorValue, serializeServiceHealth, type ServiceHealth } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ServiceHealthItemRequestBuilder extends BaseRequestBuilder<ServiceHealthItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/servicehealth-get?view=graph-rest-beta|Find more info here}
     */
