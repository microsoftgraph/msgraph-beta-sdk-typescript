...
export interface UpdatableAssetsRequestBuilder extends BaseRequestBuilder<UpdatableAssetsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/adminwindowsupdates-list-updatableassets?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/adminwindowsupdates-post-updatableassets-updatableassetgroup?view=graph-rest-beta|Find more info here}
     */
