 ...
 */
export const MicrosoftGraphWindowsUpdatesUnenrollAssetsRequestBuilderUriTemplate = "{+baseurl}/admin/windows/updates/updatableAssets/microsoft.graph.windowsUpdates.unenrollAssets";
/**
