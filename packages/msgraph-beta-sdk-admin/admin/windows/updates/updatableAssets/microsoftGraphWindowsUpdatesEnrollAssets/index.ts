 ...
 */
export const MicrosoftGraphWindowsUpdatesEnrollAssetsRequestBuilderUriTemplate = "{+baseurl}/admin/windows/updates/updatableAssets/microsoft.graph.windowsUpdates.enrollAssets";
/**
