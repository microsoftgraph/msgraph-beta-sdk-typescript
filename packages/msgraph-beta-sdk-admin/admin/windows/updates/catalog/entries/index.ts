...
// @ts-ignore
import { createCatalogEntryCollectionResponseFromDiscriminatorValue, createCatalogEntryFromDiscriminatorValue, serializeCatalogEntry, type CatalogEntry, type CatalogEntryCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/windowsUpdates/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { CatalogEntryItemRequestBuilderRequestsMetadata, type CatalogEntryItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface EntriesRequestBuilder extends BaseRequestBuilder<EntriesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/windowsupdates-catalog-list-entries?view=graph-rest-beta|Find more info here}
     */
