...
// @ts-ignore
import { type UpdateCategory, UpdateCategoryObject } from '@microsoft/msgraph-beta-sdk/models/windowsUpdates/index.js';
// @ts-ignore
...
export function deserializeIntoUnenrollAssetsByIdPostRequestBody(unenrollAssetsByIdPostRequestBody: Partial<UnenrollAssetsByIdPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "ids": n => { unenrollAssetsByIdPostRequestBody.ids = n.getCollectionOfPrimitiveValues<string>("string"); },
 ...
 */
export const MicrosoftGraphWindowsUpdatesUnenrollAssetsByIdRequestBuilderUriTemplate = "{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/exclusions/microsoft.graph.windowsUpdates.unenrollAssetsById";
/**
