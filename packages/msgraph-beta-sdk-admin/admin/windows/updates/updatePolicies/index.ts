...
// @ts-ignore
import { createUpdatePolicyCollectionResponseFromDiscriminatorValue, createUpdatePolicyFromDiscriminatorValue, serializeUpdatePolicy, type UpdatePolicy, type UpdatePolicyCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/windowsUpdates/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { type UpdatePolicyItemRequestBuilder, UpdatePolicyItemRequestBuilderNavigationMetadata, UpdatePolicyItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
...
export interface UpdatePoliciesRequestBuilder extends BaseRequestBuilder<UpdatePoliciesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/adminwindowsupdates-list-updatepolicies?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/adminwindowsupdates-post-updatepolicies?view=graph-rest-beta|Find more info here}
     */
