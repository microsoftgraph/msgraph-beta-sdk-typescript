...
// @ts-ignore
import { createM365AppsInstallationOptionsFromDiscriminatorValue, serializeM365AppsInstallationOptions, type M365AppsInstallationOptions } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface InstallationOptionsRequestBuilder extends BaseRequestBuilder<InstallationOptionsRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/m365appsinstallationoptions-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<M365AppsInstallationOptions>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/m365appsinstallationoptions-update?view=graph-rest-beta|Find more info here}
     */
