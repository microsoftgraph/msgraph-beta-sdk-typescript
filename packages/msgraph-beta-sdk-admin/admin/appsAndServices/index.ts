...
// @ts-ignore
import { createAdminAppsAndServicesFromDiscriminatorValue, serializeAdminAppsAndServices, type AdminAppsAndServices } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AppsAndServicesRequestBuilder extends BaseRequestBuilder<AppsAndServicesRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/adminappsandservices-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<AdminAppsAndServices>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/adminappsandservices-update?view=graph-rest-beta|Find more info here}
     */
