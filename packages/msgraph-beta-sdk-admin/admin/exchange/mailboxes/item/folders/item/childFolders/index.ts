...
// @ts-ignore
import { createMailboxFolderCollectionResponseFromDiscriminatorValue, createMailboxFolderFromDiscriminatorValue, serializeMailboxFolder, type MailboxFolder, type MailboxFolderCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ChildFoldersRequestBuilder extends BaseRequestBuilder<ChildFoldersRequestBuilder> {
     ...
     * @deprecated Private preview for Import Export APIs as of 2021-08/PrivatePreview:importExport on 2021-08-19 and will be removed 2021-11-15
     */
     post(body: MailboxFolder, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<MailboxFolder | undefined>;
    /**
     * Get the mailboxFolder collection under the specified mailboxFolder in a mailbox.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     * @deprecated Private preview for Import Export APIs as of 2021-08/PrivatePreview:importExport on 2021-08-19 and will be removed 2021-11-15
     */
     toPostRequestInformation(body: MailboxFolder, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Get the mailboxFolder collection under the specified mailboxFolder in a mailbox.
 */
 ...
 */
export const ChildFoldersRequestBuilderUriTemplate = "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/{mailboxFolder%2Did}/childFolders{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
...
export const ChildFoldersRequestBuilderNavigationMetadata: Record<Exclude<keyof ChildFoldersRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byMailboxFolderId1: {
        ...
        pathParametersMappings: ["mailboxFolder%2Did1"],
    },
    count: {
