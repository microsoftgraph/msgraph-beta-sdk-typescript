...
// @ts-ignore
import { createMailboxItemCollectionResponseFromDiscriminatorValue, type MailboxItemCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ItemsRequestBuilder extends BaseRequestBuilder<ItemsRequestBuilder> {
     ...
     * @deprecated Private preview for Import Export APIs as of 2021-08/PrivatePreview:importExport
     * @see {@link https://learn.microsoft.com/graph/api/mailboxfolder-list-items?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const ItemsRequestBuilderUriTemplate = "{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/{mailboxFolder%2Did}/items{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
