...
// @ts-ignore
import { createConfigurationDriftFromDiscriminatorValue, serializeConfigurationDrift, type ConfigurationDrift } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ConfigurationDriftItemRequestBuilder extends BaseRequestBuilder<ConfigurationDriftItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/configurationdrift-get?view=graph-rest-beta|Find more info here}
     */
