...
// @ts-ignore
import { createProfileCardPropertyFromDiscriminatorValue, serializeProfileCardProperty, type ProfileCardProperty } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ProfileCardPropertyItemRequestBuilder extends BaseRequestBuilder<ProfileCardPropertyItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/profilecardproperty-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/profilecardproperty-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ProfileCardProperty>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/profilecardproperty-update?view=graph-rest-beta|Find more info here}
     */
