...
// @ts-ignore
import { createProfileCardPropertyCollectionResponseFromDiscriminatorValue, createProfileCardPropertyFromDiscriminatorValue, serializeProfileCardProperty, type ProfileCardProperty, type ProfileCardPropertyCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ProfileCardPropertiesRequestBuilder extends BaseRequestBuilder<ProfileCardPropertiesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/peopleadminsettings-list-profilecardproperties?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/peopleadminsettings-post-profilecardproperties?view=graph-rest-beta|Find more info here}
     */
