...
// @ts-ignore
import { createGroupCollectionResponseFromDiscriminatorValue, createGroupFromDiscriminatorValue, serializeGroup, type Group, type GroupCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/termStore/';
// @ts-ignore
...
export interface GroupsRequestBuilder extends BaseRequestBuilder<GroupsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/termstore-list-groups?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/termstore-group-post?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const GroupsRequestBuilderUriTemplate = "{+baseurl}/termStore/groups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
