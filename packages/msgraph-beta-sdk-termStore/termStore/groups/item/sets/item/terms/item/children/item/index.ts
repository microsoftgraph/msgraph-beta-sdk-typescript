 ...
 */
export const TermItemRequestBuilderUriTemplate = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
