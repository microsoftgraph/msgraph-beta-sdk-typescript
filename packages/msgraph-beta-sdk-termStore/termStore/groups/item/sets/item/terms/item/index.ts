...
export interface TermItemRequestBuilder extends BaseRequestBuilder<TermItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/termstore-term-get?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const TermItemRequestBuilderUriTemplate = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms/{term%2Did}{?%24expand,%24select}";
/**
