 ...
 */
export const RelationItemRequestBuilderUriTemplate = "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/children/{term%2Did}/relations/{relation%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
