...
// @ts-ignore
import { createSetCollectionResponseFromDiscriminatorValue, createSetFromDiscriminatorValue, serializeSet, type Set, type SetCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/termStore/index.js';
// @ts-ignore
...
export interface SetsRequestBuilder extends BaseRequestBuilder<SetsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/termstore-group-list-sets?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const SetsRequestBuilderUriTemplate = "{+baseurl}/termStore/groups/{group%2Did}/sets{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
