...
// @ts-ignore
import { createRelationCollectionResponseFromDiscriminatorValue, createRelationFromDiscriminatorValue, serializeRelation, type Relation, type RelationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/termStore/index.js';
// @ts-ignore
...
export interface RelationsRequestBuilder extends BaseRequestBuilder<RelationsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/termstore-term-list-relations?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const RelationsRequestBuilderUriTemplate = "{+baseurl}/termStore/sets/{set%2Did}/relations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
