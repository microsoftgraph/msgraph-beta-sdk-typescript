...
// @ts-ignore
import { createTermCollectionResponseFromDiscriminatorValue, createTermFromDiscriminatorValue, serializeTerm, type Term, type TermCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/termStore/index.js';
// @ts-ignore
...
export interface ChildrenRequestBuilder extends BaseRequestBuilder<ChildrenRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/termstore-term-list-children?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/termstore-term-post?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const ChildrenRequestBuilderUriTemplate = "{+baseurl}/termStore/sets/{set%2Did}/children{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
