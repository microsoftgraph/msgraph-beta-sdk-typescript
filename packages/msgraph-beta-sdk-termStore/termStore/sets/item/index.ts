...
// @ts-ignore
import { createSetFromDiscriminatorValue, serializeSet, type Set } from '@microsoft/msgraph-beta-sdk/models/termStore/index.js';
// @ts-ignore
...
export interface SetItemRequestBuilder extends BaseRequestBuilder<SetItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/termstore-set-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Set>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/termstore-set-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Set>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/termstore-set-update?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const SetItemRequestBuilderUriTemplate = "{+baseurl}/termStore/sets/{set%2Did}{?%24expand,%24select}";
/**
