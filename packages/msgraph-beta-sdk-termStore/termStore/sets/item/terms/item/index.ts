...
// @ts-ignore
import { createTermFromDiscriminatorValue, serializeTerm, type Term } from '@microsoft/msgraph-beta-sdk/models/termStore/index.js';
// @ts-ignore
...
export interface TermItemRequestBuilder extends BaseRequestBuilder<TermItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/termstore-term-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Term>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/termstore-term-update?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const TermItemRequestBuilderUriTemplate = "{+baseurl}/termStore/sets/{set%2Did}/terms/{term%2Did}{?%24expand,%24select}";
/**
