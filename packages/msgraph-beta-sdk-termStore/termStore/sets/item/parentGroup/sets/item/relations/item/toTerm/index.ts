 ...
 */
export const ToTermRequestBuilderUriTemplate = "{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/relations/{relation%2Did}/toTerm{?%24expand,%24select}";
/**
