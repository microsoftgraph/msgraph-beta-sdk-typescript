...
// @ts-ignore
import { createStoreFromDiscriminatorValue, serializeStore, type Store } from '@microsoft/msgraph-beta-sdk/models/termStore/index.js';
// @ts-ignore
...
export interface TermStoreRequestBuilder extends BaseRequestBuilder<TermStoreRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/termstore-store-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Store>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/termstore-store-update?view=graph-rest-beta|Find more info here}
     */
