...
// @ts-ignore
import { createExternalActivityFromDiscriminatorValue, createExternalActivityResultFromDiscriminatorValue, serializeExternalActivity, serializeExternalActivityResult, type ExternalActivity, type ExternalActivityResult } from '@microsoft/msgraph-beta-sdk/models/externalConnectors/index.js';
// @ts-ignore
