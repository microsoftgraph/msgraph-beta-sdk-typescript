...
// @ts-ignore
import { createIdentityProviderBaseCollectionResponseFromDiscriminatorValue, createIdentityProviderBaseFromDiscriminatorValue, serializeIdentityProviderBase, type IdentityProviderBase, type IdentityProviderBaseCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface IdentityProvidersRequestBuilder extends BaseRequestBuilder<IdentityProvidersRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identitycontainer-list-identityproviders?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/identitycontainer-post-identityproviders?view=graph-rest-beta|Find more info here}
     */
