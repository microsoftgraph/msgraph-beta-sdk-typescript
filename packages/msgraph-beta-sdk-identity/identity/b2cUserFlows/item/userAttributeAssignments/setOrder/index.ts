...
// @ts-ignore
import { createAssignmentOrderFromDiscriminatorValue, serializeAssignmentOrder, type AssignmentOrder } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SetOrderRequestBuilder extends BaseRequestBuilder<SetOrderRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identityuserflowattributeassignment-setorder?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const SetOrderRequestBuilderUriTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments/setOrder";
/**
