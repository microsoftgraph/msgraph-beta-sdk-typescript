...
// @ts-ignore
import { createIdentityUserFlowAttributeAssignmentCollectionResponseFromDiscriminatorValue, createIdentityUserFlowAttributeAssignmentFromDiscriminatorValue, serializeIdentityUserFlowAttributeAssignment, type IdentityUserFlowAttributeAssignment, type IdentityUserFlowAttributeAssignmentCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface UserAttributeAssignmentsRequestBuilder extends BaseRequestBuilder<UserAttributeAssignmentsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/b2cidentityuserflow-list-userattributeassignments?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/b2cidentityuserflow-post-userattributeassignments?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const UserAttributeAssignmentsRequestBuilderUriTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
