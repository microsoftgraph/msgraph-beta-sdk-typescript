...
// @ts-ignore
import { type UserAttributeRequestBuilder, UserAttributeRequestBuilderRequestsMetadata } from './userAttribute/';
// @ts-ignore
...
export interface IdentityUserFlowAttributeAssignmentItemRequestBuilder extends BaseRequestBuilder<IdentityUserFlowAttributeAssignmentItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identityuserflowattributeassignment-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/identityuserflowattributeassignment-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<IdentityUserFlowAttributeAssignment>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/identityuserflowattributeassignment-update?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const IdentityUserFlowAttributeAssignmentItemRequestBuilderUriTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/userAttributeAssignments/{identityUserFlowAttributeAssignment%2Did}{?%24expand,%24select}";
/**
