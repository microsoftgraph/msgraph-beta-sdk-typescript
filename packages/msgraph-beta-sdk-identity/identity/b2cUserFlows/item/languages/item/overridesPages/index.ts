...
// @ts-ignore
import { createUserFlowLanguagePageCollectionResponseFromDiscriminatorValue, createUserFlowLanguagePageFromDiscriminatorValue, serializeUserFlowLanguagePage, type UserFlowLanguagePage, type UserFlowLanguagePageCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface OverridesPagesRequestBuilder extends BaseRequestBuilder<OverridesPagesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/userflowlanguageconfiguration-list-overridespages?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const OverridesPagesRequestBuilderUriTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}/overridesPages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
