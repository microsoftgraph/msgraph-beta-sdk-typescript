...
// @ts-ignore
import { createUserFlowLanguagePageFromDiscriminatorValue, serializeUserFlowLanguagePage, type UserFlowLanguagePage } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface UserFlowLanguagePageItemRequestBuilder extends BaseRequestBuilder<UserFlowLanguagePageItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/userflowlanguagepage-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<UserFlowLanguagePage>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/userflowlanguagepage-put?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const UserFlowLanguagePageItemRequestBuilderUriTemplate = "{+baseurl}/identity/b2cUserFlows/{b2cIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}/overridesPages/{userFlowLanguagePage%2Did}{?%24expand,%24select}";
/**
