...
export interface UserFlowLanguageConfigurationItemRequestBuilder extends BaseRequestBuilder<UserFlowLanguageConfigurationItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/userflowlanguageconfiguration-delete?view=graph-rest-1.0|Find more info here}
     */
     ...
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns a Promise of UserFlowLanguageConfiguration
     * @see {@link https://learn.microsoft.com/graph/api/b2cidentityuserflow-put-languages?view=graph-rest-1.0|Find more info here}
     */
