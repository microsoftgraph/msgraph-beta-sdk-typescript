...
// @ts-ignore
import { createCustomAuthenticationExtensionCollectionResponseFromDiscriminatorValue, createCustomAuthenticationExtensionFromDiscriminatorValue, serializeCustomAuthenticationExtension, type CustomAuthenticationExtension, type CustomAuthenticationExtensionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { CustomAuthenticationExtensionItemRequestBuilderNavigationMetadata, CustomAuthenticationExtensionItemRequestBuilderRequestsMetadata, type CustomAuthenticationExtensionItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface CustomAuthenticationExtensionsRequestBuilder extends BaseRequestBuilder<CustomAuthenticationExtensionsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identitycontainer-list-customauthenticationextensions?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/identitycontainer-post-customauthenticationextensions?view=graph-rest-beta|Find more info here}
     */
