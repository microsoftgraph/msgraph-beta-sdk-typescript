...
// @ts-ignore
import { createAuthenticationConfigurationValidationFromDiscriminatorValue, type AuthenticationConfigurationValidation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ValidateAuthenticationConfigurationRequestBuilder extends BaseRequestBuilder<ValidateAuthenticationConfigurationRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/customauthenticationextension-validateauthenticationconfiguration?view=graph-rest-beta|Find more info here}
     */
