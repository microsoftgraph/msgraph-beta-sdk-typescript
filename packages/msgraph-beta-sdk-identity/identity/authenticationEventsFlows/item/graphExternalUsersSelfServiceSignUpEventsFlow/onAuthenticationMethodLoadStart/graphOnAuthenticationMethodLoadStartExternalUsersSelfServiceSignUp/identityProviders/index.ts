...
// @ts-ignore
import { createIdentityProviderBaseCollectionResponseFromDiscriminatorValue, type IdentityProviderBaseCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface IdentityProvidersRequestBuilder extends BaseRequestBuilder<IdentityProvidersRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/onauthenticationmethodloadstartexternalusersselfservicesignup-list-identityproviders?view=graph-rest-beta|Find more info here}
     */
