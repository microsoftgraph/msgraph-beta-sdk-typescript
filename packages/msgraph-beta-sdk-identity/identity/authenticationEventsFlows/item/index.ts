...
export interface AuthenticationEventsFlowItemRequestBuilder extends BaseRequestBuilder<AuthenticationEventsFlowItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/authenticationeventsflow-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/authenticationeventsflow-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<AuthenticationEventsFlow>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/authenticationeventsflow-update?view=graph-rest-beta|Find more info here}
     */
