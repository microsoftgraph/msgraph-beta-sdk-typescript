 ...
 */
export const ConditionsRequestBuilderUriTemplate = "{+baseurl}/identity/authenticationEventsFlows/{authenticationEventsFlow%2Did}/conditions{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
