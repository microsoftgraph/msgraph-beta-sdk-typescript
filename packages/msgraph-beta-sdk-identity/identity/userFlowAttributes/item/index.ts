...
// @ts-ignore
import { createIdentityUserFlowAttributeFromDiscriminatorValue, serializeIdentityUserFlowAttribute, type IdentityUserFlowAttribute } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface IdentityUserFlowAttributeItemRequestBuilder extends BaseRequestBuilder<IdentityUserFlowAttributeItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identityuserflowattribute-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/identityuserflowattribute-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<IdentityUserFlowAttribute>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/identityuserflowattribute-update?view=graph-rest-beta|Find more info here}
     */
