...
// @ts-ignore
import { createIdentityApiConnectorCollectionResponseFromDiscriminatorValue, createIdentityApiConnectorFromDiscriminatorValue, serializeIdentityApiConnector, type IdentityApiConnector, type IdentityApiConnectorCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ApiConnectorsRequestBuilder extends BaseRequestBuilder<ApiConnectorsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identityapiconnector-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/identityapiconnector-create?view=graph-rest-beta|Find more info here}
     */
