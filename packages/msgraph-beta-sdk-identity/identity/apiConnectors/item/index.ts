...
export interface IdentityApiConnectorItemRequestBuilder extends BaseRequestBuilder<IdentityApiConnectorItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identityapiconnector-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/identityapiconnector-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<IdentityApiConnector>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/identityapiconnector-update?view=graph-rest-beta|Find more info here}
     */
