...
// @ts-ignore
import { AuthenticationContextClassReferenceItemRequestBuilderRequestsMetadata, type AuthenticationContextClassReferenceItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface AuthenticationContextClassReferencesRequestBuilder extends BaseRequestBuilder<AuthenticationContextClassReferencesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/conditionalaccessroot-list-authenticationcontextclassreferences?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/conditionalaccessroot-post-authenticationcontextclassreferences?view=graph-rest-beta|Find more info here}
     */
