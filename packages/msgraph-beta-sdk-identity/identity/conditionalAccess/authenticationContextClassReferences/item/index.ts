...
// @ts-ignore
import { createAuthenticationContextClassReferenceFromDiscriminatorValue, serializeAuthenticationContextClassReference, type AuthenticationContextClassReference } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AuthenticationContextClassReferenceItemRequestBuilder extends BaseRequestBuilder<AuthenticationContextClassReferenceItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/authenticationcontextclassreference-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/authenticationcontextclassreference-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<AuthenticationContextClassReference>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/authenticationcontextclassreference-update?view=graph-rest-beta|Find more info here}
     */
