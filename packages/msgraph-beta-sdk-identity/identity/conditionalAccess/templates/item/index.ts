...
// @ts-ignore
import { createConditionalAccessTemplateFromDiscriminatorValue, type ConditionalAccessTemplate } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ConditionalAccessTemplateItemRequestBuilder extends BaseRequestBuilder<ConditionalAccessTemplateItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/conditionalaccesstemplate-get?view=graph-rest-beta|Find more info here}
     */
