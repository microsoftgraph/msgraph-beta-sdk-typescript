...
// @ts-ignore
import { createConditionalAccessTemplateCollectionResponseFromDiscriminatorValue, type ConditionalAccessTemplateCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface TemplatesRequestBuilder extends BaseRequestBuilder<TemplatesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/conditionalaccessroot-list-templates?view=graph-rest-beta|Find more info here}
     */
