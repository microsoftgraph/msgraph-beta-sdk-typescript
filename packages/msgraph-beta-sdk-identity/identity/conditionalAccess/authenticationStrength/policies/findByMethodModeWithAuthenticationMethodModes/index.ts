 ...
 * @returns a findByMethodModeWithAuthenticationMethodModesGetResponse
 */
...
export interface FindByMethodModeWithAuthenticationMethodModesRequestBuilder extends BaseRequestBuilder<FindByMethodModeWithAuthenticationMethodModesRequestBuilder> {
     ...
     * @returns a Promise of FindByMethodModeWithAuthenticationMethodModesGetResponse
 ...
 */
export const FindByMethodModeWithAuthenticationMethodModesRequestBuilderUriTemplate = "{+baseurl}/identity/conditionalAccess/authenticationStrength/policies/findByMethodMode(authenticationMethodModes={authenticationMethodModes}){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
/* tslint:enable */
/* eslint-enable */
