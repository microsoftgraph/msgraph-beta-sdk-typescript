...
// @ts-ignore
import { createAuthenticationCombinationConfigurationCollectionResponseFromDiscriminatorValue, createAuthenticationCombinationConfigurationFromDiscriminatorValue, serializeAuthenticationCombinationConfiguration, type AuthenticationCombinationConfiguration, type AuthenticationCombinationConfigurationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { AuthenticationCombinationConfigurationItemRequestBuilderRequestsMetadata, type AuthenticationCombinationConfigurationItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface CombinationConfigurationsRequestBuilder extends BaseRequestBuilder<CombinationConfigurationsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/authenticationstrengthpolicy-list-combinationconfigurations?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/authenticationstrengthpolicy-post-combinationconfigurations?view=graph-rest-beta|Find more info here}
     */
