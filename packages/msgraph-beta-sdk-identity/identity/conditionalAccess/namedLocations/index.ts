...
// @ts-ignore
import { createNamedLocationCollectionResponseFromDiscriminatorValue, createNamedLocationFromDiscriminatorValue, serializeNamedLocation, type NamedLocation, type NamedLocationCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface NamedLocationsRequestBuilder extends BaseRequestBuilder<NamedLocationsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/conditionalaccessroot-list-namedlocations?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/conditionalaccessroot-post-namedlocations?view=graph-rest-beta|Find more info here}
     */
