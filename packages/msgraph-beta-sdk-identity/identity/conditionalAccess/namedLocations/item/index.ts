...
// @ts-ignore
import { createNamedLocationFromDiscriminatorValue, serializeNamedLocation, type NamedLocation } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface NamedLocationItemRequestBuilder extends BaseRequestBuilder<NamedLocationItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/ipnamedlocation-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/countrynamedlocation-get?view=graph-rest-beta|Find more info here}
     */
