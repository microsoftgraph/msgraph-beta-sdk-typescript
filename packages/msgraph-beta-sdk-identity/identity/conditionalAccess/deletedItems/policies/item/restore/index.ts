...
// @ts-ignore
import { createConditionalAccessPolicyFromDiscriminatorValue, type ConditionalAccessPolicy } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const RestoreRequestBuilderUriTemplate = "{+baseurl}/identity/conditionalAccess/deletedItems/policies/{conditionalAccessPolicy%2Did}/restore";
/**
