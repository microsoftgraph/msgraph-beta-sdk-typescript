...
// @ts-ignore
import { AuthenticationEventListenerItemRequestBuilderRequestsMetadata, type AuthenticationEventListenerItemRequestBuilder } from './item/';
// @ts-ignore
...
export interface AuthenticationEventListenersRequestBuilder extends BaseRequestBuilder<AuthenticationEventListenersRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identitycontainer-list-authenticationeventlisteners?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/identitycontainer-post-authenticationeventlisteners?view=graph-rest-beta|Find more info here}
     */
