...
import { createAuthenticationEventListenerCollectionResponseFromDiscriminatorValue, createAuthenticationEventListenerFromDiscriminatorValue, serializeAuthenticationEventListener, type AuthenticationEventListener, type AuthenticationEventListenerCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/';
import { CountRequestBuilderRequestsMetadata, CountRequestBuilderUriTemplate, type CountRequestBuilder } from './count/';
import { AuthenticationEventListenerItemRequestBuilderRequestsMetadata, AuthenticationEventListenerItemRequestBuilderUriTemplate, type AuthenticationEventListenerItemRequestBuilder } from './item/';
...
export interface AuthenticationEventListenersRequestBuilder extends BaseRequestBuilder<AuthenticationEventListenersRequestBuilder> {
     ...
     * @returns a AuthenticationEventListenerItemRequestBuilder
     */
     ...
     * @returns a Promise of AuthenticationEventListenerCollectionResponse
     ...
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns a Promise of AuthenticationEventListener
 ...
 */
export const AuthenticationEventListenersRequestBuilderUriTemplate = "{+baseurl}/identity/authenticationEventListeners{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
