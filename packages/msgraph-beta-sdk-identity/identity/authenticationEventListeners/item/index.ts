...
// @ts-ignore
import { createAuthenticationEventListenerFromDiscriminatorValue, serializeAuthenticationEventListener, type AuthenticationEventListener } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AuthenticationEventListenerItemRequestBuilder extends BaseRequestBuilder<AuthenticationEventListenerItemRequestBuilder> {
     ...
     * @returns {Promise<AuthenticationEventListener>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/authenticationeventlistener-update?view=graph-rest-beta|Find more info here}
     */
