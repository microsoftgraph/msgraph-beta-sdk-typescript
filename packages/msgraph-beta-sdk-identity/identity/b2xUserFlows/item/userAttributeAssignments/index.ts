...
export interface UserAttributeAssignmentsRequestBuilder extends BaseRequestBuilder<UserAttributeAssignmentsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/b2xidentityuserflow-list-userattributeassignments?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/b2xidentityuserflow-post-userattributeassignments?view=graph-rest-beta|Find more info here}
     */
