...
// @ts-ignore
import { createUserFlowApiConnectorConfigurationFromDiscriminatorValue, type UserFlowApiConnectorConfiguration } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { PreTokenIssuanceRequestBuilderNavigationMetadata, PreTokenIssuanceRequestBuilderRequestsMetadata, type PreTokenIssuanceRequestBuilder } from './preTokenIssuance/index.js';
// @ts-ignore
...
export interface ApiConnectorConfigurationRequestBuilder extends BaseRequestBuilder<ApiConnectorConfigurationRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/b2xidentityuserflow-get-apiconnectorconfiguration?view=graph-rest-beta|Find more info here}
     */
