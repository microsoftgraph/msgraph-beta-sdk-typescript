...
// @ts-ignore
import { createB2xIdentityUserFlowCollectionResponseFromDiscriminatorValue, createB2xIdentityUserFlowFromDiscriminatorValue, serializeB2xIdentityUserFlow, type B2xIdentityUserFlow, type B2xIdentityUserFlowCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { B2xIdentityUserFlowItemRequestBuilderNavigationMetadata, B2xIdentityUserFlowItemRequestBuilderRequestsMetadata, type B2xIdentityUserFlowItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface B2xUserFlowsRequestBuilder extends BaseRequestBuilder<B2xUserFlowsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/identitycontainer-list-b2xuserflows?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/identitycontainer-post-b2xuserflows?view=graph-rest-beta|Find more info here}
     */
