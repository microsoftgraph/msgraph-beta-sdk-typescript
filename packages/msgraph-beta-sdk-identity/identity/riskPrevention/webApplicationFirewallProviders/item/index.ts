...
export interface WebApplicationFirewallProviderItemRequestBuilder extends BaseRequestBuilder<WebApplicationFirewallProviderItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/riskpreventioncontainer-delete-webapplicationfirewallproviders?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/webapplicationfirewallprovider-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<WebApplicationFirewallProvider>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/webapplicationfirewallprovider-update?view=graph-rest-beta|Find more info here}
     */
