 ...
 */
export const DetectedAppItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/detectedApps/{detectedApp%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
