 ...
 * @param SendCustomNotificationToCompanyPortalPostRequestBody The instance to deserialize into.
 ...
 * @param SendCustomNotificationToCompanyPortalPostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeSendCustomNotificationToCompanyPortalPostRequestBody(writer: SerializationWriter, sendCustomNotificationToCompanyPortalPostRequestBody: Partial<SendCustomNotificationToCompanyPortalPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!sendCustomNotificationToCompanyPortalPostRequestBody || isSerializingDerivedType) { return; }
 ...
 */
export const SendCustomNotificationToCompanyPortalRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/sendCustomNotificationToCompanyPortal";
/**
