...
// @ts-ignore
import { createDeviceLogCollectionResponseFromDiscriminatorValue, serializeDeviceLogCollectionResponse, type DeviceLogCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
// @ts-ignore
import { DownloadDeviceLogsRequestBuilderRequestsMetadata, type DownloadDeviceLogsRequestBuilder } from './downloadDeviceLogs/';
// @ts-ignore
...
export interface DeviceLogCollectionResponseItemRequestBuilder extends BaseRequestBuilder<DeviceLogCollectionResponseItemRequestBuilder> {
     ...
     */
    get downloadDeviceLogs(): DownloadDeviceLogsRequestBuilder;
    /**
 ...
 */
export const DeviceLogCollectionResponseItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/logCollectionRequests/{deviceLogCollectionResponse%2Did}{?%24expand,%24select}";
/**
...
export const DeviceLogCollectionResponseItemRequestBuilderNavigationMetadata: Record<Exclude<keyof DeviceLogCollectionResponseItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ...
    downloadDeviceLogs: {
        requestsMetadata: DownloadDeviceLogsRequestBuilderRequestsMetadata,
    },
};
/**
