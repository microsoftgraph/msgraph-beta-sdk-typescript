...
import { createDeviceLogCollectionResponseCollectionResponseFromDiscriminatorValue, createDeviceLogCollectionResponseFromDiscriminatorValue, serializeDeviceLogCollectionResponse, type DeviceLogCollectionResponse, type DeviceLogCollectionResponseCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
 ...
 */
export const LogCollectionRequestsRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/logCollectionRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
