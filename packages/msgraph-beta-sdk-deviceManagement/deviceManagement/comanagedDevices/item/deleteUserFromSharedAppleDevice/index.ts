 ...
 */
export const DeleteUserFromSharedAppleDeviceRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/deleteUserFromSharedAppleDevice";
/* tslint:enable */
/* eslint-enable */
