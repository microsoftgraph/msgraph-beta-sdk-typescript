 ...
 */
export const WindowsProtectionStateRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/windowsProtectionState{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
