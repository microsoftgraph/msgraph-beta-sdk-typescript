...
import { createBulkManagedDeviceActionResultFromDiscriminatorValue, ManagedDeviceRemoteAction, ManagedDeviceRemoteActionObject, serializeBulkManagedDeviceActionResult, type BulkManagedDeviceActionResult } from '@microsoft/msgraph-beta-sdk/models/';
...
export interface ExecuteActionRequestBuilder extends BaseRequestBuilder<ExecuteActionRequestBuilder> {
     ...
     * @returns a Promise of BulkManagedDeviceActionResult
     */
 ...
 */
export const ExecuteActionRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/comanagedDevices/executeAction";
/* tslint:enable */
/* eslint-enable */
