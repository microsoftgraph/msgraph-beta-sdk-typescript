...
// @ts-ignore
import { createDepOnboardingSettingCollectionResponseFromDiscriminatorValue, createDepOnboardingSettingFromDiscriminatorValue, serializeDepOnboardingSetting, type DepOnboardingSetting, type DepOnboardingSettingCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilderRequestsMetadata, type GetExpiringVppTokenCountWithExpiringBeforeDateTimeRequestBuilder } from './getExpiringVppTokenCountWithExpiringBeforeDateTime/index.js';
// @ts-ignore
import { DepOnboardingSettingItemRequestBuilderNavigationMetadata, DepOnboardingSettingItemRequestBuilderRequestsMetadata, type DepOnboardingSettingItemRequestBuilder } from './item/index.js';
// @ts-ignore
