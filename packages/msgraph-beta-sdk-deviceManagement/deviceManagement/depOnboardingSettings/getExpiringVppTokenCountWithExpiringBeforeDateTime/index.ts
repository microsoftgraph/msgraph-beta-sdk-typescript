 ...
 * @param GetExpiringVppTokenCountWithExpiringBeforeDateTimeGetResponse The instance to deserialize into.
 ...
 * @param GetExpiringVppTokenCountWithExpiringBeforeDateTimeGetResponse The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeGetExpiringVppTokenCountWithExpiringBeforeDateTimeGetResponse(writer: SerializationWriter, getExpiringVppTokenCountWithExpiringBeforeDateTimeGetResponse: Partial<GetExpiringVppTokenCountWithExpiringBeforeDateTimeGetResponse> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!getExpiringVppTokenCountWithExpiringBeforeDateTimeGetResponse || isSerializingDerivedType) { return; }
