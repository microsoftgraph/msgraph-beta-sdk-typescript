...
// @ts-ignore
import { createCloudPcDeviceImageFromDiscriminatorValue, serializeCloudPcDeviceImage, type CloudPcDeviceImage } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/';
// @ts-ignore
import { ReuploadRequestBuilderRequestsMetadata, type ReuploadRequestBuilder } from './reupload/';
// @ts-ignore
...
export interface CloudPcDeviceImageItemRequestBuilder extends BaseRequestBuilder<CloudPcDeviceImageItemRequestBuilder> {
     ...
     */
    get reupload(): ReuploadRequestBuilder;
    /**
     * Delete a cloudPcDeviceImage object.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/cloudpcdeviceimage-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/cloudpcdeviceimage-get?view=graph-rest-beta|Find more info here}
     */
