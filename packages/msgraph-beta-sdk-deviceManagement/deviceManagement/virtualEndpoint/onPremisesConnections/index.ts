...
// @ts-ignore
import { createCloudPcOnPremisesConnectionCollectionResponseFromDiscriminatorValue, createCloudPcOnPremisesConnectionFromDiscriminatorValue, serializeCloudPcOnPremisesConnection, type CloudPcOnPremisesConnection, type CloudPcOnPremisesConnectionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { CloudPcOnPremisesConnectionItemRequestBuilderNavigationMetadata, CloudPcOnPremisesConnectionItemRequestBuilderRequestsMetadata, type CloudPcOnPremisesConnectionItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface OnPremisesConnectionsRequestBuilder extends BaseRequestBuilder<OnPremisesConnectionsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/virtualendpoint-list-onpremisesconnections?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/virtualendpoint-post-onpremisesconnections?view=graph-rest-beta|Find more info here}
     */
