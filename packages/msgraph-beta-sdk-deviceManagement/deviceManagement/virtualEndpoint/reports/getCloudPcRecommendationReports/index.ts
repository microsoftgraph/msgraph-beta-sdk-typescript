...
// @ts-ignore
import { CloudPcReportNameObject, type CloudPcReportName } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export function deserializeIntoGetCloudPcRecommendationReportsPostRequestBody(getCloudPcRecommendationReportsPostRequestBody: Partial<GetCloudPcRecommendationReportsPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "groupBy": n => { getCloudPcRecommendationReportsPostRequestBody.groupBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "orderBy": n => { getCloudPcRecommendationReportsPostRequestBody.orderBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        ...
        "select": n => { getCloudPcRecommendationReportsPostRequestBody.select = n.getCollectionOfPrimitiveValues<string>("string"); },
