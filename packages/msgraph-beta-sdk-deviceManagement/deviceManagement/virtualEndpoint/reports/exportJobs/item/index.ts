 ...
 */
export const CloudPcExportJobItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/reports/exportJobs/{cloudPcExportJob%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
