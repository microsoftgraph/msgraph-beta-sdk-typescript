...
import { CloudPcExportJobItemRequestBuilderRequestsMetadata, CloudPcExportJobItemRequestBuilderUriTemplate, type CloudPcExportJobItemRequestBuilder } from './item/';
...
export interface ExportJobsRequestBuilder extends BaseRequestBuilder<ExportJobsRequestBuilder> {
     ...
     * @returns a CloudPcExportJobItemRequestBuilder
     */
     ...
     * @returns a Promise of CloudPcExportJobCollectionResponse
     */
     ...
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns a Promise of CloudPcExportJob
