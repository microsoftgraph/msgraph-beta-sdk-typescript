...
// @ts-ignore
import { CloudPcRecommendationReportTypeObject, type CloudPcRecommendationReportType } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export function deserializeIntoRetrieveCloudPcRecommendationReportsPostRequestBody(retrieveCloudPcRecommendationReportsPostRequestBody: Partial<RetrieveCloudPcRecommendationReportsPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "reportName": n => { retrieveCloudPcRecommendationReportsPostRequestBody.reportName = n.getEnumValue<CloudPcRecommendationReportType>(CloudPcRecommendationReportTypeObject); },
...
export interface RetrieveCloudPcRecommendationReportsPostRequestBody extends AdditionalDataHolder, BackedModel, Parsable {
     ...
     */
    reportName?: CloudPcRecommendationReportType | null;
    /**
     * The search property
     */
    search?: string | null;
 ...
 */
export const RetrieveCloudPcRecommendationReportsRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/reports/retrieveCloudPcRecommendationReports";
/**
