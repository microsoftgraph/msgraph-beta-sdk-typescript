...
// @ts-ignore
import { CloudPCPerformanceReportNameObject, type CloudPCPerformanceReportName } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export function deserializeIntoRetrieveCloudPcTenantMetricsReportPostRequestBody(retrieveCloudPcTenantMetricsReportPostRequestBody: Partial<RetrieveCloudPcTenantMetricsReportPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "groupBy": n => { retrieveCloudPcTenantMetricsReportPostRequestBody.groupBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "orderBy": n => { retrieveCloudPcTenantMetricsReportPostRequestBody.orderBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        ...
        "select": n => { retrieveCloudPcTenantMetricsReportPostRequestBody.select = n.getCollectionOfPrimitiveValues<string>("string"); },
