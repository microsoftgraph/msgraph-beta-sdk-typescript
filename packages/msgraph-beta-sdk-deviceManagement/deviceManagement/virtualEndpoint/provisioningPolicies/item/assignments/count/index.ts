 ...
 */
export const CountRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/{cloudPcProvisioningPolicy%2Did}/assignments/$count{?%24search,%24filter}";
/* tslint:enable */
/* eslint-enable */
