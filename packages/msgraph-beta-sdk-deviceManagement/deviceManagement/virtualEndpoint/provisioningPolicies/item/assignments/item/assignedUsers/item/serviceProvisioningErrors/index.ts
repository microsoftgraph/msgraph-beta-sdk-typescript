...
// @ts-ignore
import { createServiceProvisioningErrorCollectionResponseFromDiscriminatorValue, type ServiceProvisioningErrorCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
