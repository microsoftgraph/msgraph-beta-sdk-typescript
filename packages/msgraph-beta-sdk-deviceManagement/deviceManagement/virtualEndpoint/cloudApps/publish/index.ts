...
export interface PublishRequestBuilder extends BaseRequestBuilder<PublishRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/cloudpccloudapp-publish?view=graph-rest-beta|Find more info here}
     */
     post(body: PublishPostRequestBody, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<void>;
    /**
     * Publish a cloudPcCloudApp object to make it available to end users through their portal, such as the Windows App. 
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export function serializePublishPostRequestBody(writer: SerializationWriter, publishPostRequestBody: Partial<PublishPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeCollectionOfPrimitiveValues<string>("cloudAppIds", publishPostRequestBody.cloudAppIds);
    writer.writeAdditionalData(publishPostRequestBody.additionalData);
}
/**
 * Uri template for the request builder.
 */
export const PublishRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/cloudApps/publish";
/**
