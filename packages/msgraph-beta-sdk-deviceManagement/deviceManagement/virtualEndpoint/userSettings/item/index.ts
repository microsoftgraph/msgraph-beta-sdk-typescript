...
// @ts-ignore
import { createCloudPcUserSettingFromDiscriminatorValue, serializeCloudPcUserSetting, type CloudPcUserSetting } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CloudPcUserSettingItemRequestBuilder extends BaseRequestBuilder<CloudPcUserSettingItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/cloudpcusersetting-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/cloudpcusersetting-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<CloudPcUserSetting>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/cloudpcusersetting-update?view=graph-rest-beta|Find more info here}
     */
