...
// @ts-ignore
import { createCloudPcAuditEventFromDiscriminatorValue, serializeCloudPcAuditEvent, type CloudPcAuditEvent } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CloudPcAuditEventItemRequestBuilder extends BaseRequestBuilder<CloudPcAuditEventItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/cloudpcauditevent-get?view=graph-rest-beta|Find more info here}
     */
