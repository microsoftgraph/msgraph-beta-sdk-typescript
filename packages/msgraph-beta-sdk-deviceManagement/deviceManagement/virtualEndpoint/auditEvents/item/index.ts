 ...
 */
export const CloudPcAuditEventItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/virtualEndpoint/auditEvents/{cloudPcAuditEvent%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
