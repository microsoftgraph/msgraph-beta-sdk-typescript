...
// @ts-ignore
import { createCloudPcGalleryImageCollectionResponseFromDiscriminatorValue, createCloudPcGalleryImageFromDiscriminatorValue, serializeCloudPcGalleryImage, type CloudPcGalleryImage, type CloudPcGalleryImageCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface GalleryImagesRequestBuilder extends BaseRequestBuilder<GalleryImagesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/virtualendpoint-list-galleryimages?view=graph-rest-beta|Find more info here}
     */
