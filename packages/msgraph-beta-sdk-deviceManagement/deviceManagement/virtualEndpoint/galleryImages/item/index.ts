...
// @ts-ignore
import { createCloudPcGalleryImageFromDiscriminatorValue, serializeCloudPcGalleryImage, type CloudPcGalleryImage } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CloudPcGalleryImageItemRequestBuilder extends BaseRequestBuilder<CloudPcGalleryImageItemRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/cloudpcgalleryimage-get?view=graph-rest-beta|Find more info here}
     */
