...
// @ts-ignore
import { createLocalizedNotificationMessageFromDiscriminatorValue, serializeLocalizedNotificationMessage, type LocalizedNotificationMessage } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
