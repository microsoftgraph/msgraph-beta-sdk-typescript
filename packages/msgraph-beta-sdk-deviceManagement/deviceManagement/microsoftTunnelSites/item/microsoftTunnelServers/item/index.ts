...
// @ts-ignore
import { createMicrosoftTunnelServerFromDiscriminatorValue, serializeMicrosoftTunnelServer, type MicrosoftTunnelServer } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CreateServerLogCollectionRequestRequestBuilderRequestsMetadata, type CreateServerLogCollectionRequestRequestBuilder } from './createServerLogCollectionRequest/index.js';
// @ts-ignore
import { GenerateServerLogCollectionRequestRequestBuilderRequestsMetadata, type GenerateServerLogCollectionRequestRequestBuilder } from './generateServerLogCollectionRequest/index.js';
// @ts-ignore
import { GetHealthMetricsRequestBuilderRequestsMetadata, type GetHealthMetricsRequestBuilder } from './getHealthMetrics/index.js';
// @ts-ignore
import { GetHealthMetricTimeSeriesRequestBuilderRequestsMetadata, type GetHealthMetricTimeSeriesRequestBuilder } from './getHealthMetricTimeSeries/index.js';
// @ts-ignore
