...
// @ts-ignore
import { createIntuneBrandingProfileAssignmentFromDiscriminatorValue, serializeIntuneBrandingProfileAssignment, type IntuneBrandingProfileAssignment } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export function deserializeIntoAssignPostRequestBody(assignPostRequestBody: Partial<AssignPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "assignments": n => { assignPostRequestBody.assignments = n.getCollectionOfObjectValues<IntuneBrandingProfileAssignment>(createIntuneBrandingProfileAssignmentFromDiscriminatorValue); },
...
export function serializeAssignPostRequestBody(writer: SerializationWriter, assignPostRequestBody: Partial<AssignPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeCollectionOfObjectValues<IntuneBrandingProfileAssignment>("assignments", assignPostRequestBody.assignments, serializeIntuneBrandingProfileAssignment);
    writer.writeAdditionalData(assignPostRequestBody.additionalData);
}
/**
 * Uri template for the request builder.
 */
export const AssignRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/intuneBrandingProfiles/{intuneBrandingProfile%2Did}/assign";
/**
