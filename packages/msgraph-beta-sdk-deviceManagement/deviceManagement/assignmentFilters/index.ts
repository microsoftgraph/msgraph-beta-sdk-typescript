...
// @ts-ignore
import { createDeviceAndAppManagementAssignmentFilterCollectionResponseFromDiscriminatorValue, createDeviceAndAppManagementAssignmentFilterFromDiscriminatorValue, serializeDeviceAndAppManagementAssignmentFilter, type DeviceAndAppManagementAssignmentFilter, type DeviceAndAppManagementAssignmentFilterCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
// @ts-ignore
import { GetPlatformSupportedPropertiesWithPlatformRequestBuilderRequestsMetadata, type GetPlatformSupportedPropertiesWithPlatformRequestBuilder } from './getPlatformSupportedPropertiesWithPlatform/index.js';
// @ts-ignore
import { GetStateRequestBuilderRequestsMetadata, type GetStateRequestBuilder } from './getState/index.js';
// @ts-ignore
import { DeviceAndAppManagementAssignmentFilterItemRequestBuilderNavigationMetadata, DeviceAndAppManagementAssignmentFilterItemRequestBuilderRequestsMetadata, type DeviceAndAppManagementAssignmentFilterItemRequestBuilder } from './item/index.js';
// @ts-ignore
import { type ValidateFilterRequestBuilder, ValidateFilterRequestBuilderRequestsMetadata } from './validateFilter/index.js';
// @ts-ignore
