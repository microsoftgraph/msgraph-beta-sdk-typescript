...
import { createEmbeddedSIMActivationCodePoolAssignmentFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeEmbeddedSIMActivationCodePoolAssignment, type BaseCollectionPaginationCountResponse, type EmbeddedSIMActivationCodePoolAssignment } from '@microsoft/msgraph-beta-sdk/models/';
...
export function deserializeIntoAssignPostRequestBody(assignPostRequestBody: Partial<AssignPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "assignments": n => { assignPostRequestBody.assignments = n.getCollectionOfObjectValues<EmbeddedSIMActivationCodePoolAssignment>(createEmbeddedSIMActivationCodePoolAssignmentFromDiscriminatorValue); },
...
export function deserializeIntoAssignPostResponse(assignPostResponse: Partial<AssignPostResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "value": n => { assignPostResponse.value = n.getCollectionOfObjectValues<EmbeddedSIMActivationCodePoolAssignment>(createEmbeddedSIMActivationCodePoolAssignmentFromDiscriminatorValue); },
    }
}
/**
...
export function serializeAssignPostRequestBody(writer: SerializationWriter, assignPostRequestBody: Partial<AssignPostRequestBody> | undefined = {}) : void {
    writer.writeCollectionOfObjectValues<EmbeddedSIMActivationCodePoolAssignment>("assignments", assignPostRequestBody.assignments, serializeEmbeddedSIMActivationCodePoolAssignment);
...
export function serializeAssignPostResponse(writer: SerializationWriter, assignPostResponse: Partial<AssignPostResponse> | undefined = {}) : void {
    ...
    writer.writeCollectionOfObjectValues<EmbeddedSIMActivationCodePoolAssignment>("value", assignPostResponse.value, serializeEmbeddedSIMActivationCodePoolAssignment);
}
/**
 * Uri template for the request builder.
 */
export const AssignRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/embeddedSIMActivationCodePools/{embeddedSIMActivationCodePool%2Did}/assign";
/**
