...
export interface ActivateRequestBuilder extends BaseRequestBuilder<ActivateRequestBuilder> {
     ...
     */
     post(body: ActivatePostRequestBody, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<CloudCertificationAuthority | undefined>;
    /**
     * Invoke action activate
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export function deserializeIntoActivatePostRequestBody(activatePostRequestBody: Partial<ActivatePostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "certificationAuthorityVersion": n => { activatePostRequestBody.certificationAuthorityVersion = n.getNumberValue(); },
    }
}
/**
...
export function serializeActivatePostRequestBody(writer: SerializationWriter, activatePostRequestBody: Partial<ActivatePostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeNumberValue("certificationAuthorityVersion", activatePostRequestBody.certificationAuthorityVersion);
    writer.writeAdditionalData(activatePostRequestBody.additionalData);
}
/**
 * Uri template for the request builder.
 */
export const ActivateRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/cloudCertificationAuthority/{cloudCertificationAuthority%2Did}/activate";
/**
