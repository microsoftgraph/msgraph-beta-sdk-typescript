 ...
 */
export const AppDiagnosticsWithUpnRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/managedDevices/appDiagnostics(upn='{upn}'){?%24top,%24skip,%24search,%24filter,%24count}";
/* tslint:enable */
/* eslint-enable */
