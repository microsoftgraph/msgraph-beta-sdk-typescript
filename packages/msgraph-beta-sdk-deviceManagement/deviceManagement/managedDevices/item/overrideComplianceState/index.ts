...
// @ts-ignore
import { AdministratorConfiguredDeviceComplianceStateObject, type AdministratorConfiguredDeviceComplianceState } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface OverrideComplianceStatePostRequestBody extends AdditionalDataHolder, BackedModel, Parsable {
     ...
     */
    complianceState?: AdministratorConfiguredDeviceComplianceState | null;
    /**
 ...
 */
export const OverrideComplianceStateRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/overrideComplianceState";
/**
