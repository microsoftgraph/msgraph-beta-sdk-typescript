...
// @ts-ignore
import { createGroupPolicyConfigurationAssignmentFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeGroupPolicyConfigurationAssignment, type BaseCollectionPaginationCountResponse, type GroupPolicyConfigurationAssignment } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export function deserializeIntoAssignPostRequestBody(assignPostRequestBody: Partial<AssignPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "assignments": n => { assignPostRequestBody.assignments = n.getCollectionOfObjectValues<GroupPolicyConfigurationAssignment>(createGroupPolicyConfigurationAssignmentFromDiscriminatorValue); },
...
export function deserializeIntoAssignPostResponse(assignPostResponse: Partial<AssignPostResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "value": n => { assignPostResponse.value = n.getCollectionOfObjectValues<GroupPolicyConfigurationAssignment>(createGroupPolicyConfigurationAssignmentFromDiscriminatorValue); },
    }
}
/**
...
export function serializeAssignPostRequestBody(writer: SerializationWriter, assignPostRequestBody: Partial<AssignPostRequestBody> | undefined = {}) : void {
    writer.writeCollectionOfObjectValues<GroupPolicyConfigurationAssignment>("assignments", assignPostRequestBody.assignments, serializeGroupPolicyConfigurationAssignment);
...
export function serializeAssignPostResponse(writer: SerializationWriter, assignPostResponse: Partial<AssignPostResponse> | undefined = {}) : void {
    ...
    writer.writeCollectionOfObjectValues<GroupPolicyConfigurationAssignment>("value", assignPostResponse.value, serializeGroupPolicyConfigurationAssignment);
}
/**
 * Uri template for the request builder.
 */
export const AssignRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/groupPolicyConfigurations/{groupPolicyConfiguration%2Did}/assign";
/**
