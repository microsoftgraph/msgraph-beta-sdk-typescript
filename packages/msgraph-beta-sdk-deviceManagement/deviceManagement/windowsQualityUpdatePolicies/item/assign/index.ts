...
export interface AssignPostRequestBody extends AdditionalDataHolder, BackedModel, Parsable {
     ...
     */
    assignments?: WindowsQualityUpdatePolicyAssignment[];
    /**
...
export function deserializeIntoAssignPostRequestBody(assignPostRequestBody: Partial<AssignPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "assignments": n => { assignPostRequestBody.assignments = n.getCollectionOfObjectValues<WindowsQualityUpdatePolicyAssignment>(createWindowsQualityUpdatePolicyAssignmentFromDiscriminatorValue); },
...
export function serializeAssignPostRequestBody(writer: SerializationWriter, assignPostRequestBody: Partial<AssignPostRequestBody> | undefined = {}) : void {
    writer.writeCollectionOfObjectValues<WindowsQualityUpdatePolicyAssignment>("assignments", assignPostRequestBody.assignments, serializeWindowsQualityUpdatePolicyAssignment);
    writer.writeAdditionalData(assignPostRequestBody.additionalData);
}
/**
 * Uri template for the request builder.
 */
export const AssignRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/windowsQualityUpdatePolicies/{windowsQualityUpdatePolicy%2Did}/assign";
/**
