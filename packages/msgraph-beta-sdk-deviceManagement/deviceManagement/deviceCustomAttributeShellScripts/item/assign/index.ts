...
// @ts-ignore
import { createDeviceManagementScriptAssignmentFromDiscriminatorValue, createDeviceManagementScriptGroupAssignmentFromDiscriminatorValue, serializeDeviceManagementScriptAssignment, serializeDeviceManagementScriptGroupAssignment, type DeviceManagementScriptAssignment, type DeviceManagementScriptGroupAssignment } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AssignPostRequestBody extends AdditionalDataHolder, BackedModel, Parsable {
     ...
     */
    deviceManagementScriptAssignments?: DeviceManagementScriptAssignment[] | null;
    /**
     * The deviceManagementScriptGroupAssignments property
     */
    deviceManagementScriptGroupAssignments?: DeviceManagementScriptGroupAssignment[] | null;
}
/**
 ...
 */
export const AssignRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/deviceCustomAttributeShellScripts/{deviceCustomAttributeShellScript%2Did}/assign";
/**
