...
// @ts-ignore
import { createOperationApprovalRequestCollectionResponseFromDiscriminatorValue, createOperationApprovalRequestFromDiscriminatorValue, serializeOperationApprovalRequest, type OperationApprovalRequest, type OperationApprovalRequestCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CancelMyRequestRequestBuilderRequestsMetadata, type CancelMyRequestRequestBuilder } from './cancelMyRequest/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { OperationApprovalRequestItemRequestBuilderNavigationMetadata, OperationApprovalRequestItemRequestBuilderRequestsMetadata, type OperationApprovalRequestItemRequestBuilder } from './item/index.js';
// @ts-ignore
import { RetrieveMyRequestByIdWithIdRequestBuilderRequestsMetadata, type RetrieveMyRequestByIdWithIdRequestBuilder } from './retrieveMyRequestByIdWithId/index.js';
// @ts-ignore
import { RetrieveMyRequestsRequestBuilderRequestsMetadata, type RetrieveMyRequestsRequestBuilder } from './retrieveMyRequests/index.js';
// @ts-ignore
import { RetrieveRequestStatusRequestBuilderRequestsMetadata, type RetrieveRequestStatusRequestBuilder } from './retrieveRequestStatus/index.js';
// @ts-ignore
