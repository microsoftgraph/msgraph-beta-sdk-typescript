...
export function deserializeIntoAssignPostRequestBody(assignPostRequestBody: Partial<AssignPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "assignments": n => { assignPostRequestBody.assignments = n.getCollectionOfObjectValues<WindowsDriverUpdateProfileAssignment>(createWindowsDriverUpdateProfileAssignmentFromDiscriminatorValue); },
...
export function serializeAssignPostRequestBody(writer: SerializationWriter, assignPostRequestBody: Partial<AssignPostRequestBody> | undefined | null = {}) : void {
    if (assignPostRequestBody) {
        writer.writeCollectionOfObjectValues<WindowsDriverUpdateProfileAssignment>("assignments", assignPostRequestBody.assignments, serializeWindowsDriverUpdateProfileAssignment);
 ...
 */
export const AssignRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/windowsDriverUpdateProfiles/{windowsDriverUpdateProfile%2Did}/assign";
/**
