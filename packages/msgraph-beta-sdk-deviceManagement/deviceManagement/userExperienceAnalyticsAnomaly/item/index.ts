 ...
 */
export const UserExperienceAnalyticsAnomalyItemRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/userExperienceAnalyticsAnomaly/{userExperienceAnalyticsAnomaly%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
