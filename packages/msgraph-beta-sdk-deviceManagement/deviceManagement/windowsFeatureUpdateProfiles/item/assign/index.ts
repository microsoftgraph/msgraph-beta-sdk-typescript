...
export function deserializeIntoAssignPostRequestBody(assignPostRequestBody: Partial<AssignPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "assignments": n => { assignPostRequestBody.assignments = n.getCollectionOfObjectValues<WindowsFeatureUpdateProfileAssignment>(createWindowsFeatureUpdateProfileAssignmentFromDiscriminatorValue); },
...
export function serializeAssignPostRequestBody(writer: SerializationWriter, assignPostRequestBody: Partial<AssignPostRequestBody> | undefined | null = {}) : void {
    if (assignPostRequestBody) {
        writer.writeCollectionOfObjectValues<WindowsFeatureUpdateProfileAssignment>("assignments", assignPostRequestBody.assignments, serializeWindowsFeatureUpdateProfileAssignment);
 ...
 */
export const AssignRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/windowsFeatureUpdateProfiles/{windowsFeatureUpdateProfile%2Did}/assign";
/**
