...
export function deserializeIntoGetComplianceSettingsReportPostRequestBody(getComplianceSettingsReportPostRequestBody: Partial<GetComplianceSettingsReportPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "groupBy": n => { getComplianceSettingsReportPostRequestBody.groupBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "name": n => { getComplianceSettingsReportPostRequestBody.name = n.getStringValue(); },
        "orderBy": n => { getComplianceSettingsReportPostRequestBody.orderBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "search": n => { getComplianceSettingsReportPostRequestBody.search = n.getStringValue(); },
        "select": n => { getComplianceSettingsReportPostRequestBody.select = n.getCollectionOfPrimitiveValues<string>("string"); },
