 ...
 * @param GetUnhealthyFirewallReportPostRequestBody The instance to deserialize into.
...
export function deserializeIntoGetUnhealthyFirewallReportPostRequestBody(getUnhealthyFirewallReportPostRequestBody: Partial<GetUnhealthyFirewallReportPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "groupBy": n => { getUnhealthyFirewallReportPostRequestBody.groupBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "name": n => { getUnhealthyFirewallReportPostRequestBody.name = n.getStringValue(); },
        "orderBy": n => { getUnhealthyFirewallReportPostRequestBody.orderBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "search": n => { getUnhealthyFirewallReportPostRequestBody.search = n.getStringValue(); },
        "select": n => { getUnhealthyFirewallReportPostRequestBody.select = n.getCollectionOfPrimitiveValues<string>("string"); },
 ...
 * @param GetUnhealthyFirewallReportPostRequestBody The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeGetUnhealthyFirewallReportPostRequestBody(writer: SerializationWriter, getUnhealthyFirewallReportPostRequestBody: Partial<GetUnhealthyFirewallReportPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!getUnhealthyFirewallReportPostRequestBody || isSerializingDerivedType) { return; }
