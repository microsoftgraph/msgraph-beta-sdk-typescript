 ...
 * @param GetWindowsDriverUpdateAlertSummaryReportPostRequestBody The instance to deserialize into.
...
export function deserializeIntoGetWindowsDriverUpdateAlertSummaryReportPostRequestBody(getWindowsDriverUpdateAlertSummaryReportPostRequestBody: Partial<GetWindowsDriverUpdateAlertSummaryReportPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "groupBy": n => { getWindowsDriverUpdateAlertSummaryReportPostRequestBody.groupBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "name": n => { getWindowsDriverUpdateAlertSummaryReportPostRequestBody.name = n.getStringValue(); },
        "orderBy": n => { getWindowsDriverUpdateAlertSummaryReportPostRequestBody.orderBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "search": n => { getWindowsDriverUpdateAlertSummaryReportPostRequestBody.search = n.getStringValue(); },
        "select": n => { getWindowsDriverUpdateAlertSummaryReportPostRequestBody.select = n.getCollectionOfPrimitiveValues<string>("string"); },
 ...
 * @param GetWindowsDriverUpdateAlertSummaryReportPostRequestBody The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeGetWindowsDriverUpdateAlertSummaryReportPostRequestBody(writer: SerializationWriter, getWindowsDriverUpdateAlertSummaryReportPostRequestBody: Partial<GetWindowsDriverUpdateAlertSummaryReportPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!getWindowsDriverUpdateAlertSummaryReportPostRequestBody || isSerializingDerivedType) { return; }
