 ...
 * @param GetAllCertificatesReportPostRequestBody The instance to deserialize into.
...
export function deserializeIntoGetAllCertificatesReportPostRequestBody(getAllCertificatesReportPostRequestBody: Partial<GetAllCertificatesReportPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "groupBy": n => { getAllCertificatesReportPostRequestBody.groupBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "name": n => { getAllCertificatesReportPostRequestBody.name = n.getStringValue(); },
        "orderBy": n => { getAllCertificatesReportPostRequestBody.orderBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "search": n => { getAllCertificatesReportPostRequestBody.search = n.getStringValue(); },
        "select": n => { getAllCertificatesReportPostRequestBody.select = n.getCollectionOfPrimitiveValues<string>("string"); },
 ...
 * @param GetAllCertificatesReportPostRequestBody The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeGetAllCertificatesReportPostRequestBody(writer: SerializationWriter, getAllCertificatesReportPostRequestBody: Partial<GetAllCertificatesReportPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!getAllCertificatesReportPostRequestBody || isSerializingDerivedType) { return; }
