...
export function deserializeIntoGetSettingNonComplianceReportPostRequestBody(getSettingNonComplianceReportPostRequestBody: Partial<GetSettingNonComplianceReportPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "groupBy": n => { getSettingNonComplianceReportPostRequestBody.groupBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "name": n => { getSettingNonComplianceReportPostRequestBody.name = n.getStringValue(); },
        "orderBy": n => { getSettingNonComplianceReportPostRequestBody.orderBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "search": n => { getSettingNonComplianceReportPostRequestBody.search = n.getStringValue(); },
        "select": n => { getSettingNonComplianceReportPostRequestBody.select = n.getCollectionOfPrimitiveValues<string>("string"); },
