 ...
 * @param GetMobileApplicationManagementAppConfigurationReportPostRequestBody The instance to deserialize into.
...
export function deserializeIntoGetMobileApplicationManagementAppConfigurationReportPostRequestBody(getMobileApplicationManagementAppConfigurationReportPostRequestBody: Partial<GetMobileApplicationManagementAppConfigurationReportPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "groupBy": n => { getMobileApplicationManagementAppConfigurationReportPostRequestBody.groupBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "name": n => { getMobileApplicationManagementAppConfigurationReportPostRequestBody.name = n.getStringValue(); },
        "orderBy": n => { getMobileApplicationManagementAppConfigurationReportPostRequestBody.orderBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "search": n => { getMobileApplicationManagementAppConfigurationReportPostRequestBody.search = n.getStringValue(); },
        "select": n => { getMobileApplicationManagementAppConfigurationReportPostRequestBody.select = n.getCollectionOfPrimitiveValues<string>("string"); },
 ...
 * @param GetMobileApplicationManagementAppConfigurationReportPostRequestBody The instance to serialize from.
 * @param isSerializingDerivedType A boolean indicating whether the serialization is for a derived type.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeGetMobileApplicationManagementAppConfigurationReportPostRequestBody(writer: SerializationWriter, getMobileApplicationManagementAppConfigurationReportPostRequestBody: Partial<GetMobileApplicationManagementAppConfigurationReportPostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!getMobileApplicationManagementAppConfigurationReportPostRequestBody || isSerializingDerivedType) { return; }
