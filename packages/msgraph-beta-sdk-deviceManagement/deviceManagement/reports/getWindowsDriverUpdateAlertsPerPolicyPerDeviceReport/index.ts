...
export function deserializeIntoGetWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPostRequestBody(getWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPostRequestBody: Partial<GetWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "groupBy": n => { getWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPostRequestBody.groupBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "name": n => { getWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPostRequestBody.name = n.getStringValue(); },
        "orderBy": n => { getWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPostRequestBody.orderBy = n.getCollectionOfPrimitiveValues<string>("string"); },
        "search": n => { getWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPostRequestBody.search = n.getStringValue(); },
        "select": n => { getWindowsDriverUpdateAlertsPerPolicyPerDeviceReportPostRequestBody.select = n.getCollectionOfPrimitiveValues<string>("string"); },
