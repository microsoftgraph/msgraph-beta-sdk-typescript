 ...
 */
export interface ConfigurationSettingsRequestBuilder extends BaseRequestBuilder<ConfigurationSettingsRequestBuilder> {
    /**
     ...
     */
     get(requestConfiguration?: RequestConfiguration<ConfigurationSettingsRequestBuilderGetQueryParameters> | undefined) : Promise<DeviceManagementConfigurationSettingDefinitionCollectionResponse | undefined>;
    /**
     ...
     */
     toGetRequestInformation(requestConfiguration?: RequestConfiguration<ConfigurationSettingsRequestBuilderGetQueryParameters> | undefined) : RequestInformation;
    /**
     * Create new navigation property to configurationSettings for deviceManagement
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 * List of all ConfigurationSettings
 */
export interface ConfigurationSettingsRequestBuilderGetQueryParameters {
    /**
 ...
 */
const ConfigurationSettingsRequestBuilderGetQueryParametersMapper: Record<string, string> = {
    "count": "%24count",
    "expand": "%24expand",
    "filter": "%24filter",
    "orderby": "%24orderby",
 ...
 */
export const ConfigurationSettingsRequestBuilderNavigationMetadata: Record<Exclude<keyof ConfigurationSettingsRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
 ...
 */
export const ConfigurationSettingsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        queryParametersMapper: ConfigurationSettingsRequestBuilderGetQueryParametersMapper,
    },
    post: {
        responseBodyContentType: "application/json",
        errorMappings: {
 ...
 */
export const ConfigurationSettingsRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/configurationSettings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
