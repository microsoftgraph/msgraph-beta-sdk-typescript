 ...
 */
export const DefinitionFileRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition/definitionFile{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
