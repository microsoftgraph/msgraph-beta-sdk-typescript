 ...
 */
export const CategoryRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/nextVersionDefinition/category{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
