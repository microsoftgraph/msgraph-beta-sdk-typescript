 ...
 */
export const CategoryRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/groupPolicyDefinitions/{groupPolicyDefinition%2Did}/previousVersionDefinition/category{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
