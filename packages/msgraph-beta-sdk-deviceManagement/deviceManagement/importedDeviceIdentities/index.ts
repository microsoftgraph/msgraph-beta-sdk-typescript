...
// @ts-ignore
import { createImportedDeviceIdentityCollectionResponseFromDiscriminatorValue, createImportedDeviceIdentityFromDiscriminatorValue, serializeImportedDeviceIdentity, type ImportedDeviceIdentity, type ImportedDeviceIdentityCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { ImportDeviceIdentityListRequestBuilderRequestsMetadata, type ImportDeviceIdentityListRequestBuilder } from './importDeviceIdentityList/index.js';
// @ts-ignore
import { ImportedDeviceIdentityItemRequestBuilderRequestsMetadata, type ImportedDeviceIdentityItemRequestBuilder } from './item/index.js';
// @ts-ignore
import { SearchExistingIdentitiesRequestBuilderRequestsMetadata, type SearchExistingIdentitiesRequestBuilder } from './searchExistingIdentities/index.js';
// @ts-ignore
