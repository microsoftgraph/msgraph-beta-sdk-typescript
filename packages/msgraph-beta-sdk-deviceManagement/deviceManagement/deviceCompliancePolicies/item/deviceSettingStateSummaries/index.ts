...
import { createSettingStateDeviceSummaryCollectionResponseFromDiscriminatorValue, createSettingStateDeviceSummaryFromDiscriminatorValue, serializeSettingStateDeviceSummary, type SettingStateDeviceSummary, type SettingStateDeviceSummaryCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/';
 ...
 */
export const DeviceSettingStateSummariesRequestBuilderUriTemplate = "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/deviceSettingStateSummaries{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
