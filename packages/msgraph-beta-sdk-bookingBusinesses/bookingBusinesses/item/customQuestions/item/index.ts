 ...
 */
export const BookingCustomQuestionItemRequestBuilderUriTemplate = "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/customQuestions/{bookingCustomQuestion%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
