 ...
 */
export const BookingAppointmentItemRequestBuilderUriTemplate = "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/calendarView/{bookingAppointment%2Did}{?start*,end*,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
