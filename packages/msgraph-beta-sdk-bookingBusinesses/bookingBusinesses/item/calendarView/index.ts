...
// @ts-ignore
import { createBookingAppointmentCollectionResponseFromDiscriminatorValue, createBookingAppointmentFromDiscriminatorValue, serializeBookingAppointment, type BookingAppointment, type BookingAppointmentCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
 ...
 */
export const CalendarViewRequestBuilderUriTemplate = "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/calendarView{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
...
export const CalendarViewRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/calendarView?end={end}&start={start}{&%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}",
