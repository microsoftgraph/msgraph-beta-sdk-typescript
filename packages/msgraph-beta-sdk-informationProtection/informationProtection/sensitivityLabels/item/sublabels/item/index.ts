 ...
 */
export const SensitivityLabelItemRequestBuilderUriTemplate = "{+baseurl}/informationProtection/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/{sensitivityLabel%2Did1}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
