...
// @ts-ignore
import { createDriveItemFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeDriveItem, type BaseCollectionPaginationCountResponse, type DriveItem } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface SharedWithMeRequestBuilder extends BaseRequestBuilder<SharedWithMeRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/drive-sharedwithme?view=graph-rest-beta|Find more info here}
     */
