...
// @ts-ignore
import { createItemRetentionLabelFromDiscriminatorValue, serializeItemRetentionLabel, type ItemRetentionLabel } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RetentionLabelRequestBuilder extends BaseRequestBuilder<RetentionLabelRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/driveitem-removeretentionlabel?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/driveitem-getretentionlabel?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<ItemRetentionLabel>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/driveitem-lockorunlockrecord?view=graph-rest-beta|Find more info here}
     */
