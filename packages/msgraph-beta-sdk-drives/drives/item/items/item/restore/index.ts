...
// @ts-ignore
import { createDriveItemFromDiscriminatorValue, createItemReferenceFromDiscriminatorValue, serializeDriveItem, serializeItemReference, type DriveItem, type ItemReference } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RestoreRequestBuilder extends BaseRequestBuilder<RestoreRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/driveitem-restore?view=graph-rest-beta|Find more info here}
     */
