...
// @ts-ignore
import { createDriveItemFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeDriveItem, type BaseDeltaFunctionResponse, type DriveItem } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DeltaRequestBuilder extends BaseRequestBuilder<DeltaRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/driveitem-delta?view=graph-rest-beta|Find more info here}
     */
