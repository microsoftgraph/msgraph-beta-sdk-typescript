...
// @ts-ignore
import { createWorkbookSessionInfoFromDiscriminatorValue, serializeWorkbookSessionInfo, type WorkbookSessionInfo } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface CreateSessionRequestBuilder extends BaseRequestBuilder<CreateSessionRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/workbook-createsession?view=graph-rest-beta|Find more info here}
     */
