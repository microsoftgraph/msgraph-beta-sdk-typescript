...
import { createWorkbookChartDataLabelsFromDiscriminatorValue, serializeWorkbookChartDataLabels, type WorkbookChartDataLabels } from '@microsoft/msgraph-beta-sdk/models/';
 ...
 */
export const DataLabelsRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/itemAt(index={index})/dataLabels{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
