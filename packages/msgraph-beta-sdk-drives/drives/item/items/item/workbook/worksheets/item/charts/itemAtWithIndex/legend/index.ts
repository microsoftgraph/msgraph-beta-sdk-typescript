...
// @ts-ignore
import { createWorkbookChartLegendFromDiscriminatorValue, serializeWorkbookChartLegend, type WorkbookChartLegend } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
