...
// @ts-ignore
import { createWorkbookChartLineFormatFromDiscriminatorValue, serializeWorkbookChartLineFormat, type WorkbookChartLineFormat } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
