...
// @ts-ignore
import { createWorkbookRangeFromDiscriminatorValue, type WorkbookRange } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface HeaderRowRangeRequestBuilder extends BaseRequestBuilder<HeaderRowRangeRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/tablecolumn-headerrowrange?view=graph-rest-beta|Find more info here}
     */
