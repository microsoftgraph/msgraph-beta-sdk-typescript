...
// @ts-ignore
import { createWorkbookChartLegendFormatFromDiscriminatorValue, serializeWorkbookChartLegendFormat, type WorkbookChartLegendFormat } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
