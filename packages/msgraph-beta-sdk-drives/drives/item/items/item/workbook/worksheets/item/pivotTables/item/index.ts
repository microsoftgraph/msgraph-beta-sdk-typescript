...
// @ts-ignore
import { createWorkbookPivotTableFromDiscriminatorValue, serializeWorkbookPivotTable, type WorkbookPivotTable } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
