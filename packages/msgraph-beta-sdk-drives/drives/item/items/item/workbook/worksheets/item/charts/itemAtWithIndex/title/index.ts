...
// @ts-ignore
import { createWorkbookChartTitleFromDiscriminatorValue, serializeWorkbookChartTitle, type WorkbookChartTitle } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
