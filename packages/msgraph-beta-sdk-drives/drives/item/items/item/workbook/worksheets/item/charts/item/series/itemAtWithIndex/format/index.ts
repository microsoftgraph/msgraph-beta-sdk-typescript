...
// @ts-ignore
import { createWorkbookChartSeriesFormatFromDiscriminatorValue, serializeWorkbookChartSeriesFormat, type WorkbookChartSeriesFormat } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
