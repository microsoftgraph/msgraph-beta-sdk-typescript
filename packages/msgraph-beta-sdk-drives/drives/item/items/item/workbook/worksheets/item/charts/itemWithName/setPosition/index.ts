...
// @ts-ignore
import { createJsonFromDiscriminatorValue, serializeJson, type Json } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface SetPositionRequestBuilder extends BaseRequestBuilder<SetPositionRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/chart-setposition?view=graph-rest-beta|Find more info here}
     */
