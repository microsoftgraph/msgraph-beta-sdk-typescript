...
// @ts-ignore
import { createWorkbookChartDataLabelFormatFromDiscriminatorValue, serializeWorkbookChartDataLabelFormat, type WorkbookChartDataLabelFormat } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
