...
// @ts-ignore
import { createWorkbookChartFillFromDiscriminatorValue, serializeWorkbookChartFill, type WorkbookChartFill } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
