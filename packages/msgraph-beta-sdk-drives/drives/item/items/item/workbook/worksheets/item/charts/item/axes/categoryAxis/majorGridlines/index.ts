...
// @ts-ignore
import { createWorkbookChartGridlinesFromDiscriminatorValue, serializeWorkbookChartGridlines, type WorkbookChartGridlines } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
