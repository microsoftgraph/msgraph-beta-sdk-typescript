...
// @ts-ignore
import { createJsonFromDiscriminatorValue, createWorkbookTableRowFromDiscriminatorValue, serializeJson, serializeWorkbookTableRow, type Json, type WorkbookTableRow } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface AddRequestBuilder extends BaseRequestBuilder<AddRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/tablerowcollection-add?view=graph-rest-beta|Find more info here}
     */
