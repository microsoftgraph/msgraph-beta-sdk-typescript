...
// @ts-ignore
import { createWorkbookDocumentTaskFromDiscriminatorValue, type WorkbookDocumentTask } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { ChangesRequestBuilderRequestsMetadata, type ChangesRequestBuilder } from './changes/index.js';
// @ts-ignore
import { CommentRequestBuilderRequestsMetadata, type CommentRequestBuilder } from './comment/index.js';
// @ts-ignore
