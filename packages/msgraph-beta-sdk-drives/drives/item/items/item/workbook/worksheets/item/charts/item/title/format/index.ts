...
// @ts-ignore
import { createWorkbookChartTitleFormatFromDiscriminatorValue, serializeWorkbookChartTitleFormat, type WorkbookChartTitleFormat } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
