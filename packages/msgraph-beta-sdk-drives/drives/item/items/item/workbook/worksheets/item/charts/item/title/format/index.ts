...
// @ts-ignore
import { createWorkbookChartTitleFormatFromDiscriminatorValue, serializeWorkbookChartTitleFormat, type WorkbookChartTitleFormat } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
