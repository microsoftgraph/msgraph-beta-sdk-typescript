...
import { createWorkbookWorksheetFromDiscriminatorValue, type WorkbookWorksheet } from '@microsoft/msgraph-beta-sdk/models/';
 ...
 */
export const WorksheetRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/itemAt(index={index})/worksheet{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
