...
// @ts-ignore
import { createWorkbookChartSeriesFromDiscriminatorValue, serializeWorkbookChartSeries, type WorkbookChartSeries } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
