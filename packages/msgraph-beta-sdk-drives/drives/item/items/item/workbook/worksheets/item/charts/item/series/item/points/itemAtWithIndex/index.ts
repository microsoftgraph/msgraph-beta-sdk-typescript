...
// @ts-ignore
import { createWorkbookChartPointFromDiscriminatorValue, type WorkbookChartPoint } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ItemAtWithIndexRequestBuilder extends BaseRequestBuilder<ItemAtWithIndexRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/chartpointscollection-itemat?view=graph-rest-beta|Find more info here}
     */
