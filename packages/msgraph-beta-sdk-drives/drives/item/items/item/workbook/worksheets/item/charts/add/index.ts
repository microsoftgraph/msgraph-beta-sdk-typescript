...
// @ts-ignore
import { createJsonFromDiscriminatorValue, createWorkbookChartFromDiscriminatorValue, serializeJson, serializeWorkbookChart, type Json, type WorkbookChart } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface AddRequestBuilder extends BaseRequestBuilder<AddRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/chartcollection-add?view=graph-rest-beta|Find more info here}
     */
