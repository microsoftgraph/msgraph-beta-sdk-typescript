...
// @ts-ignore
import { createWorkbookChartAxisTitleFromDiscriminatorValue, serializeWorkbookChartAxisTitle, type WorkbookChartAxisTitle } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
