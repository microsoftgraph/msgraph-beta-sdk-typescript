...
// @ts-ignore
import { createWorkbookChartFromDiscriminatorValue, type WorkbookChart } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ItemAtWithIndexRequestBuilder extends BaseRequestBuilder<ItemAtWithIndexRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/chartcollection-itemat?view=graph-rest-beta|Find more info here}
     */
