...
// @ts-ignore
import { createJsonFromDiscriminatorValue, createWorkbookTableColumnFromDiscriminatorValue, serializeJson, serializeWorkbookTableColumn, type Json, type WorkbookTableColumn } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface AddRequestBuilder extends BaseRequestBuilder<AddRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/tablecolumncollection-add?view=graph-rest-beta|Find more info here}
     */
