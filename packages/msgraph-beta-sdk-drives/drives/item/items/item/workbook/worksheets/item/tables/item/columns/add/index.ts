...
// @ts-ignore
import { createWorkbookTableColumnFromDiscriminatorValue, serializeWorkbookTableColumn, type WorkbookTableColumn } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
