...
// @ts-ignore
import { createWorkbookChartAreaFormatFromDiscriminatorValue, serializeWorkbookChartAreaFormat, type WorkbookChartAreaFormat } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
