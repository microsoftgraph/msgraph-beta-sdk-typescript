...
// @ts-ignore
import { createWorkbookChartGridlinesFormatFromDiscriminatorValue, serializeWorkbookChartGridlinesFormat, type WorkbookChartGridlinesFormat } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
