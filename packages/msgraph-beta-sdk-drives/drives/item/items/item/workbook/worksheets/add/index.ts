...
// @ts-ignore
import { createWorkbookWorksheetFromDiscriminatorValue, serializeWorkbookWorksheet, type WorkbookWorksheet } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AddRequestBuilder extends BaseRequestBuilder<AddRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/worksheetcollection-add?view=graph-rest-beta|Find more info here}
     */
