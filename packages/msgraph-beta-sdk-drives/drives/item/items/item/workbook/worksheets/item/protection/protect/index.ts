...
// @ts-ignore
import { createWorkbookWorksheetProtectionOptionsFromDiscriminatorValue, serializeWorkbookWorksheetProtectionOptions, type WorkbookWorksheetProtectionOptions } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ProtectRequestBuilder extends BaseRequestBuilder<ProtectRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/worksheetprotection-protect?view=graph-rest-beta|Find more info here}
     */
