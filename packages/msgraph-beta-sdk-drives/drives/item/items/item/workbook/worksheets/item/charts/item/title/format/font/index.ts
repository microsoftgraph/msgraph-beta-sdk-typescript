...
// @ts-ignore
import { createWorkbookChartFontFromDiscriminatorValue, serializeWorkbookChartFont, type WorkbookChartFont } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
