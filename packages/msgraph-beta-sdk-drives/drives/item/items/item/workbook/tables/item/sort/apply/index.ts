...
// @ts-ignore
import { createWorkbookSortFieldFromDiscriminatorValue, serializeWorkbookSortField, type WorkbookSortField } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ApplyRequestBuilder extends BaseRequestBuilder<ApplyRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/tablesort-apply?view=graph-rest-beta|Find more info here}
     */
