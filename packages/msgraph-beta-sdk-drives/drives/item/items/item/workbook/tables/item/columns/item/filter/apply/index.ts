...
// @ts-ignore
import { createWorkbookFilterCriteriaFromDiscriminatorValue, serializeWorkbookFilterCriteria, type WorkbookFilterCriteria } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
