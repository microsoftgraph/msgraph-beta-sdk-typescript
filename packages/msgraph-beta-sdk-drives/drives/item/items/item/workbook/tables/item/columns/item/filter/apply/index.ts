...
// @ts-ignore
import { createWorkbookFilterCriteriaFromDiscriminatorValue, serializeWorkbookFilterCriteria, type WorkbookFilterCriteria } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ApplyRequestBuilder extends BaseRequestBuilder<ApplyRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/filter-apply?view=graph-rest-beta|Find more info here}
     */
