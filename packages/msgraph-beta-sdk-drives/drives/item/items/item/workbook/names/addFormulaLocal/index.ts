...
// @ts-ignore
import { createWorkbookNamedItemFromDiscriminatorValue, serializeWorkbookNamedItem, type WorkbookNamedItem } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AddFormulaLocalRequestBuilder extends BaseRequestBuilder<AddFormulaLocalRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/nameditem-addformulalocal?view=graph-rest-beta|Find more info here}
     */
