...
// @ts-ignore
import { createWorkbookFunctionResultFromDiscriminatorValue, serializeWorkbookFunctionResult, type WorkbookFunctionResult } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export function deserializeIntoIsNumberPostRequestBody(isNumberPostRequestBody: Partial<IsNumberPostRequestBody> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "backingStoreEnabled": n => { isNumberPostRequestBody.backingStoreEnabled = true; },
        "value": n => { isNumberPostRequestBody.value = n.getObjectValue<UntypedNode>(createUntypedNodeFromDiscriminatorValue); },
    }
}
export interface IsNumberPostRequestBody extends AdditionalDataHolder, BackedModel, Parsable {
    /**
