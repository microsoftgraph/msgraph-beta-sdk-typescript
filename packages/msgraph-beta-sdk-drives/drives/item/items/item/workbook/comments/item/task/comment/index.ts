 ...
 */
export const CommentRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments/{workbookComment%2Did}/task/comment{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
