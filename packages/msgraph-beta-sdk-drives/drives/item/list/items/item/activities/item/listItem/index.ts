 ...
 */
export const ListItemRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/listItem{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
