 ...
 */
export const ListItemRequestBuilderUriTemplate = "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/listItem{?%24expand,%24select}";
/* tslint:enable */
/* eslint-enable */
