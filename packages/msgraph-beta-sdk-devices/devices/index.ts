...
export interface DevicesRequestBuilder extends BaseRequestBuilder<DevicesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/device-list?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/device-post-devices?view=graph-rest-beta|Find more info here}
     */
