...
export interface GraphGroupRequestBuilder extends BaseRequestBuilder<GraphGroupRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/device-list-transitivememberof?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const GraphGroupRequestBuilderUriTemplate = "{+baseurl}/devices/{device%2Did}/transitiveMemberOf/{directoryObject%2Did}/graph.group{?%24expand,%24select}";
/**
