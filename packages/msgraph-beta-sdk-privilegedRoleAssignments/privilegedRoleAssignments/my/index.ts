...
// @ts-ignore
import { createPrivilegedRoleAssignmentFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializePrivilegedRoleAssignment, type BaseCollectionPaginationCountResponse, type PrivilegedRoleAssignment } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export function deserializeIntoMyGetResponse(myGetResponse: Partial<MyGetResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "value": n => { myGetResponse.value = n.getCollectionOfObjectValues<PrivilegedRoleAssignment>(createPrivilegedRoleAssignmentFromDiscriminatorValue); },
    }
}
 ...
 */
export const MyRequestBuilderUriTemplate = "{+baseurl}/privilegedRoleAssignments/my(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
