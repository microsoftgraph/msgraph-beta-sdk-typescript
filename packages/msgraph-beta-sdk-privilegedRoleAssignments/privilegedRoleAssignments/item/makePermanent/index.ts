 ...
 */
// @ts-ignore
export function serializeMakePermanentPostRequestBody(writer: SerializationWriter, makePermanentPostRequestBody: Partial<MakePermanentPostRequestBody> | undefined | null = {}) : void {
    if (makePermanentPostRequestBody) {
