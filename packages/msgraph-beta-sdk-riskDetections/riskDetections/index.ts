...
// @ts-ignore
import { createRiskDetectionCollectionResponseFromDiscriminatorValue, createRiskDetectionFromDiscriminatorValue, serializeRiskDetection, type RiskDetection, type RiskDetectionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { RiskDetectionItemRequestBuilderRequestsMetadata, type RiskDetectionItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface RiskDetectionsRequestBuilder extends BaseRequestBuilder<RiskDetectionsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/riskdetection-list?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const RiskDetectionsRequestBuilderUriTemplate = "{+baseurl}/riskDetections{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
