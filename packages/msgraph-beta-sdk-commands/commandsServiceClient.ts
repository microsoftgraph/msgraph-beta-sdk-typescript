...
export function createCommandsServiceClient(requestAdapter: RequestAdapter, backingStore?: BackingStoreFactory | undefined) {
    ...
    return apiClientProxifier<CommandsServiceClient>(requestAdapter, pathParameters, CommandsServiceClientUriTemplate, CommandsServiceClientNavigationMetadata, undefined);
}
/**
