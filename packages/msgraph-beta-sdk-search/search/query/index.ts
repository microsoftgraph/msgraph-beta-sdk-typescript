...
export interface QueryRequestBuilder extends BaseRequestBuilder<QueryRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/search-query?view=graph-rest-beta|Find more info here}
     */
