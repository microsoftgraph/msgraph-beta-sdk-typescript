...
// @ts-ignore
import { createQnaFromDiscriminatorValue, serializeQna, type Qna } from '@microsoft/msgraph-beta-sdk/models/search/index.js';
// @ts-ignore
...
export interface QnaItemRequestBuilder extends BaseRequestBuilder<QnaItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/search-qna-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Qna>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/search-qna-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Qna>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/search-qna-update?view=graph-rest-beta|Find more info here}
     */
