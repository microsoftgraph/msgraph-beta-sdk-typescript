...
// @ts-ignore
import { createQnaCollectionResponseFromDiscriminatorValue, createQnaFromDiscriminatorValue, serializeQna, type Qna, type QnaCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/search/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { QnaItemRequestBuilderRequestsMetadata, type QnaItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface QnasRequestBuilder extends BaseRequestBuilder<QnasRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/search-searchentity-list-qnas?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Qna>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/search-searchentity-post-qnas?view=graph-rest-beta|Find more info here}
     */
