...
import { createQnaCollectionResponseFromDiscriminatorValue, createQnaFromDiscriminatorValue, serializeQna, type Qna, type QnaCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/search/';
import { CountRequestBuilderRequestsMetadata, CountRequestBuilderUriTemplate, type CountRequestBuilder } from './count/';
import { QnaItemRequestBuilderRequestsMetadata, QnaItemRequestBuilderUriTemplate, type QnaItemRequestBuilder } from './item/';
 ...
 */
export const QnasRequestBuilderUriTemplate = "{+baseurl}/search/qnas{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
