...
// @ts-ignore
import { createBookmarkCollectionResponseFromDiscriminatorValue, createBookmarkFromDiscriminatorValue, serializeBookmark, type Bookmark, type BookmarkCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/search/index.js';
// @ts-ignore
...
export interface BookmarksRequestBuilder extends BaseRequestBuilder<BookmarksRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/search-searchentity-list-bookmarks?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/search-searchentity-post-bookmarks?view=graph-rest-beta|Find more info here}
     */
