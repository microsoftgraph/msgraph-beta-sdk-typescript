...
// @ts-ignore
import { createBookmarkFromDiscriminatorValue, serializeBookmark, type Bookmark } from '@microsoft/msgraph-beta-sdk/models/search/index.js';
// @ts-ignore
...
export interface BookmarkItemRequestBuilder extends BaseRequestBuilder<BookmarkItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/search-bookmark-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/search-bookmark-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Bookmark>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/search-bookmark-update?view=graph-rest-beta|Find more info here}
     */
