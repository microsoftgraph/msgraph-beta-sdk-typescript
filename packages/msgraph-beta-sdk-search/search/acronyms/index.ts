...
export interface AcronymsRequestBuilder extends BaseRequestBuilder<AcronymsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/search-searchentity-list-acronyms?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/search-searchentity-post-acronyms?view=graph-rest-beta|Find more info here}
     */
