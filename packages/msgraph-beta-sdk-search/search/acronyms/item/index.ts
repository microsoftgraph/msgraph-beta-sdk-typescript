...
// @ts-ignore
import { createAcronymFromDiscriminatorValue, serializeAcronym, type Acronym } from '@microsoft/msgraph-beta-sdk/models/search/index.js';
// @ts-ignore
...
export interface AcronymItemRequestBuilder extends BaseRequestBuilder<AcronymItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/search-acronym-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/search-acronym-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<Acronym>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/search-acronym-update?view=graph-rest-beta|Find more info here}
     */
