 ...
 */
export const RoleSettingRequestBuilderUriTemplate = "{+baseurl}/governanceRoleSettings/{governanceRoleSetting%2Did}/roleDefinition/roleSetting{?%24expand,%24select}";
/* tslint:enable */
/* eslint-enable */
