 ...
 */
export const RoleSettingRequestBuilderUriTemplate = "{+baseurl}/governanceRoleSettings/{governanceRoleSetting%2Did}/roleDefinition/roleSetting{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
