...
// @ts-ignore
import { createServicePrincipalFromDiscriminatorValue, deserializeIntoBaseDeltaFunctionResponse, serializeBaseDeltaFunctionResponse, serializeServicePrincipal, type BaseDeltaFunctionResponse, type ServicePrincipal } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
