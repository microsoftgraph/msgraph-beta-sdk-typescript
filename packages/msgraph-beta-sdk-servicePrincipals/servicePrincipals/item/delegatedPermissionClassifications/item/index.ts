...
// @ts-ignore
import { createDelegatedPermissionClassificationFromDiscriminatorValue, serializeDelegatedPermissionClassification, type DelegatedPermissionClassification } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface DelegatedPermissionClassificationItemRequestBuilder extends BaseRequestBuilder<DelegatedPermissionClassificationItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/serviceprincipal-delete-delegatedpermissionclassifications?view=graph-rest-beta|Find more info here}
     */
