 ...
 */
export const GraphUserRequestBuilderUriTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/{directoryObject%2Did}/graph.user{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
