...
// @ts-ignore
import { createSynchronizationTemplateCollectionResponseFromDiscriminatorValue, createSynchronizationTemplateFromDiscriminatorValue, serializeSynchronizationTemplate, type SynchronizationTemplate, type SynchronizationTemplateCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { SynchronizationTemplateItemRequestBuilderNavigationMetadata, SynchronizationTemplateItemRequestBuilderRequestsMetadata, type SynchronizationTemplateItemRequestBuilder } from './item/index.js';
// @ts-ignore
 ...
 */
export const TemplatesRequestBuilderUriTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
