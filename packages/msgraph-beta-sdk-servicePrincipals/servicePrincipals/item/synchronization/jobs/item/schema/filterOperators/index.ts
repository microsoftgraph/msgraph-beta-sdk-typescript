...
// @ts-ignore
import { createFilterOperatorSchemaFromDiscriminatorValue, deserializeIntoBaseCollectionPaginationCountResponse, serializeBaseCollectionPaginationCountResponse, serializeFilterOperatorSchema, type BaseCollectionPaginationCountResponse, type FilterOperatorSchema } from '@microsoft/msgraph-beta-sdk/models/';
// @ts-ignore
...
export interface FilterOperatorsRequestBuilder extends BaseRequestBuilder<FilterOperatorsRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/synchronization-synchronizationschema-filteroperators?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const FilterOperatorsRequestBuilderUriTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/filterOperators(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
