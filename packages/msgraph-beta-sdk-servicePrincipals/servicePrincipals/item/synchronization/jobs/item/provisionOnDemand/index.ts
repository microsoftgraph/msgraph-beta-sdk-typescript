...
// @ts-ignore
import { createStringKeyStringValuePairFromDiscriminatorValue, createSynchronizationJobApplicationParametersFromDiscriminatorValue, serializeStringKeyStringValuePair, serializeSynchronizationJobApplicationParameters, type StringKeyStringValuePair, type SynchronizationJobApplicationParameters } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface ProvisionOnDemandRequestBuilder extends BaseRequestBuilder<ProvisionOnDemandRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/synchronization-synchronizationjob-provisionondemand?view=graph-rest-beta|Find more info here}
     */
