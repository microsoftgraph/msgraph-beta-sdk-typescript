...
// @ts-ignore
import { createSynchronizationJobRestartCriteriaFromDiscriminatorValue, serializeSynchronizationJobRestartCriteria, type SynchronizationJobRestartCriteria } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RestartRequestBuilder extends BaseRequestBuilder<RestartRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/synchronization-synchronizationjob-restart?view=graph-rest-beta|Find more info here}
     */
