...
// @ts-ignore
import { createSelfSignedCertificateFromDiscriminatorValue, serializeSelfSignedCertificate, type SelfSignedCertificate } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AddTokenSigningCertificateRequestBuilder extends BaseRequestBuilder<AddTokenSigningCertificateRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/serviceprincipal-addtokensigningcertificate?view=graph-rest-beta|Find more info here}
     */
