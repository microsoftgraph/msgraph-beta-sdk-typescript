 ...
 */
export const LicenseDetailsItemRequestBuilderUriTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/licenseDetails/{licenseDetails%2Did}{?%24select,%24expand}";
/* tslint:enable */
/* eslint-enable */
