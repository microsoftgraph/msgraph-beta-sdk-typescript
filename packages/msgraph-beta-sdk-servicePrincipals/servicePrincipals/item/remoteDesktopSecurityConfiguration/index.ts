...
// @ts-ignore
import { createRemoteDesktopSecurityConfigurationFromDiscriminatorValue, serializeRemoteDesktopSecurityConfiguration, type RemoteDesktopSecurityConfiguration } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface RemoteDesktopSecurityConfigurationRequestBuilder extends BaseRequestBuilder<RemoteDesktopSecurityConfigurationRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/serviceprincipal-delete-remotedesktopsecurityconfiguration?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/remotedesktopsecurityconfiguration-get?view=graph-rest-beta|Find more info here}
     */
     ...
     * @returns {Promise<RemoteDesktopSecurityConfiguration>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/remotedesktopsecurityconfiguration-update?view=graph-rest-beta|Find more info here}
     */
