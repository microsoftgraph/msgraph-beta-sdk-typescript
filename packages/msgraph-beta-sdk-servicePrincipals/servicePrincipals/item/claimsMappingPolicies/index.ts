...
// @ts-ignore
import { createClaimsMappingPolicyCollectionResponseFromDiscriminatorValue, type ClaimsMappingPolicyCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { CountRequestBuilderRequestsMetadata, type CountRequestBuilder } from './count/index.js';
// @ts-ignore
import { ClaimsMappingPolicyItemRequestBuilderNavigationMetadata, type ClaimsMappingPolicyItemRequestBuilder } from './item/index.js';
// @ts-ignore
...
export interface ClaimsMappingPoliciesRequestBuilder extends BaseRequestBuilder<ClaimsMappingPoliciesRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/serviceprincipal-list-claimsmappingpolicies?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const ClaimsMappingPoliciesRequestBuilderUriTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/claimsMappingPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
