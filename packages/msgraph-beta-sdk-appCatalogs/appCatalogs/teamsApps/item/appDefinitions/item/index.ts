...
// @ts-ignore
import { createTeamsAppDefinitionFromDiscriminatorValue, serializeTeamsAppDefinition, type TeamsAppDefinition } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
import { createODataErrorFromDiscriminatorValue, type ODataError } from '@microsoft/msgraph-beta-sdk/models/oDataErrors/index.js';
// @ts-ignore
import { BotRequestBuilderRequestsMetadata, type BotRequestBuilder } from './bot/index.js';
// @ts-ignore
import { ColorIconRequestBuilderNavigationMetadata, ColorIconRequestBuilderRequestsMetadata, type ColorIconRequestBuilder } from './colorIcon/index.js';
// @ts-ignore
import { DashboardCardsRequestBuilderNavigationMetadata, DashboardCardsRequestBuilderRequestsMetadata, type DashboardCardsRequestBuilder } from './dashboardCards/index.js';
// @ts-ignore
import { OutlineIconRequestBuilderNavigationMetadata, OutlineIconRequestBuilderRequestsMetadata, type OutlineIconRequestBuilder } from './outlineIcon/index.js';
// @ts-ignore
...
export interface TeamsAppDefinitionItemRequestBuilder extends BaseRequestBuilder<TeamsAppDefinitionItemRequestBuilder> {
     ...
     */
    get outlineIcon(): OutlineIconRequestBuilder;
    /**
     ...
     * @returns {Promise<TeamsAppDefinition>}
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/teamsapp-publish?view=graph-rest-beta|Find more info here}
     */
...
export const TeamsAppDefinitionItemRequestBuilderNavigationMetadata: Record<Exclude<keyof TeamsAppDefinitionItemRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ...
    outlineIcon: {
        ...
        navigationMetadata: OutlineIconRequestBuilderNavigationMetadata,
    },
};
/**
