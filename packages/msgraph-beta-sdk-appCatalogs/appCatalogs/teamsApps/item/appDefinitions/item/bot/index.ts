...
// @ts-ignore
import { createTeamworkBotFromDiscriminatorValue, serializeTeamworkBot, type TeamworkBot } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface BotRequestBuilder extends BaseRequestBuilder<BotRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/teamworkbot-get?view=graph-rest-beta|Find more info here}
     */
