...
// @ts-ignore
import { createTeamsAppDefinitionCollectionResponseFromDiscriminatorValue, createTeamsAppDefinitionFromDiscriminatorValue, serializeTeamsAppDefinition, type TeamsAppDefinition, type TeamsAppDefinitionCollectionResponse } from '@microsoft/msgraph-beta-sdk/models/index.js';
// @ts-ignore
...
export interface AppDefinitionsRequestBuilder extends BaseRequestBuilder<AppDefinitionsRequestBuilder> {
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @see {@link https://learn.microsoft.com/graph/api/teamsapp-update?view=graph-rest-beta|Find more info here}
     */
