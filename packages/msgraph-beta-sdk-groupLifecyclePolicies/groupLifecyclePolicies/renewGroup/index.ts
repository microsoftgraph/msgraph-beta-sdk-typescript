 ...
 * @returns a renewGroupPostRequestBody
 */
 ...
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
 * @returns a renewGroupPostResponse
 */
...
export interface RenewGroupRequestBuilder extends BaseRequestBuilder<RenewGroupRequestBuilder> {
     ...
     * @returns a Promise of RenewGroupPostResponse
     * @see {@link https://learn.microsoft.com/graph/api/grouplifecyclepolicy-renewgroup?view=graph-rest-1.0|Find more info here}
     */
